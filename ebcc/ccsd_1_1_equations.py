...
def lam_updates_ccsd_1_1(cc):
    ...
    L1 += 1.0*einsum('I,iaI->ia', G, LU11old)
    L1 += -1.0*einsum('ibja,jb->ia', I.ovov, L1old)
    L1 += -1.0*einsum('Iij,jaI->ia', g.oo, LU11old)
    L1 += 1.0*einsum('Iba,ibI->ia', g.vv, LU11old)
    ...
    # NOTE: This w including diagonal 
    L1 += 1.0*einsum('IJ,J,iaI->ia', w_full, S1old, LU11old)
    ...
    L1 += -1.0*einsum('ib,Ibj,jaI->ia', F.ov, U11old, LU11old)
    L1 += -1.0*einsum('Iib,bj,jaI->ia', g.ov, T1old, LU11old)
    L1 += -1.0*einsum('ja,Ibj,ibI->ia', F.ov, U11old, LU11old)
    L1 += -1.0*einsum('Ija,bj,ibI->ia', g.ov, T1old, LU11old)
    L1 += 1.0*einsum('jb,Ibj,iaI->ia', F.ov, U11old, LU11old)
    L1 += 1.0*einsum('Ijb,bj,iaI->ia', g.ov, T1old, LU11old)
    ...
    L1 += -1.0*einsum('jika,Ibj,kbI->ia', I.ooov, U11old, LU11old)
    L1 += 1.0*einsum('ibac,Icj,jbI->ia', I.ovvv, U11old, LU11old)
    L1 += 1.0*einsum('jikb,Ibj,kaI->ia', I.ooov, U11old, LU11old)
    L1 += -1.0*einsum('jbac,Icj,ibI->ia', I.ovvv, U11old, LU11old)
    ...
    L1 += -1.0*einsum('Iib,I,Jbj,jaJ->ia', g.ov, S1old, U11old, LU11old)
    L1 += -1.0*einsum('Ija,I,Jbj,ibJ->ia', g.ov, S1old, U11old, LU11old)
    L1 += 1.0*einsum('Ijb,I,Jbj,iaJ->ia', g.ov, S1old, U11old, LU11old)
    ...
    L1 += 1.0*einsum('jiab,cj,Ibk,kcI->ia', I.oovv, T1old, U11old, LU11old)
    L1 += 1.0*einsum('jiab,bk,Icj,kcI->ia', I.oovv, T1old, U11old, LU11old)
    L1 += -1.0*einsum('jibc,ck,Ibj,kaI->ia', I.oovv, T1old, U11old, LU11old)
    L1 += 1.0*einsum('jibc,cj,Ibk,kaI->ia', I.oovv, T1old, U11old, LU11old)
    L1 += -1.0*einsum('jkab,cj,Ibk,icI->ia', I.oovv, T1old, U11old, LU11old)
    L1 += 1.0*einsum('jkab,bj,Ick,icI->ia', I.oovv, T1old, U11old, LU11old)
    L1 += -1.0*einsum('jkbc,cj,Ibk,iaI->ia', I.oovv, T1old, U11old, LU11old)
    ...
    L2 += 1.0*einsum('Ijb,iaI->ijab', g.ov, LU11old)
    L2 += -1.0*einsum('Ija,ibI->ijab', g.ov, LU11old)
    L2 += -1.0*einsum('Iib,jaI->ijab', g.ov, LU11old)
    L2 += 1.0*einsum('Iia,jbI->ijab', g.ov, LU11old)
    ...
    L2 += -1.0*einsum('jibc,Ick,kaI->ijab', I.oovv, U11old, LU11old)
    L2 += 1.0*einsum('jiac,Ick,kbI->ijab', I.oovv, U11old, LU11old)
    L2 += 1.0*einsum('kjba,Ick,icI->ijab', I.oovv, U11old, LU11old)
    L2 += -1.0*einsum('kjbc,Ick,iaI->ijab', I.oovv, U11old, LU11old)
    L2 += 1.0*einsum('kjac,Ick,ibI->ijab', I.oovv, U11old, LU11old)
    L2 += -1.0*einsum('kiba,Ick,jcI->ijab', I.oovv, U11old, LU11old)
    L2 += 1.0*einsum('kibc,Ick,jaI->ijab', I.oovv, U11old, LU11old)
    L2 += -1.0*einsum('kiac,Ick,jbI->ijab', I.oovv, U11old, LU11old)
    ...
    L2 += 2.0*einsum('ia,I->ijab', L1old, G)
    L2 += -2.0*einsum('ib,I->ijab', L1old, G)
    L2 += -2.0*einsum('ja,I->ijab', L1old, G)
    L2 += 2.0*einsum('jb,I->ijab', L1old, G)
    L2 += 1.0*einsum('I,kc->ijab', LS1old, F.ov)
    L2 += -2.0*einsum('ia,Ikl->ijab', L1old, g.oo)
    L2 += 2.0*einsum('ib,Ikl->ijab', L1old, g.oo)
    L2 += 2.0*einsum('ja,Ikl->ijab', L1old, g.oo)
    L2 += -2.0*einsum('jb,Ikl->ijab', L1old, g.oo)
    L2 += 2.0*einsum('ia,Ikc->ijab', L1old, g.ov)
    L2 += -2.0*einsum('ib,Ikc->ijab', L1old, g.ov)
    L2 += -2.0*einsum('ja,Ikc->ijab', L1old, g.ov)
    L2 += 2.0*einsum('jb,Ikc->ijab', L1old, g.ov)
    L2 += 2.0*einsum('ia,Ick->ijab', L1old, g.vo)
    L2 += -2.0*einsum('ib,Ick->ijab', L1old, g.vo)
    L2 += -2.0*einsum('ja,Ick->ijab', L1old, g.vo)
    L2 += 2.0*einsum('jb,Ick->ijab', L1old, g.vo)
    L2 += 2.0*einsum('ia,Icd->ijab', L1old, g.vv)
    L2 += -2.0*einsum('ib,Icd->ijab', L1old, g.vv)
    L2 += -2.0*einsum('ja,Icd->ijab', L1old, g.vv)
    L2 += 2.0*einsum('jb,Icd->ijab', L1old, g.vv)
    L2 += 1.0*einsum('kcI,ld->ijab', LU11old, F.ov)
    ...
    L2 += 1.0*einsum('I,J,Ikc->ijab', S1old, LS1old, g.ov)
    L2 += -1.0*einsum('ck,I,kldc->ijab', T1old, LS1old, I.oovv)
    L2 += 1.0*einsum('I,kcJ,Ild->ijab', S1old, LU11old, g.ov)
    L2 += -1.0*einsum('ck,ldI,kmec->ijab', T1old, LU11old, I.oovv)
    ...
    LS1 += 1.0*einsum('ai,iaI->I', F.vo, LU11old)
    ...
    LS1 += 1.0*einsum('J,Jai,iaI->I', G, U11old, LU11old)
    LS1 += 1.0*einsum('Jai,J,iaI->I', g.vo, S1old, LU11old)
    # NOTE: Does this want to be full F?
    LS1 += -1.0*einsum('ij,ai,jaI->I', F_full.oo, T1old, LU11old)
    LS1 += 1.0*einsum('ab,bi,iaI->I', F_full.vv, T1old, LU11old)
    LS1 += -1.0*einsum('Iia,baij,jb->I', g.ov, T2old, L1old)
    LS1 += -1.0*einsum('Iij,Jai,jaJ->I', g.oo, U11old, LU11old)
    LS1 += 1.0*einsum('Iab,Jbi,iaJ->I', g.vv, U11old, LU11old)
    LS1 += -1.0*einsum('ia,baij,jbI->I', F.ov, T2old, LU11old)
    LS1 += -1.0*einsum('Jij,Jai,jaI->I', g.oo, U11old, LU11old)
    LS1 += 1.0*einsum('Jab,Jbi,iaI->I', g.vv, U11old, LU11old)
    LS1 += -1.0*einsum('iajb,bi,jaI->I', I.ovov, T1old, LU11old)
    LS1 += 0.5*einsum('ijka,baji,kbI->I', I.ooov, T2old, LU11old)
    LS1 += -0.5*einsum('iabc,cbij,jaI->I', I.ovvv, T2old, LU11old)
    ...
    LS1 += -1.0*einsum('ia,aj,bi,jbI->I', F.ov, T1old, T1old, LU11old)
    LS1 += -1.0*einsum('Jij,ai,J,jaI->I', g.oo, T1old, S1old, LU11old)
    LS1 += 1.0*einsum('Jab,bi,J,iaI->I', g.vv, T1old, S1old, LU11old)
    LS1 += -1.0*einsum('Iia,bi,Jaj,jbJ->I', g.ov, T1old, U11old, LU11old)
    LS1 += -1.0*einsum('Iia,aj,Jbi,jbJ->I', g.ov, T1old, U11old, LU11old)
    LS1 += -1.0*einsum('Jia,bi,Jaj,jbI->I', g.ov, T1old, U11old, LU11old)
    LS1 += -1.0*einsum('Jia,aj,Jbi,jbI->I', g.ov, T1old, U11old, LU11old)
    LS1 += 1.0*einsum('Jia,ai,Jbj,jbI->I', g.ov, T1old, U11old, LU11old)
    LS1 += -1.0*einsum('Jia,baij,J,jbI->I', g.ov, T2old, S1old, LU11old)
    LS1 += -1.0*einsum('ijka,bi,aj,kbI->I', I.ooov, T1old, T1old, LU11old)
    LS1 += 1.0*einsum('iabc,cj,bi,jaI->I', I.ovvv, T1old, T1old, LU11old)
    LS1 += -0.5*einsum('ijab,ci,bajk,kcI->I', I.oovv, T1old, T2old, LU11old)
    LS1 += -0.5*einsum('ijab,bk,caji,kcI->I', I.oovv, T1old, T2old, LU11old)
    LS1 += 1.0*einsum('ijab,bi,cajk,kcI->I', I.oovv, T1old, T2old, LU11old)
    LS1 += 0.5*einsum('Iia,bi,cajk,kjcb->I', g.ov, T1old, T2old, L2old)
    LS1 += 0.5*einsum('Iia,aj,bcik,jkcb->I', g.ov, T1old, T2old, L2old)
    LS1 += -1.0*einsum('Jia,aj,bi,J,jbI->I', g.ov, T1old, T1old, S1old, LU11old)
    LS1 += 1.0*einsum('ijab,bk,ci,aj,kcI->I', I.oovv, T1old, T1old, T1old, LU11old)
    ...
    LU11 += -1.0*einsum('ij,jaI->Iia', F.oo, LU11old)
    LU11 += 1.0*einsum('ba,ibI->Iia', F.vv, LU11old)
    LU11 += 1.0*einsum('JI,iaJ->Iia', w, LU11old)
    LU11 += -1.0*einsum('ibja,jbI->Iia', I.ovov, LU11old)
    ...
    LU11 += -1.0*einsum('ib,bj,jaI->Iia', F.ov, T1old, LU11old)
    LU11 += -1.0*einsum('Jij,J,jaI->Iia', g.oo, S1old, LU11old)
    LU11 += -1.0*einsum('ja,bj,ibI->Iia', F.ov, T1old, LU11old)
    LU11 += 1.0*einsum('Jba,J,ibI->Iia', g.vv, S1old, LU11old)
    LU11 += 1.0*einsum('Jia,Jbj,jbI->Iia', g.ov, U11old, LU11old)
    LU11 += -1.0*einsum('jika,bj,kbI->Iia', I.ooov, T1old, LU11old)
    LU11 += 1.0*einsum('ibac,cj,jbI->Iia', I.ovvv, T1old, LU11old)
    LU11 += -1.0*einsum('Iib,Jbj,jaJ->Iia', g.ov, U11old, LU11old)
    LU11 += -1.0*einsum('Jib,Jbj,jaI->Iia', g.ov, U11old, LU11old)
    LU11 += 1.0*einsum('jikb,bj,kaI->Iia', I.ooov, T1old, LU11old)
    LU11 += -1.0*einsum('Ija,Jbj,ibJ->Iia', g.ov, U11old, LU11old)
    LU11 += -1.0*einsum('Jja,Jbj,ibI->Iia', g.ov, U11old, LU11old)
    LU11 += 1.0*einsum('Ijb,Jbj,iaJ->Iia', g.ov, U11old, LU11old)
    LU11 += -1.0*einsum('jbac,cj,ibI->Iia', I.ovvv, T1old, LU11old)
    LU11 += 1.0*einsum('Ijk,bj,kiab->Iia', g.oo, T1old, L2old)
    LU11 += -1.0*einsum('Ibc,cj,jiab->Iia', g.vv, T1old, L2old)
    LU11 += 1.0*einsum('jiab,cbjk,kcI->Iia', I.oovv, T2old, LU11old)
    LU11 += 0.5*einsum('jibc,cbjk,kaI->Iia', I.oovv, T2old, LU11old)
    LU11 += 0.5*einsum('jkab,cbkj,icI->Iia', I.oovv, T2old, LU11old)
    ...
    LU11 += -1.0*einsum('Jib,bj,J,jaI->Iia', g.ov, T1old, S1old, LU11old)
    LU11 += -1.0*einsum('Jja,bj,J,ibI->Iia', g.ov, T1old, S1old, LU11old)
    LU11 += 1.0*einsum('jiab,bk,cj,kcI->Iia', I.oovv, T1old, T1old, LU11old)
    LU11 += -1.0*einsum('jibc,ck,bj,kaI->Iia', I.oovv, T1old, T1old, LU11old)
    LU11 += -1.0*einsum('jkab,cj,bk,icI->Iia', I.oovv, T1old, T1old, LU11old)
    LU11 += 1.0*einsum('Ijb,bk,cj,kiac->Iia', g.ov, T1old, T1old, L2old)

    # Disconnected piece projecting onto single fermionic excitations...
    LU11 += 1.0*einsum('I,ia->Iia', LS1old, F.ov)
    LU11 += 2.0*einsum('I,J->Iia', LS1old, G)
    LU11 += -2.0*einsum('I,Jjk->Iia', LS1old, g.oo)
    LU11 += 2.0*einsum('I,Jjb->Iia', LS1old, g.ov)
    LU11 += 2.0*einsum('I,Jbj->Iia', LS1old, g.vo)
    LU11 += 2.0*einsum('I,Jbc->Iia', LS1old, g.vv)
    LU11 += 1.0*einsum('jb,kc->Iia', L1old, F.ov)
    LU11 += 0.25*einsum('jkbc,ld->Iia', L2old, F.ov)
    LU11 += 1.0*einsum('J,I,Jia->Iia', S1old, LS1old, g.ov)
    LU11 += -1.0*einsum('bj,I,jiab->Iia', T1old, LS1old, I.oovv)
    LU11 += 1.0*einsum('J,jb,Jkc->Iia', S1old, L1old, g.ov)
    LU11 += -1.0*einsum('bj,kc,jldb->Iia', T1old, L1old, I.oovv)
    LU11 += 0.25*einsum('J,jkbc,Jld->Iia', S1old, L2old, g.ov)
    LU11 += -0.25*einsum('bj,klcd,jmeb->Iia', T1old, L2old, I.oovv)
...
def calc_lam_resid_1_1(F, I, T1old, L1old, T2old, L2old, S1old, LS1old, U11old, LU11old):
    ...
    L1 += -1.0*einsum('ja,bj,ib->ia', F.ov, T1old, L1old)
    L1 += 1.0*einsum('Iba,I,ib->ia', g.vv, S1old, L1old)
    L1 += 1.0*einsum('IJ,J,iaI->ia', w, S1old, LU11old)
    L1 += -1.0*einsum('jiab,Ibj,I->ia', I.oovv, U11old, LS1old)
    L1 += 1.0*einsum('Iia,Ibj,jb->ia', g.ov, U11old, L1old)
    L1 += -1.0*einsum('jika,bj,kb->ia', I.ooov, T1old, L1old)
    L1 += 1.0*einsum('ibac,cj,jb->ia', I.ovvv, T1old, L1old)
    ...
    LS1 += 1.0*einsum('J,Jai,iaI->I', G, U11old, LU11old)
    LS1 += 1.0*einsum('Jai,J,iaI->I', g.vo, S1old, LU11old)
    LS1 += -1.0*einsum('ij,ai,jaI->I', F.oo, T1old, LU11old)
    LS1 += 1.0*einsum('ab,bi,iaI->I', F.vv, T1old, LU11old)
    LS1 += -1.0*einsum('Iia,baij,jb->I', g.ov, T2old, L1old)
    LS1 += -1.0*einsum('Iij,Jai,jaJ->I', g.oo, U11old, LU11old)
    LS1 += 1.0*einsum('Iab,Jbi,iaJ->I', g.vv, U11old, LU11old)
    LS1 += -1.0*einsum('ia,baij,jbI->I', F.ov, T2old, LU11old)
    ...
    res = np.linalg.norm(L1) / np.sqrt(L1.size) + np.linalg.norm(L2) / np.sqrt(L2.size)
    res += np.linalg.norm(LS1) / np.sqrt(LS1.size) + np.linalg.norm(LU11) / np.sqrt(LU11.size)
