...
def calc_lagrangian_1_1(F, I, G, g, w_diag, T1, L1, T2, L2, S1, LS1, U11, LU11):
    ...
    if simplify:
        ...
        Lag += 1.0*einsum('Iia,Iai->', LU11, g.vo)
        ...
        Lag += 1.0*einsum('I,Iia,ai->', LS1, g.ov, T1)
        ...
        Lag += -1.0*einsum('Iia,Ijb,bi,aj->', LU11, g.ov, T1, T1)
...
def calc_lam_resid_1_1(F, I, G, g, w_diag, T1old, L1old, T2old, L2old, S1old, LS1old, U11old, LU11old):
    ...
    simplify = False    # Whether the residual equations were generated with the 'simplify' flag in wick or not
...
# disconnected piece projecting onto single bosonic excitations...
        ...
        L1 = 1.0*einsum('ia->ia', F.ov)
        L1 += 1.0*einsum('I,Iia->ia', S1old, g.ov)
        L1 += 1.0*einsum('bj,jiba->ia', T1old, I.oovv)
        ...
        L1 += -1.0*einsum('Iij,Ija->ia', g.oo, LU11old)
        L1 += 1.0*einsum('Iba,Iib->ia', g.vv, LU11old)
        L1 += 1.0*einsum('bj,jiba->ia', F.vo, L2old)
        L1 += 0.5*einsum('ibjk,jkba->ia', I.ovoo, L2old)
        L1 += 0.5*einsum('bcja,jibc->ia', I.vvov, L2old)
        L1 += -1.0*einsum('ib,bj,ja->ia', F.ov, T1old, L1old)
        L1 += -1.0*einsum('Iij,I,ja->ia', g.oo, S1old, L1old)
        L1 += -1.0*einsum('ja,bj,ib->ia', F.ov, T1old, L1old)
        L1 += 1.0*einsum('Iba,I,ib->ia', g.vv, S1old, L1old)
        L1 += 1.0*einsum('IJ,J,Iia->ia', w, S1old, LU11old)
        L1 += 1.0*einsum('jiba,Ibj,I->ia', I.oovv, U11old, LS1old)
        L1 += 1.0*einsum('Iia,Ibj,jb->ia', g.ov, U11old, L1old)
        L1 += -1.0*einsum('jika,bj,kb->ia', I.ooov, T1old, L1old)
        L1 += -1.0*einsum('ibca,cj,jb->ia', I.ovvv, T1old, L1old)
        L1 += -1.0*einsum('Iib,Ibj,ja->ia', g.ov, U11old, L1old)
        L1 += 1.0*einsum('jikb,bj,ka->ia', I.ooov, T1old, L1old)
        L1 += -1.0*einsum('Ija,Ibj,ib->ia', g.ov, U11old, L1old)
        L1 += 1.0*einsum('jbca,cj,ib->ia', I.ovvv, T1old, L1old)
        L1 += -1.0*einsum('ib,Ibj,Ija->ia', F.ov, U11old, LU11old)
        L1 += -1.0*einsum('Iib,bj,Ija->ia', g.ov, T1old, LU11old)
        L1 += -1.0*einsum('ja,Ibj,Iib->ia', F.ov, U11old, LU11old)
        L1 += -1.0*einsum('Ija,bj,Iib->ia', g.ov, T1old, LU11old)
        L1 += 1.0*einsum('jb,Ibj,Iia->ia', F.ov, U11old, LU11old)
        L1 += 1.0*einsum('Ijb,bj,Iia->ia', g.ov, T1old, LU11old)
        L1 += 1.0*einsum('I,Ibj,jiba->ia', G, U11old, L2old)
        L1 += 1.0*einsum('Ibj,I,jiba->ia', g.vo, S1old, L2old)
        L1 += -1.0*einsum('jk,bj,kiba->ia', F.oo, T1old, L2old)
        L1 += 1.0*einsum('bc,cj,jiba->ia', F.vv, T1old, L2old)
        L1 += 1.0*einsum('jiba,cbkj,kc->ia', I.oovv, T2old, L1old)
        L1 += 0.5*einsum('jibc,bckj,ka->ia', I.oovv, T2old, L1old)
        L1 += 0.5*einsum('jkba,cbjk,ic->ia', I.oovv, T2old, L1old)
        L1 += -1.0*einsum('jika,Ibj,Ikb->ia', I.ooov, U11old, LU11old)
        L1 += -1.0*einsum('ibca,Icj,Ijb->ia', I.ovvv, U11old, LU11old)
        L1 += 1.0*einsum('jikb,Ibj,Ika->ia', I.ooov, U11old, LU11old)
        L1 += 1.0*einsum('jbca,Icj,Iib->ia', I.ovvv, U11old, LU11old)
        L1 += -0.5*einsum('ib,cbjk,jkca->ia', F.ov, T2old, L2old)
        L1 += 1.0*einsum('Iij,Ibk,jkba->ia', g.oo, U11old, L2old)
        L1 += 1.0*einsum('ibjc,ck,jkba->ia', I.ovov, T1old, L2old)
        L1 += 0.5*einsum('jikl,bj,klba->ia', I.oooo, T1old, L2old)
        L1 += -0.5*einsum('ja,bckj,kibc->ia', F.ov, T2old, L2old)
        L1 += -1.0*einsum('Iba,Icj,jibc->ia', g.vv, U11old, L2old)
        L1 += 1.0*einsum('jbka,cj,kibc->ia', I.ovov, T1old, L2old)
        L1 += 1.0*einsum('jb,cbkj,kica->ia', F.ov, T2old, L2old)
        L1 += -1.0*einsum('Ijk,Ibj,kiba->ia', g.oo, U11old, L2old)
        L1 += 1.0*einsum('Ibc,Icj,jiba->ia', g.vv, U11old, L2old)
        L1 += -1.0*einsum('jbkc,cj,kiba->ia', I.ovov, T1old, L2old)
        L1 += 0.5*einsum('bcda,dj,jibc->ia', I.vvvv, T1old, L2old)
        L1 += 0.5*einsum('jika,bclj,klbc->ia', I.ooov, T2old, L2old)
        L1 += 0.5*einsum('ibca,dcjk,jkbd->ia', I.ovvv, T2old, L2old)
        L1 += -1.0*einsum('jikb,cblj,klca->ia', I.ooov, T2old, L2old)
        L1 += 0.25*einsum('ibcd,cdjk,jkba->ia', I.ovvv, T2old, L2old)
        L1 += 0.25*einsum('jkla,bcjk,libc->ia', I.ooov, T2old, L2old)
        L1 += -1.0*einsum('jbca,dckj,kibd->ia', I.ovvv, T2old, L2old)
        L1 += -0.5*einsum('jklb,cbjk,lica->ia', I.ooov, T2old, L2old)
        L1 += -0.5*einsum('jbcd,cdkj,kiba->ia', I.ovvv, T2old, L2old)
        L1 += -1.0*einsum('Iib,I,bj,ja->ia', g.ov, S1old, T1old, L1old)
        L1 += -1.0*einsum('Ija,I,bj,ib->ia', g.ov, S1old, T1old, L1old)
        L1 += -1.0*einsum('jiba,cj,bk,kc->ia', I.oovv, T1old, T1old, L1old)
        L1 += 1.0*einsum('jibc,bk,cj,ka->ia', I.oovv, T1old, T1old, L1old)
        L1 += 1.0*einsum('jkba,cj,bk,ic->ia', I.oovv, T1old, T1old, L1old)
        L1 += -1.0*einsum('Iib,I,Jbj,Jja->ia', g.ov, S1old, U11old, LU11old)
        L1 += -1.0*einsum('Ija,I,Jbj,Jib->ia', g.ov, S1old, U11old, LU11old)
        L1 += 1.0*einsum('Ijb,I,Jbj,Jia->ia', g.ov, S1old, U11old, LU11old)
        L1 += -1.0*einsum('jb,cj,bk,kica->ia', F.ov, T1old, T1old, L2old)
        L1 += -1.0*einsum('Ijk,I,bj,kiba->ia', g.oo, S1old, T1old, L2old)
        L1 += 1.0*einsum('Ibc,I,cj,jiba->ia', g.vv, S1old, T1old, L2old)
        L1 += -1.0*einsum('jiba,cj,Ibk,Ikc->ia', I.oovv, T1old, U11old, LU11old)
        L1 += -1.0*einsum('jiba,bk,Icj,Ikc->ia', I.oovv, T1old, U11old, LU11old)
        L1 += 1.0*einsum('jibc,bk,Icj,Ika->ia', I.oovv, T1old, U11old, LU11old)
        L1 += -1.0*einsum('jibc,bj,Ick,Ika->ia', I.oovv, T1old, U11old, LU11old)
        L1 += 1.0*einsum('jkba,cj,Ibk,Iic->ia', I.oovv, T1old, U11old, LU11old)
        L1 += -1.0*einsum('jkba,bj,Ick,Iic->ia', I.oovv, T1old, U11old, LU11old)
        L1 += 1.0*einsum('jkbc,bj,Ick,Iia->ia', I.oovv, T1old, U11old, LU11old)
        L1 += 1.0*einsum('Iib,bj,Ick,jkca->ia', g.ov, T1old, U11old, L2old)
        L1 += -0.5*einsum('Iib,I,cbjk,jkca->ia', g.ov, S1old, T2old, L2old)
        L1 += 1.0*einsum('jikb,cj,bl,klca->ia', I.ooov, T1old, T1old, L2old)
        L1 += 0.5*einsum('ibcd,cj,dk,jkba->ia', I.ovvv, T1old, T1old, L2old)
        L1 += 1.0*einsum('Ija,bj,Ick,kibc->ia', g.ov, T1old, U11old, L2old)
        L1 += -1.0*einsum('Ijb,cj,Ibk,kica->ia', g.ov, T1old, U11old, L2old)
        L1 += -1.0*einsum('Ijb,bk,Icj,kica->ia', g.ov, T1old, U11old, L2old)
        L1 += 1.0*einsum('Ijb,bj,Ick,kica->ia', g.ov, T1old, U11old, L2old)
        L1 += -0.5*einsum('Ija,I,bckj,kibc->ia', g.ov, S1old, T2old, L2old)
        L1 += 1.0*einsum('Ijb,I,cbkj,kica->ia', g.ov, S1old, T2old, L2old)
        L1 += 0.5*einsum('jkla,bj,ck,libc->ia', I.ooov, T1old, T1old, L2old)
        L1 += 1.0*einsum('jbca,dj,ck,kibd->ia', I.ovvv, T1old, T1old, L2old)
        L1 += -1.0*einsum('jklb,cj,bk,lica->ia', I.ooov, T1old, T1old, L2old)
        L1 += -1.0*einsum('jbcd,ck,dj,kiba->ia', I.ovvv, T1old, T1old, L2old)
        L1 += 0.5*einsum('jiba,cj,dbkl,klcd->ia', I.oovv, T1old, T2old, L2old)
        L1 += 0.5*einsum('jiba,bk,cdlj,klcd->ia', I.oovv, T1old, T2old, L2old)
        L1 += 0.25*einsum('jibc,dj,bckl,klda->ia', I.oovv, T1old, T2old, L2old)
        L1 += -1.0*einsum('jibc,bk,dclj,klda->ia', I.oovv, T1old, T2old, L2old)
        L1 += -0.5*einsum('jibc,bj,dckl,klda->ia', I.oovv, T1old, T2old, L2old)
        L1 += -1.0*einsum('jkba,cj,dblk,licd->ia', I.oovv, T1old, T2old, L2old)
        L1 += 0.25*einsum('jkba,bl,cdjk,licd->ia', I.oovv, T1old, T2old, L2old)
        L1 += -0.5*einsum('jkba,bj,cdlk,licd->ia', I.oovv, T1old, T2old, L2old)
        L1 += -0.5*einsum('jkbc,dj,bclk,lida->ia', I.oovv, T1old, T2old, L2old)
        L1 += -0.5*einsum('jkbc,bl,dcjk,lida->ia', I.oovv, T1old, T2old, L2old)
        L1 += 1.0*einsum('jkbc,bj,dclk,lida->ia', I.oovv, T1old, T2old, L2old)
        L1 += -1.0*einsum('Ijb,I,cj,bk,kica->ia', g.ov, S1old, T1old, T1old, L2old)
        L1 += 0.5*einsum('jibc,dj,bk,cl,klda->ia', I.oovv, T1old, T1old, T1old, L2old)
        L1 += 0.5*einsum('jkba,cj,dk,bl,licd->ia', I.oovv, T1old, T1old, T1old, L2old)
        L1 += -1.0*einsum('jkbc,dj,bl,ck,lida->ia', I.oovv, T1old, T1old, T1old, L2old)

        #Computing lambda residuals for 2 fermion deexcitation space...
        #Computing connected piece not proportional to Lambda...
        L2 = 1.0*einsum('ijab->ijab', I.oovv)

        #Computing connected piece proportional to Lambda...
        L2 += -1.0*einsum('ijkb,ka->ijab', I.ooov, L1old)
        L2 += 1.0*einsum('ijka,kb->ijab', I.ooov, L1old)
        L2 += -1.0*einsum('jcab,ic->ijab', I.ovvv, L1old)
        L2 += 1.0*einsum('icab,jc->ijab', I.ovvv, L1old)
        L2 += 1.0*einsum('Ijb,Iia->ijab', g.ov, LU11old)
        L2 += -1.0*einsum('Ija,Iib->ijab', g.ov, LU11old)
        L2 += -1.0*einsum('Iib,Ija->ijab', g.ov, LU11old)
        L2 += 1.0*einsum('Iia,Ijb->ijab', g.ov, LU11old)
        L2 += 1.0*einsum('jk,kiab->ijab', F.oo, L2old)
        L2 += -1.0*einsum('ik,kjab->ijab', F.oo, L2old)
        L2 += -1.0*einsum('cb,ijca->ijab', F.vv, L2old)
        L2 += 1.0*einsum('ca,ijcb->ijab', F.vv, L2old)
        L2 += 0.5*einsum('ijkl,klab->ijab', I.oooo, L2old)
        L2 += -1.0*einsum('jckb,kica->ijab', I.ovov, L2old)
        L2 += 1.0*einsum('jcka,kicb->ijab', I.ovov, L2old)
        L2 += 1.0*einsum('ickb,kjca->ijab', I.ovov, L2old)
        L2 += -1.0*einsum('icka,kjcb->ijab', I.ovov, L2old)
        L2 += 0.5*einsum('cdab,ijcd->ijab', I.vvvv, L2old)
        L2 += -1.0*einsum('ijcb,ck,ka->ijab', I.oovv, T1old, L1old)
        L2 += 1.0*einsum('ijca,ck,kb->ijab', I.oovv, T1old, L1old)
        L2 += -1.0*einsum('kjab,ck,ic->ijab', I.oovv, T1old, L1old)
        L2 += 1.0*einsum('kiab,ck,jc->ijab', I.oovv, T1old, L1old)
        L2 += 1.0*einsum('jc,ck,kiab->ijab', F.ov, T1old, L2old)
        L2 += -1.0*einsum('ic,ck,kjab->ijab', F.ov, T1old, L2old)
        L2 += 1.0*einsum('Ijk,I,kiab->ijab', g.oo, S1old, L2old)
        L2 += -1.0*einsum('Iik,I,kjab->ijab', g.oo, S1old, L2old)
        L2 += 1.0*einsum('kb,ck,ijca->ijab', F.ov, T1old, L2old)
        L2 += -1.0*einsum('ka,ck,ijcb->ijab', F.ov, T1old, L2old)
        L2 += -1.0*einsum('Icb,I,ijca->ijab', g.vv, S1old, L2old)
        L2 += 1.0*einsum('Ica,I,ijcb->ijab', g.vv, S1old, L2old)
        L2 += -1.0*einsum('ijcb,Ick,Ika->ijab', I.oovv, U11old, LU11old)
        L2 += 1.0*einsum('ijca,Ick,Ikb->ijab', I.oovv, U11old, LU11old)
        L2 += -1.0*einsum('kjab,Ick,Iic->ijab', I.oovv, U11old, LU11old)
        L2 += 1.0*einsum('kjcb,Ick,Iia->ijab', I.oovv, U11old, LU11old)
        L2 += -1.0*einsum('kjca,Ick,Iib->ijab', I.oovv, U11old, LU11old)
        L2 += 1.0*einsum('kiab,Ick,Ijc->ijab', I.oovv, U11old, LU11old)
        L2 += -1.0*einsum('kicb,Ick,Ija->ijab', I.oovv, U11old, LU11old)
        L2 += 1.0*einsum('kica,Ick,Ijb->ijab', I.oovv, U11old, LU11old)
        L2 += 1.0*einsum('ijkc,cl,klab->ijab', I.ooov, T1old, L2old)
        L2 += 1.0*einsum('Ijb,Ick,kica->ijab', g.ov, U11old, L2old)
        L2 += -1.0*einsum('Ija,Ick,kicb->ijab', g.ov, U11old, L2old)
        L2 += 1.0*einsum('Ijc,Ick,kiab->ijab', g.ov, U11old, L2old)
        L2 += -1.0*einsum('Iib,Ick,kjca->ijab', g.ov, U11old, L2old)
        L2 += 1.0*einsum('Iia,Ick,kjcb->ijab', g.ov, U11old, L2old)
        L2 += -1.0*einsum('Iic,Ick,kjab->ijab', g.ov, U11old, L2old)
        L2 += -1.0*einsum('kjlb,ck,lica->ijab', I.ooov, T1old, L2old)
        L2 += -1.0*einsum('jcdb,dk,kica->ijab', I.ovvv, T1old, L2old)
        L2 += 1.0*einsum('kjla,ck,licb->ijab', I.ooov, T1old, L2old)
        L2 += 1.0*einsum('jcda,dk,kicb->ijab', I.ovvv, T1old, L2old)
        L2 += -1.0*einsum('kjlc,ck,liab->ijab', I.ooov, T1old, L2old)
        L2 += 1.0*einsum('kilb,ck,ljca->ijab', I.ooov, T1old, L2old)
        L2 += 1.0*einsum('icdb,dk,kjca->ijab', I.ovvv, T1old, L2old)
        L2 += -1.0*einsum('kila,ck,ljcb->ijab', I.ooov, T1old, L2old)
        L2 += -1.0*einsum('icda,dk,kjcb->ijab', I.ovvv, T1old, L2old)
        L2 += 1.0*einsum('kilc,ck,ljab->ijab', I.ooov, T1old, L2old)
        L2 += 1.0*einsum('Ikb,Ick,ijca->ijab', g.ov, U11old, L2old)
        L2 += -1.0*einsum('Ika,Ick,ijcb->ijab', g.ov, U11old, L2old)
        L2 += 1.0*einsum('kcab,dk,ijcd->ijab', I.ovvv, T1old, L2old)
        L2 += -1.0*einsum('kcdb,dk,ijca->ijab', I.ovvv, T1old, L2old)
        L2 += 1.0*einsum('kcda,dk,ijcb->ijab', I.ovvv, T1old, L2old)
        L2 += -0.5*einsum('ijcb,dckl,klda->ijab', I.oovv, T2old, L2old)
        L2 += 0.5*einsum('ijca,dckl,kldb->ijab', I.oovv, T2old, L2old)
        L2 += 0.25*einsum('ijcd,cdkl,klab->ijab', I.oovv, T2old, L2old)
        L2 += -0.5*einsum('kjab,cdlk,licd->ijab', I.oovv, T2old, L2old)
        L2 += 1.0*einsum('kjcb,dclk,lida->ijab', I.oovv, T2old, L2old)
        L2 += -1.0*einsum('kjca,dclk,lidb->ijab', I.oovv, T2old, L2old)
        L2 += -0.5*einsum('kjcd,cdlk,liab->ijab', I.oovv, T2old, L2old)
        L2 += 0.5*einsum('kiab,cdlk,ljcd->ijab', I.oovv, T2old, L2old)
        L2 += -1.0*einsum('kicb,dclk,ljda->ijab', I.oovv, T2old, L2old)
        L2 += 1.0*einsum('kica,dclk,ljdb->ijab', I.oovv, T2old, L2old)
        L2 += 0.5*einsum('kicd,cdlk,ljab->ijab', I.oovv, T2old, L2old)
        L2 += 0.25*einsum('klab,cdkl,ijcd->ijab', I.oovv, T2old, L2old)
        L2 += -0.5*einsum('klcb,dckl,ijda->ijab', I.oovv, T2old, L2old)
        L2 += 0.5*einsum('klca,dckl,ijdb->ijab', I.oovv, T2old, L2old)
        L2 += 1.0*einsum('Ijc,I,ck,kiab->ijab', g.ov, S1old, T1old, L2old)
        L2 += -1.0*einsum('Iic,I,ck,kjab->ijab', g.ov, S1old, T1old, L2old)
        L2 += 1.0*einsum('Ikb,I,ck,ijca->ijab', g.ov, S1old, T1old, L2old)
        L2 += -1.0*einsum('Ika,I,ck,ijcb->ijab', g.ov, S1old, T1old, L2old)
        L2 += 0.5*einsum('ijcd,ck,dl,klab->ijab', I.oovv, T1old, T1old, L2old)
        L2 += -1.0*einsum('kjcb,dk,cl,lida->ijab', I.oovv, T1old, T1old, L2old)
        L2 += 1.0*einsum('kjca,dk,cl,lidb->ijab', I.oovv, T1old, T1old, L2old)
        L2 += -1.0*einsum('kjcd,cl,dk,liab->ijab', I.oovv, T1old, T1old, L2old)
        L2 += 1.0*einsum('kicb,dk,cl,ljda->ijab', I.oovv, T1old, T1old, L2old)
        L2 += -1.0*einsum('kica,dk,cl,ljdb->ijab', I.oovv, T1old, T1old, L2old)
        L2 += 1.0*einsum('kicd,cl,dk,ljab->ijab', I.oovv, T1old, T1old, L2old)
        L2 += 0.5*einsum('klab,ck,dl,ijcd->ijab', I.oovv, T1old, T1old, L2old)
        L2 += -1.0*einsum('klcb,dk,cl,ijda->ijab', I.oovv, T1old, T1old, L2old)
        L2 += 1.0*einsum('klca,dk,cl,ijdb->ijab', I.oovv, T1old, T1old, L2old)
        ...
        L2 += -1.0*einsum('I,ib,Ija->ijab', S1old, L1old, g.ov)
        L2 += 1.0*einsum('I,ia,Ijb->ijab', S1old, L1old, g.ov)
        L2 += 0.25*einsum('ck,jb,kica->ijab', T1old, L1old, I.oovv)
        L2 += -0.25*einsum('ck,ja,kicb->ijab', T1old, L1old, I.oovv)
        L2 += -0.25*einsum('ck,jb,kiac->ijab', T1old, L1old, I.oovv)
        L2 += 0.25*einsum('ck,ja,kibc->ijab', T1old, L1old, I.oovv)
        L2 += -0.25*einsum('ck,ib,kjca->ijab', T1old, L1old, I.oovv)
        L2 += 0.25*einsum('ck,ia,kjcb->ijab', T1old, L1old, I.oovv)
        L2 += 0.25*einsum('ck,ib,kjac->ijab', T1old, L1old, I.oovv)
        L2 += -0.25*einsum('ck,ia,kjbc->ijab', T1old, L1old, I.oovv)
        L2 += -0.25*einsum('ck,jb,ikca->ijab', T1old, L1old, I.oovv)
        L2 += 0.25*einsum('ck,ja,ikcb->ijab', T1old, L1old, I.oovv)
        L2 += 0.25*einsum('ck,jb,ikac->ijab', T1old, L1old, I.oovv)
        L2 += -0.25*einsum('ck,ja,ikbc->ijab', T1old, L1old, I.oovv)
        L2 += 0.25*einsum('ck,ib,jkca->ijab', T1old, L1old, I.oovv)
        L2 += -0.25*einsum('ck,ia,jkcb->ijab', T1old, L1old, I.oovv)
        L2 += -0.25*einsum('ck,ib,jkac->ijab', T1old, L1old, I.oovv)
        L2 += 0.25*einsum('ck,ia,jkbc->ijab', T1old, L1old, I.oovv)
        ...
        LS1 += -1.0*einsum('ij,ai,Ija->I', F.oo, T1old, LU11old)
        LS1 += 1.0*einsum('ab,bi,Iia->I', F.vv, T1old, LU11old)
        LS1 += 1.0*einsum('Iia,baji,jb->I', g.ov, T2old, L1old)
        LS1 += -1.0*einsum('Iij,Jai,Jja->I', g.oo, U11old, LU11old)
        LS1 += 1.0*einsum('Iab,Jbi,Jia->I', g.vv, U11old, LU11old)
        LS1 += 1.0*einsum('ia,baji,Ijb->I', F.ov, T2old, LU11old)
        LS1 += -1.0*einsum('Jij,Jai,Ija->I', g.oo, U11old, LU11old)
        LS1 += 1.0*einsum('Jab,Jbi,Iia->I', g.vv, U11old, LU11old)
        LS1 += -1.0*einsum('iajb,bi,Ija->I', I.ovov, T1old, LU11old)
        LS1 += -0.5*einsum('ijka,baij,Ikb->I', I.ooov, T2old, LU11old)
        LS1 += -0.5*einsum('iabc,bcji,Ija->I', I.ovvv, T2old, LU11old)
        LS1 += 0.5*einsum('Iij,abki,jkab->I', g.oo, T2old, L2old)
        LS1 += -0.5*einsum('Iab,cbij,ijac->I', g.vv, T2old, L2old)
        LS1 += -1.0*einsum('Iia,bi,aj,jb->I', g.ov, T1old, T1old, L1old)
        LS1 += -1.0*einsum('ia,bi,aj,Ijb->I', F.ov, T1old, T1old, LU11old)
        LS1 += -1.0*einsum('Jij,J,ai,Ija->I', g.oo, S1old, T1old, LU11old)
        LS1 += 1.0*einsum('Jab,J,bi,Iia->I', g.vv, S1old, T1old, LU11old)
        LS1 += -1.0*einsum('Iia,bi,Jaj,Jjb->I', g.ov, T1old, U11old, LU11old)
        LS1 += -1.0*einsum('Iia,aj,Jbi,Jjb->I', g.ov, T1old, U11old, LU11old)
        LS1 += -1.0*einsum('Jia,bi,Jaj,Ijb->I', g.ov, T1old, U11old, LU11old)
        LS1 += -1.0*einsum('Jia,aj,Jbi,Ijb->I', g.ov, T1old, U11old, LU11old)
        LS1 += 1.0*einsum('Jia,ai,Jbj,Ijb->I', g.ov, T1old, U11old, LU11old)
        LS1 += 1.0*einsum('Jia,J,baji,Ijb->I', g.ov, S1old, T2old, LU11old)
        LS1 += -1.0*einsum('ijka,bi,aj,Ikb->I', I.ooov, T1old, T1old, LU11old)
        LS1 += -1.0*einsum('iabc,bj,ci,Ija->I', I.ovvv, T1old, T1old, LU11old)
        LS1 += -0.5*einsum('ijab,ci,abkj,Ikc->I', I.oovv, T1old, T2old, LU11old)
        LS1 += -0.5*einsum('ijab,ak,cbij,Ikc->I', I.oovv, T1old, T2old, LU11old)
        LS1 += 1.0*einsum('ijab,ai,cbkj,Ikc->I', I.oovv, T1old, T2old, LU11old)
        LS1 += 0.5*einsum('Iia,bi,cajk,jkbc->I', g.ov, T1old, T2old, L2old)
        LS1 += 0.5*einsum('Iia,aj,bcki,jkbc->I', g.ov, T1old, T2old, L2old)
        LS1 += -1.0*einsum('Jia,J,bi,aj,Ijb->I', g.ov, S1old, T1old, T1old, LU11old)
        LS1 += -1.0*einsum('ijab,ci,ak,bj,Ikc->I', I.oovv, T1old, T1old, T1old, LU11old)
        ...
        LU11 += 1.0*einsum('ba,Iib->Iia', F.vv, LU11old)
        LU11 += -1.0*einsum('ibja,Ijb->Iia', I.ovov, LU11old)
        LU11 += 1.0*einsum('Ibj,jiba->Iia', g.vo, L2old)
        LU11 += -1.0*einsum('Iib,bj,ja->Iia', g.ov, T1old, L1old)
        LU11 += -1.0*einsum('Ija,bj,ib->Iia', g.ov, T1old, L1old)
        LU11 += -1.0*einsum('ib,bj,Ija->Iia', F.ov, T1old, LU11old)
        LU11 += -1.0*einsum('ja,bj,Iib->Iia', F.ov, T1old, LU11old)
        ...
        LU11 += -1.0*einsum('Jja,Jbj,Iib->Iia', g.ov, U11old, LU11old)
        LU11 += -1.0*einsum('jika,bj,Ikb->Iia', I.ooov, T1old, LU11old)
        LU11 += -1.0*einsum('ibca,cj,Ijb->Iia', I.ovvv, T1old, LU11old)
        LU11 += 1.0*einsum('jikb,bj,Ika->Iia', I.ooov, T1old, LU11old)
        LU11 += 1.0*einsum('jbca,cj,Iib->Iia', I.ovvv, T1old, LU11old)
        LU11 += -1.0*einsum('Ijk,bj,kiba->Iia', g.oo, T1old, L2old)
        LU11 += 1.0*einsum('Ibc,cj,jiba->Iia', g.vv, T1old, L2old)
        LU11 += 1.0*einsum('jiba,cbkj,Ikc->Iia', I.oovv, T2old, LU11old)
        LU11 += 0.5*einsum('jibc,bckj,Ika->Iia', I.oovv, T2old, LU11old)
        LU11 += 0.5*einsum('jkba,cbjk,Iic->Iia', I.oovv, T2old, LU11old)
        LU11 += -0.5*einsum('Iib,cbjk,jkca->Iia', g.ov, T2old, L2old)
        LU11 += -0.5*einsum('Ija,bckj,kibc->Iia', g.ov, T2old, L2old)
        LU11 += 1.0*einsum('Ijb,cbkj,kica->Iia', g.ov, T2old, L2old)
        LU11 += -1.0*einsum('Jib,J,bj,Ija->Iia', g.ov, S1old, T1old, LU11old)
        LU11 += -1.0*einsum('Jja,J,bj,Iib->Iia', g.ov, S1old, T1old, LU11old)
        LU11 += -1.0*einsum('jiba,cj,bk,Ikc->Iia', I.oovv, T1old, T1old, LU11old)
        LU11 += 1.0*einsum('jibc,bk,cj,Ika->Iia', I.oovv, T1old, T1old, LU11old)
        LU11 += 1.0*einsum('jkba,cj,bk,Iic->Iia', I.oovv, T1old, T1old, LU11old)
        LU11 += -1.0*einsum('Ijb,cj,bk,kica->Iia', g.ov, T1old, T1old, L2old)
        #Computing disconnected piece projecting onto single fermionic excitations...
        LU11 += 1.0*einsum('I,ia->Iia', LS1old, F.ov)
        LU11 += 1.0*einsum('J,I,Jia->Iia', S1old, LS1old, g.ov)
        LU11 += 0.25*einsum('bj,I,jiba->Iia', T1old, LS1old, I.oovv)
        LU11 += -0.25*einsum('bj,I,jiab->Iia', T1old, LS1old, I.oovv)
        LU11 += -0.25*einsum('bj,I,ijba->Iia', T1old, LS1old, I.oovv)
        LU11 += 0.25*einsum('bj,I,ijab->Iia', T1old, LS1old, I.oovv)
