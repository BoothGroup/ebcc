...
def update_amps(f=None, v=None, space=None, t1=None, t2=None, t3=None, **kwargs):
    ...
    nocc = (space[0].nocc, space[1].nocc)
    nvir = (space[0].nvir, space[1].nvir)
    ...
    sOa = space[0].active[space[0].occupied]
    sVa = space[0].active[space[0].virtual]
    sOb = space[1].active[space[1].occupied]
    sVb = space[1].active[space[1].virtual]
    ...
    t1new_bb[np.ix_(sOb,sVb)] += einsum(v.aaaa.OVOV, (0, 1, 2, 3), t3.abaaba, (0, 4, 2, 3, 5, 1), (4, 5)) * -1.0
    ...
    t1new_aa[np.ix_(sOa,sVa)] += einsum(v.bbbb.OVOV, (0, 1, 2, 3), t3.babbab, (0, 4, 2, 3, 5, 1), (4, 5)) * -1.0
    ...
    t2new_abab[np.ix_(soa,sOb,sVa,sVb)] += einsum(v.aaaa.oOOV, (0, 1, 2, 3), t3.abaaba, (2, 4, 1, 5, 6, 3), (0, 4, 5, 6)) * 2.0
    t2new_abab[np.ix_(sOa,sob,sVa,sVb)] += einsum(v.aabb.OVoO, (0, 1, 2, 3), t3.abaaba, (4, 3, 0, 5, 6, 1), (4, 2, 5, 6)) * -2.0
    t2new_abab[np.ix_(sOa,sOb,sva,sVb)] += einsum(v.aaaa.vVOV, (0, 1, 2, 3), t3.abaaba, (4, 5, 2, 1, 6, 3), (4, 5, 0, 6)) * 2.0
    ...
    t2new_abab[np.ix_(sOa,sOb,sVa,svb)] += einsum(v.bbbb.vVOV, (0, 1, 2, 3), t3.babbab, (4, 5, 2, 3, 6, 1), (5, 4, 6, 0)) * -2.0
    ...
    t2new_aaaa[np.ix_(soa,soa,sva,sva)] += einsum(x50, (0, 1, 2, 3), (1, 0, 3, 2))
    del x50
    x51 = np.zeros((naocc[0], navir[0], navir[0], nocc[0]), dtype=np.float64)
    ...
    del x51
    x52 = np.zeros((naocc[0], naocc[0], navir[0], nvir[0]), dtype=np.float64)
    ...
    del x52
    x53 = np.zeros((naocc[0], navir[0], navir[0], nocc[0]), dtype=np.float64)
    ...
    del x53
    x54 = np.zeros((naocc[0], naocc[0], navir[0], nvir[0]), dtype=np.float64)
    ...
    x87 = np.zeros((naocc[0], navir[0], navir[0], nocc[0]), dtype=np.float64)
    ...
    del x87
    x88 = np.zeros((naocc[0], naocc[0], navir[0], nocc[0]), dtype=np.float64)
    x88 += einsum(v.aabb.oVOV, (0, 1, 2, 3), t3.abaaba, (4, 2, 5, 6, 3, 1), (4, 5, 6, 0))
    x89 = np.zeros((naocc[0], naocc[0], navir[0], nvir[0]), dtype=np.float64)
    ...
    del x89
    x90 = np.zeros((naocc[1], navir[1]), dtype=np.float64)
    ...
    del x90
    x91 = np.zeros((naocc[0], naocc[0], navir[0], nocc[0]), dtype=np.float64)
    x91 += einsum(t1.aa[np.ix_(soa,sva)], (0, 1), v.aaaa.vOOV, (1, 2, 3, 4), (3, 2, 4, 0))
    t2new_abab[np.ix_(soa,sOb,sVa,sVb)] += einsum(x91, (0, 1, 2, 3), t3.abaaba, (0, 4, 1, 5, 6, 2), (3, 4, 5, 6))
    x92 = np.zeros((naocc[0], navir[0], navir[0], nocc[0]), dtype=np.float64)
    x92 += einsum(x91, (0, 1, 2, 3), t3.aaaaaa, (4, 0, 1, 5, 6, 2), (4, 5, 6, 3))
    del x91
    ...
    del x92
    x93 = np.zeros((naocc[0], naocc[0], navir[0], nocc[0]), dtype=np.float64)
    x93 += einsum(t1.aa[np.ix_(soa,sva)], (0, 1), v.aaaa.vOOV, (1, 2, 3, 4), (3, 2, 4, 0))
    t2new_abab[np.ix_(soa,sOb,sVa,sVb)] += einsum(x93, (0, 1, 2, 3), t3.abaaba, (0, 4, 1, 5, 6, 2), (3, 4, 5, 6))
    x94 = np.zeros((naocc[0], navir[0], navir[0], nocc[0]), dtype=np.float64)
    x94 += einsum(x93, (0, 1, 2, 3), t3.aaaaaa, (4, 0, 1, 5, 6, 2), (4, 5, 6, 3))
    del x93
    ...
    del x94
    x95 = np.zeros((naocc[0], naocc[0], navir[0], nocc[0]), dtype=np.float64)
    x95 += einsum(v.aaaa.oVOV, (0, 1, 2, 3), t3.aaaaaa, (4, 5, 2, 6, 1, 3), (4, 5, 6, 0)) * -1.0
    x96 = np.zeros((naocc[0], naocc[0], navir[0], nvir[0]), dtype=np.float64)
    ...
    del x98
    x99 = np.zeros((naocc[1], navir[1]), dtype=np.float64)
    ...
    del x99
    x100 = np.zeros((naocc[1], navir[1]), dtype=np.float64)
    ...
    del x100
    x101 = np.zeros((naocc[0], navir[0]), dtype=np.float64)
    ...
    x103 += einsum(t2.abab[np.ix_(soa,sob,sva,svb)], (0, 1, 2, 3), x102, (4, 1, 5, 3), (0, 4, 2, 5))
    del x102
    ...
    x105 += einsum(t2.abab[np.ix_(soa,sob,sva,svb)], (0, 1, 2, 3), x104, (4, 1, 5, 3), (0, 4, 2, 5))
    del x104
    ...
    x110 += einsum(t2.aaaa[np.ix_(soa,soa,sva,sva)], (0, 1, 2, 3), x49, (4, 1, 5, 3), (0, 4, 2, 5))
    del x49
    ...
    x113 += einsum(t2.aaaa[np.ix_(soa,soa,sva,sva)], (0, 1, 2, 3), x112, (4, 1, 5, 3), (0, 4, 2, 5))
    del x112
    ...
    t2new_aaaa[np.ix_(soa,soa,sva,sva)] += einsum(x115, (0, 1, 2, 3), (0, 1, 3, 2)) * 2.0
    del x115
    x116 = np.zeros((nocc[0], nocc[0], nocc[0], nocc[0]), dtype=np.float64)
    x116 += einsum(t2.aaaa[np.ix_(soa,soa,sva,sva)], (0, 1, 2, 3), v.aaaa.ovov, (4, 2, 5, 3), (0, 1, 4, 5))
    ...
    del x142
    x143 = np.zeros((nocc[0], nocc[1], nvir[0], nvir[1]), dtype=np.float64)
    ...
    del x146
    x147 = np.zeros((nocc[0], nocc[1], nocc[1], nvir[0]), dtype=np.float64)
    ...
    del x147
    x148 = np.zeros((nocc[0], nocc[0], nocc[1], nvir[1]), dtype=np.float64)
    ...
    del x149
    x150 = np.zeros((nocc[1], nvir[0], nvir[0], nvir[1]), dtype=np.float64)
    ...
    del x150
    x151 = np.zeros((nocc[0], nocc[1], nocc[1], nvir[0]), dtype=np.float64)
    ...
    del x151
    x152 = np.zeros((nocc[0], nocc[0], nocc[1], nvir[1]), dtype=np.float64)
    ...
    x155 = np.zeros((nocc[0], nocc[0], nvir[1], nvir[1]), dtype=np.float64)
    ...
    del x155
    x156 = np.zeros((nocc[0], nocc[0], nocc[1], nvir[1]), dtype=np.float64)
    ...
    del x156
    x157 = np.zeros((nocc[0], nocc[0], nocc[1], nvir[1]), dtype=np.float64)
    ...
    del x158
    x159 = np.zeros((nocc[0], nocc[0], nocc[1], nocc[1]), dtype=np.float64)
    ...
    x166 = np.zeros((nocc[0], nocc[1], nocc[1], nvir[0]), dtype=np.float64)
    ...
    del x166
    x167 = np.zeros((nocc[0], nocc[1], nocc[1], nvir[0]), dtype=np.float64)
    ...
    del x167
    x168 = np.zeros((naocc[0], naocc[1], navir[1], nocc[0]), dtype=np.float64)
    x168 += einsum(v.aaaa.oVOV, (0, 1, 2, 3), t3.abaaba, (4, 5, 2, 1, 6, 3), (4, 5, 6, 0)) * -1.0
    t2new_abab[np.ix_(sOa,sOb,sva,sVb)] += einsum(t1.aa[np.ix_(soa,sva)], (0, 1), x168, (2, 3, 4, 0), (2, 3, 1, 4)) * 2.0
    del x168
    x169 = np.zeros((naocc[0], naocc[1], navir[1], nocc[0]), dtype=np.float64)
    ...
    del x169
    x170 = np.zeros((naocc[0], naocc[1], navir[0], nocc[1]), dtype=np.float64)
    ...
    x171 = np.zeros((naocc[0], naocc[1], navir[0], nocc[1]), dtype=np.float64)
    ...
    del x171
    x172 = np.zeros((naocc[1], naocc[1], navir[1], nocc[1]), dtype=np.float64)
    ...
    x173 = np.zeros((naocc[1], naocc[1], navir[1], nocc[1]), dtype=np.float64)
    ...
    x174 = np.zeros((naocc[0], naocc[1], navir[0], nocc[1]), dtype=np.float64)
    x174 += einsum(v.bbbb.oVOV, (0, 1, 2, 3), t3.babbab, (4, 5, 2, 3, 6, 1), (5, 4, 6, 0))
    t2new_abab[np.ix_(sOa,sOb,sVa,svb)] += einsum(t1.bb[np.ix_(sob,svb)], (0, 1), x174, (2, 3, 4, 0), (2, 3, 4, 1)) * 2.0
    del x174
    x175 = np.zeros((nocc[0], nocc[0], nocc[1], nocc[1]), dtype=np.float64)
    ...
    x177 = np.zeros((nocc[1], nocc[1], nvir[0], nvir[0]), dtype=np.float64)
    ...
    x180 = np.zeros((nocc[0], nocc[1], nvir[0], nvir[1]), dtype=np.float64)
    ...
    x182 += einsum(t2.bbbb[np.ix_(sob,sob,svb,svb)], (0, 1, 2, 3), v.bbbb.ovov, (0, 4, 1, 3), (2, 4))
    ...
    x187 = np.zeros((nocc[0], nocc[0], nocc[1], nvir[1]), dtype=np.float64)
    ...
    del x189
    x190 = np.zeros((nocc[0], nocc[1], nocc[1], nvir[0]), dtype=np.float64)
    ...
    del x190
    x191 = np.zeros((nocc[0], nocc[0], nocc[1], nvir[1]), dtype=np.float64)
    ...
    del x195
    x196 = np.zeros((nocc[0], nocc[0], nocc[1], nocc[1]), dtype=np.float64)
    ...
    x197 = np.zeros((nocc[0], nocc[1], nocc[1], nvir[0]), dtype=np.float64)
    ...
    del x197
    x198 = np.zeros((nocc[0], nocc[0], nocc[1], nvir[1]), dtype=np.float64)
    ...
    del x200
    x201 = np.zeros((nocc[0], nocc[1], nocc[1], nvir[0]), dtype=np.float64)
    ...
    x211 += einsum(t2.bbbb[np.ix_(sob,sob,svb,svb)], (0, 1, 2, 3), v.bbbb.oooo, (4, 1, 5, 0), (4, 5, 2, 3)) * -1.0
    ...
    x213 += einsum(t2.bbbb[np.ix_(sob,sob,svb,svb)], (0, 1, 2, 3), v.bbbb.vvvv, (4, 3, 5, 2), (0, 1, 4, 5)) * -1.0
    t2new_bbbb[np.ix_(sob,sob,svb,svb)] += einsum(x213, (0, 1, 2, 3), (1, 0, 3, 2))
    t2new_bbbb[np.ix_(sob,sob,svb,svb)] += einsum(x213, (0, 1, 2, 3), (1, 0, 3, 2))
    del x213
    x214 = np.zeros((naocc[1], navir[1], navir[1], nocc[1]), dtype=np.float64)
    ...
    del x214
    x215 = np.zeros((naocc[1], naocc[1], navir[1], nvir[1]), dtype=np.float64)
    ...
    del x215
    x216 = np.zeros((naocc[1], navir[1], navir[1], nocc[1]), dtype=np.float64)
    x216 += einsum(v.bbbb.oOOV, (0, 1, 2, 3), t3.bbbbbb, (4, 2, 1, 5, 6, 3), (4, 5, 6, 0))
    ...
    del x216
    x217 = np.zeros((naocc[1], naocc[1], navir[1], nvir[1]), dtype=np.float64)
    x217 += einsum(v.bbbb.vVOV, (0, 1, 2, 3), t3.bbbbbb, (4, 5, 2, 6, 3, 1), (4, 5, 6, 0))
    ...
    del x222
    x223 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    ...
    del x225
    x226 = np.zeros((nocc[1], nvir[1], nvir[1], nvir[1]), dtype=np.float64)
    ...
    x234 += einsum(t2.bbbb[np.ix_(sob,sob,svb,svb)], (0, 1, 2, 3), x233, (4, 5, 1, 0), (4, 5, 2, 3)) * -1.0
    ...
    del x246
    x247 = np.zeros((naocc[1], navir[1], navir[1], nocc[1]), dtype=np.float64)
    ...
    del x247
    x248 = np.zeros((naocc[1], naocc[1], navir[1], nocc[1]), dtype=np.float64)
    x248 += einsum(v.aabb.OVoV, (0, 1, 2, 3), t3.babbab, (4, 0, 5, 6, 1, 3), (4, 5, 6, 2))
    x249 = np.zeros((naocc[1], naocc[1], navir[1], nvir[1]), dtype=np.float64)
    ...
    del x249
    x250 = np.zeros((naocc[1], navir[1], navir[1], nocc[1]), dtype=np.float64)
    x250 += einsum(x172, (0, 1, 2, 3), t3.bbbbbb, (4, 1, 0, 5, 6, 2), (4, 5, 6, 3)) * -1.0
    del x172
    ...
    del x250
    x251 = np.zeros((naocc[1], navir[1], navir[1], nocc[1]), dtype=np.float64)
    x251 += einsum(x173, (0, 1, 2, 3), t3.bbbbbb, (4, 0, 1, 5, 6, 2), (4, 5, 6, 3))
    del x173
    ...
    del x251
    x252 = np.zeros((naocc[1], naocc[1], navir[1], nocc[1]), dtype=np.float64)
    x252 += einsum(v.bbbb.oVOV, (0, 1, 2, 3), t3.bbbbbb, (4, 5, 2, 6, 3, 1), (4, 5, 6, 0))
    x253 = np.zeros((naocc[1], naocc[1], navir[1], nvir[1]), dtype=np.float64)
    ...
    x259 += einsum(t2.bbbb[np.ix_(sob,sob,svb,svb)], (0, 1, 2, 3), x179, (4, 1, 5, 3), (4, 0, 5, 2))
    del x179
    ...
    x261 += einsum(t2.bbbb[np.ix_(sob,sob,svb,svb)], (0, 1, 2, 3), x181, (4, 1, 5, 3), (4, 0, 5, 2))
    del x181
    ...
    t2new_bbbb[np.ix_(sob,sob,svb,svb)] += einsum(x262, (0, 1, 2, 3), (0, 1, 3, 2)) * 2.0
    del x262
    x263 = np.zeros((nocc[1], nocc[1], nocc[1], nocc[1]), dtype=np.float64)
    ...
    del x281
    x282 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    ...
    del x290
    x291 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x291
    x292 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x293
    x294 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x294
    x295 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x295
    x296 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x296
    x297 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x297
    x298 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    x298 += einsum(v.aaaa.VVVV, (0, 1, 2, 3), t3.aaaaaa, (4, 5, 6, 7, 1, 3), (4, 5, 6, 7, 0, 2))
    ...
    del x298
    x299 = np.zeros((naocc[0], naocc[0]), dtype=np.float64)
    x299 += einsum(f.aa.vO, (0, 1), t1.aa[np.ix_(sOa,sva)], (2, 0), (1, 2))
    t3new_babbab += einsum(x299, (0, 1), t3.babbab, (2, 0, 3, 4, 5, 6), (2, 1, 3, 4, 5, 6)) * -2.0
    x300 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x300
    x301 = np.zeros((navir[0], navir[0]), dtype=np.float64)
    x301 += einsum(f.aa.oV, (0, 1), t1.aa[np.ix_(soa,sVa)], (0, 2), (1, 2))
    t3new_babbab += einsum(x301, (0, 1), t3.babbab, (2, 3, 4, 5, 0, 6), (2, 3, 4, 5, 1, 6)) * -2.0
    x302 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x302
    x303 = np.zeros((naocc[0], naocc[0], navir[0], nocc[0]), dtype=np.float64)
    x303 += einsum(f.aa.ov, (0, 1), t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (2, 3, 1, 4), (2, 3, 4, 0)) * -1.0
    x304 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x304
    x305 = np.zeros((naocc[0], naocc[0], navir[0], nocc[0]), dtype=np.float64)
    x305 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), v.aaaa.oOvV, (2, 3, 1, 4), (0, 3, 4, 2))
    x306 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x306
    x307 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], nocc[0]), dtype=np.float64)
    x307 += einsum(t2.aaaa[np.ix_(soa,sOa,sVa,sVa)], (0, 1, 2, 3), v.aaaa.oOoO, (4, 5, 0, 6), (1, 5, 6, 2, 3, 4)) * -1.0
    x308 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x308
    x309 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], nocc[0]), dtype=np.float64)
    x309 += einsum(t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (0, 1, 2, 3), v.aaaa.oOvV, (4, 5, 2, 6), (0, 1, 5, 3, 6, 4)) * -1.0
    x310 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x310
    x311 = np.zeros((naocc[0], naocc[0], navir[0], nocc[0]), dtype=np.float64)
    x311 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), v.aaaa.ovOV, (2, 1, 3, 4), (0, 3, 4, 2))
    x312 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x312
    x313 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], nocc[0]), dtype=np.float64)
    x313 += einsum(t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (0, 1, 2, 3), v.aaaa.ovOV, (4, 2, 5, 6), (0, 1, 5, 3, 6, 4)) * -1.0
    x314 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    x316 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x316
    x317 = np.zeros((naocc[0], naocc[1], navir[0], navir[1]), dtype=np.float64)
    ...
    x318 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x318
    x319 = np.zeros((naocc[0], naocc[1], navir[0], navir[1]), dtype=np.float64)
    ...
    x320 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x320
    x321 = np.zeros((naocc[0], naocc[0], naocc[0], naocc[0]), dtype=np.float64)
    x321 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), v.aaaa.vOOO, (1, 2, 3, 4), (0, 3, 4, 2))
    x322 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    x322 += einsum(x321, (0, 1, 2, 3), t3.aaaaaa, (4, 2, 3, 5, 6, 7), (0, 4, 1, 5, 6, 7))
    ...
    del x322
    x323 = np.zeros((naocc[0], naocc[0], navir[0], navir[0]), dtype=np.float64)
    ...
    x324 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x324
    x325 = np.zeros((naocc[0], naocc[0], navir[0], navir[0]), dtype=np.float64)
    ...
    x326 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x326
    x327 = np.zeros((naocc[0], naocc[0]), dtype=np.float64)
    ...
    x328 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x328
    x329 = np.zeros((naocc[0], naocc[0]), dtype=np.float64)
    ...
    x330 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x330
    x331 = np.zeros((naocc[0], naocc[0], navir[0], navir[0]), dtype=np.float64)
    ...
    x332 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x332
    x333 = np.zeros((naocc[0], naocc[0], navir[0], navir[0]), dtype=np.float64)
    ...
    x334 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x334
    x335 = np.zeros((navir[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    x335 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), v.aaaa.oVVV, (0, 2, 3, 4), (1, 3, 4, 2))
    x336 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x336
    x337 = np.zeros((navir[0], navir[0]), dtype=np.float64)
    ...
    x338 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x338
    x339 = np.zeros((navir[0], navir[0]), dtype=np.float64)
    ...
    x340 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x340
    x341 = np.zeros((naocc[0], naocc[0]), dtype=np.float64)
    ...
    x342 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x342
    x343 = np.zeros((navir[0], navir[0]), dtype=np.float64)
    ...
    x344 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x344
    x345 = np.zeros((naocc[0], naocc[0], navir[0], nocc[0]), dtype=np.float64)
    x345 += einsum(t2.baba[np.ix_(sob,sOa,svb,sVa)], (0, 1, 2, 3), v.aabb.oOov, (4, 5, 0, 2), (1, 5, 3, 4))
    x346 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x346
    x347 = np.zeros((naocc[0], navir[0], navir[0], nvir[0]), dtype=np.float64)
    x347 += einsum(t2.baba[np.ix_(sob,sOa,svb,sVa)], (0, 1, 2, 3), v.aabb.vVov, (4, 5, 0, 2), (1, 3, 5, 4))
    x348 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x348
    x349 = np.zeros((naocc[0], naocc[0], navir[0], nocc[0]), dtype=np.float64)
    x349 += einsum(t2.aaaa[np.ix_(soa,sOa,sva,sVa)], (0, 1, 2, 3), v.aaaa.ovoO, (0, 2, 4, 5), (1, 5, 3, 4))
    x350 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x350
    x351 = np.zeros((naocc[0], naocc[0], navir[0], nocc[0]), dtype=np.float64)
    x351 += einsum(t2.aaaa[np.ix_(soa,sOa,sva,sVa)], (0, 1, 2, 3), v.aaaa.ovoO, (4, 2, 0, 5), (1, 5, 3, 4))
    x352 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x352
    x353 = np.zeros((naocc[0], navir[0], navir[0], nvir[0]), dtype=np.float64)
    x353 += einsum(t2.aaaa[np.ix_(soa,soa,sVa,sVa)], (0, 1, 2, 3), v.aaaa.ovoO, (1, 4, 0, 5), (5, 2, 3, 4))
    x354 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    t3new_aaaaaa += einsum(x354, (0, 1, 2, 3, 4, 5), (2, 1, 0, 5, 4, 3)) * -2.0
    del x354
    x355 = np.zeros((naocc[0], navir[0], navir[0], nvir[0]), dtype=np.float64)
    x355 += einsum(t2.aaaa[np.ix_(soa,sOa,sva,sVa)], (0, 1, 2, 3), v.aaaa.ovvV, (0, 4, 2, 5), (1, 3, 5, 4))
    x356 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x356
    x357 = np.zeros((naocc[0], naocc[0], navir[0], nocc[0]), dtype=np.float64)
    x357 += einsum(t2.aaaa[np.ix_(sOa,sOa,sva,sva)], (0, 1, 2, 3), v.aaaa.ovvV, (4, 2, 3, 5), (0, 1, 5, 4)) * -1.0
    x358 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    t3new_aaaaaa += einsum(x358, (0, 1, 2, 3, 4, 5), (0, 1, 2, 5, 4, 3)) * -2.0
    del x358
    x359 = np.zeros((naocc[0], navir[0], navir[0], nvir[0]), dtype=np.float64)
    x359 += einsum(t2.aaaa[np.ix_(soa,sOa,sva,sVa)], (0, 1, 2, 3), v.aaaa.ovvV, (0, 2, 4, 5), (1, 3, 5, 4))
    x360 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x360
    x361 = np.zeros((naocc[0], naocc[1], navir[0], navir[1]), dtype=np.float64)
    x361 += einsum(t2.baba[np.ix_(sob,sOa,svb,sVa)], (0, 1, 2, 3), v.bbbb.ovOV, (0, 2, 4, 5), (1, 4, 3, 5))
    t3new_babbab += einsum(x361, (0, 1, 2, 3), t3.bbbbbb, (4, 5, 1, 6, 7, 3), (4, 0, 5, 6, 2, 7)) * 6.0000000000000595
    x362 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x362
    x363 = np.zeros((naocc[0], naocc[1], navir[0], navir[1]), dtype=np.float64)
    x363 += einsum(t2.baba[np.ix_(sob,sOa,svb,sVa)], (0, 1, 2, 3), v.bbbb.oVvO, (0, 4, 2, 5), (1, 5, 3, 4))
    t3new_babbab += einsum(x363, (0, 1, 2, 3), t3.bbbbbb, (4, 5, 1, 6, 7, 3), (4, 0, 5, 6, 2, 7)) * -6.0000000000000595
    x364 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x364
    x365 = np.zeros((naocc[0], naocc[0]), dtype=np.float64)
    x365 += einsum(t2.baba[np.ix_(sob,sOa,svb,sva)], (0, 1, 2, 3), v.aabb.vOov, (3, 4, 0, 2), (1, 4))
    t3new_babbab += einsum(x365, (0, 1), t3.babbab, (2, 1, 3, 4, 5, 6), (2, 0, 3, 4, 5, 6)) * -2.0
    x366 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x366
    x367 = np.zeros((naocc[0], naocc[0], navir[0], navir[0]), dtype=np.float64)
    x367 += einsum(t2.baba[np.ix_(sob,sOa,svb,sVa)], (0, 1, 2, 3), v.aabb.OVov, (4, 5, 0, 2), (1, 4, 3, 5))
    t3new_babbab += einsum(x367, (0, 1, 2, 3), t3.babbab, (4, 1, 5, 6, 3, 7), (4, 0, 5, 6, 2, 7)) * 2.00000000000002
    x368 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x368
    x369 = np.zeros((navir[0], navir[0]), dtype=np.float64)
    x369 += einsum(t2.baba[np.ix_(sob,soa,svb,sVa)], (0, 1, 2, 3), v.aabb.oVov, (1, 4, 0, 2), (3, 4))
    t3new_babbab += einsum(x369, (0, 1), t3.babbab, (2, 3, 4, 5, 1, 6), (2, 3, 4, 5, 0, 6)) * -2.0
    x370 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x370
    x371 = np.zeros((naocc[0], naocc[0], naocc[0], naocc[1], navir[0], navir[1]), dtype=np.float64)
    x371 += einsum(t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (0, 1, 2, 3), v.aabb.vOOV, (2, 4, 5, 6), (0, 1, 4, 5, 3, 6)) * -1.0
    x372 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x372
    x373 = np.zeros((naocc[0], naocc[1], navir[0], navir[0], navir[0], navir[1]), dtype=np.float64)
    x373 += einsum(t2.aaaa[np.ix_(soa,sOa,sVa,sVa)], (0, 1, 2, 3), v.aabb.oVOV, (0, 4, 5, 6), (1, 5, 2, 3, 4, 6)) * -1.0
    x374 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    x374 += einsum(t3.abaaba, (0, 1, 2, 3, 4, 5), x373, (6, 1, 7, 8, 5, 4), (6, 0, 2, 8, 7, 3)) * -1.0
    ...
    del x374
    x375 = np.zeros((naocc[0], naocc[1], navir[0], navir[1]), dtype=np.float64)
    ...
    del x376
    x377 = np.zeros((naocc[0], naocc[0], naocc[0], naocc[0], navir[0], navir[0]), dtype=np.float64)
    x377 += einsum(t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (0, 1, 2, 3), v.aaaa.vOOV, (2, 4, 5, 6), (0, 1, 5, 4, 3, 6)) * -1.0
    x378 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x378
    x379 = np.zeros((naocc[0], naocc[0], naocc[0], naocc[0]), dtype=np.float64)
    x379 += einsum(t2.aaaa[np.ix_(sOa,sOa,sva,sva)], (0, 1, 2, 3), v.aaaa.vOvO, (2, 4, 3, 5), (0, 1, 4, 5))
    x380 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    x380 += einsum(x379, (0, 1, 2, 3), t3.aaaaaa, (4, 3, 2, 5, 6, 7), (1, 0, 4, 5, 6, 7))
    ...
    t3new_aaaaaa += einsum(x380, (0, 1, 2, 3, 4, 5), (2, 1, 0, 4, 5, 3)) * -3.0
    del x380
    x381 = np.zeros((naocc[0], naocc[0], naocc[0], naocc[0], navir[0], navir[0]), dtype=np.float64)
    x381 += einsum(t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (0, 1, 2, 3), v.aaaa.vOOV, (2, 4, 5, 6), (0, 1, 5, 4, 3, 6)) * -1.0
    x382 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x382
    x383 = np.zeros((naocc[0], naocc[0], navir[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    x383 += einsum(t2.aaaa[np.ix_(soa,sOa,sVa,sVa)], (0, 1, 2, 3), v.aaaa.oVOV, (0, 4, 5, 6), (1, 5, 2, 3, 6, 4)) * -1.0
    x384 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    x384 += einsum(t3.aaaaaa, (0, 1, 2, 3, 4, 5), x383, (6, 2, 7, 8, 4, 5), (6, 0, 1, 8, 7, 3)) * -1.0
    ...
    del x384
    x385 = np.zeros((naocc[0], naocc[0], navir[0], navir[0]), dtype=np.float64)
    ...
    x386 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x386
    x387 = np.zeros((naocc[0], naocc[0]), dtype=np.float64)
    x387 += einsum(t2.aaaa[np.ix_(soa,sOa,sva,sva)], (0, 1, 2, 3), v.aaaa.ovvO, (0, 2, 3, 4), (1, 4))
    x388 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    t3new_aaaaaa += einsum(x388, (0, 1, 2, 3, 4, 5), (1, 2, 0, 4, 5, 3)) * -6.0
    del x388
    x389 = np.zeros((naocc[0], naocc[0], navir[0], navir[0]), dtype=np.float64)
    ...
    x390 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x390
    x391 = np.zeros((navir[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    x392 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    x392 += einsum(x391, (0, 1, 2, 3), t3.aaaaaa, (4, 5, 6, 7, 3, 2), (4, 5, 6, 1, 0, 7))
    del x391
    ...
    del x392
    x393 = np.zeros((navir[0], navir[0]), dtype=np.float64)
    ...
    x394 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x394
    x395 = np.zeros((navir[0], navir[0]), dtype=np.float64)
    ...
    x396 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x396
    x397 = np.zeros((naocc[0], naocc[0], navir[0], navir[0], navir[0], nvir[0]), dtype=np.float64)
    x397 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), t2.aaaa[np.ix_(soa,sOa,sVa,sVa)], (2, 3, 4, 5), v.aaaa.ovoO, (2, 6, 0, 7), (3, 7, 1, 4, 5, 6)) * -1.0
    x398 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x398
    x399 = np.zeros((naocc[0], naocc[0], navir[0], navir[0], navir[0], nvir[0]), dtype=np.float64)
    x399 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), t2.aaaa[np.ix_(soa,sOa,sVa,sVa)], (2, 3, 4, 5), v.aaaa.ovoO, (0, 6, 2, 7), (3, 7, 1, 4, 5, 6)) * -1.0
    x400 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x400
    x401 = np.zeros((naocc[0], navir[0], navir[0], nvir[0]), dtype=np.float64)
    x401 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), t1.aa[np.ix_(soa,sVa)], (2, 3), v.aaaa.ovoO, (2, 4, 0, 5), (5, 1, 3, 4))
    x402 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x402
    x403 = np.zeros((naocc[0], naocc[0], navir[0], navir[0], navir[0], nvir[0]), dtype=np.float64)
    x403 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), t2.aaaa[np.ix_(soa,sOa,sVa,sVa)], (2, 3, 4, 5), v.aaaa.ovvV, (2, 1, 6, 7), (0, 3, 4, 5, 7, 6)) * -1.0
    x404 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x404
    x405 = np.zeros((naocc[0], naocc[0], navir[0], navir[0], navir[0], nvir[0]), dtype=np.float64)
    x405 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (2, 3, 4, 5), v.aaaa.ovvV, (0, 6, 4, 7), (2, 3, 1, 5, 7, 6)) * -1.0
    x406 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x406
    x407 = np.zeros((naocc[0], naocc[0], navir[0], navir[0], navir[0], nvir[0]), dtype=np.float64)
    x407 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (2, 3, 4, 5), v.aaaa.ovvV, (0, 4, 6, 7), (2, 3, 1, 5, 7, 6)) * -1.0
    x408 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x408
    x409 = np.zeros((naocc[0], naocc[1], navir[1], nocc[0]), dtype=np.float64)
    x409 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), v.aabb.ovOV, (2, 1, 3, 4), (0, 3, 4, 2))
    x410 = np.zeros((naocc[0], naocc[1], navir[0], navir[1]), dtype=np.float64)
    ...
    x411 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x411
    x412 = np.zeros((naocc[0], naocc[0], naocc[0], nvir[0]), dtype=np.float64)
    x412 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), v.aaaa.vOvO, (2, 3, 1, 4), (0, 3, 4, 2))
    x413 = np.zeros((naocc[0], naocc[0], naocc[0], naocc[0]), dtype=np.float64)
    x413 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), x412, (2, 3, 4, 1), (2, 0, 4, 3))
    del x412
    x414 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    t3new_aaaaaa += einsum(x414, (0, 1, 2, 3, 4, 5), (2, 1, 0, 4, 5, 3)) * -3.0
    del x414
    x415 = np.zeros((naocc[0], naocc[0], navir[0], nocc[0]), dtype=np.float64)
    x415 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), v.aaaa.ovOV, (2, 1, 3, 4), (0, 3, 4, 2))
    x416 = np.zeros((naocc[0], naocc[0], navir[0], navir[0]), dtype=np.float64)
    ...
    x417 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x417
    x418 = np.zeros((naocc[0], naocc[0], navir[0], nocc[0]), dtype=np.float64)
    x418 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), v.aaaa.oVvO, (2, 3, 1, 4), (0, 4, 3, 2))
    x419 = np.zeros((naocc[0], naocc[0], navir[0], navir[0]), dtype=np.float64)
    ...
    x420 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x426
    x427 = np.zeros((navir[0], navir[0], navir[0], nocc[0]), dtype=np.float64)
    x427 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), v.aaaa.oVoV, (2, 3, 0, 4), (1, 3, 4, 2))
    x428 = np.zeros((navir[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    x428 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), x427, (2, 3, 4, 0), (2, 1, 4, 3))
    del x427
    t3new_abaaba += einsum(x428, (0, 1, 2, 3), t3.abaaba, (4, 5, 6, 2, 7, 3), (4, 5, 6, 0, 7, 1)) * 2.0
    x429 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x441
    x442 = np.zeros((naocc[0], navir[0], nocc[0], nvir[0]), dtype=np.float64)
    x442 += einsum(t2.baba[np.ix_(sob,sOa,svb,sVa)], (0, 1, 2, 3), v.aabb.ovov, (4, 5, 0, 2), (1, 3, 4, 5))
    x443 = np.zeros((naocc[0], naocc[0], navir[0], nocc[0]), dtype=np.float64)
    x443 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), x442, (2, 3, 4, 1), (0, 2, 3, 4))
    x444 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x444
    x445 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], nocc[0]), dtype=np.float64)
    x445 += einsum(t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (0, 1, 2, 3), x442, (4, 5, 6, 2), (0, 1, 4, 3, 5, 6)) * -1.0
    x446 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x446
    x447 = np.zeros((naocc[0], navir[0], nocc[0], nvir[0]), dtype=np.float64)
    x447 += einsum(t2.aaaa[np.ix_(soa,sOa,sva,sVa)], (0, 1, 2, 3), v.aaaa.ovov, (4, 5, 0, 2), (1, 3, 4, 5))
    x448 = np.zeros((naocc[0], naocc[0], navir[0], nocc[0]), dtype=np.float64)
    x448 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), x447, (2, 3, 4, 1), (0, 2, 3, 4))
    x449 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x449
    x450 = np.zeros((naocc[0], navir[0], nocc[0], nvir[0]), dtype=np.float64)
    x450 += einsum(t2.aaaa[np.ix_(soa,sOa,sva,sVa)], (0, 1, 2, 3), v.aaaa.ovov, (4, 2, 0, 5), (1, 3, 4, 5))
    x451 = np.zeros((naocc[0], naocc[0], navir[0], nocc[0]), dtype=np.float64)
    x451 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), x450, (2, 3, 4, 1), (0, 2, 3, 4))
    x452 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x452
    x453 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], nocc[0], nocc[0]), dtype=np.float64)
    x453 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (2, 3, 4, 5), v.aaaa.ovov, (6, 1, 7, 4), (0, 2, 3, 5, 6, 7)) * -1.0
    x454 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    t3new_aaaaaa += einsum(x454, (0, 1, 2, 3, 4, 5), (1, 2, 0, 5, 4, 3)) * 2.0
    del x454
    x455 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], nocc[0]), dtype=np.float64)
    x455 += einsum(t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (0, 1, 2, 3), x447, (4, 5, 6, 2), (0, 1, 4, 3, 5, 6)) * -1.0
    x456 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x456
    x457 = np.zeros((naocc[0], naocc[0], nocc[0], nocc[0]), dtype=np.float64)
    x457 += einsum(t2.aaaa[np.ix_(sOa,sOa,sva,sva)], (0, 1, 2, 3), v.aaaa.ovov, (4, 2, 5, 3), (0, 1, 4, 5))
    x458 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], nocc[0]), dtype=np.float64)
    x458 += einsum(t2.aaaa[np.ix_(soa,sOa,sVa,sVa)], (0, 1, 2, 3), x457, (4, 5, 0, 6), (4, 5, 1, 2, 3, 6))
    x459 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    t3new_aaaaaa += einsum(x459, (0, 1, 2, 3, 4, 5), (0, 1, 2, 5, 4, 3)) * 2.0
    del x459
    x460 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], nocc[0]), dtype=np.float64)
    x460 += einsum(t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (0, 1, 2, 3), x450, (4, 5, 6, 2), (0, 1, 4, 3, 5, 6)) * -1.0
    x461 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x461
    x462 = np.zeros((naocc[0], naocc[0], navir[0], nocc[0]), dtype=np.float64)
    x462 += einsum(x11, (0, 1), t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (2, 3, 1, 4), (2, 3, 4, 0)) * -1.0
    x463 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x463
    x464 = np.zeros((naocc[0], naocc[0], navir[0], nocc[0]), dtype=np.float64)
    x464 += einsum(x12, (0, 1), t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (2, 3, 1, 4), (2, 3, 4, 0)) * -1.0
    x465 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x465
    x466 = np.zeros((naocc[0], naocc[0], navir[0], nocc[0]), dtype=np.float64)
    x466 += einsum(x15, (0, 1), t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (2, 3, 1, 4), (2, 3, 4, 0)) * -1.0
    x467 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x467
    x468 = np.zeros((naocc[0], naocc[0], navir[0], navir[0], nocc[0], nvir[0]), dtype=np.float64)
    x468 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), t2.aaaa[np.ix_(soa,sOa,sVa,sVa)], (2, 3, 4, 5), v.aaaa.ovov, (6, 7, 2, 1), (0, 3, 4, 5, 6, 7)) * -1.0
    x469 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], nocc[0]), dtype=np.float64)
    x469 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), x468, (2, 3, 4, 5, 6, 1), (0, 2, 3, 4, 5, 6))
    del x468
    x470 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x470
    x471 = np.zeros((naocc[0], naocc[0], navir[0], navir[0], nocc[0], nvir[0]), dtype=np.float64)
    x471 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (2, 3, 4, 5), v.aaaa.ovov, (6, 7, 0, 4), (2, 3, 1, 5, 6, 7)) * -1.0
    x472 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], nocc[0]), dtype=np.float64)
    x472 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), x471, (2, 3, 4, 5, 6, 1), (0, 2, 3, 4, 5, 6))
    del x471
    x473 = np.zeros((naocc[0], naocc[0], naocc[0], navir[0], navir[0], navir[0]), dtype=np.float64)
    ...
    del x473
    x474 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x474
    x475 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x475
    x476 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x476 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), v.bbbb.oOOV, (0, 4, 5, 6), (1, 5, 4, 3, 2, 6))
    ...
    del x476
    x477 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x477
    x478 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x478 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), v.bbbb.vVOV, (2, 4, 5, 6), (1, 0, 5, 3, 6, 4))
    ...
    del x478
    x479 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x479
    x480 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x480
    x481 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x481
    x482 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x482
    x483 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x483
    x484 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x484
    x485 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x485
    x486 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x486
    x487 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x487
    x488 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x488
    x489 = np.zeros((naocc[1], naocc[1]), dtype=np.float64)
    x489 += einsum(f.bb.vO, (0, 1), t1.bb[np.ix_(sOb,svb)], (2, 0), (1, 2))
    t3new_abaaba += einsum(x489, (0, 1), t3.abaaba, (2, 0, 3, 4, 5, 6), (2, 1, 3, 4, 5, 6)) * -2.0
    x490 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x490
    x491 = np.zeros((navir[1], navir[1]), dtype=np.float64)
    x491 += einsum(f.bb.oV, (0, 1), t1.bb[np.ix_(sob,sVb)], (0, 2), (1, 2))
    t3new_abaaba += einsum(x491, (0, 1), t3.abaaba, (2, 3, 4, 5, 0, 6), (2, 3, 4, 5, 1, 6)) * -2.0
    x492 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x492
    x493 = np.zeros((naocc[0], naocc[1], navir[1], nocc[0]), dtype=np.float64)
    x493 += einsum(f.aa.ov, (0, 1), t2.abab[np.ix_(sOa,sOb,sva,sVb)], (2, 3, 1, 4), (2, 3, 4, 0)) * -1.0
    x494 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x494
    x495 = np.zeros((naocc[0], naocc[1], navir[0], nocc[1]), dtype=np.float64)
    x495 += einsum(f.bb.ov, (0, 1), t2.baba[np.ix_(sOb,sOa,svb,sVa)], (2, 3, 1, 4), (3, 2, 4, 0))
    x496 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x496
    x497 = np.zeros((naocc[1], naocc[1], navir[1], nocc[1]), dtype=np.float64)
    x497 += einsum(f.bb.ov, (0, 1), t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (2, 3, 1, 4), (2, 3, 4, 0)) * -1.0
    x498 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x498 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x497, (4, 5, 6, 0), (1, 5, 4, 3, 6, 2)) * -1.0
    t3new_babbab += einsum(x498, (0, 1, 2, 3, 4, 5), (1, 0, 2, 4, 3, 5)) * -2.0
    t3new_babbab += einsum(x498, (0, 1, 2, 3, 4, 5), (1, 0, 2, 5, 3, 4)) * 2.0
    del x498
    x499 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x499
    x500 = np.zeros((naocc[0], naocc[1], naocc[1], navir[1], navir[1], nocc[0]), dtype=np.float64)
    x500 += einsum(t2.abab[np.ix_(sOa,sOb,sva,sVb)], (0, 1, 2, 3), v.aabb.ovOV, (4, 2, 5, 6), (0, 1, 5, 3, 6, 4)) * -1.0
    x501 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x501
    x502 = np.zeros((naocc[0], naocc[1], naocc[1], navir[1], navir[1], nocc[0]), dtype=np.float64)
    x502 += einsum(t2.bbbb[np.ix_(sob,sOb,sVb,sVb)], (0, 1, 2, 3), v.aabb.oOoO, (4, 5, 0, 6), (5, 1, 6, 2, 3, 4)) * -1.0
    x503 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x503
    x504 = np.zeros((naocc[0], naocc[1], naocc[1], navir[1], navir[1], nocc[0]), dtype=np.float64)
    x504 += einsum(t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (0, 1, 2, 3), v.aabb.oOvV, (4, 5, 2, 6), (5, 0, 1, 3, 6, 4)) * -1.0
    x505 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x505
    x506 = np.zeros((naocc[0], naocc[1], navir[0], nocc[1]), dtype=np.float64)
    x506 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), v.aabb.vVoO, (1, 2, 3, 4), (0, 4, 2, 3))
    x507 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x507
    x508 = np.zeros((naocc[1], naocc[1], navir[0], navir[1], navir[1], nvir[0]), dtype=np.float64)
    x508 += einsum(t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (0, 1, 2, 3), v.aabb.vVvV, (4, 5, 2, 6), (0, 1, 5, 3, 6, 4)) * -1.0
    x509 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x509
    x510 = np.zeros((naocc[1], naocc[1], navir[1], nocc[1]), dtype=np.float64)
    x510 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), v.bbbb.oOvV, (2, 3, 1, 4), (0, 3, 4, 2))
    x511 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x511 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x510, (4, 5, 6, 0), (1, 4, 5, 3, 2, 6))
    ...
    del x511
    x512 = np.zeros((naocc[0], naocc[1], navir[1], nocc[0]), dtype=np.float64)
    x512 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), v.aabb.oOvV, (2, 3, 1, 4), (3, 0, 4, 2))
    x513 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x513
    x514 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], nocc[1]), dtype=np.float64)
    x514 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), v.bbbb.oOoO, (4, 5, 0, 6), (1, 5, 6, 3, 2, 4))
    x515 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x515
    x516 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], nocc[1]), dtype=np.float64)
    x516 += einsum(t2.abab[np.ix_(soa,sOb,sVa,sVb)], (0, 1, 2, 3), v.aabb.oOoO, (0, 4, 5, 6), (4, 1, 6, 2, 3, 5)) * -1.0
    x517 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x517
    x518 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], nocc[1]), dtype=np.float64)
    x518 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), v.bbbb.oOvV, (4, 5, 2, 6), (1, 0, 5, 3, 6, 4))
    x519 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x519
    x520 = np.zeros((naocc[1], naocc[1], navir[1], nocc[1]), dtype=np.float64)
    x520 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), v.bbbb.ovOV, (2, 1, 3, 4), (0, 3, 4, 2))
    x521 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x521 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x520, (4, 5, 6, 0), (1, 4, 5, 3, 2, 6))
    ...
    del x521
    x522 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], nocc[1]), dtype=np.float64)
    x522 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), v.bbbb.ovOV, (4, 2, 5, 6), (1, 0, 5, 3, 6, 4))
    x523 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x523
    x524 = np.zeros((naocc[0], naocc[1], navir[0], navir[1], navir[1], nvir[1]), dtype=np.float64)
    x524 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), v.bbbb.vVvV, (4, 5, 2, 6), (1, 0, 3, 5, 6, 4))
    x525 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x525
    x526 = np.zeros((naocc[0], naocc[1], navir[0], navir[1], navir[1], nvir[1]), dtype=np.float64)
    x526 += einsum(t2.abab[np.ix_(sOa,sOb,sva,sVb)], (0, 1, 2, 3), v.aabb.vVvV, (2, 4, 5, 6), (0, 1, 4, 3, 6, 5)) * -1.0
    x527 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x527
    x528 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], nocc[1]), dtype=np.float64)
    x528 += einsum(t2.abab[np.ix_(sOa,sOb,sva,sVb)], (0, 1, 2, 3), v.aabb.vVoO, (2, 4, 5, 6), (0, 1, 6, 4, 3, 5)) * -1.0
    x529 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x529
    x530 = np.zeros((naocc[0], naocc[1], navir[0], nocc[1]), dtype=np.float64)
    x530 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), v.aabb.OVov, (2, 3, 4, 1), (2, 0, 3, 4))
    x531 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x531
    x532 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], nocc[1]), dtype=np.float64)
    x532 += einsum(t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (0, 1, 2, 3), v.aabb.OVov, (4, 5, 6, 2), (4, 0, 1, 5, 3, 6)) * -1.0
    x533 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x533
    x534 = np.zeros((naocc[0], naocc[0], naocc[1], naocc[1]), dtype=np.float64)
    x534 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), v.aabb.vOOO, (1, 2, 3, 4), (0, 2, 3, 4))
    x535 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x535
    x536 = np.zeros((naocc[0], naocc[0], navir[1], navir[1]), dtype=np.float64)
    x536 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), v.aabb.vOVV, (1, 2, 3, 4), (0, 2, 3, 4))
    x537 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x537
    x538 = np.zeros((naocc[1], naocc[1], navir[0], navir[0]), dtype=np.float64)
    x538 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), v.aabb.oVOO, (0, 2, 3, 4), (3, 4, 1, 2))
    x539 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x539
    x540 = np.zeros((naocc[1], naocc[1]), dtype=np.float64)
    ...
    x541 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x541
    x542 = np.zeros((navir[0], navir[0], navir[1], navir[1]), dtype=np.float64)
    x542 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), v.aabb.oVVV, (0, 2, 3, 4), (1, 2, 3, 4))
    x543 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x543
    x544 = np.zeros((navir[1], navir[1]), dtype=np.float64)
    ...
    x545 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x545
    x546 = np.zeros((naocc[0], naocc[1], navir[0], navir[1]), dtype=np.float64)
    ...
    x547 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x547
    x548 = np.zeros((naocc[0], naocc[1], navir[0], navir[1]), dtype=np.float64)
    ...
    x549 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x549
    x550 = np.zeros((naocc[0], naocc[0], naocc[1], naocc[1]), dtype=np.float64)
    x550 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), v.aabb.OOvO, (2, 3, 1, 4), (2, 3, 0, 4))
    x551 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x551
    x552 = np.zeros((naocc[1], naocc[1], naocc[1], naocc[1]), dtype=np.float64)
    x552 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), v.bbbb.vOOO, (1, 2, 3, 4), (0, 3, 4, 2))
    x553 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x553 += einsum(x552, (0, 1, 2, 3), t3.babbab, (2, 4, 3, 5, 6, 7), (4, 0, 1, 6, 5, 7))
    t3new_babbab += einsum(x553, (0, 1, 2, 3, 4, 5), (1, 0, 2, 5, 3, 4)) * 2.0
    t3new_babbab += einsum(x553, (0, 1, 2, 3, 4, 5), (2, 0, 1, 5, 3, 4)) * -2.0
    del x553
    x554 = np.zeros((naocc[1], naocc[1], navir[1], navir[1]), dtype=np.float64)
    ...
    x555 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x555
    x556 = np.zeros((naocc[1], naocc[1], navir[1], navir[1]), dtype=np.float64)
    ...
    x557 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x557
    x558 = np.zeros((naocc[0], naocc[0], navir[1], navir[1]), dtype=np.float64)
    x558 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), v.aabb.OOoV, (2, 3, 0, 4), (2, 3, 1, 4))
    x559 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x559
    x560 = np.zeros((naocc[1], naocc[1]), dtype=np.float64)
    ...
    x561 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x561
    x562 = np.zeros((naocc[1], naocc[1]), dtype=np.float64)
    ...
    x563 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x563
    x564 = np.zeros((naocc[1], naocc[1], navir[1], navir[1]), dtype=np.float64)
    ...
    x565 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x565
    x566 = np.zeros((naocc[1], naocc[1], navir[1], navir[1]), dtype=np.float64)
    ...
    x567 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x567
    x568 = np.zeros((navir[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    x568 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), v.bbbb.oVVV, (0, 2, 3, 4), (1, 3, 4, 2))
    x569 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x569 += einsum(x568, (0, 1, 2, 3), t3.babbab, (4, 5, 6, 2, 7, 3), (5, 4, 6, 7, 0, 1))
    t3new_babbab += einsum(x569, (0, 1, 2, 3, 4, 5), (1, 0, 2, 4, 3, 5)) * 2.0
    t3new_babbab += einsum(x569, (0, 1, 2, 3, 4, 5), (1, 0, 2, 5, 3, 4)) * -2.0
    del x569
    x570 = np.zeros((navir[1], navir[1]), dtype=np.float64)
    ...
    x571 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x571
    x572 = np.zeros((navir[1], navir[1]), dtype=np.float64)
    ...
    x573 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x573
    x574 = np.zeros((naocc[1], naocc[1], navir[0], navir[0]), dtype=np.float64)
    x574 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), v.aabb.VVvO, (2, 3, 1, 4), (0, 4, 2, 3))
    x575 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x575
    x576 = np.zeros((navir[0], navir[0], navir[1], navir[1]), dtype=np.float64)
    x576 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), v.aabb.VVoV, (2, 3, 0, 4), (2, 3, 1, 4))
    x577 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x577
    x578 = np.zeros((naocc[0], naocc[1], navir[1], nocc[0]), dtype=np.float64)
    x578 += einsum(t2.abab[np.ix_(soa,sOb,sva,sVb)], (0, 1, 2, 3), v.aaaa.ovoO, (4, 2, 0, 5), (5, 1, 3, 4))
    x579 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x579
    x580 = np.zeros((naocc[0], naocc[1], navir[1], nocc[0]), dtype=np.float64)
    x580 += einsum(t2.abab[np.ix_(soa,sOb,sva,sVb)], (0, 1, 2, 3), v.aaaa.ovoO, (0, 2, 4, 5), (5, 1, 3, 4))
    x581 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x581
    x582 = np.zeros((naocc[1], navir[0], navir[1], nvir[0]), dtype=np.float64)
    x582 += einsum(t2.abab[np.ix_(soa,sob,sVa,sVb)], (0, 1, 2, 3), v.aabb.ovoO, (0, 4, 1, 5), (5, 2, 3, 4))
    x583 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x583
    x584 = np.zeros((naocc[1], naocc[1], navir[1], nocc[1]), dtype=np.float64)
    x584 += einsum(t2.abab[np.ix_(soa,sOb,sva,sVb)], (0, 1, 2, 3), v.aabb.ovoO, (0, 2, 4, 5), (1, 5, 3, 4))
    x585 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x585 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x584, (4, 5, 6, 0), (1, 4, 5, 3, 2, 6))
    ...
    del x585
    x586 = np.zeros((naocc[0], naocc[1], navir[1], nocc[0]), dtype=np.float64)
    x586 += einsum(t2.baab[np.ix_(sob,sOa,sva,sVb)], (0, 1, 2, 3), v.aabb.ovoO, (4, 2, 0, 5), (1, 5, 3, 4))
    x587 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    x588 += einsum(t2.abba[np.ix_(soa,sOb,svb,sVa)], (0, 1, 2, 3), v.aabb.ovvV, (0, 4, 2, 5), (1, 3, 5, 4))
    x589 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x589
    x590 = np.zeros((naocc[0], naocc[1], navir[1], nocc[0]), dtype=np.float64)
    x590 += einsum(t2.abab[np.ix_(sOa,sOb,sva,svb)], (0, 1, 2, 3), v.aabb.ovvV, (4, 2, 3, 5), (0, 1, 5, 4))
    x591 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x591
    x592 = np.zeros((naocc[1], navir[0], navir[1], nvir[0]), dtype=np.float64)
    x592 += einsum(t2.abab[np.ix_(soa,sOb,sva,sVb)], (0, 1, 2, 3), v.aaaa.ovvV, (0, 4, 2, 5), (1, 5, 3, 4))
    x593 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x593
    x594 = np.zeros((naocc[1], navir[1], navir[1], nvir[1]), dtype=np.float64)
    x594 += einsum(t2.abab[np.ix_(soa,sOb,sva,sVb)], (0, 1, 2, 3), v.aabb.ovvV, (0, 2, 4, 5), (1, 3, 5, 4))
    x595 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x595 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), x594, (4, 5, 6, 2), (1, 0, 4, 3, 5, 6))
    ...
    del x595
    x596 = np.zeros((naocc[1], navir[0], navir[1], nvir[0]), dtype=np.float64)
    x596 += einsum(t2.abab[np.ix_(soa,sOb,sva,sVb)], (0, 1, 2, 3), v.aaaa.ovvV, (0, 2, 4, 5), (1, 5, 3, 4))
    x597 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x597
    x598 = np.zeros((naocc[1], naocc[1], navir[1], nocc[1]), dtype=np.float64)
    x598 += einsum(t2.bbbb[np.ix_(sob,sOb,svb,sVb)], (0, 1, 2, 3), v.bbbb.ovoO, (0, 2, 4, 5), (1, 5, 3, 4))
    x599 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x599 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x598, (4, 5, 6, 0), (1, 4, 5, 3, 2, 6))
    ...
    del x599
    x600 = np.zeros((naocc[0], naocc[1], navir[0], nocc[1]), dtype=np.float64)
    x600 += einsum(t2.baba[np.ix_(sob,sOa,svb,sVa)], (0, 1, 2, 3), v.bbbb.ovoO, (4, 2, 0, 5), (1, 5, 3, 4))
    x601 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x601
    x602 = np.zeros((naocc[1], naocc[1], navir[1], nocc[1]), dtype=np.float64)
    x602 += einsum(t2.bbbb[np.ix_(sob,sOb,svb,sVb)], (0, 1, 2, 3), v.bbbb.ovoO, (4, 2, 0, 5), (1, 5, 3, 4))
    x603 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x603 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x602, (4, 5, 6, 0), (1, 4, 5, 3, 2, 6))
    ...
    del x603
    x604 = np.zeros((naocc[0], naocc[1], navir[0], nocc[1]), dtype=np.float64)
    x604 += einsum(t2.baba[np.ix_(sob,sOa,svb,sVa)], (0, 1, 2, 3), v.bbbb.ovoO, (0, 2, 4, 5), (1, 5, 3, 4))
    x605 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x605
    x606 = np.zeros((naocc[1], navir[1], navir[1], nvir[1]), dtype=np.float64)
    x606 += einsum(t2.bbbb[np.ix_(sob,sob,sVb,sVb)], (0, 1, 2, 3), v.bbbb.ovoO, (1, 4, 0, 5), (5, 2, 3, 4))
    x607 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x607 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), x606, (4, 5, 6, 2), (1, 0, 4, 3, 5, 6))
    t3new_babbab += einsum(x607, (0, 1, 2, 3, 4, 5), (2, 0, 1, 5, 3, 4)) * -1.0
    t3new_babbab += einsum(x607, (0, 1, 2, 3, 4, 5), (2, 0, 1, 5, 3, 4)) * -1.0
    t3new_babbab += einsum(x607, (0, 1, 2, 3, 4, 5), (1, 0, 2, 5, 3, 4))
    t3new_babbab += einsum(x607, (0, 1, 2, 3, 4, 5), (1, 0, 2, 5, 3, 4))
    del x607
    x608 = np.zeros((naocc[0], naocc[1], navir[1], nocc[0]), dtype=np.float64)
    x608 += einsum(t2.bbbb[np.ix_(sob,sOb,svb,sVb)], (0, 1, 2, 3), v.aabb.oOov, (4, 5, 0, 2), (5, 1, 3, 4))
    x609 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x609
    x610 = np.zeros((naocc[0], naocc[1], navir[0], nocc[1]), dtype=np.float64)
    x610 += einsum(t2.abba[np.ix_(soa,sOb,svb,sVa)], (0, 1, 2, 3), v.aabb.oOov, (0, 4, 5, 2), (4, 1, 3, 5))
    x611 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x611
    x612 = np.zeros((naocc[0], navir[0], navir[1], nvir[1]), dtype=np.float64)
    x612 += einsum(t2.abab[np.ix_(soa,sob,sVa,sVb)], (0, 1, 2, 3), v.aabb.oOov, (0, 4, 1, 5), (4, 2, 3, 5))
    x613 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x613
    x614 = np.zeros((naocc[1], navir[1], navir[1], nvir[1]), dtype=np.float64)
    x614 += einsum(t2.bbbb[np.ix_(sob,sOb,svb,sVb)], (0, 1, 2, 3), v.bbbb.ovvV, (0, 4, 2, 5), (1, 3, 5, 4))
    x615 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x615 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), x614, (4, 5, 6, 2), (1, 0, 4, 3, 5, 6))
    ...
    del x615
    x616 = np.zeros((naocc[1], navir[1], navir[1], nvir[1]), dtype=np.float64)
    x616 += einsum(t2.bbbb[np.ix_(sob,sOb,svb,sVb)], (0, 1, 2, 3), v.bbbb.ovvV, (0, 2, 4, 5), (1, 3, 5, 4))
    x617 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x617 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), x616, (4, 5, 6, 2), (1, 0, 4, 3, 5, 6))
    ...
    del x617
    x618 = np.zeros((naocc[0], navir[0], navir[1], nvir[1]), dtype=np.float64)
    x618 += einsum(t2.baba[np.ix_(sob,sOa,svb,sVa)], (0, 1, 2, 3), v.bbbb.ovvV, (0, 2, 4, 5), (1, 3, 5, 4))
    x619 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x619
    x620 = np.zeros((naocc[1], naocc[1], navir[1], nocc[1]), dtype=np.float64)
    x620 += einsum(t2.bbbb[np.ix_(sOb,sOb,svb,svb)], (0, 1, 2, 3), v.bbbb.ovvV, (4, 3, 2, 5), (0, 1, 5, 4))
    x621 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x621 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x620, (4, 5, 6, 0), (1, 5, 4, 3, 2, 6)) * -1.0
    t3new_babbab += einsum(x621, (0, 1, 2, 3, 4, 5), (1, 0, 2, 5, 3, 4)) * -1.0
    t3new_babbab += einsum(x621, (0, 1, 2, 3, 4, 5), (1, 0, 2, 4, 3, 5))
    t3new_babbab += einsum(x621, (0, 1, 2, 3, 4, 5), (1, 0, 2, 5, 3, 4)) * -1.0
    t3new_babbab += einsum(x621, (0, 1, 2, 3, 4, 5), (1, 0, 2, 4, 3, 5))
    del x621
    x622 = np.zeros((naocc[0], navir[0], navir[1], nvir[1]), dtype=np.float64)
    x622 += einsum(t2.baba[np.ix_(sob,sOa,svb,sVa)], (0, 1, 2, 3), v.bbbb.ovvV, (0, 4, 2, 5), (1, 3, 5, 4))
    x623 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x623
    x624 = np.zeros((naocc[1], navir[0], navir[1], nvir[0]), dtype=np.float64)
    x624 += einsum(t2.bbbb[np.ix_(sob,sOb,svb,sVb)], (0, 1, 2, 3), v.aabb.vVov, (4, 5, 0, 2), (1, 5, 3, 4))
    x625 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x625
    x626 = np.zeros((naocc[0], naocc[1], navir[0], nocc[1]), dtype=np.float64)
    x626 += einsum(t2.abab[np.ix_(sOa,sOb,sva,svb)], (0, 1, 2, 3), v.aabb.vVov, (2, 4, 5, 3), (0, 1, 4, 5))
    x627 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x627
    x628 = np.zeros((naocc[0], navir[0], navir[1], nvir[1]), dtype=np.float64)
    x628 += einsum(t2.baab[np.ix_(sob,sOa,sva,sVb)], (0, 1, 2, 3), v.aabb.vVov, (2, 4, 0, 5), (1, 4, 3, 5))
    x629 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x629
    x630 = np.zeros((naocc[0], naocc[1], navir[0], nocc[1]), dtype=np.float64)
    x630 += einsum(t2.aaaa[np.ix_(soa,sOa,sva,sVa)], (0, 1, 2, 3), v.aabb.ovoO, (0, 2, 4, 5), (1, 5, 3, 4))
    x631 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x631
    x632 = np.zeros((naocc[0], navir[0], navir[1], nvir[1]), dtype=np.float64)
    x632 += einsum(t2.aaaa[np.ix_(soa,sOa,sva,sVa)], (0, 1, 2, 3), v.aabb.ovvV, (0, 2, 4, 5), (1, 3, 5, 4))
    x633 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x633
    x634 = np.zeros((naocc[0], naocc[0], naocc[0], naocc[1], navir[0], navir[1]), dtype=np.float64)
    x634 += einsum(t2.abab[np.ix_(sOa,sOb,sva,sVb)], (0, 1, 2, 3), v.aaaa.vOOV, (2, 4, 5, 6), (0, 5, 4, 1, 6, 3)) * -1.0
    x635 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x635
    x636 = np.zeros((naocc[0], naocc[0], naocc[0], naocc[1], navir[0], navir[1]), dtype=np.float64)
    x636 += einsum(t2.abab[np.ix_(sOa,sOb,sva,sVb)], (0, 1, 2, 3), v.aaaa.vOOV, (2, 4, 5, 6), (0, 5, 4, 1, 6, 3)) * -1.0
    x637 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x637
    x638 = np.zeros((naocc[0], naocc[1], navir[0], navir[0], navir[0], navir[1]), dtype=np.float64)
    x638 += einsum(t2.abab[np.ix_(soa,sOb,sVa,sVb)], (0, 1, 2, 3), v.aaaa.oVOV, (0, 4, 5, 6), (5, 1, 2, 6, 4, 3)) * -1.0
    x639 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x639
    x640 = np.zeros((naocc[0], naocc[1], navir[0], navir[1]), dtype=np.float64)
    ...
    x641 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    x643 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x643
    x644 = np.zeros((naocc[0], naocc[0], naocc[1], naocc[1], navir[1], navir[1]), dtype=np.float64)
    x644 += einsum(t2.abab[np.ix_(sOa,sOb,sva,sVb)], (0, 1, 2, 3), v.aabb.vOOV, (2, 4, 5, 6), (0, 4, 1, 5, 3, 6)) * -1.0
    x645 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x645
    x646 = np.zeros((naocc[0], naocc[0], naocc[1], naocc[1]), dtype=np.float64)
    x646 += einsum(t2.abab[np.ix_(sOa,sOb,sva,svb)], (0, 1, 2, 3), v.aabb.vOvO, (2, 4, 3, 5), (0, 4, 1, 5))
    x647 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x647
    x648 = np.zeros((naocc[0], naocc[0], naocc[1], naocc[1], navir[0], navir[0]), dtype=np.float64)
    x648 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), v.aabb.OVvO, (4, 5, 2, 6), (1, 4, 0, 6, 3, 5))
    x649 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x649
    x650 = np.zeros((naocc[0], naocc[0], navir[0], navir[0], navir[1], navir[1]), dtype=np.float64)
    x650 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), v.aabb.OVoV, (4, 5, 0, 6), (1, 4, 3, 5, 2, 6))
    x651 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    x652 += einsum(t2.baab[np.ix_(sob,sOa,sva,sVb)], (0, 1, 2, 3), v.aabb.vOoV, (2, 4, 0, 5), (1, 4, 3, 5))
    x653 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x653
    x654 = np.zeros((naocc[1], naocc[1], navir[0], navir[0], navir[1], navir[1]), dtype=np.float64)
    x654 += einsum(t2.abab[np.ix_(soa,sOb,sVa,sVb)], (0, 1, 2, 3), v.aabb.oVOV, (0, 4, 5, 6), (1, 5, 2, 4, 3, 6)) * -1.0
    x655 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x655
    x656 = np.zeros((naocc[1], naocc[1], navir[1], navir[1]), dtype=np.float64)
    ...
    x657 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x657
    x658 = np.zeros((naocc[1], naocc[1]), dtype=np.float64)
    ...
    x659 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x659
    x660 = np.zeros((naocc[1], naocc[1], navir[0], navir[0]), dtype=np.float64)
    x660 += einsum(t2.abba[np.ix_(soa,sOb,svb,sVa)], (0, 1, 2, 3), v.aabb.oVvO, (0, 4, 2, 5), (1, 5, 3, 4))
    x661 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x661
    x662 = np.zeros((navir[0], navir[0], navir[1], navir[1]), dtype=np.float64)
    x662 += einsum(t2.abab[np.ix_(soa,sob,sVa,sVb)], (0, 1, 2, 3), v.aabb.oVoV, (0, 4, 1, 5), (2, 4, 3, 5))
    x663 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x663
    x664 = np.zeros((navir[1], navir[1]), dtype=np.float64)
    ...
    x665 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x665
    x666 = np.zeros((naocc[0], naocc[1], naocc[1], naocc[1], navir[0], navir[1]), dtype=np.float64)
    x666 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), v.bbbb.vOOV, (2, 4, 5, 6), (1, 0, 5, 4, 3, 6))
    x667 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x667 += einsum(t3.bbbbbb, (0, 1, 2, 3, 4, 5), x666, (6, 7, 2, 1, 8, 5), (6, 7, 0, 8, 3, 4)) * -1.0
    t3new_babbab += einsum(x667, (0, 1, 2, 3, 4, 5), (1, 0, 2, 5, 3, 4)) * 3.0
    t3new_babbab += einsum(x667, (0, 1, 2, 3, 4, 5), (2, 0, 1, 5, 3, 4)) * -3.0
    del x667
    x668 = np.zeros((naocc[0], naocc[1], naocc[1], naocc[1], navir[0], navir[1]), dtype=np.float64)
    x668 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), v.bbbb.vOOV, (2, 4, 5, 6), (1, 0, 5, 4, 3, 6))
    x669 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x669
    x670 = np.zeros((naocc[0], naocc[1], navir[0], navir[1], navir[1], navir[1]), dtype=np.float64)
    x670 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), v.bbbb.oVOV, (0, 4, 5, 6), (1, 5, 3, 2, 6, 4))
    x671 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x671 += einsum(t3.bbbbbb, (0, 1, 2, 3, 4, 5), x670, (6, 2, 7, 8, 5, 4), (6, 0, 1, 7, 8, 3)) * -1.0
    t3new_babbab += einsum(x671, (0, 1, 2, 3, 4, 5), (1, 0, 2, 4, 3, 5)) * -6.0
    t3new_babbab += einsum(x671, (0, 1, 2, 3, 4, 5), (1, 0, 2, 5, 3, 4)) * 6.0
    del x671
    x672 = np.zeros((naocc[0], naocc[1], naocc[1], naocc[1], navir[0], navir[1]), dtype=np.float64)
    x672 += einsum(t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (0, 1, 2, 3), v.aabb.OVvO, (4, 5, 2, 6), (4, 0, 1, 6, 5, 3)) * -1.0
    x673 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x673
    x674 = np.zeros((naocc[0], naocc[1], navir[0], navir[1], navir[1], navir[1]), dtype=np.float64)
    x674 += einsum(t2.bbbb[np.ix_(sob,sOb,sVb,sVb)], (0, 1, 2, 3), v.aabb.OVoV, (4, 5, 0, 6), (4, 1, 5, 2, 3, 6)) * -1.0
    x675 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x675
    x676 = np.zeros((naocc[0], naocc[1], navir[0], navir[1]), dtype=np.float64)
    ...
    del x677
    x678 = np.zeros((naocc[1], naocc[1], naocc[1], naocc[1], navir[1], navir[1]), dtype=np.float64)
    x678 += einsum(t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (0, 1, 2, 3), v.bbbb.vOOV, (2, 4, 5, 6), (0, 1, 5, 4, 3, 6)) * -1.0
    x679 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x679 += einsum(t3.babbab, (0, 1, 2, 3, 4, 5), x678, (6, 7, 0, 2, 8, 5), (1, 7, 6, 4, 8, 3)) * -1.0
    t3new_babbab += einsum(x679, (0, 1, 2, 3, 4, 5), (1, 0, 2, 4, 3, 5)) * 2.0
    t3new_babbab += einsum(x679, (0, 1, 2, 3, 4, 5), (1, 0, 2, 5, 3, 4)) * -2.0
    del x679
    x680 = np.zeros((naocc[1], naocc[1], naocc[1], naocc[1]), dtype=np.float64)
    x680 += einsum(t2.bbbb[np.ix_(sOb,sOb,svb,svb)], (0, 1, 2, 3), v.bbbb.vOvO, (2, 4, 3, 5), (0, 1, 4, 5))
    x681 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x681 += einsum(x680, (0, 1, 2, 3), t3.babbab, (2, 4, 3, 5, 6, 7), (4, 1, 0, 6, 5, 7)) * -1.0
    t3new_babbab += einsum(x681, (0, 1, 2, 3, 4, 5), (1, 0, 2, 5, 3, 4)) * -1.0
    t3new_babbab += einsum(x681, (0, 1, 2, 3, 4, 5), (1, 0, 2, 5, 3, 4)) * -1.0
    del x681
    x682 = np.zeros((naocc[1], naocc[1], naocc[1], naocc[1], navir[1], navir[1]), dtype=np.float64)
    x682 += einsum(t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (0, 1, 2, 3), v.bbbb.vOOV, (2, 4, 5, 6), (0, 1, 5, 4, 3, 6)) * -1.0
    x683 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x683
    x684 = np.zeros((naocc[1], naocc[1], navir[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    x684 += einsum(t2.bbbb[np.ix_(sob,sOb,sVb,sVb)], (0, 1, 2, 3), v.bbbb.oVOV, (0, 4, 5, 6), (1, 5, 2, 3, 6, 4)) * -1.0
    x685 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x685
    x686 = np.zeros((naocc[1], naocc[1], navir[1], navir[1]), dtype=np.float64)
    ...
    x687 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x687
    x688 = np.zeros((naocc[1], naocc[1]), dtype=np.float64)
    x688 += einsum(t2.bbbb[np.ix_(sob,sOb,svb,svb)], (0, 1, 2, 3), v.bbbb.ovvO, (0, 3, 2, 4), (1, 4)) * -1.0
    x689 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    t3new_babbab += einsum(x689, (0, 1, 2, 3, 4, 5), (2, 0, 1, 5, 3, 4)) * 2.0
    del x689
    x690 = np.zeros((naocc[1], naocc[1], navir[1], navir[1]), dtype=np.float64)
    ...
    x691 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x691
    x692 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x692 += einsum(x387, (0, 1), t3.babbab, (2, 1, 3, 4, 5, 6), (0, 2, 3, 5, 4, 6))
    t3new_babbab += einsum(x692, (0, 1, 2, 3, 4, 5), (1, 0, 2, 5, 3, 4)) * 2.0
    t3new_babbab += einsum(x692, (0, 1, 2, 3, 4, 5), (1, 0, 2, 5, 3, 4)) * 2.0
    del x692
    x693 = np.zeros((navir[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    x693 += einsum(t2.bbbb[np.ix_(sob,sob,sVb,sVb)], (0, 1, 2, 3), v.bbbb.oVoV, (0, 4, 1, 5), (2, 3, 4, 5))
    t3new_babbab += einsum(x693, (0, 1, 2, 3), t3.babbab, (4, 5, 6, 2, 7, 3), (4, 5, 6, 0, 7, 1)) * 2.0
    x694 = np.zeros((navir[1], navir[1]), dtype=np.float64)
    ...
    x695 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x695
    x696 = np.zeros((navir[1], navir[1]), dtype=np.float64)
    ...
    x697 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x697
    x698 = np.zeros((naocc[1], naocc[1], navir[0], navir[1], navir[1], nvir[0]), dtype=np.float64)
    x698 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), t2.bbbb[np.ix_(sob,sOb,sVb,sVb)], (2, 3, 4, 5), v.aabb.ovoO, (0, 6, 2, 7), (3, 7, 1, 4, 5, 6)) * -1.0
    x699 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x699
    x700 = np.zeros((naocc[1], naocc[1], navir[0], navir[1], navir[1], nvir[0]), dtype=np.float64)
    x700 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (2, 3, 4, 5), v.aabb.ovvV, (0, 6, 4, 7), (2, 3, 1, 5, 7, 6)) * -1.0
    x701 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x701
    x702 = np.zeros((naocc[1], naocc[1], navir[0], navir[1], navir[1], nvir[0]), dtype=np.float64)
    x702 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), t2.abab[np.ix_(soa,sOb,sVa,sVb)], (2, 3, 4, 5), v.aabb.ovvV, (2, 6, 1, 7), (0, 3, 4, 5, 7, 6)) * -1.0
    x703 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x703
    x704 = np.zeros((naocc[1], naocc[1], navir[0], navir[1], navir[1], nvir[0]), dtype=np.float64)
    x704 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), t2.abab[np.ix_(soa,sOb,sVa,sVb)], (2, 3, 4, 5), v.aabb.ovoO, (2, 6, 0, 7), (3, 7, 4, 1, 5, 6)) * -1.0
    x705 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x705
    x706 = np.zeros((naocc[0], naocc[1], navir[0], navir[1], navir[1], nvir[1]), dtype=np.float64)
    x706 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), t2.abab[np.ix_(sOa,sOb,sva,sVb)], (2, 3, 4, 5), v.aabb.ovvV, (0, 4, 6, 7), (2, 3, 1, 5, 7, 6)) * -1.0
    x707 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    x709 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x709
    x710 = np.zeros((naocc[0], naocc[1], navir[0], navir[1], navir[1], nvir[1]), dtype=np.float64)
    x710 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), t2.bbbb[np.ix_(sob,sOb,sVb,sVb)], (2, 3, 4, 5), v.aabb.oOov, (0, 6, 2, 7), (6, 3, 1, 4, 5, 7)) * -1.0
    x711 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x711
    x712 = np.zeros((naocc[0], navir[0], navir[1], nvir[1]), dtype=np.float64)
    x712 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), t1.bb[np.ix_(sob,sVb)], (2, 3), v.aabb.oOov, (0, 4, 2, 5), (4, 1, 3, 5))
    x713 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x713
    x714 = np.zeros((naocc[1], naocc[1], navir[0], navir[1], navir[1], nvir[0]), dtype=np.float64)
    x714 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), t2.bbbb[np.ix_(sob,sOb,sVb,sVb)], (2, 3, 4, 5), v.aabb.vVov, (6, 7, 2, 1), (0, 3, 7, 4, 5, 6)) * -1.0
    x715 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    x717 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x717
    x718 = np.zeros((naocc[0], naocc[1], navir[0], navir[1], navir[1], nvir[1]), dtype=np.float64)
    x718 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), t2.baba[np.ix_(sob,sOa,sVb,sVa)], (2, 3, 4, 5), v.bbbb.ovoO, (2, 6, 0, 7), (3, 7, 5, 1, 4, 6))
    x719 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x719
    x720 = np.zeros((naocc[0], naocc[1], navir[0], navir[1], navir[1], nvir[1]), dtype=np.float64)
    x720 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), t2.baba[np.ix_(sob,sOa,sVb,sVa)], (2, 3, 4, 5), v.bbbb.ovoO, (0, 6, 2, 7), (3, 7, 5, 1, 4, 6))
    x721 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x721
    x722 = np.zeros((naocc[0], naocc[1], navir[0], navir[1], navir[1], nvir[1]), dtype=np.float64)
    x722 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), t2.abab[np.ix_(soa,sOb,sVa,sVb)], (2, 3, 4, 5), v.aabb.oOov, (2, 6, 0, 7), (6, 3, 4, 1, 5, 7)) * -1.0
    x723 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    x725 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x725 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), x724, (4, 5, 6, 2), (1, 0, 4, 3, 5, 6))
    ...
    del x725
    x726 = np.zeros((naocc[0], naocc[1], navir[0], navir[1], navir[1], nvir[1]), dtype=np.float64)
    x726 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), t2.baba[np.ix_(sob,sOa,sVb,sVa)], (2, 3, 4, 5), v.bbbb.ovvV, (2, 1, 6, 7), (3, 0, 5, 4, 7, 6))
    x727 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x727
    x728 = np.zeros((naocc[0], naocc[1], navir[0], navir[1], navir[1], nvir[1]), dtype=np.float64)
    x728 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), t2.baba[np.ix_(sOb,sOa,svb,sVa)], (2, 3, 4, 5), v.bbbb.ovvV, (0, 6, 4, 7), (3, 2, 5, 1, 7, 6))
    x729 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x729
    x730 = np.zeros((naocc[0], naocc[1], navir[0], navir[1], navir[1], nvir[1]), dtype=np.float64)
    x730 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), t2.baba[np.ix_(sOb,sOa,svb,sVa)], (2, 3, 4, 5), v.bbbb.ovvV, (0, 4, 6, 7), (3, 2, 5, 1, 7, 6))
    x731 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x731
    x732 = np.zeros((naocc[0], naocc[1], navir[0], navir[1], navir[1], nvir[1]), dtype=np.float64)
    x732 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), t2.abab[np.ix_(sOa,sOb,sva,sVb)], (2, 3, 4, 5), v.aabb.vVov, (4, 6, 0, 7), (2, 3, 6, 1, 5, 7)) * -1.0
    x733 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x733
    x734 = np.zeros((naocc[0], naocc[1], naocc[1], nvir[0]), dtype=np.float64)
    x734 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), v.aabb.vOvO, (2, 3, 1, 4), (3, 0, 4, 2))
    x735 = np.zeros((naocc[0], naocc[0], naocc[1], naocc[1]), dtype=np.float64)
    x735 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), x734, (2, 3, 4, 1), (0, 2, 3, 4))
    del x734
    x736 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x736
    x737 = np.zeros((naocc[0], naocc[0], navir[1], nocc[1]), dtype=np.float64)
    x737 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), v.aabb.vOoV, (1, 2, 3, 4), (0, 2, 4, 3))
    x738 = np.zeros((naocc[0], naocc[0], navir[1], navir[1]), dtype=np.float64)
    x738 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), x737, (2, 3, 4, 0), (2, 3, 1, 4))
    del x737
    x739 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x739
    x740 = np.zeros((naocc[1], naocc[1], navir[0], nocc[0]), dtype=np.float64)
    x740 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), v.aabb.oVvO, (2, 3, 1, 4), (0, 4, 3, 2))
    x741 = np.zeros((naocc[1], naocc[1], navir[0], navir[0]), dtype=np.float64)
    x741 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), x740, (2, 3, 4, 0), (2, 3, 1, 4))
    del x740
    x742 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x745
    x746 = np.zeros((navir[0], navir[1], navir[1], nocc[0]), dtype=np.float64)
    x746 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), v.aabb.oVoV, (2, 3, 0, 4), (3, 1, 4, 2))
    x747 = np.zeros((navir[0], navir[0], navir[1], navir[1]), dtype=np.float64)
    x747 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), x746, (2, 3, 4, 0), (1, 2, 3, 4))
    del x746
    x748 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x751
    x752 = np.zeros((naocc[0], naocc[1], navir[0], navir[1]), dtype=np.float64)
    ...
    x753 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x753
    x754 = np.zeros((naocc[1], naocc[1], naocc[1], nvir[1]), dtype=np.float64)
    x754 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), v.bbbb.vOvO, (2, 3, 1, 4), (0, 3, 4, 2))
    x755 = np.zeros((naocc[1], naocc[1], naocc[1], naocc[1]), dtype=np.float64)
    x755 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), x754, (2, 3, 4, 1), (2, 0, 4, 3))
    del x754
    x756 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x756 += einsum(x755, (0, 1, 2, 3), t3.babbab, (3, 4, 2, 5, 6, 7), (4, 1, 0, 6, 5, 7))
    ...
    x758 = np.zeros((naocc[1], naocc[1], navir[1], navir[1]), dtype=np.float64)
    ...
    x759 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    x761 = np.zeros((naocc[1], naocc[1], navir[1], navir[1]), dtype=np.float64)
    ...
    x762 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x768
    x769 = np.zeros((navir[1], navir[1], navir[1], nocc[1]), dtype=np.float64)
    x769 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), v.bbbb.oVoV, (2, 3, 0, 4), (1, 3, 4, 2))
    x770 = np.zeros((navir[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x776
    x777 = np.zeros((naocc[1], navir[1], nocc[0], nvir[0]), dtype=np.float64)
    x777 += einsum(t2.abab[np.ix_(soa,sOb,sva,sVb)], (0, 1, 2, 3), v.aaaa.ovov, (4, 2, 0, 5), (1, 3, 4, 5))
    x778 = np.zeros((naocc[0], naocc[1], navir[1], nocc[0]), dtype=np.float64)
    x778 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), x777, (2, 3, 4, 1), (0, 2, 3, 4))
    x779 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x779
    x780 = np.zeros((naocc[1], navir[1], nocc[0], nvir[0]), dtype=np.float64)
    x780 += einsum(t2.abab[np.ix_(soa,sOb,sva,sVb)], (0, 1, 2, 3), v.aaaa.ovov, (4, 5, 0, 2), (1, 3, 4, 5))
    x781 = np.zeros((naocc[0], naocc[1], navir[1], nocc[0]), dtype=np.float64)
    x781 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), x780, (2, 3, 4, 1), (0, 2, 3, 4))
    x782 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x782
    x783 = np.zeros((naocc[0], naocc[1], naocc[1], navir[1], navir[1], nocc[0]), dtype=np.float64)
    x783 += einsum(t2.abab[np.ix_(sOa,sOb,sva,sVb)], (0, 1, 2, 3), x780, (4, 5, 6, 2), (0, 1, 4, 3, 5, 6)) * -1.0
    x784 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x784
    x785 = np.zeros((naocc[0], naocc[1], naocc[1], navir[1], navir[1], nocc[0]), dtype=np.float64)
    x785 += einsum(t2.abab[np.ix_(sOa,sOb,sva,sVb)], (0, 1, 2, 3), x777, (4, 5, 6, 2), (0, 1, 4, 3, 5, 6)) * -1.0
    x786 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x786
    x787 = np.zeros((naocc[0], naocc[1], navir[1], nocc[0]), dtype=np.float64)
    x787 += einsum(x11, (0, 1), t2.abab[np.ix_(sOa,sOb,sva,sVb)], (2, 3, 1, 4), (2, 3, 4, 0)) * -1.0
    del x11
    x788 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x788
    x789 = np.zeros((naocc[0], naocc[1], navir[1], nocc[0]), dtype=np.float64)
    x789 += einsum(x12, (0, 1), t2.abab[np.ix_(sOa,sOb,sva,sVb)], (2, 3, 1, 4), (2, 3, 4, 0)) * -1.0
    del x12
    x790 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    x792 = np.zeros((naocc[0], naocc[1], navir[1], nocc[0]), dtype=np.float64)
    x792 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), x791, (2, 3, 4, 1), (0, 2, 3, 4))
    x793 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x793
    x794 = np.zeros((naocc[1], navir[0], nocc[1], nvir[0]), dtype=np.float64)
    x794 += einsum(t2.abba[np.ix_(soa,sOb,svb,sVa)], (0, 1, 2, 3), v.aabb.ovov, (0, 4, 5, 2), (1, 3, 5, 4))
    x795 = np.zeros((naocc[0], naocc[1], navir[0], nocc[1]), dtype=np.float64)
    x795 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), x794, (2, 3, 4, 1), (0, 2, 3, 4))
    x796 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x796
    x797 = np.zeros((naocc[0], naocc[1], naocc[1], navir[1], nocc[0], nocc[1]), dtype=np.float64)
    x797 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (2, 3, 4, 5), v.aabb.ovov, (6, 1, 7, 4), (0, 2, 3, 5, 6, 7)) * -1.0
    x798 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x798
    x799 = np.zeros((naocc[0], naocc[1], naocc[1], navir[1], navir[1], nocc[0]), dtype=np.float64)
    x799 += einsum(t2.abab[np.ix_(sOa,sOb,sva,sVb)], (0, 1, 2, 3), x791, (4, 5, 6, 2), (0, 1, 4, 3, 5, 6)) * -1.0
    x800 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x800
    x801 = np.zeros((naocc[0], naocc[1], nocc[0], nocc[1]), dtype=np.float64)
    x801 += einsum(t2.abab[np.ix_(sOa,sOb,sva,svb)], (0, 1, 2, 3), v.aabb.ovov, (4, 2, 5, 3), (0, 1, 4, 5))
    x802 = np.zeros((naocc[0], naocc[1], naocc[1], navir[1], navir[1], nocc[0]), dtype=np.float64)
    x802 += einsum(t2.bbbb[np.ix_(sob,sOb,sVb,sVb)], (0, 1, 2, 3), x801, (4, 5, 6, 0), (4, 5, 1, 2, 3, 6)) * -1.0
    x803 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x803
    x804 = np.zeros((naocc[0], navir[1], nocc[0], nvir[1]), dtype=np.float64)
    x804 += einsum(t2.baab[np.ix_(sob,sOa,sva,sVb)], (0, 1, 2, 3), v.aabb.ovov, (4, 2, 0, 5), (1, 3, 4, 5))
    x805 = np.zeros((naocc[0], naocc[1], naocc[1], navir[1], navir[1], nocc[0]), dtype=np.float64)
    x805 += einsum(t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (0, 1, 2, 3), x804, (4, 5, 6, 2), (4, 0, 1, 3, 5, 6)) * -1.0
    x806 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x806
    x807 = np.zeros((naocc[0], naocc[1], navir[0], nocc[1]), dtype=np.float64)
    x807 += einsum(x0, (0, 1), t2.baba[np.ix_(sOb,sOa,svb,sVa)], (2, 3, 1, 4), (3, 2, 4, 0))
    x808 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x808
    x809 = np.zeros((naocc[1], naocc[1], navir[1], nocc[1]), dtype=np.float64)
    x809 += einsum(x0, (0, 1), t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (2, 3, 1, 4), (2, 3, 4, 0)) * -1.0
    del x0
    x810 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x810 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x809, (4, 5, 6, 0), (1, 5, 4, 3, 6, 2)) * -1.0
    t3new_babbab += einsum(x810, (0, 1, 2, 3, 4, 5), (1, 0, 2, 4, 3, 5)) * -2.0
    t3new_babbab += einsum(x810, (0, 1, 2, 3, 4, 5), (1, 0, 2, 5, 3, 4)) * 2.0
    del x810
    x811 = np.zeros((naocc[0], naocc[1], naocc[1], navir[1], nocc[0], nocc[1]), dtype=np.float64)
    x811 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), t2.abab[np.ix_(sOa,sOb,sva,sVb)], (2, 3, 4, 5), v.aabb.ovov, (6, 4, 7, 1), (2, 0, 3, 5, 6, 7)) * -1.0
    x812 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x812
    x813 = np.zeros((naocc[1], navir[1], nocc[1], nvir[1]), dtype=np.float64)
    x813 += einsum(t2.abab[np.ix_(soa,sOb,sva,sVb)], (0, 1, 2, 3), v.aabb.ovov, (0, 2, 4, 5), (1, 3, 4, 5))
    x814 = np.zeros((naocc[1], naocc[1], navir[1], nocc[1]), dtype=np.float64)
    x814 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), x813, (2, 3, 4, 1), (0, 2, 3, 4))
    x815 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x815 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x814, (4, 5, 6, 0), (1, 4, 5, 3, 2, 6))
    ...
    del x815
    x816 = np.zeros((naocc[0], naocc[1], navir[1], nocc[0]), dtype=np.float64)
    x816 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), x804, (2, 3, 4, 1), (2, 0, 3, 4))
    x817 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x817
    x818 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], nocc[1]), dtype=np.float64)
    x818 += einsum(t2.abab[np.ix_(sOa,sOb,sva,sVb)], (0, 1, 2, 3), x794, (4, 5, 6, 2), (0, 1, 4, 5, 3, 6)) * -1.0
    x819 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x819
    x820 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], nocc[1]), dtype=np.float64)
    x820 += einsum(t2.abab[np.ix_(soa,sOb,sVa,sVb)], (0, 1, 2, 3), x801, (4, 5, 0, 6), (4, 5, 1, 2, 3, 6)) * -1.0
    x821 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x821
    x822 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], nocc[1]), dtype=np.float64)
    x822 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), x813, (4, 5, 6, 2), (1, 0, 4, 3, 5, 6))
    x823 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x823
    x824 = np.zeros((naocc[0], naocc[1], navir[1], nocc[0]), dtype=np.float64)
    x824 += einsum(x15, (0, 1), t2.abab[np.ix_(sOa,sOb,sva,sVb)], (2, 3, 1, 4), (2, 3, 4, 0)) * -1.0
    del x15
    x825 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x825
    x826 = np.zeros((naocc[1], navir[1], nocc[1], nvir[1]), dtype=np.float64)
    x826 += einsum(t2.bbbb[np.ix_(sob,sOb,svb,sVb)], (0, 1, 2, 3), v.bbbb.ovov, (4, 5, 0, 2), (1, 3, 4, 5))
    x827 = np.zeros((naocc[1], naocc[1], navir[1], nocc[1]), dtype=np.float64)
    x827 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), x826, (2, 3, 4, 1), (0, 2, 3, 4))
    x828 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x828 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x827, (4, 5, 6, 0), (1, 4, 5, 3, 2, 6))
    ...
    del x828
    x829 = np.zeros((naocc[0], navir[0], nocc[1], nvir[1]), dtype=np.float64)
    x829 += einsum(t2.baba[np.ix_(sob,sOa,svb,sVa)], (0, 1, 2, 3), v.bbbb.ovov, (4, 2, 0, 5), (1, 3, 4, 5))
    x830 = np.zeros((naocc[0], naocc[1], navir[0], nocc[1]), dtype=np.float64)
    x830 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), x829, (2, 3, 4, 1), (2, 0, 3, 4))
    x831 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x831
    x832 = np.zeros((naocc[1], navir[1], nocc[1], nvir[1]), dtype=np.float64)
    x832 += einsum(t2.bbbb[np.ix_(sob,sOb,svb,sVb)], (0, 1, 2, 3), v.bbbb.ovov, (4, 2, 0, 5), (1, 3, 4, 5))
    x833 = np.zeros((naocc[1], naocc[1], navir[1], nocc[1]), dtype=np.float64)
    x833 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), x832, (2, 3, 4, 1), (0, 2, 3, 4))
    x834 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x834 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x833, (4, 5, 6, 0), (1, 4, 5, 3, 2, 6))
    ...
    del x834
    x835 = np.zeros((naocc[0], navir[0], nocc[1], nvir[1]), dtype=np.float64)
    x835 += einsum(t2.baba[np.ix_(sob,sOa,svb,sVa)], (0, 1, 2, 3), v.bbbb.ovov, (4, 5, 0, 2), (1, 3, 4, 5))
    x836 = np.zeros((naocc[0], naocc[1], navir[0], nocc[1]), dtype=np.float64)
    x836 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), x835, (2, 3, 4, 1), (2, 0, 3, 4))
    x837 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x837
    x838 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], nocc[1], nocc[1]), dtype=np.float64)
    x838 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), t2.baba[np.ix_(sOb,sOa,svb,sVa)], (2, 3, 4, 5), v.bbbb.ovov, (6, 1, 7, 4), (3, 0, 2, 5, 6, 7))
    x839 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    t3new_babbab += einsum(x839, (0, 1, 2, 3, 4, 5), (2, 0, 1, 5, 3, 4))
    del x839
    x840 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], nocc[1]), dtype=np.float64)
    x840 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), x826, (4, 5, 6, 2), (1, 0, 4, 3, 5, 6))
    x841 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x841
    x842 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], nocc[1]), dtype=np.float64)
    x842 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), x832, (4, 5, 6, 2), (1, 0, 4, 3, 5, 6))
    x843 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x843
    x844 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], nocc[1]), dtype=np.float64)
    x844 += einsum(t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (0, 1, 2, 3), x829, (4, 5, 6, 2), (4, 0, 1, 5, 3, 6)) * -1.0
    x845 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x845
    x846 = np.zeros((naocc[1], naocc[1], nocc[1], nocc[1]), dtype=np.float64)
    x846 += einsum(t2.bbbb[np.ix_(sOb,sOb,svb,svb)], (0, 1, 2, 3), v.bbbb.ovov, (4, 2, 5, 3), (0, 1, 4, 5))
    x847 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], nocc[1]), dtype=np.float64)
    x847 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x846, (4, 5, 0, 6), (1, 4, 5, 3, 2, 6)) * -1.0
    x848 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    t3new_babbab += einsum(x848, (0, 1, 2, 3, 4, 5), (1, 0, 2, 5, 3, 4)) * -1.0
    del x848
    x849 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], nocc[1]), dtype=np.float64)
    x849 += einsum(t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (0, 1, 2, 3), x835, (4, 5, 6, 2), (4, 0, 1, 5, 3, 6)) * -1.0
    x850 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x850
    x851 = np.zeros((naocc[0], naocc[1], navir[0], nocc[1]), dtype=np.float64)
    x851 += einsum(x1, (0, 1), t2.baba[np.ix_(sOb,sOa,svb,sVa)], (2, 3, 1, 4), (3, 2, 4, 0))
    x852 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x852
    x853 = np.zeros((naocc[0], naocc[1], navir[0], nocc[1]), dtype=np.float64)
    x853 += einsum(x20, (0, 1), t2.baba[np.ix_(sOb,sOa,svb,sVa)], (2, 3, 1, 4), (3, 2, 4, 0))
    x854 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x854
    x855 = np.zeros((naocc[1], naocc[1], navir[1], nocc[1]), dtype=np.float64)
    x855 += einsum(x1, (0, 1), t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (2, 3, 1, 4), (2, 3, 4, 0)) * -1.0
    del x1
    x856 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x856 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x855, (4, 5, 6, 0), (1, 5, 4, 3, 6, 2)) * -1.0
    t3new_babbab += einsum(x856, (0, 1, 2, 3, 4, 5), (1, 0, 2, 4, 3, 5)) * -2.0
    t3new_babbab += einsum(x856, (0, 1, 2, 3, 4, 5), (1, 0, 2, 5, 3, 4)) * 2.0
    del x856
    x857 = np.zeros((naocc[1], naocc[1], navir[1], nocc[1]), dtype=np.float64)
    x857 += einsum(x20, (0, 1), t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (2, 3, 1, 4), (2, 3, 4, 0)) * -1.0
    del x20
    x858 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    x858 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x857, (4, 5, 6, 0), (1, 5, 4, 3, 6, 2)) * -1.0
    t3new_babbab += einsum(x858, (0, 1, 2, 3, 4, 5), (1, 0, 2, 4, 3, 5)) * 2.0
    t3new_babbab += einsum(x858, (0, 1, 2, 3, 4, 5), (1, 0, 2, 5, 3, 4)) * -2.0
    del x858
    x859 = np.zeros((naocc[0], navir[0], nocc[1], nvir[1]), dtype=np.float64)
    x859 += einsum(t2.aaaa[np.ix_(soa,sOa,sva,sVa)], (0, 1, 2, 3), v.aabb.ovov, (0, 2, 4, 5), (1, 3, 4, 5))
    x860 = np.zeros((naocc[0], naocc[1], navir[0], nocc[1]), dtype=np.float64)
    x860 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), x859, (2, 3, 4, 1), (2, 0, 3, 4))
    x861 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x861
    x862 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], nocc[1]), dtype=np.float64)
    x862 += einsum(t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (0, 1, 2, 3), x859, (4, 5, 6, 2), (4, 0, 1, 5, 3, 6)) * -1.0
    x863 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x863
    x864 = np.zeros((naocc[1], naocc[1], navir[1], navir[1], nocc[0], nvir[0]), dtype=np.float64)
    x864 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), t2.bbbb[np.ix_(sob,sOb,sVb,sVb)], (2, 3, 4, 5), v.aabb.ovov, (6, 7, 2, 1), (0, 3, 4, 5, 6, 7)) * -1.0
    x865 = np.zeros((naocc[0], naocc[1], naocc[1], navir[1], navir[1], nocc[0]), dtype=np.float64)
    x865 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), x864, (2, 3, 4, 5, 6, 1), (0, 2, 3, 4, 5, 6))
    del x864
    x866 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    x868 = np.zeros((naocc[0], naocc[1], naocc[1], navir[1], navir[1], nocc[0]), dtype=np.float64)
    x868 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), x867, (2, 3, 4, 5, 6, 1), (0, 2, 3, 4, 5, 6))
    del x867
    x869 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x869
    x870 = np.zeros((naocc[1], naocc[1], navir[0], navir[1], nocc[1], nvir[0]), dtype=np.float64)
    x870 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), t2.abab[np.ix_(soa,sOb,sVa,sVb)], (2, 3, 4, 5), v.aabb.ovov, (2, 6, 7, 1), (0, 3, 4, 5, 7, 6)) * -1.0
    x871 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], nocc[1]), dtype=np.float64)
    x871 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), x870, (2, 3, 4, 5, 6, 1), (0, 2, 3, 4, 5, 6))
    del x870
    x872 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x872
    x873 = np.zeros((naocc[0], naocc[1], navir[1], navir[1], nocc[0], nvir[1]), dtype=np.float64)
    x873 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), t2.abab[np.ix_(sOa,sOb,sva,sVb)], (2, 3, 4, 5), v.aabb.ovov, (6, 4, 0, 7), (2, 3, 1, 5, 6, 7)) * -1.0
    x874 = np.zeros((naocc[0], naocc[1], naocc[1], navir[1], navir[1], nocc[0]), dtype=np.float64)
    x874 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), x873, (2, 3, 4, 5, 6, 1), (2, 0, 3, 4, 5, 6))
    del x873
    x875 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x875
    x876 = np.zeros((naocc[0], naocc[1], navir[0], navir[1], nocc[1], nvir[1]), dtype=np.float64)
    x876 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), t2.baba[np.ix_(sob,sOa,sVb,sVa)], (2, 3, 4, 5), v.bbbb.ovov, (6, 7, 2, 1), (3, 0, 5, 4, 6, 7))
    x877 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], nocc[1]), dtype=np.float64)
    x877 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), x876, (2, 3, 4, 5, 6, 1), (2, 0, 3, 4, 5, 6))
    del x876
    x878 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x878
    x879 = np.zeros((naocc[0], naocc[1], navir[0], navir[1], nocc[1], nvir[1]), dtype=np.float64)
    x879 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), t2.baba[np.ix_(sOb,sOa,svb,sVa)], (2, 3, 4, 5), v.bbbb.ovov, (6, 7, 0, 4), (3, 2, 5, 1, 6, 7))
    x880 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], nocc[1]), dtype=np.float64)
    x880 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), x879, (2, 3, 4, 5, 6, 1), (2, 0, 3, 4, 5, 6))
    del x879
    x881 = np.zeros((naocc[0], naocc[1], naocc[1], navir[0], navir[1], navir[1]), dtype=np.float64)
    ...
    del x881
    x882 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x882
    x883 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x883
    x884 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x884
    x885 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x885 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), v.aabb.OVoO, (4, 5, 0, 6), (1, 4, 6, 3, 5, 2))
    ...
    del x885
    x886 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x886 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), v.aabb.OVvV, (4, 5, 2, 6), (1, 4, 0, 3, 5, 6))
    ...
    del x886
    x887 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x887
    x888 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x888
    x889 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x889
    x890 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x890
    x891 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x891
    x892 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x892
    x893 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x893
    x894 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x894
    x895 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x895
    x896 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x896
    x897 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x897
    x898 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x898
    x899 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x899 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x495, (4, 5, 6, 0), (4, 1, 5, 6, 3, 2))
    del x495
    ...
    del x900
    x901 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x901
    x902 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x902
    x903 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[1], nocc[0]), dtype=np.float64)
    x903 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), v.aabb.oOoO, (4, 5, 0, 6), (1, 5, 6, 3, 2, 4))
    x904 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x904
    x905 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[1], nocc[0]), dtype=np.float64)
    x905 += einsum(t2.abab[np.ix_(soa,sOb,sVa,sVb)], (0, 1, 2, 3), v.aaaa.oOoO, (4, 5, 0, 6), (5, 6, 1, 2, 3, 4)) * -1.0
    x906 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x906
    x907 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[1], nocc[0]), dtype=np.float64)
    x907 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), v.aabb.oOvV, (4, 5, 2, 6), (1, 5, 0, 3, 6, 4))
    x908 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x908
    x909 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[1], nocc[0]), dtype=np.float64)
    x909 += einsum(t2.abab[np.ix_(sOa,sOb,sva,sVb)], (0, 1, 2, 3), v.aaaa.oOvV, (4, 5, 2, 6), (0, 5, 1, 6, 3, 4)) * -1.0
    x910 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x910
    x911 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x911
    x912 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[1], nocc[0]), dtype=np.float64)
    x912 += einsum(t2.abab[np.ix_(sOa,sOb,sva,sVb)], (0, 1, 2, 3), v.aaaa.ovOV, (4, 2, 5, 6), (0, 5, 1, 6, 3, 4)) * -1.0
    x913 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x913
    x914 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x914 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x506, (4, 5, 6, 0), (4, 1, 5, 3, 6, 2))
    del x506
    ...
    del x914
    x915 = np.zeros((naocc[0], naocc[1], navir[0], navir[0], navir[1], nvir[0]), dtype=np.float64)
    x915 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), v.aabb.vVvV, (4, 5, 2, 6), (1, 0, 3, 5, 6, 4))
    x916 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x916
    x917 = np.zeros((naocc[0], naocc[1], navir[0], navir[0], navir[1], nvir[0]), dtype=np.float64)
    x917 += einsum(t2.abab[np.ix_(sOa,sOb,sva,sVb)], (0, 1, 2, 3), v.aaaa.vVvV, (4, 5, 2, 6), (0, 1, 5, 6, 3, 4)) * -1.0
    x918 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x918
    x919 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x919
    x920 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[1], nocc[0]), dtype=np.float64)
    x920 += einsum(t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (0, 1, 2, 3), v.aabb.ovOV, (4, 2, 5, 6), (0, 1, 5, 3, 6, 4)) * -1.0
    x921 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x921
    x922 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x922 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x530, (4, 5, 6, 0), (1, 4, 5, 3, 6, 2))
    del x530
    ...
    del x922
    x923 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], nocc[1]), dtype=np.float64)
    x923 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), v.aabb.OVov, (4, 5, 6, 2), (1, 4, 0, 3, 5, 6))
    x924 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x924
    x925 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x925
    x926 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], nocc[1]), dtype=np.float64)
    x926 += einsum(t2.aaaa[np.ix_(soa,sOa,sVa,sVa)], (0, 1, 2, 3), v.aabb.oOoO, (0, 4, 5, 6), (1, 4, 6, 2, 3, 5)) * -1.0
    x927 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x927
    x928 = np.zeros((naocc[0], naocc[0], navir[0], navir[0], navir[1], nvir[1]), dtype=np.float64)
    x928 += einsum(t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (0, 1, 2, 3), v.aabb.vVvV, (2, 4, 5, 6), (0, 1, 3, 4, 6, 5)) * -1.0
    x929 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x929
    x930 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], nocc[1]), dtype=np.float64)
    x930 += einsum(t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (0, 1, 2, 3), v.aabb.vVoO, (2, 4, 5, 6), (0, 1, 6, 3, 4, 5)) * -1.0
    x931 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x931
    x932 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x932
    x933 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x933
    x934 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x934
    x935 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x935
    x936 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x936
    x937 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x937
    x938 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x938
    x939 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x939
    x940 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x940
    x941 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x941
    x942 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x942
    x943 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x943 += einsum(x335, (0, 1, 2, 3), t3.abaaba, (4, 5, 6, 3, 7, 2), (4, 6, 5, 0, 1, 7)) * -1.0
    del x335
    t3new_abaaba += einsum(x943, (0, 1, 2, 3, 4, 5), (0, 2, 1, 3, 5, 4)) * 2.0
    t3new_abaaba += einsum(x943, (0, 1, 2, 3, 4, 5), (0, 2, 1, 4, 5, 3)) * -2.0
    del x943
    x944 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x944
    x945 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x945
    x946 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x946
    x947 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x947
    x948 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x948
    x949 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x949
    x950 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x950
    x951 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x951
    x952 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x952
    x953 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x953
    x954 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x954 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x604, (4, 5, 6, 0), (1, 4, 5, 3, 6, 2))
    del x604
    ...
    del x954
    x955 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x955 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x600, (4, 5, 6, 0), (1, 4, 5, 3, 6, 2))
    del x600
    ...
    del x955
    x956 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x956 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), x612, (4, 5, 6, 2), (1, 4, 0, 3, 5, 6))
    del x612
    ...
    del x956
    x957 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x957 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x610, (4, 5, 6, 0), (1, 4, 5, 3, 6, 2))
    del x610
    ...
    del x957
    x958 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x958
    x959 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x959 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), x622, (4, 5, 6, 2), (1, 4, 0, 3, 5, 6))
    del x622
    ...
    del x959
    x960 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x960 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), x618, (4, 5, 6, 2), (1, 4, 0, 3, 5, 6))
    del x618
    ...
    del x960
    x961 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x961
    x962 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x962 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x626, (4, 5, 6, 0), (4, 1, 5, 3, 6, 2))
    del x626
    ...
    del x962
    x963 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x963 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), x628, (4, 5, 6, 2), (1, 4, 0, 3, 5, 6))
    del x628
    ...
    del x963
    x964 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    t3new_abaaba += einsum(x964, (0, 1, 2, 3, 4, 5), (1, 2, 0, 4, 5, 3))
    del x964
    x965 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x965
    x966 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x966
    x967 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x967
    x968 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x968
    x969 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x969 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x630, (4, 5, 6, 0), (1, 4, 5, 3, 6, 2))
    del x630
    ...
    del x969
    x970 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x970
    x971 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x971
    x972 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x972
    x973 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x973
    x974 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x974 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), x632, (4, 5, 6, 2), (1, 4, 0, 3, 5, 6))
    del x632
    ...
    del x974
    x975 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x975
    x976 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    t3new_abaaba += einsum(x976, (0, 1, 2, 3, 4, 5), (0, 2, 1, 4, 5, 3))
    del x976
    x977 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x977
    x978 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x978
    x979 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x979
    x980 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x980
    x981 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x981
    x982 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x982
    x983 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x983
    x984 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x984
    x985 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x985
    x986 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x986
    x987 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x987
    x988 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x988
    x989 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x989
    x990 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x990
    x991 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x991
    x992 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x992
    x993 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x993
    x994 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x994
    x995 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x995 += einsum(t3.babbab, (0, 1, 2, 3, 4, 5), x670, (6, 2, 7, 8, 5, 3), (6, 1, 0, 7, 4, 8)) * -1.0
    del x670
    ...
    del x995
    x996 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x996
    x997 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x997
    x998 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x998 += einsum(t3.aaaaaa, (0, 1, 2, 3, 4, 5), x634, (6, 1, 2, 7, 5, 8), (6, 0, 7, 3, 4, 8))
    del x634
    t3new_abaaba += einsum(x998, (0, 1, 2, 3, 4, 5), (0, 2, 1, 4, 5, 3)) * -3.0
    t3new_abaaba += einsum(x998, (0, 1, 2, 3, 4, 5), (1, 2, 0, 4, 5, 3)) * 3.0
    del x998
    x999 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x999
    x1000 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x1000 += einsum(t3.aaaaaa, (0, 1, 2, 3, 4, 5), x638, (2, 6, 7, 4, 5, 8), (0, 1, 6, 7, 3, 8))
    del x638
    t3new_abaaba += einsum(x1000, (0, 1, 2, 3, 4, 5), (0, 2, 1, 3, 5, 4)) * 6.0
    t3new_abaaba += einsum(x1000, (0, 1, 2, 3, 4, 5), (0, 2, 1, 4, 5, 3)) * -6.0
    del x1000
    x1001 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1001
    x1002 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x1002 += einsum(x379, (0, 1, 2, 3), t3.abaaba, (2, 4, 3, 5, 6, 7), (1, 0, 4, 5, 7, 6)) * -1.0
    del x379
    t3new_abaaba += einsum(x1002, (0, 1, 2, 3, 4, 5), (0, 2, 1, 4, 5, 3)) * -1.0
    t3new_abaaba += einsum(x1002, (0, 1, 2, 3, 4, 5), (0, 2, 1, 4, 5, 3)) * -1.0
    del x1002
    x1003 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    x1004 += einsum(t3.abaaba, (0, 1, 2, 3, 4, 5), x383, (6, 2, 7, 8, 5, 3), (6, 0, 1, 8, 7, 4))
    del x383
    t3new_abaaba += einsum(x1004, (0, 1, 2, 3, 4, 5), (0, 2, 1, 4, 5, 3)) * -4.0
    t3new_abaaba += einsum(x1004, (0, 1, 2, 3, 4, 5), (1, 2, 0, 4, 5, 3)) * 4.0
    del x1004
    x1005 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1005
    x1006 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    t3new_abaaba += einsum(x1006, (0, 1, 2, 3, 4, 5), (1, 2, 0, 4, 5, 3)) * 2.0
    del x1006
    x1007 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1007
    x1008 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x1008 += einsum(x688, (0, 1), t3.abaaba, (2, 1, 3, 4, 5, 6), (2, 3, 0, 4, 6, 5))
    t3new_abaaba += einsum(x1008, (0, 1, 2, 3, 4, 5), (0, 2, 1, 4, 5, 3)) * 2.0
    t3new_abaaba += einsum(x1008, (0, 1, 2, 3, 4, 5), (0, 2, 1, 4, 5, 3)) * 2.0
    del x1008
    x1009 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1009
    x1010 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1010
    x1011 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1011
    x1012 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x1012 += einsum(t3.babbab, (0, 1, 2, 3, 4, 5), x373, (6, 2, 7, 8, 4, 5), (6, 1, 0, 8, 7, 3)) * -1.0
    del x373
    ...
    del x1013
    x1014 = np.zeros((naocc[0], naocc[1], navir[0], navir[0], navir[1], nvir[0]), dtype=np.float64)
    x1014 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), t2.abab[np.ix_(soa,sOb,sVa,sVb)], (2, 3, 4, 5), v.aaaa.ovoO, (2, 6, 0, 7), (7, 3, 1, 4, 5, 6)) * -1.0
    x1015 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1015
    x1016 = np.zeros((naocc[0], naocc[1], navir[0], navir[0], navir[1], nvir[0]), dtype=np.float64)
    x1016 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), t2.abab[np.ix_(soa,sOb,sVa,sVb)], (2, 3, 4, 5), v.aaaa.ovoO, (0, 6, 2, 7), (7, 3, 1, 4, 5, 6)) * -1.0
    x1017 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1017
    x1018 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1018
    x1019 = np.zeros((naocc[0], naocc[1], navir[0], navir[0], navir[1], nvir[0]), dtype=np.float64)
    x1019 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), t2.abab[np.ix_(soa,sOb,sVa,sVb)], (2, 3, 4, 5), v.aaaa.ovvV, (2, 1, 6, 7), (0, 3, 4, 7, 5, 6)) * -1.0
    x1020 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1020
    x1021 = np.zeros((naocc[0], naocc[1], navir[0], navir[0], navir[1], nvir[0]), dtype=np.float64)
    x1021 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), t2.baba[np.ix_(sob,sOa,sVb,sVa)], (2, 3, 4, 5), v.aabb.ovoO, (0, 6, 2, 7), (3, 7, 1, 5, 4, 6))
    x1022 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1022
    x1023 = np.zeros((naocc[0], naocc[1], navir[0], navir[0], navir[1], nvir[0]), dtype=np.float64)
    x1023 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), t2.baba[np.ix_(sOb,sOa,svb,sVa)], (2, 3, 4, 5), v.aabb.ovvV, (0, 6, 4, 7), (3, 2, 1, 5, 7, 6))
    x1024 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1024
    x1025 = np.zeros((naocc[0], naocc[1], navir[0], navir[0], navir[1], nvir[0]), dtype=np.float64)
    x1025 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), t2.abab[np.ix_(sOa,sOb,sva,sVb)], (2, 3, 4, 5), v.aaaa.ovvV, (0, 6, 4, 7), (2, 3, 1, 7, 5, 6)) * -1.0
    x1026 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1026
    x1027 = np.zeros((naocc[0], naocc[1], navir[0], navir[0], navir[1], nvir[0]), dtype=np.float64)
    x1027 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), t2.abab[np.ix_(sOa,sOb,sva,sVb)], (2, 3, 4, 5), v.aaaa.ovvV, (0, 4, 6, 7), (2, 3, 1, 7, 5, 6)) * -1.0
    x1028 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1028
    x1029 = np.zeros((naocc[0], naocc[0], navir[0], navir[0], navir[1], nvir[1]), dtype=np.float64)
    x1029 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), t2.baba[np.ix_(sob,sOa,sVb,sVa)], (2, 3, 4, 5), v.aabb.oOov, (0, 6, 2, 7), (3, 6, 1, 5, 4, 7))
    x1030 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1030
    x1031 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x1031 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), x712, (4, 5, 6, 2), (1, 4, 0, 5, 3, 6))
    del x712
    ...
    del x1031
    x1032 = np.zeros((naocc[0], naocc[1], navir[0], navir[0], navir[1], nvir[0]), dtype=np.float64)
    x1032 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), t2.baba[np.ix_(sob,sOa,sVb,sVa)], (2, 3, 4, 5), v.aabb.vVov, (6, 7, 2, 1), (3, 0, 5, 7, 4, 6))
    x1033 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1033
    x1034 = np.zeros((naocc[0], naocc[1], navir[0], navir[0], navir[1], nvir[0]), dtype=np.float64)
    x1034 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), t2.baba[np.ix_(sOb,sOa,svb,sVa)], (2, 3, 4, 5), v.aabb.vVov, (6, 7, 0, 4), (3, 2, 5, 7, 1, 6))
    x1035 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1035
    x1036 = np.zeros((naocc[0], naocc[1], navir[0], navir[0], navir[1], nvir[0]), dtype=np.float64)
    x1036 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), t2.aaaa[np.ix_(soa,sOa,sVa,sVa)], (2, 3, 4, 5), v.aabb.ovvV, (2, 6, 1, 7), (3, 0, 4, 5, 7, 6)) * -1.0
    x1037 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1037
    x1038 = np.zeros((naocc[0], naocc[1], navir[0], navir[0], navir[1], nvir[0]), dtype=np.float64)
    x1038 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), t2.aaaa[np.ix_(soa,sOa,sVa,sVa)], (2, 3, 4, 5), v.aabb.ovoO, (2, 6, 0, 7), (3, 7, 4, 5, 1, 6)) * -1.0
    x1039 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1039
    x1040 = np.zeros((naocc[0], naocc[0], navir[0], navir[0], navir[1], nvir[1]), dtype=np.float64)
    x1040 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (2, 3, 4, 5), v.aabb.ovvV, (0, 4, 6, 7), (2, 3, 1, 5, 7, 6)) * -1.0
    x1041 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1041
    x1042 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1042
    x1043 = np.zeros((naocc[0], naocc[0], navir[0], navir[0], navir[1], nvir[1]), dtype=np.float64)
    x1043 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), t2.aaaa[np.ix_(soa,sOa,sVa,sVa)], (2, 3, 4, 5), v.aabb.oOov, (2, 6, 0, 7), (3, 6, 4, 5, 1, 7)) * -1.0
    x1044 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1044
    x1045 = np.zeros((naocc[0], naocc[0], navir[0], navir[0], navir[1], nvir[1]), dtype=np.float64)
    x1045 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (2, 3, 4, 5), v.aabb.vVov, (4, 6, 0, 7), (2, 3, 5, 6, 1, 7)) * -1.0
    x1046 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1046
    x1047 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x1047 += einsum(x413, (0, 1, 2, 3), t3.abaaba, (2, 4, 3, 5, 6, 7), (1, 0, 4, 5, 7, 6)) * -1.0
    del x413
    t3new_abaaba += einsum(x1047, (0, 1, 2, 3, 4, 5), (0, 2, 1, 4, 5, 3)) * -1.0
    t3new_abaaba += einsum(x1047, (0, 1, 2, 3, 4, 5), (0, 2, 1, 4, 5, 3)) * -1.0
    del x1047
    x1048 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1048
    x1049 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1049
    x1050 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1050
    x1051 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1051
    x1052 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1052
    x1053 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1054
    x1055 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1055
    x1056 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1056
    x1057 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1057
    x1058 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1058
    x1059 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1059
    x1060 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1060
    x1061 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], nocc[0], nocc[1]), dtype=np.float64)
    x1061 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), t2.baba[np.ix_(sOb,sOa,svb,sVa)], (2, 3, 4, 5), v.aabb.ovov, (6, 1, 7, 4), (0, 3, 2, 5, 6, 7))
    x1062 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1062
    x1063 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x1063 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x795, (4, 5, 6, 0), (4, 1, 5, 3, 6, 2))
    del x795
    ...
    del x1063
    x1064 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1064
    x1065 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[1], nocc[0]), dtype=np.float64)
    x1065 += einsum(t2.abab[np.ix_(sOa,sOb,sva,sVb)], (0, 1, 2, 3), x442, (4, 5, 6, 2), (0, 4, 1, 5, 3, 6)) * -1.0
    del x442
    x1066 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1066
    x1067 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[1], nocc[0]), dtype=np.float64)
    x1067 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x801, (4, 5, 6, 0), (4, 1, 5, 3, 2, 6))
    x1068 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1068
    x1069 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[1], nocc[0]), dtype=np.float64)
    x1069 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), x804, (4, 5, 6, 2), (1, 4, 0, 3, 5, 6))
    del x804
    x1070 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1070
    x1071 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x1071 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x807, (4, 5, 6, 0), (4, 1, 5, 6, 3, 2))
    del x807
    ...
    del x1071
    x1072 = np.zeros((naocc[0], naocc[0], naocc[1], navir[1], nocc[0], nocc[0]), dtype=np.float64)
    x1072 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), t2.abab[np.ix_(sOa,sOb,sva,sVb)], (2, 3, 4, 5), v.aaaa.ovov, (6, 1, 7, 4), (0, 2, 3, 5, 6, 7)) * -1.0
    x1073 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    t3new_abaaba += einsum(x1073, (0, 1, 2, 3, 4, 5), (1, 2, 0, 4, 5, 3)) * -1.0
    del x1073
    x1074 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1074
    x1075 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1075
    x1076 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1076
    x1077 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1077
    x1078 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[1], nocc[0]), dtype=np.float64)
    x1078 += einsum(t2.abab[np.ix_(sOa,sOb,sva,sVb)], (0, 1, 2, 3), x447, (4, 5, 6, 2), (0, 4, 1, 5, 3, 6)) * -1.0
    del x447
    x1079 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1079
    x1080 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[1], nocc[0]), dtype=np.float64)
    x1080 += einsum(t2.abab[np.ix_(sOa,sOb,sva,sVb)], (0, 1, 2, 3), x450, (4, 5, 6, 2), (0, 4, 1, 5, 3, 6)) * -1.0
    del x450
    x1081 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x457
    x1083 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    t3new_abaaba += einsum(x1083, (0, 1, 2, 3, 4, 5), (0, 2, 1, 4, 5, 3))
    del x1083
    x1084 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[1], nocc[0]), dtype=np.float64)
    x1084 += einsum(t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (0, 1, 2, 3), x777, (4, 5, 6, 2), (0, 1, 4, 3, 5, 6)) * -1.0
    del x777
    x1085 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1085
    x1086 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[1], nocc[0]), dtype=np.float64)
    x1086 += einsum(t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (0, 1, 2, 3), x780, (4, 5, 6, 2), (0, 1, 4, 3, 5, 6)) * -1.0
    del x780
    x1087 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1087
    x1088 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1088
    x1089 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1089
    x1090 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1090
    x1091 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1091
    x1092 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1092
    x1093 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[1], nocc[0]), dtype=np.float64)
    x1093 += einsum(t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (0, 1, 2, 3), x791, (4, 5, 6, 2), (0, 1, 4, 3, 5, 6)) * -1.0
    del x791
    x1094 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1094
    x1095 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x1095 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x836, (4, 5, 6, 0), (1, 4, 5, 3, 6, 2))
    del x836
    ...
    del x1095
    x1096 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x1096 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x830, (4, 5, 6, 0), (1, 4, 5, 3, 6, 2))
    del x830
    ...
    del x1096
    x1097 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], nocc[1]), dtype=np.float64)
    x1097 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), x835, (4, 5, 6, 2), (1, 4, 0, 3, 5, 6))
    del x835
    x1098 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1098
    x1099 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], nocc[1]), dtype=np.float64)
    x1099 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), x829, (4, 5, 6, 2), (1, 4, 0, 3, 5, 6))
    del x829
    x1100 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1100
    x1101 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x1101 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x851, (4, 5, 6, 0), (4, 1, 5, 6, 3, 2))
    del x851
    ...
    x1102 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x853, (4, 5, 6, 0), (4, 1, 5, 6, 3, 2))
    del x853
    ...
    del x1102
    x1103 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    x1103 += einsum(t2.baba[np.ix_(sob,sOa,sVb,sVa)], (0, 1, 2, 3), x860, (4, 5, 6, 0), (1, 4, 5, 3, 6, 2))
    del x860
    ...
    del x1103
    x1104 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1104
    x1105 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], nocc[0], nocc[1]), dtype=np.float64)
    x1105 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (2, 3, 4, 5), v.aabb.ovov, (6, 4, 7, 1), (2, 3, 0, 5, 6, 7)) * -1.0
    x1106 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1106
    x1107 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], nocc[1]), dtype=np.float64)
    x1107 += einsum(t2.aaaa[np.ix_(soa,sOa,sVa,sVa)], (0, 1, 2, 3), x801, (4, 5, 0, 6), (4, 1, 5, 2, 3, 6)) * -1.0
    del x801
    x1108 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1108
    x1109 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], nocc[1]), dtype=np.float64)
    x1109 += einsum(t2.baba[np.ix_(sOb,sOa,svb,sVa)], (0, 1, 2, 3), x859, (4, 5, 6, 2), (1, 4, 0, 3, 5, 6))
    del x859
    x1110 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1110
    x1111 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], nocc[1]), dtype=np.float64)
    x1111 += einsum(t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (0, 1, 2, 3), x794, (4, 5, 6, 2), (0, 1, 4, 3, 5, 6)) * -1.0
    del x794
    x1112 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1112
    x1113 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1113
    x1114 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1114
    x1115 = np.zeros((naocc[0], naocc[1], navir[0], navir[1], nocc[0], nvir[0]), dtype=np.float64)
    x1115 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), t2.abab[np.ix_(soa,sOb,sVa,sVb)], (2, 3, 4, 5), v.aaaa.ovov, (6, 7, 2, 1), (0, 3, 4, 5, 6, 7)) * -1.0
    x1116 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[1], nocc[0]), dtype=np.float64)
    x1116 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), x1115, (2, 3, 4, 5, 6, 1), (0, 2, 3, 4, 5, 6))
    del x1115
    x1117 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1117
    x1118 = np.zeros((naocc[0], naocc[1], navir[0], navir[1], nocc[0], nvir[0]), dtype=np.float64)
    x1118 += einsum(t1.aa[np.ix_(soa,sVa)], (0, 1), t2.abab[np.ix_(sOa,sOb,sva,sVb)], (2, 3, 4, 5), v.aaaa.ovov, (6, 7, 0, 4), (2, 3, 1, 5, 6, 7)) * -1.0
    x1119 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[1], nocc[0]), dtype=np.float64)
    x1119 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), x1118, (2, 3, 4, 5, 6, 1), (0, 2, 3, 4, 5, 6))
    del x1118
    x1120 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1120
    x1121 = np.zeros((naocc[0], naocc[1], navir[0], navir[1], nocc[0], nvir[0]), dtype=np.float64)
    x1121 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), t2.baba[np.ix_(sob,sOa,sVb,sVa)], (2, 3, 4, 5), v.aabb.ovov, (6, 7, 2, 1), (3, 0, 5, 4, 6, 7))
    x1122 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[1], nocc[0]), dtype=np.float64)
    x1122 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), x1121, (2, 3, 4, 5, 6, 1), (0, 2, 3, 4, 5, 6))
    del x1121
    x1123 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1123
    x1124 = np.zeros((naocc[0], naocc[1], navir[0], navir[1], nocc[0], nvir[0]), dtype=np.float64)
    x1124 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), t2.baba[np.ix_(sOb,sOa,svb,sVa)], (2, 3, 4, 5), v.aabb.ovov, (6, 7, 0, 4), (3, 2, 5, 1, 6, 7))
    x1125 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[1], nocc[0]), dtype=np.float64)
    x1125 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), x1124, (2, 3, 4, 5, 6, 1), (0, 2, 3, 4, 5, 6))
    del x1124
    x1126 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1126
    x1127 = np.zeros((naocc[0], naocc[1], navir[0], navir[0], nocc[1], nvir[0]), dtype=np.float64)
    x1127 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), t2.aaaa[np.ix_(soa,sOa,sVa,sVa)], (2, 3, 4, 5), v.aabb.ovov, (2, 6, 7, 1), (3, 0, 4, 5, 7, 6)) * -1.0
    x1128 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], nocc[1]), dtype=np.float64)
    x1128 += einsum(t1.aa[np.ix_(sOa,sva)], (0, 1), x1127, (2, 3, 4, 5, 6, 1), (0, 2, 3, 4, 5, 6))
    del x1127
    x1129 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1129
    x1130 = np.zeros((naocc[0], naocc[0], navir[0], navir[1], nocc[0], nvir[1]), dtype=np.float64)
    x1130 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), t2.aaaa[np.ix_(sOa,sOa,sva,sVa)], (2, 3, 4, 5), v.aabb.ovov, (6, 4, 0, 7), (2, 3, 5, 1, 6, 7)) * -1.0
    x1131 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[1], nocc[0]), dtype=np.float64)
    x1131 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), x1130, (2, 3, 4, 5, 6, 1), (2, 3, 0, 4, 5, 6))
    del x1130
    x1132 = np.zeros((naocc[0], naocc[0], naocc[1], navir[0], navir[0], navir[1]), dtype=np.float64)
    ...
    del x1133
    x1134 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1134
    x1135 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1135
    x1136 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1136
    x1137 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1137
    x1138 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    x1138 += einsum(v.bbbb.OOOO, (0, 1, 2, 3), t3.bbbbbb, (4, 1, 3, 5, 6, 7), (4, 0, 2, 5, 6, 7))
    ...
    del x1138
    x1139 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1139
    x1140 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1140
    x1141 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1142
    x1143 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1143
    x1144 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1144
    x1145 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1145
    x1146 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], nocc[1]), dtype=np.float64)
    x1146 += einsum(t2.bbbb[np.ix_(sob,sOb,sVb,sVb)], (0, 1, 2, 3), v.bbbb.oOoO, (4, 5, 0, 6), (1, 5, 6, 2, 3, 4)) * -1.0
    x1147 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1147
    x1148 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], nocc[1]), dtype=np.float64)
    x1148 += einsum(t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (0, 1, 2, 3), v.bbbb.oOvV, (4, 5, 2, 6), (0, 1, 5, 3, 6, 4)) * -1.0
    x1149 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1149
    x1150 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1150
    x1151 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], nocc[1]), dtype=np.float64)
    x1151 += einsum(t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (0, 1, 2, 3), v.bbbb.ovOV, (4, 2, 5, 6), (0, 1, 5, 3, 6, 4)) * -1.0
    x1152 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1152
    x1153 = np.zeros((naocc[1], naocc[1], navir[1], navir[1], navir[1], nvir[1]), dtype=np.float64)
    x1153 += einsum(t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (0, 1, 2, 3), v.bbbb.vVvV, (4, 5, 2, 6), (0, 1, 3, 5, 6, 4)) * -1.0
    x1154 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1154
    x1155 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1155
    x1156 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1156
    x1157 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1157
    x1158 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    x1159 += einsum(x552, (0, 1, 2, 3), t3.bbbbbb, (4, 2, 3, 5, 6, 7), (0, 4, 1, 5, 6, 7))
    del x552
    ...
    del x1159
    x1160 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1160
    x1161 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1161
    x1162 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1162
    x1163 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1163
    x1164 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1164
    x1165 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1165
    x1166 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1166
    x1167 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1167
    x1168 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1168
    x1169 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1169
    x1170 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1170
    x1171 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1171
    x1172 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    t3new_bbbbbb += einsum(x1173, (0, 1, 2, 3, 4, 5), (2, 1, 0, 5, 4, 3)) * -2.0
    del x1173
    x1174 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1174
    x1175 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    t3new_bbbbbb += einsum(x1175, (0, 1, 2, 3, 4, 5), (0, 1, 2, 5, 4, 3)) * -2.0
    del x1175
    x1176 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1176
    x1177 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1177
    x1178 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1178
    x1179 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1179
    x1180 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1180
    x1181 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1181
    x1182 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1182
    x1183 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1183
    x1184 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1184
    x1185 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1185
    x1186 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    t3new_bbbbbb += einsum(x1186, (0, 1, 2, 3, 4, 5), (2, 1, 0, 4, 5, 3)) * -3.0
    del x1186
    x1187 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1187
    x1188 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1188
    x1189 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1189
    x1190 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    t3new_bbbbbb += einsum(x1190, (0, 1, 2, 3, 4, 5), (1, 2, 0, 4, 5, 3)) * -6.0
    del x1190
    x1191 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1191
    x1192 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1193
    x1194 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1194
    x1195 = np.zeros((naocc[1], naocc[1], navir[1], navir[1], navir[1], nvir[1]), dtype=np.float64)
    x1195 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), t2.bbbb[np.ix_(sob,sOb,sVb,sVb)], (2, 3, 4, 5), v.bbbb.ovoO, (2, 6, 0, 7), (3, 7, 1, 4, 5, 6)) * -1.0
    x1196 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1196
    x1197 = np.zeros((naocc[1], naocc[1], navir[1], navir[1], navir[1], nvir[1]), dtype=np.float64)
    x1197 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), t2.bbbb[np.ix_(sob,sOb,sVb,sVb)], (2, 3, 4, 5), v.bbbb.ovoO, (0, 6, 2, 7), (3, 7, 1, 4, 5, 6)) * -1.0
    x1198 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1198
    x1199 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1199
    x1200 = np.zeros((naocc[1], naocc[1], navir[1], navir[1], navir[1], nvir[1]), dtype=np.float64)
    x1200 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), t2.bbbb[np.ix_(sob,sOb,sVb,sVb)], (2, 3, 4, 5), v.bbbb.ovvV, (2, 1, 6, 7), (0, 3, 4, 5, 7, 6)) * -1.0
    x1201 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1201
    x1202 = np.zeros((naocc[1], naocc[1], navir[1], navir[1], navir[1], nvir[1]), dtype=np.float64)
    x1202 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (2, 3, 4, 5), v.bbbb.ovvV, (0, 6, 4, 7), (2, 3, 1, 5, 7, 6)) * -1.0
    x1203 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1203
    x1204 = np.zeros((naocc[1], naocc[1], navir[1], navir[1], navir[1], nvir[1]), dtype=np.float64)
    x1204 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (2, 3, 4, 5), v.bbbb.ovvV, (0, 4, 6, 7), (2, 3, 1, 5, 7, 6)) * -1.0
    x1205 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1205
    x1206 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1206
    x1207 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1207
    x1208 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1208
    x1209 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    t3new_bbbbbb += einsum(x1209, (0, 1, 2, 3, 4, 5), (2, 1, 0, 4, 5, 3)) * -3.0
    del x1209
    x1210 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1210
    x1211 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1211
    x1212 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1212
    x1213 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1213
    x1214 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    x1214 += einsum(x770, (0, 1, 2, 3), t3.bbbbbb, (4, 5, 6, 7, 2, 3), (4, 5, 6, 1, 0, 7)) * -1.0
    del x770
    ...
    del x1214
    x1215 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1215
    x1216 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1217
    x1218 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1218
    x1219 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], nocc[1]), dtype=np.float64)
    x1219 += einsum(t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (0, 1, 2, 3), x813, (4, 5, 6, 2), (0, 1, 4, 3, 5, 6)) * -1.0
    del x813
    x1220 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1220
    x1221 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1221
    x1222 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1222
    x1223 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], nocc[1], nocc[1]), dtype=np.float64)
    x1223 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (2, 3, 4, 5), v.bbbb.ovov, (6, 1, 7, 4), (0, 2, 3, 5, 6, 7)) * -1.0
    x1224 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    t3new_bbbbbb += einsum(x1224, (0, 1, 2, 3, 4, 5), (1, 2, 0, 5, 4, 3)) * 2.0
    del x1224
    x1225 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], nocc[1]), dtype=np.float64)
    x1225 += einsum(t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (0, 1, 2, 3), x826, (4, 5, 6, 2), (0, 1, 4, 3, 5, 6)) * -1.0
    del x826
    x1226 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1226
    x1227 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], nocc[1]), dtype=np.float64)
    x1227 += einsum(t2.bbbb[np.ix_(sob,sOb,sVb,sVb)], (0, 1, 2, 3), x846, (4, 5, 0, 6), (4, 5, 1, 2, 3, 6))
    del x846
    x1228 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    t3new_bbbbbb += einsum(x1228, (0, 1, 2, 3, 4, 5), (0, 1, 2, 5, 4, 3)) * 2.0
    del x1228
    x1229 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], nocc[1]), dtype=np.float64)
    x1229 += einsum(t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (0, 1, 2, 3), x832, (4, 5, 6, 2), (0, 1, 4, 3, 5, 6)) * -1.0
    del x832
    x1230 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1230
    x1231 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1231
    x1232 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1232
    x1233 = np.zeros((naocc[1], naocc[1], navir[1], navir[1], nocc[1], nvir[1]), dtype=np.float64)
    x1233 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), t2.bbbb[np.ix_(sob,sOb,sVb,sVb)], (2, 3, 4, 5), v.bbbb.ovov, (6, 7, 2, 1), (0, 3, 4, 5, 6, 7)) * -1.0
    x1234 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], nocc[1]), dtype=np.float64)
    x1234 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), x1233, (2, 3, 4, 5, 6, 1), (0, 2, 3, 4, 5, 6))
    del x1233
    x1235 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
    ...
    del x1235
    x1236 = np.zeros((naocc[1], naocc[1], navir[1], navir[1], nocc[1], nvir[1]), dtype=np.float64)
    x1236 += einsum(t1.bb[np.ix_(sob,sVb)], (0, 1), t2.bbbb[np.ix_(sOb,sOb,svb,sVb)], (2, 3, 4, 5), v.bbbb.ovov, (6, 7, 0, 4), (2, 3, 1, 5, 6, 7)) * -1.0
    x1237 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], nocc[1]), dtype=np.float64)
    x1237 += einsum(t1.bb[np.ix_(sOb,svb)], (0, 1), x1236, (2, 3, 4, 5, 6, 1), (0, 2, 3, 4, 5, 6))
    del x1236
    x1238 = np.zeros((naocc[1], naocc[1], naocc[1], navir[1], navir[1], navir[1]), dtype=np.float64)
