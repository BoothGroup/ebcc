...
with common.FilePrinter("%sccsd" % prefix) as file_printer:
    ...
    #        case(i, j, a, k, transpose("rdm2_f_ovoo"), comment="oovo block"),
    #        case(i, a, j, k, transpose("rdm2_f_oovo"), comment="ovoo block"),
    #        case(a, i, j, k, transpose("rdm2_f_vooo"), comment="vooo block"),
    #        case(i, j, a, b, transpose("rdm2_f_ovov"), comment="oovv block"),
    #        case(i, a, j, b, transpose("rdm2_f_oovv"), comment="ovov block"),
    #        case(i, a, b, j, transpose("rdm2_f_ovvo"), comment="ovvo block"),
    #        case(a, i, j, b, transpose("rdm2_f_voov"), comment="voov block"),
    #        case(a, i, b, j, transpose("rdm2_f_vvoo"), comment="vovo block"),
    #        case(a, b, i, j, transpose("rdm2_f_vovo"), comment="vvoo block"),
    #        case(i, a, b, c, transpose("rdm2_f_ovvv"), comment="ovvv block"),
    #        case(a, i, b, c, transpose("rdm2_f_vvov"), comment="vovv block"),
    #        case(a, b, i, c, transpose("rdm2_f_vovv"), comment="vvov block"),
