...
https://github.com/obackhouse/albert
  ...
  * date: 2024-08-16T18:50:55.637459
...
def energy(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-16T18:50:55.960038.
    ...
    e_mp += einsum(v.aaaa.ovov, (0, 1, 2, 3), t2.aaaa, (0, 2, 3, 1), ()) * -1
...
def make_rdm1_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-16T18:50:56.493906.
...
def make_rdm2_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-16T18:50:56.808513.
...
def hbar_matvec_ip_intermediates(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-16T18:50:59.388393.
    ...
    tmp10 = einsum(t2.abab, (0, 1, 2, 3), v.aabb.ovov, (0, 2, 4, 3), (1, 4))
    tmp8 = einsum(t2.bbbb, (0, 1, 2, 3), v.bbbb.ovov, (4, 3, 1, 2), (0, 4)) * -1
...
def hbar_matvec_ip(f=None, r1=None, r2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-16T18:50:59.393877.
    ...
    r1new = Namespace()
    r2new = Namespace()
    tmp5 = einsum(r2.bbb, (0, 1, 2), f.bb.oo, (3, 1), (3, 0, 2))
    tmp4 = einsum(v.bbbb.ooov, (0, 1, 2, 3), r1.b, (1,), (0, 2, 3))
    tmp3 = einsum(r2.aaa, (0, 1, 2), f.aa.oo, (3, 1), (3, 0, 2))
...
def hbar_matvec_ea_intermediates(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-16T18:51:01.975570.
    ...
    tmp8 = einsum(v.bbbb.ovov, (0, 1, 2, 3), t2.bbbb, (0, 2, 4, 1), (4, 3)) * -1
...
def hbar_matvec_ea(f=None, r1=None, r2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-16T18:51:01.981245.
    ...
    tmp6 = einsum(v.bbbb.ovvv, (0, 1, 2, 3), r1.b, (3,), (0, 1, 2))
...
def hbar_matvec_ee_intermediates(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-16T18:51:09.500074.
...
def hbar_matvec_ee(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-16T18:51:09.511159.
    ...
    tmp3 = einsum(r1.bb, (0, 1), tmp2, (0, 2, 1, 3), (2, 3))
    del tmp2
    ...
    tmp18 = einsum(r2.aaaa, (0, 1, 2, 3), f.aa.oo, (4, 1), (4, 0, 2, 3))
    tmp17 = einsum(f.aa.vv, (0, 1), r2.aaaa, (2, 3, 4, 1), (2, 3, 0, 4))
    tmp16 = tmp14.copy()
    del tmp14
    tmp16 += tmp15
    del tmp15
    ...
    r1new.aa += tmp0
    del tmp0
    r1new.aa += einsum(v.aaaa.ovvv, (0, 1, 2, 3), r2.aaaa, (4, 0, 1, 3), (4, 2)) * -2
    ...
    del tmp8
    r1new.aa += einsum(r1.aa, (0, 1), tmp9, (1, 2), (0, 2)) * -1
    del tmp9
