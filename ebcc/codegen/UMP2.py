...
https://github.com/obackhouse/albert
  ...
  * date: 2024-08-17T00:53:15.343333
...
def energy(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-17T00:53:15.669647.
    ...
    e_mp += einsum(v.bbbb.ovov, (0, 1, 2, 3), t2.bbbb, (0, 2, 3, 1), ()) * -1
...
def make_rdm1_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-17T00:53:16.198106.
...
def make_rdm2_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-17T00:53:16.513366.
    ...
    rdm2.bbbb.vvoo = l2.bbbb.copy() * 0.25
    rdm2.bbbb.vvoo += l2.bbbb * 0.25
    rdm2.abab.vvoo = l2.abab.copy() * 0.25
    rdm2.aaaa.vvoo = l2.aaaa.copy() * 0.25
    rdm2.aaaa.vvoo += l2.aaaa * 0.25
    ...
    rdm2.abab.oooo = einsum(delta.bb.oo, (0, 1), delta.aa.oo, (2, 3), (2, 0, 3, 1))
...
def hbar_matvec_ip_intermediates(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-17T00:53:19.750319.
...
def hbar_matvec_ip(f=None, r1=None, r2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-17T00:53:19.755987.
    ...
    r2new.aba += einsum(r2.aba, (0, 1, 2), f.aa.oo, (3, 0), (3, 1, 2)) * -1
...
def hbar_matvec_ea_intermediates(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-17T00:53:23.069682.
...
def hbar_matvec_ea(f=None, r1=None, r2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-17T00:53:23.076491.
    ...
    r2new.aba += einsum(r2.aba, (0, 1, 2), f.aa.oo, (3, 2), (0, 1, 3)) * -1
...
def hbar_matvec_ee_intermediates(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-17T00:53:30.428506.
    ...
    tmp32 = einsum(v.bbbb.ovov, (0, 1, 2, 3), t2.bbbb, (4, 2, 3, 1), (4, 0)) * -1
...
def hbar_matvec_ee(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-17T00:53:30.439724.
    ...
    tmp6 = einsum(tmp5, (0, 1, 2, 3), r1.aa, (0, 3), (1, 2))
    del tmp5
    tmp21 = tmp19.copy()
    del tmp19
    tmp21 += tmp20
    ...
    tmp22 = einsum(r2.bbbb, (0, 1, 2, 3), f.bb.vv, (4, 3), (0, 1, 4, 2))
    ...
    del tmp21
    r2new.bbbb += tmp22.transpose((1, 0, 2, 3)) * 2
    ...
    r2new.abab += einsum(r2.abab, (0, 1, 2, 3), f.aa.oo, (4, 0), (4, 1, 2, 3)) * -1
    r2new.abab += einsum(r1.aa, (0, 1), v.aabb.ooov, (2, 0, 3, 4), (2, 3, 1, 4)) * -1
    ...
    r1new.bb += einsum(v.bbbb.ooov, (0, 1, 2, 3), r2.bbbb, (2, 1, 4, 3), (0, 4)) * 2
    r1new.bb += einsum(r2.abab, (0, 1, 2, 3), v.aabb.ovvv, (0, 2, 4, 3), (1, 4))
    r1new.bb += einsum(v.bbbb.ovvv, (0, 1, 2, 3), r2.bbbb, (4, 0, 3, 1), (4, 2)) * 2
    r1new.bb += tmp1
    del tmp1
