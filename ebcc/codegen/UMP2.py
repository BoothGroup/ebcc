...
https://github.com/obackhouse/albert
  ...
  * date: 2024-08-17T11:56:49.657133
...
def energy(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-17T11:56:49.940695.
...
def make_rdm1_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-17T11:56:50.416874.
...
def make_rdm2_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-17T11:56:50.587704.
    ...
    rdm2.abab = Namespace()
    rdm2.bbbb = Namespace()
    rdm2.bbbb.vvoo = l2.bbbb.copy() * 0.5
    rdm2.abab.vvoo = l2.abab.copy() * 0.25
    rdm2.aaaa.vvoo = l2.aaaa.copy() * 0.5
    rdm2.bbbb.oovv = t2.bbbb.copy() * 0.5
    rdm2.abab.oovv = t2.abab.copy() * 0.25
    rdm2.aaaa.oovv = t2.aaaa.copy() * 0.5
...
def hbar_matvec_ip_intermediates(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-17T11:56:53.455714.
    ...
    tmp4 = einsum(t2.abab, (0, 1, 2, 3), v.aabb.ovov, (4, 2, 1, 3), (0, 4))
    tmp2 = einsum(t2.aaaa, (0, 1, 2, 3), v.aaaa.ovov, (4, 3, 1, 2), (0, 4)) * -1

    return {f"tmp10": tmp10, f"tmp12": tmp12, f"tmp2": tmp2, f"tmp4": tmp4}

def hbar_matvec_ip(f=None, r1=None, r2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-17T11:56:53.460689.
...
def hbar_matvec_ea_intermediates(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-17T11:56:56.381819.
    ...
    tmp10 = einsum(v.bbbb.ovov, (0, 1, 2, 3), t2.bbbb, (0, 2, 4, 3), (4, 1))
...
def hbar_matvec_ea(f=None, r1=None, r2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-17T11:56:56.387075.
    ...
    tmp5 = einsum(r1.a, (0,), v.aaaa.ovvv, (1, 2, 3, 0), (1, 2, 3))
...
def hbar_matvec_ee_intermediates(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-17T11:57:02.821670.
    ...
    tmp23 = einsum(v.bbbb.ovov, (0, 1, 2, 3), t2.bbbb, (0, 2, 4, 1), (4, 3)) * -1
...
def hbar_matvec_ee(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-17T11:57:02.832418.
    ...
    r1new = Namespace()
    r2new = Namespace()
    tmp1 = v.aaaa.ovov.transpose((0, 2, 3, 1)).copy()
    tmp1 += v.aaaa.ovov.transpose((0, 2, 1, 3)) * -1
    ...
    tmp2 = einsum(r1.aa, (0, 1), tmp1, (0, 2, 1, 3), (2, 3))
    del tmp1
    tmp4 = einsum(r1.aa, (0, 1), v.aabb.ovov, (0, 1, 2, 3), (2, 3))
    tmp6 = einsum(tmp5, (0, 1, 2, 3), r1.bb, (0, 3), (1, 2))
    del tmp5
    ...
    tmp21 += tmp20
    del tmp20
    tmp22 = einsum(r2.bbbb, (0, 1, 2, 3), f.bb.oo, (4, 1), (4, 0, 2, 3))
    tmp17 = einsum(r2.aaaa, (0, 1, 2, 3), f.aa.vv, (4, 3), (0, 1, 4, 2))
    tmp16 = tmp14.copy()
    del tmp14
    tmp16 += tmp15
    del tmp15
    tmp18 = einsum(f.aa.oo, (0, 1), r2.aaaa, (2, 1, 3, 4), (0, 2, 3, 4))
    ...
    del tmp23
    r2new.abab = einsum(f.bb.vv, (0, 1), r2.abab, (2, 3, 4, 1), (2, 3, 4, 0))
    ...
    r2new.abab += einsum(r1.bb, (0, 1), v.aabb.ovoo, (2, 3, 4, 0), (2, 4, 3, 1)) * -1
    ...
    del tmp16
    r2new.aaaa += tmp17.transpose((1, 0, 2, 3)) * 2
    r2new.aaaa += tmp17.transpose((1, 0, 3, 2)) * -2
    del tmp17
    r2new.aaaa += tmp18.transpose((0, 1, 3, 2)) * -2
    ...
    r1new.bb += einsum(tmp3, (0, 1), t2.abab, (0, 2, 1, 3), (2, 3))
    ...
    r1new.aa += einsum(r2.aaaa, (0, 1, 2, 3), v.aaaa.ovvv, (1, 2, 4, 3), (0, 4)) * -2
    r1new.aa += einsum(t2.aaaa, (0, 1, 2, 3), tmp3, (1, 3), (0, 2)) * 2
    del tmp3
    r1new.aa += einsum(t2.abab, (0, 1, 2, 3), tmp7, (1, 3), (0, 2))
    del tmp7
