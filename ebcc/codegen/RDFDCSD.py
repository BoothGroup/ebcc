...
def update_amps(f=None, v=None, nocc=None, nvir=None, naux=None, t1=None, t2=None, **kwargs):
    ...
    x14 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    ...
    del x16
    x17 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    ...
    x18 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    ...
    del x21
    x22 = np.zeros((nvir, nvir, nvir, nvir), dtype=np.float64)
    x22 += einsum(v.xvv, (0, 1, 2), v.xvv, (0, 3, 4), (1, 3, 4, 2))
    t2new += einsum(t2, (0, 1, 2, 3), x22, (4, 2, 5, 3), (0, 1, 5, 4))
    del x22
    x23 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    ...
    x27 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    ...
    del x0
    x32 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    x32 += einsum(v.xov, (0, 1, 2), x12, (1, 3, 4, 2), (3, 4, 0))
    del x12
    x33 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    ...
    x38 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    x38 += einsum(v.xov, (0, 1, 2), x37, (1, 3, 4, 2), (3, 4, 0))
    x39 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    ...
    del x50
    x52 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    x52 += einsum(v.xov, (0, 1, 2), x8, (1, 3, 2, 4), (3, 4, 0)) * 0.5
    del x8
    x53 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    ...
    del x24
    x63 = np.zeros((nocc, nvir, naux), dtype=np.float64)
