...
def energy(f=None, v=None, nocc=None, nvir=None, naux=None, t1=None, t2=None, **kwargs):
    ...
    x2 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    ...
    del x2
    x3 = np.zeros((nocc, nocc, naux), dtype=np.float64)
...
def update_amps(f=None, v=None, nocc=None, nvir=None, naux=None, t1=None, t2=None, **kwargs):
    ...
    x4 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    ...
    del x4
    x5 = np.zeros((nocc, nocc, naux), dtype=np.float64)
    x5 += einsum(t1, (0, 1), v.xov, (2, 3, 1), (0, 3, 2))
    x6 = np.zeros((nocc, nocc, naux), dtype=np.float64)
    ...
    x12 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    ...
    del x14
    x15 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    ...
    del x17
    x19 = np.zeros((nocc, nvir, naux), dtype=np.float64)
...
def update_lams(f=None, v=None, nocc=None, nvir=None, naux=None, t1=None, t2=None, l1=None, l2=None, **kwargs):
    ...
    x3 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    ...
    x5 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    ...
    x7 = np.zeros((nocc, nocc, naux), dtype=np.float64)
    ...
    x12 = np.zeros((nocc, nocc, naux), dtype=np.float64)
    x12 += einsum(v.xoo, (0, 1, 2), (1, 2, 0))
    x12 += einsum(x7, (0, 1, 2), (0, 1, 2))
    x13 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    ...
    x29 = np.zeros((nocc, nocc, naux), dtype=np.float64)
    ...
    del x57
    x60 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    x60 += einsum(l1, (0, 1), v.xvv, (2, 3, 0), (1, 3, 2))
    x61 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    ...
    x64 = np.zeros((nocc, nocc, naux), dtype=np.float64)
    ...
    del x63
    x67 = np.zeros((naux,), dtype=np.float64)
    ...
    x69 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    ...
    x83 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    x83 += einsum(x2, (0, 1), v.xov, (2, 1, 3), (0, 3, 2))
    del x2
    x84 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    ...
    x94 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    ...
    x96 = np.zeros((nocc, nvir, naux), dtype=np.float64)
    ...
    del x111
    x112 = np.zeros((nocc, nocc, nocc, nocc), dtype=np.float64)
...
def make_rdm2_f(f=None, v=None, nocc=None, nvir=None, naux=None, t1=None, t2=None, l1=None, l2=None, **kwargs):
    ...
    rdm2_f_vvvo += einsum(x108, (0, 1, 2, 3), (1, 2, 3, 0)) * -1.0
    rdm2_f_vvvo += einsum(x108, (0, 1, 2, 3), (2, 1, 3, 0))
    x109 = np.zeros((nvir, nvir, nvir, nvir), dtype=np.float64)
    ...
    rdm2_f_vvvv += einsum(x109, (0, 1, 2, 3), (1, 0, 3, 2))
    x110 = np.zeros((nvir, nvir, nvir, nvir), dtype=np.float64)
