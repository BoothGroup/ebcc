...
https://github.com/obackhouse/albert
  ...
  * date: 2024-10-23T10:20:49.043271
...
def energy(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:21:00.286180.
...
def update_amps(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:22:43.943228.
    ...
    t2new += einsum(t2, (0, 1, 2, 3), tmp3, (4, 1, 5, 2), (4, 0, 3, 5))
    ...
    del tmp8
    tmp9 = einsum(v.xov, (0, 1, 2), tmp2, (3, 4, 0), (3, 1, 4, 2))
    tmp14 = np.copy(tmp9)
    del tmp9
    tmp12 = np.copy(np.transpose(tmp5, (1, 0, 3, 2)))
    del tmp5
    tmp12 += tmp3 * -1
    del tmp3
    ...
    tmp10 += tmp2 * -1
    del tmp2
    tmp11 = einsum(tmp10, (0, 1, 2), v.xov, (2, 3, 4), (3, 0, 4, 1))
    del tmp10
    tmp12 += np.transpose(tmp11, (1, 0, 3, 2)) * -2
    del tmp11
    tmp13 = einsum(t2, (0, 1, 2, 3), tmp12, (4, 1, 5, 3), (0, 4, 2, 5))
    del tmp12
    tmp14 += tmp13
    del tmp13
    t2new += tmp14 * -1
    ...
    tmp15 += t2 * 2
    tmp16 = einsum(v.xov, (0, 1, 2), tmp15, (1, 3, 2, 4), (3, 4, 0))
    del tmp15
    tmp17 = einsum(tmp16, (0, 1, 2), v.xov, (2, 0, 3), (3, 1)) * 0.5
    tmp18 = einsum(tmp17, (0, 1), t2, (2, 3, 0, 4), (2, 3, 4, 1)) * 2
    del tmp17
    tmp21 = np.copy(np.transpose(tmp18, (1, 0, 2, 3)))
    del tmp18
    tmp19 = einsum(tmp16, (0, 1, 2), v.xov, (2, 3, 1), (3, 0))
    del tmp16
    tmp20 = einsum(tmp19, (0, 1), t2, (2, 0, 3, 4), (2, 1, 4, 3))
    del tmp19
    ...
    del tmp23
    t2new += einsum(t2, (0, 1, 2, 3), tmp24, (4, 1, 5, 3), (4, 0, 5, 2)) * 2
    del tmp24
...
def update_lams(f=None, l2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:24:48.381538.
    ...
    del tmp2
    tmp3 = einsum(f.vv, (0, 1), l2, (2, 1, 3, 4), (3, 4, 0, 2))
    tmp8 = np.copy(tmp3)
    del tmp3
    tmp4 = einsum(v.xoo, (0, 1, 2), v.xvv, (0, 3, 4), (1, 2, 3, 4))
    tmp6 = np.copy(np.transpose(tmp4, (1, 0, 3, 2))) * -1
    tmp5 = einsum(t2, (0, 1, 2, 3), tmp1, (4, 1, 2, 5), (0, 4, 3, 5))
    tmp6 += tmp5
    del tmp5
    tmp7 = einsum(l2, (0, 1, 2, 3), tmp6, (2, 4, 1, 5), (3, 4, 0, 5))
    del tmp6
    tmp8 += tmp7
    del tmp7
    ...
    del tmp8
    tmp9 = einsum(l2, (0, 1, 2, 3), f.oo, (4, 3), (4, 2, 0, 1))
    l2new += np.transpose(tmp9, (3, 2, 0, 1)) * -1
    l2new += np.transpose(tmp9, (2, 3, 1, 0)) * -1
    del tmp9
    tmp10 = einsum(tmp4, (0, 1, 2, 3), l2, (4, 3, 5, 1), (5, 0, 4, 2))
    del tmp4
    tmp22 = np.copy(tmp10)
    del tmp10
    tmp11 = einsum(t2, (0, 1, 2, 3), l2, (4, 2, 5, 1), (5, 0, 4, 3))
    tmp14 = np.copy(tmp11)
    del tmp11
    tmp12 = np.copy(np.transpose(l2, (3, 2, 0, 1))) * 2
    tmp12 += np.transpose(l2, (2, 3, 0, 1)) * -1
    tmp13 = einsum(t2, (0, 1, 2, 3), tmp12, (1, 4, 5, 3), (0, 4, 2, 5))
    del tmp12
    tmp14 += np.transpose(tmp13, (1, 0, 3, 2)) * -1
    del tmp13
    tmp15 = einsum(tmp14, (0, 1, 2, 3), tmp1, (1, 4, 5, 3), (4, 0, 5, 2))
    del tmp14
    tmp22 += np.transpose(tmp15, (1, 0, 3, 2)) * -1
    del tmp15
    ...
    tmp16 += t2 * 2
    tmp17 = einsum(v.xov, (0, 1, 2), tmp16, (1, 3, 2, 4), (3, 4, 0))
    del tmp16
    tmp18 += tmp17
    del tmp17
    tmp20 = einsum(tmp19, (0, 1, 2, 3), tmp18, (0, 2, 4), (1, 3, 4))
    del tmp19, tmp18
    tmp21 = einsum(tmp20, (0, 1, 2), v.xov, (2, 3, 4), (3, 0, 4, 1))
    del tmp20
    tmp22 += np.transpose(tmp21, (1, 0, 3, 2)) * -1
    del tmp21
    l2new += np.transpose(tmp22, (2, 3, 0, 1)) * -1
    l2new += np.transpose(tmp22, (3, 2, 1, 0)) * -1
    del tmp22
    tmp23 = np.copy(np.transpose(t2, (0, 1, 3, 2))) * -0.5
    tmp23 += t2
    tmp24 = einsum(tmp23, (0, 1, 2, 3), l2, (2, 3, 0, 4), (4, 1)) * 2
    del tmp23
    tmp25 = einsum(tmp24, (0, 1), v.xov, (2, 1, 3), (0, 3, 2)) * 0.5
    del tmp24
    tmp26 = einsum(v.xov, (0, 1, 2), tmp25, (3, 4, 0), (1, 3, 2, 4)) * 2
    del tmp25
    tmp31 = np.copy(np.transpose(tmp26, (1, 0, 2, 3)))
    del tmp26
    tmp27 = np.copy(np.transpose(t2, (0, 1, 3, 2)))
    tmp27 += t2 * -0.5
    tmp28 = einsum(tmp27, (0, 1, 2, 3), l2, (4, 3, 1, 0), (4, 2)) * 2
    del tmp27
    ...
    del tmp31
    tmp32 = np.copy(np.transpose(t2, (0, 1, 3, 2))) * -1
    tmp32 += t2 * 2
    tmp33 = einsum(v.xov, (0, 1, 2), tmp32, (1, 3, 2, 4), (3, 4, 0))
    del tmp32
    tmp34 = einsum(tmp33, (0, 1, 2), v.xov, (2, 0, 3), (3, 1)) * 0.5
    tmp35 = einsum(l2, (0, 1, 2, 3), tmp34, (4, 1), (3, 2, 0, 4)) * 2
    del tmp34
    tmp38 = np.copy(np.transpose(tmp35, (1, 0, 2, 3)))
    del tmp35
    tmp36 = einsum(tmp33, (0, 1, 2), v.xov, (2, 3, 1), (3, 0))
    del tmp33
    tmp37 = einsum(l2, (0, 1, 2, 3), tmp36, (4, 2), (4, 3, 0, 1))
    del tmp36
    ...
    del tmp38
    tmp39 = einsum(v.xoo, (0, 1, 2), v.xoo, (0, 3, 4), (1, 3, 4, 2))
    tmp39 += einsum(t2, (0, 1, 2, 3), tmp1, (4, 5, 3, 2), (0, 1, 4, 5))
    del tmp1
    l2new += einsum(l2, (0, 1, 2, 3), tmp39, (2, 3, 4, 5), (0, 1, 5, 4))
    del tmp39
...
def make_rdm1_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:24:57.105608.
...
def make_rdm2_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:29:12.427936.
    ...
    rdm2.vvoo += l2 * 4
    tmp28 = einsum(t2, (0, 1, 2, 3), l2, (4, 5, 1, 0), (4, 5, 3, 2))
    ...
    rdm2.oooo += np.transpose(tmp0, (2, 3, 1, 0)) * -2
    ...
    rdm2.ovov += einsum(tmp13, (0, 1), delta.oo, (2, 3), (2, 1, 3, 0)) * 8
    ...
    rdm2.ovvo += einsum(tmp13, (0, 1), delta.oo, (2, 3), (2, 1, 0, 3)) * -4
    ...
    tmp26 += np.transpose(l2, (2, 3, 0, 1))
    tmp27 = einsum(tmp26, (0, 1, 2, 3), t2, (4, 0, 3, 5), (4, 1, 5, 2))
    del tmp26
    ...
    del tmp9
    tmp10 = einsum(tmp4, (0, 1, 2, 3), t2, (4, 1, 3, 5), (4, 0, 5, 2))
    del tmp4
...
def hbar_matvec_ip_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:31:54.634237.
    ...
    tmp43 = einsum(v.xov, (0, 1, 2), tmp6, (1, 3, 0), (3, 2))
...
def hbar_matvec_ip(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:31:55.386354.
    ...
    r2new += einsum(r2, (0, 1, 2), ints.tmp25, (3, 0, 4, 1), (4, 3, 2))
    del ints.tmp25
    ...
    tmp6 += ints.tmp3 * -1
    del ints.tmp3
    tmp5 = einsum(tmp1, (0, 1, 2), v.xov, (3, 0, 2), (1, 3)) * 0.5
    ...
    del tmp7
    tmp8 = einsum(ints.tmp15, (0, 1, 2, 3), tmp1, (0, 1, 2), (3,)) * 0.5
    del tmp1, ints.tmp15
    r2new += einsum(t2, (0, 1, 2, 3), tmp8, (3,), (0, 1, 2)) * -2
    del tmp8
    ...
    tmp10 += ints.tmp50 * -1
    del ints.tmp50
    r2new += einsum(tmp10, (0, 1), r1, (2,), (0, 2, 1)) * -1
    del tmp10
...
def hbar_matvec_ea_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:34:33.947899.
...
def hbar_matvec_ea(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:34:34.722666.
    ...
    r1new = einsum(ints.tmp0, (0, 1, 2, 3), tmp0, (0, 3, 2), (1,)) * -2
    del tmp0
    ...
    del ints.tmp28
    tmp3 = einsum(ints.tmp15, (0, 1, 2, 3), r2, (3, 2, 4), (0, 1, 4))
    ...
    tmp7 += ints.tmp3 * -1
    del ints.tmp3
    tmp6 = einsum(tmp1, (0, 1, 2), v.xov, (3, 0, 1), (2, 3)) * 0.5
    del tmp1
    ...
    del tmp2
    tmp10 = einsum(f.ov, (0, 1), r1, (1,), (0,)) * 0.5
    tmp9 = np.copy(np.transpose(r2, (2, 0, 1))) * -0.5
    tmp9 += np.transpose(r2, (2, 1, 0))
    tmp10 += einsum(ints.tmp15, (0, 1, 2, 3), tmp9, (0, 3, 2), (1,)) * -1
    del ints.tmp15, tmp9
    r2new += einsum(t2, (0, 1, 2, 3), tmp10, (1,), (2, 3, 0)) * 2
    del tmp10
    tmp11 = np.copy(f.oo)
...
def hbar_lmatvec_ip_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:38:06.115626.
    ...
    tmp41 = einsum(v.xoo, (0, 1, 2), v.xvv, (0, 3, 4), (1, 2, 3, 4))
    tmp9 = einsum(v.xov, (0, 1, 2), t2, (3, 1, 2, 4), (3, 4, 0))
    tmp10 = einsum(tmp9, (0, 1, 2), v.xov, (2, 3, 1), (0, 3))
    ...
    tmp18 = einsum(t2, (0, 1, 2, 3), tmp6, (4, 0, 1, 3), (4, 2))
    ...
    tmp63 = einsum(tmp43, (0, 1, 2, 3), t2, (4, 5, 3, 2), (4, 5, 1, 0))
    tmp65 = einsum(v.xov, (0, 1, 2), tmp9, (1, 3, 0), (3, 2))
    tmp67 = einsum(v.xov, (0, 1, 2), tmp12, (1, 3, 0), (3, 2))
...
def hbar_lmatvec_ip(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:38:06.836925.
    ...
    r1new += einsum(tmp2, (0, 1, 2), tmp3, (0, 1, 3, 2), (3,))
    del tmp3
    tmp4 = np.copy(f.ov)
    tmp4 += ints.tmp15
    del ints.tmp15
    ...
    tmp4 += ints.tmp32 * -1
    del ints.tmp32
    r1new += einsum(tmp4, (0, 1), tmp2, (0, 2, 1), (2,)) * -1
    del tmp4
    tmp5 = np.copy(f.oo)
    tmp5 += ints.tmp13 * 2
    del ints.tmp13
    ...
    tmp9 += ints.tmp9 * -0.5
    del ints.tmp9
    tmp10 = einsum(tmp9, (0, 1, 2), tmp2, (0, 3, 1), (3, 2)) * 2
    del tmp2, tmp9
...
def hbar_lmatvec_ea_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:41:20.196237.
    ...
    tmp1 = einsum(f.ov, (0, 1), t2, (2, 0, 3, 1), (2, 3))
    tmp43 = einsum(v.xoo, (0, 1, 2), v.xvv, (0, 3, 4), (1, 2, 3, 4))
    ...
    tmp17 = einsum(t2, (0, 1, 2, 3), tmp16, (0, 4, 1, 2), (4, 3))
    tmp20 = einsum(t2, (0, 1, 2, 3), tmp16, (0, 4, 1, 3), (4, 2))
    tmp23 = einsum(t2, (0, 1, 2, 3), tmp16, (0, 4, 1, 5), (4, 2, 3, 5))
    del tmp16
    tmp26 = einsum(tmp13, (0, 1, 2), v.xvv, (2, 3, 1), (0, 3))
    tmp29 = einsum(tmp10, (0, 1, 2), v.xvv, (2, 3, 1), (0, 3))
    ...
    tmp37 = einsum(t2, (0, 1, 2, 3), tmp7, (1, 2, 4, 5), (0, 3, 5, 4))
...
def hbar_lmatvec_ea(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:41:20.736087.
    ...
    tmp2 += ints.tmp29 * -1
    del ints.tmp29
    tmp3 = np.copy(np.transpose(r2, (2, 0, 1))) * 2
    tmp3 += np.transpose(r2, (2, 1, 0)) * -1
    r1new += einsum(tmp2, (0, 1), tmp3, (0, 1, 2), (2,)) * -1
    del tmp2, tmp3
    tmp4 = np.copy(f.vv)
    tmp4 += ints.tmp11
    del ints.tmp11
