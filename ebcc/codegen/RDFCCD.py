...
https://github.com/obackhouse/albert
  ...
  * date: 2024-10-20T09:35:50.430350
...
def energy(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:36:01.637616.
...
def update_amps(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:37:46.243513.
    ...
    del tmp8
    tmp9 = einsum(tmp2, (0, 1, 2), v.xov, (2, 3, 4), (0, 3, 1, 4))
    tmp14 = np.copy(tmp9)
    del tmp9
    ...
    tmp10 += tmp2 * -1
    del tmp2
    tmp11 = einsum(v.xov, (0, 1, 2), tmp10, (3, 4, 0), (1, 3, 2, 4))
    del tmp10
...
def update_lams(f=None, l2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:39:43.115801.
    ...
    tmp0 = einsum(v.xvv, (0, 1, 2), v.xvv, (0, 3, 4), (1, 3, 4, 2))
    l2new = einsum(l2, (0, 1, 2, 3), tmp0, (4, 0, 5, 1), (5, 4, 2, 3))
    del tmp0
    tmp1 = einsum(v.xov, (0, 1, 2), v.xov, (0, 3, 4), (3, 1, 4, 2))
    ...
    del tmp2
    tmp3 = einsum(t2, (0, 1, 2, 3), tmp1, (4, 5, 2, 3), (0, 1, 4, 5))
    l2new += einsum(l2, (0, 1, 2, 3), tmp3, (2, 3, 4, 5), (0, 1, 4, 5))
    del tmp3
    tmp4 = einsum(v.xoo, (0, 1, 2), v.xoo, (0, 3, 4), (3, 1, 2, 4))
    ...
    tmp8 += tmp7
    del tmp7
    tmp9 = einsum(l2, (0, 1, 2, 3), tmp8, (2, 4, 1, 5), (3, 4, 0, 5))
    del tmp8
    tmp10 += tmp9
    del tmp9
    ...
    del tmp10
    tmp11 = einsum(l2, (0, 1, 2, 3), f.oo, (4, 3), (4, 2, 0, 1))
    l2new += np.transpose(tmp11, (3, 2, 0, 1)) * -1
    l2new += np.transpose(tmp11, (2, 3, 1, 0)) * -1
    del tmp11
    tmp12 = einsum(l2, (0, 1, 2, 3), tmp6, (4, 3, 5, 1), (2, 4, 0, 5))
    del tmp6
    tmp23 = np.copy(tmp12)
    del tmp12
    tmp13 = einsum(l2, (0, 1, 2, 3), t2, (4, 3, 1, 5), (2, 4, 0, 5))
    tmp16 = np.copy(tmp13)
    del tmp13
    ...
    del tmp15
    tmp17 = einsum(tmp16, (0, 1, 2, 3), tmp1, (1, 4, 5, 3), (4, 0, 5, 2))
    del tmp1, tmp16
    tmp23 += np.transpose(tmp17, (1, 0, 3, 2)) * -1
    del tmp17
    ...
    tmp20 += tmp19
    del tmp19
    tmp21 = einsum(tmp20, (0, 1, 2), tmp14, (0, 3, 1, 4), (3, 4, 2))
    del tmp14, tmp20
    tmp22 = einsum(tmp21, (0, 1, 2), v.xov, (2, 3, 4), (3, 0, 4, 1))
    del tmp21
    ...
    tmp24 += t2 * -0.5
    tmp25 = einsum(tmp24, (0, 1, 2, 3), l2, (3, 2, 0, 4), (4, 1)) * 2
    del tmp24
    tmp26 = einsum(tmp25, (0, 1), v.xov, (2, 1, 3), (0, 3, 2)) * 0.5
    del tmp25
    tmp27 = einsum(tmp26, (0, 1, 2), v.xov, (2, 3, 4), (3, 0, 4, 1)) * 2
    del tmp26
    tmp32 = np.copy(np.transpose(tmp27, (1, 0, 2, 3)))
    del tmp27
    tmp28 = np.copy(np.transpose(t2, (0, 1, 3, 2))) * -0.5
    tmp28 += t2
    tmp29 = einsum(tmp28, (0, 1, 2, 3), l2, (4, 3, 0, 1), (4, 2)) * 2
    del tmp28
    tmp30 = einsum(tmp29, (0, 1), v.xov, (2, 3, 1), (3, 0, 2))
    del tmp29
    tmp31 = einsum(tmp30, (0, 1, 2), v.xov, (2, 3, 4), (3, 0, 4, 1))
    del tmp30
    ...
    del tmp32
    tmp33 = np.copy(np.transpose(t2, (0, 1, 3, 2))) * -1
    tmp33 += t2 * 2
    tmp34 = einsum(v.xov, (0, 1, 2), tmp33, (1, 3, 2, 4), (3, 4, 0))
    del tmp33
    tmp35 = einsum(v.xov, (0, 1, 2), tmp34, (1, 3, 0), (2, 3)) * 0.5
    tmp36 = einsum(l2, (0, 1, 2, 3), tmp35, (4, 1), (3, 2, 0, 4)) * 2
    del tmp35
    tmp39 = np.copy(np.transpose(tmp36, (1, 0, 2, 3)))
    del tmp36
    tmp37 = einsum(v.xov, (0, 1, 2), tmp34, (3, 2, 0), (1, 3))
    del tmp34
    tmp38 = einsum(tmp37, (0, 1), l2, (2, 3, 1, 4), (0, 4, 2, 3))
    del tmp37
...
def make_rdm1_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:39:52.425664.
    ...
    rdm1.vv = einsum(tmp0, (0, 1, 2, 3), l2, (4, 2, 1, 0), (4, 3)) * 4
    del tmp0
...
def make_rdm2_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:43:40.157905.
    ...
    tmp14 = einsum(t2, (0, 1, 2, 3), tmp13, (0, 1, 4, 3), (2, 4)) * 0.5
    ...
    tmp4 = einsum(t2, (0, 1, 2, 3), tmp3, (1, 4, 3, 5), (4, 0, 5, 2))
    ...
    del tmp28
    tmp26 = einsum(t2, (0, 1, 2, 3), tmp13, (0, 1, 4, 3), (2, 4))
    del tmp13
    ...
    tmp8 = einsum(tmp7, (0, 1, 2, 3), t2, (4, 1, 3, 5), (0, 4, 2, 5))
    del tmp7
    tmp9 += tmp8
    del tmp8
    rdm2.oovv += tmp9 * 2
    ...
    del tmp9
    tmp10 = einsum(tmp3, (0, 1, 2, 3), t2, (4, 0, 2, 5), (1, 4, 3, 5))
    del tmp3
    ...
    del tmp15
    tmp16 = einsum(t2, (0, 1, 2, 3), tmp2, (1, 4), (4, 0, 3, 2))
    del tmp2
...
def hbar_matvec_ip_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:45:56.746572.
    ...
    tmp23 = einsum(t2, (0, 1, 2, 3), f.ov, (1, 2), (0, 3))
    ...
    tmp41 = einsum(v.xov, (0, 1, 2), tmp3, (1, 3, 0), (3, 2))
...
def hbar_matvec_ip(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:45:57.454564.
    ...
    r1new = einsum(ints.tmp0, (0, 1, 2, 3), tmp0, (1, 2, 3), (0,))
    r1new += einsum(f.ov, (0, 1), tmp0, (2, 0, 1), (2,)) * -1
    tmp1 = np.copy(f.oo)
    ...
    del ints.tmp32
    tmp2 += ints.tmp31 * -0.5
    r2new += einsum(tmp2, (0, 1, 2, 3), r2, (1, 4, 3), (0, 4, 2)) * -2
    del tmp2
    tmp3 = np.copy(ints.tmp18)
    del ints.tmp18
    tmp3 += ints.tmp31 * -1
    del ints.tmp31
    r2new += einsum(r2, (0, 1, 2), tmp3, (3, 1, 4, 2), (0, 3, 4)) * -1
    del tmp3
    tmp4 = np.copy(ints.tmp16)
    del ints.tmp16
    tmp4 += np.transpose(ints.tmp25, (0, 2, 3, 1))
    del ints.tmp25
    r2new += einsum(tmp4, (0, 1, 2, 3), r2, (3, 2, 4), (1, 0, 4))
    del tmp4
    ...
    tmp6 += ints.tmp3 * -1
    del ints.tmp3
    tmp5 = einsum(tmp0, (0, 1, 2), v.xov, (3, 1, 2), (0, 3)) * 0.5
    del tmp0
    ...
    del tmp7
    tmp8 = np.copy(ints.tmp15) * -0.5
    tmp8 += np.transpose(ints.tmp15, (1, 0, 2, 3))
    del ints.tmp15
    tmp9 = einsum(r2, (0, 1, 2), tmp8, (1, 0, 2, 3), (3,))
    del tmp8
    ...
    del ints.tmp40
    r2new += einsum(r1, (0,), tmp10, (1, 0, 2, 3), (2, 1, 3))
    del tmp10
...
def hbar_matvec_ea_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:48:08.499199.
    ...
    tmp36 = einsum(t2, (0, 1, 2, 3), f.ov, (1, 2), (0, 3))
    tmp3 = einsum(t2, (0, 1, 2, 3), v.xov, (4, 1, 2), (0, 3, 4))
    tmp4 = einsum(v.xov, (0, 1, 2), tmp3, (1, 3, 0), (3, 2))
...
def hbar_matvec_ea(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:48:09.081675.
    ...
    r1new += einsum(tmp1, (0, 1, 2), f.ov, (0, 1), (2,)) * -1
    tmp2 = np.copy(f.vv)
    ...
    tmp7 += ints.tmp3 * -1
    del ints.tmp3
    tmp6 = einsum(v.xov, (0, 1, 2), tmp1, (1, 2, 3), (3, 0)) * 0.5
    del tmp1
...
def hbar_lmatvec_ip_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:50:52.556048.
    ...
    tmp21 = einsum(t2, (0, 1, 2, 3), tmp6, (1, 4, 5, 2), (0, 4, 5, 3))
    tmp23 = einsum(t2, (0, 1, 2, 3), tmp6, (1, 4, 5, 3), (0, 4, 5, 2))
    tmp25 = einsum(tmp9, (0, 1, 2), v.xoo, (2, 3, 4), (0, 3, 4, 1))
    tmp29 = einsum(v.xvv, (0, 1, 2), tmp12, (3, 2, 0), (3, 1))
    tmp32 = einsum(tmp9, (0, 1, 2), v.xvv, (2, 3, 1), (0, 3))
    ...
    tmp63 = einsum(t2, (0, 1, 2, 3), tmp43, (4, 5, 2, 3), (0, 1, 4, 5))
    ...
    tmp36 = einsum(tmp35, (0, 1, 2, 3), t2, (4, 5, 3, 1), (4, 5, 0, 2))
    del tmp35
...
def hbar_lmatvec_ip(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:50:53.097066.
    ...
    r1new += einsum(tmp4, (0, 1), tmp5, (2, 0, 1), (2,)) * -1
    del tmp4
    tmp6 = np.copy(f.oo)
    tmp6 += ints.tmp13 * 2
    del ints.tmp13
    ...
    tmp7 = np.copy(ints.tmp41) * 0.5
    tmp7 += np.transpose(ints.tmp45, (1, 0, 3, 2))
    del ints.tmp45
    tmp7 += np.transpose(ints.tmp44, (1, 0, 3, 2)) * -0.5
    r2new += einsum(tmp7, (0, 1, 2, 3), r2, (1, 4, 3), (0, 4, 2)) * -2
    del tmp7
    tmp8 = np.copy(ints.tmp41)
    del ints.tmp41
    tmp8 += np.transpose(ints.tmp44, (1, 0, 3, 2)) * -1
    del ints.tmp44
    r2new += einsum(tmp8, (0, 1, 2, 3), r2, (4, 1, 3), (4, 0, 2)) * -1
    del tmp8
    tmp9 = np.copy(ints.tmp59)
    del ints.tmp59
    tmp9 += np.transpose(ints.tmp63, (2, 1, 3, 0))
    del ints.tmp63
    r2new += einsum(tmp9, (0, 1, 2, 3), r2, (1, 3, 4), (2, 0, 4))
    del tmp9
    tmp10 = np.copy(ints.tmp12)
    del ints.tmp12
    tmp10 += np.transpose(v.xov, (1, 2, 0)) * 0.5
    tmp10 += ints.tmp9 * -0.5
    del ints.tmp9
    tmp11 = einsum(tmp10, (0, 1, 2), tmp5, (3, 0, 1), (3, 2)) * 2
    del tmp5, tmp10
    r2new += einsum(tmp11, (0, 1), v.xov, (1, 2, 3), (2, 0, 3))
    del tmp11
    tmp12 = np.copy(f.vv)
    tmp12 += ints.tmp65
    del ints.tmp65
    tmp12 += ints.tmp67 * -2
    del ints.tmp67
    r2new += einsum(r2, (0, 1, 2), tmp12, (2, 3), (0, 1, 3))
    del tmp12
    tmp13 = np.copy(np.transpose(t2, (0, 1, 3, 2)))
    tmp13 += t2 * -0.5
    tmp14 = einsum(r2, (0, 1, 2), tmp13, (1, 0, 2, 3), (3,))
    del tmp13
    r2new += einsum(tmp14, (0,), ints.tmp43, (1, 2, 3, 0), (1, 2, 3)) * -2
    del tmp14, ints.tmp43
...
def hbar_lmatvec_ea_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:53:14.687428.
...
def hbar_lmatvec_ea(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:53:15.112799.
    ...
    r1new += einsum(tmp3, (0, 1, 2), tmp2, (0, 1), (2,)) * -1
    del tmp3, tmp2
    tmp4 = np.copy(f.vv)
    tmp4 += ints.tmp11
    del ints.tmp11
    ...
    tmp11 += ints.tmp10 * -1
    del ints.tmp10
    tmp12 = einsum(tmp10, (0, 1, 2), tmp11, (0, 1, 3), (2, 3)) * 2
    del tmp10, tmp11
