...
https://github.com/obackhouse/albert
  ...
  * date: 2024-08-07T21:05:38.621230
...
def energy(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-07T21:05:38.906840.
...
def update_amps(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-07T21:05:42.167406.
    ...
    tmp10 = einsum(tmp9, (0, 1, 2, 3), t2, (4, 0, 3, 2), (4, 1)) * 2
    del tmp9
    ...
    del tmp13
    tmp15 = v.ovov.transpose((0, 2, 1, 3)).copy() * 0.5
    tmp15 += v.oovv * -0.25
    tmp15 += tmp1
    del tmp1
