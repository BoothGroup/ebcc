...
def update_amps(f=None, v=None, nocc=None, nvir=None, t2=None, **kwargs):
    # T amplitudes
    t2new = np.zeros((nocc, nvir), dtype=np.float64)
    t2new += einsum(v.ovov, (0, 1, 2, 3), (0, 1)) * 2.0
    t2new += einsum(v.ovov, (0, 1, 2, 3), (0, 3)) * -1.0
    ...
    del x1
    t2new += einsum(t2, (0, 1, 2, 3), x2, (4, 0, 1, 2), (4, 3))
    del x2
    ...
    t2new += einsum(x11, (0, 1, 2), x12, (1, 3, 2), (0, 3)) * 2.0
    del x11, x12
    ...
    del x15
    t2new += einsum(x16, (0, 1, 2), t2, (0, 2, 3, 4), (1, 3)) * 2.0
    del x16
    ...
    t2new += einsum(x21, (0,), x22, (1, 0, 2), (1, 2)) * -2.0
    del x21, x22
