...
https://github.com/obackhouse/albert
  ...
  * date: 2024-10-18T21:45:51.048440
...
def energy(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:45:56.181240.
...
def update_amps(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:46:57.433413.
    ...
    del tmp4
    tmp5 = einsum(t2, (0, 1, 2, 3), f.oo, (4, 1), (4, 0, 2, 3))
    ...
    tmp8 = einsum(t2, (0, 1, 2, 3), tmp7, (0, 1, 4, 2), (3, 4))
    del tmp7
    tmp9 = einsum(t2, (0, 1, 2, 3), tmp8, (4, 2), (0, 1, 3, 4))
    del tmp8
    tmp13 += np.transpose(tmp9, (1, 0, 2, 3))
    del tmp9
    tmp10 = np.copy(np.transpose(v.ovov, (0, 2, 3, 1))) * -0.5
    tmp10 += np.transpose(v.ovov, (0, 2, 1, 3))
    tmp11 = einsum(tmp10, (0, 1, 2, 3), t2, (4, 0, 3, 2), (4, 1)) * 2
    del tmp10
    tmp12 = einsum(t2, (0, 1, 2, 3), tmp11, (4, 1), (0, 4, 3, 2)) * 0.5
    del tmp11
    tmp13 += np.transpose(tmp12, (0, 1, 3, 2))
    del tmp12
    t2new += tmp13 * -1
    ...
    tmp15 += tmp1 * 4
    del tmp1
    t2new += einsum(t2, (0, 1, 2, 3), tmp15, (4, 1, 5, 3), (0, 4, 2, 5))
    del tmp15
