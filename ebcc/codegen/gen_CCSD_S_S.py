...
bra = bra1, bra2, bra1b, bra1b1e = wick.get_bra_spaces(rank=rank, occs=occs, virs=virs, nms=nms)
ket = ket1, ket2, ket1b, ket1b1e = wick.get_ket_spaces(rank=rank, occs=occs, virs=virs, nms=nms)
#braip = bra1ip, bra2ip, bra1bip, bra1b1eip = wick.get_bra_ip_spaces(rank=rank, occs=occs, virs=virs, nms=nms)
#braea = bra1ea, bra2ea, bra1bea, bra1b1eea = wick.get_bra_ea_spaces(rank=rank, occs=occs, virs=virs, nms=nms)
#ketip = ket1ip, ket2ip, ket1bip, ket1b1eip = wick.get_ket_ip_spaces(rank=rank, occs=occs, virs=virs, nms=nms)
#ketea = ket1ea, ket2ea, ket1bea, ket1b1eea = wick.get_ket_ea_spaces(rank=rank, occs=occs, virs=virs, nms=nms)
#rip = r1ip, r2ip, r1bip, r1b1eip = wick.get_r_ip_spaces(rank=rank, occs=occs, virs=virs, nms=nms)
#rea = r1ea, r2ea, r1bea, r1b1eea = wick.get_r_ea_spaces(rank=rank, occs=occs, virs=virs, nms=nms)
