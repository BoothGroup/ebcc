 ...
 * date: 2024-12-14T12:12:32.736919
...
def update_amps_external(f=None, t3=None, t4=None, v=None, **kwargs):
    ...
    t2new.OOVV += einsum(v.OOVV, (0, 1, 2, 3), t4, (4, 5, 0, 1, 6, 7, 2, 3), (4, 5, 6, 7)) * 0.25
...
def convert_c3_to_t3(c3=None, t1=None, t2=None, **kwargs):
    ...
    t3 += einsum(t1, (0, 1), tmp0, (2, 3, 4, 5), (0, 3, 2, 5, 1, 4))
    t3 += einsum(tmp0, (0, 1, 2, 3), t1, (4, 5), (1, 0, 4, 3, 5, 2))
    t3 += einsum(t1, (0, 1), tmp0, (2, 3, 4, 5), (3, 0, 2, 5, 1, 4)) * -1
    del tmp0
...
def convert_c4_to_t4(c4=None, t1=None, t2=None, t3=None, **kwargs):
    ...
    t4 += einsum(t3, (0, 1, 2, 3, 4, 5), t1, (6, 7), (0, 1, 2, 6, 3, 7, 4, 5)) * -1
    ...
    t4 += einsum(t2, (0, 1, 2, 3), t2, (4, 5, 6, 7), (4, 0, 1, 5, 2, 6, 3, 7))
    ...
    tmp1 += einsum(t2, (0, 1, 2, 3), t1, (4, 5), (0, 1, 4, 2, 5, 3)) * -1
    tmp1 += einsum(t2, (0, 1, 2, 3), t1, (4, 5), (0, 1, 4, 2, 3, 5))
    tmp0 = np.copy(t2)
    tmp0 += einsum(t1, (0, 1), t1, (2, 3), (0, 2, 3, 1)) * -1
    tmp0 += einsum(t1, (0, 1), t1, (2, 3), (0, 2, 1, 3))
    tmp1 += einsum(t1, (0, 1), tmp0, (2, 3, 4, 5), (0, 3, 2, 1, 5, 4))
    tmp1 += einsum(t1, (0, 1), tmp0, (2, 3, 4, 5), (0, 3, 2, 5, 4, 1))
    tmp1 += einsum(t1, (0, 1), tmp0, (2, 3, 4, 5), (0, 3, 2, 5, 1, 4)) * -1
    del tmp0
    ...
    tmp2 += einsum(t2, (0, 1, 2, 3), t1, (4, 5), (0, 1, 4, 2, 5, 3)) * -1
    tmp2 += einsum(t2, (0, 1, 2, 3), t1, (4, 5), (0, 1, 4, 2, 3, 5))
    t4 += einsum(t1, (0, 1), tmp2, (2, 3, 4, 5, 6, 7), (3, 0, 4, 2, 1, 6, 7, 5))
    t4 += einsum(t1, (0, 1), tmp2, (2, 3, 4, 5, 6, 7), (3, 0, 4, 2, 6, 7, 1, 5))
    t4 += einsum(t1, (0, 1), tmp2, (2, 3, 4, 5, 6, 7), (3, 0, 4, 2, 6, 1, 7, 5)) * -1
    t4 += einsum(tmp2, (0, 1, 2, 3, 4, 5), t1, (6, 7), (1, 6, 2, 0, 4, 5, 3, 7)) * -1
    del tmp2
    tmp3 = np.copy(t3)
    tmp3 += einsum(t1, (0, 1), t2, (2, 3, 4, 5), (0, 2, 3, 1, 4, 5))
    tmp3 += einsum(t1, (0, 1), t2, (2, 3, 4, 5), (0, 2, 3, 4, 1, 5)) * -1
    tmp3 += einsum(t1, (0, 1), t2, (2, 3, 4, 5), (0, 2, 3, 4, 5, 1))
    t4 += einsum(tmp3, (0, 1, 2, 3, 4, 5), t1, (6, 7), (1, 2, 6, 0, 4, 7, 5, 3))
    t4 += einsum(t1, (0, 1), tmp3, (2, 3, 4, 5, 6, 7), (3, 4, 0, 2, 6, 7, 5, 1))
...
def convert_t2_to_c2(t1=None, t2=None, **kwargs):
    ...
    c2 = np.copy(t2)
    c2 += einsum(t1, (0, 1), t1, (2, 3), (0, 2, 3, 1)) * -1
    c2 += einsum(t1, (0, 1), t1, (2, 3), (0, 2, 1, 3))
...
def convert_t4_to_c4(t1=None, t2=None, t3=None, t4=None, **kwargs):
    ...
    c4 = np.copy(t4)
    c4 += einsum(t3, (0, 1, 2, 3, 4, 5), t1, (6, 7), (0, 1, 2, 6, 7, 3, 4, 5)) * -1
    c4 += einsum(t3, (0, 1, 2, 3, 4, 5), t1, (6, 7), (0, 1, 2, 6, 3, 7, 4, 5))
    c4 += einsum(t3, (0, 1, 2, 3, 4, 5), t1, (6, 7), (0, 1, 2, 6, 3, 4, 7, 5)) * -1
    c4 += einsum(t3, (0, 1, 2, 3, 4, 5), t1, (6, 7), (0, 1, 2, 6, 3, 4, 5, 7))
    c4 += einsum(t2, (0, 1, 2, 3), t2, (4, 5, 6, 7), (4, 0, 1, 5, 2, 3, 6, 7))
    c4 += einsum(t2, (0, 1, 2, 3), t2, (4, 5, 6, 7), (4, 0, 1, 5, 2, 6, 3, 7)) * -1
    c4 += einsum(t2, (0, 1, 2, 3), t2, (4, 5, 6, 7), (4, 0, 1, 5, 6, 2, 3, 7))
    c4 += einsum(t2, (0, 1, 2, 3), t2, (4, 5, 6, 7), (4, 0, 1, 5, 2, 6, 7, 3))
    c4 += einsum(t2, (0, 1, 2, 3), t2, (4, 5, 6, 7), (0, 4, 5, 1, 2, 6, 3, 7)) * -1
    c4 += einsum(t2, (0, 1, 2, 3), t2, (4, 5, 6, 7), (0, 4, 5, 1, 2, 3, 6, 7))
    c4 += einsum(t2, (0, 1, 2, 3), t2, (4, 5, 6, 7), (0, 4, 1, 5, 6, 7, 2, 3)) * -1
    c4 += einsum(t2, (0, 1, 2, 3), t2, (4, 5, 6, 7), (0, 4, 1, 5, 6, 2, 7, 3))
    c4 += einsum(t2, (0, 1, 2, 3), t2, (4, 5, 6, 7), (0, 4, 1, 5, 2, 6, 7, 3)) * -1
    c4 += einsum(t2, (0, 1, 2, 3), t2, (4, 5, 6, 7), (0, 4, 1, 5, 6, 2, 3, 7)) * -1
    c4 += einsum(t2, (0, 1, 2, 3), t2, (4, 5, 6, 7), (4, 0, 5, 1, 6, 2, 7, 3))
    c4 += einsum(t2, (0, 1, 2, 3), t2, (4, 5, 6, 7), (4, 0, 5, 1, 6, 7, 2, 3)) * -1
    c4 += einsum(t2, (0, 1, 2, 3), t2, (4, 5, 6, 7), (4, 5, 0, 1, 2, 3, 6, 7))
    c4 += einsum(t2, (0, 1, 2, 3), t2, (4, 5, 6, 7), (4, 5, 0, 1, 2, 6, 3, 7)) * -1
    c4 += einsum(t2, (0, 1, 2, 3), t2, (4, 5, 6, 7), (0, 1, 4, 5, 2, 6, 7, 3))
    c4 += einsum(t2, (0, 1, 2, 3), t2, (4, 5, 6, 7), (0, 1, 4, 5, 6, 2, 3, 7))
    c4 += einsum(t2, (0, 1, 2, 3), t2, (4, 5, 6, 7), (4, 5, 0, 1, 6, 2, 7, 3)) * -1
    ...
    tmp1 += einsum(t1, (0, 1), tmp0, (2, 3, 4, 5), (0, 3, 2, 5, 1, 4)) * -1
    del tmp0
    c4 += einsum(tmp1, (0, 1, 2, 3, 4, 5), t1, (6, 7), (6, 1, 2, 0, 7, 4, 5, 3))
    c4 += einsum(t1, (0, 1), tmp1, (2, 3, 4, 5, 6, 7), (0, 3, 4, 2, 6, 7, 1, 5))
    c4 += einsum(tmp1, (0, 1, 2, 3, 4, 5), t1, (6, 7), (6, 1, 2, 0, 4, 7, 5, 3)) * -1
    c4 += einsum(tmp1, (0, 1, 2, 3, 4, 5), t1, (6, 7), (6, 1, 2, 0, 4, 5, 3, 7)) * -1
    del tmp1
    tmp2 = np.copy(t3)
    tmp2 += einsum(t1, (0, 1), t2, (2, 3, 4, 5), (0, 2, 3, 1, 4, 5))
    tmp2 += einsum(t1, (0, 1), t2, (2, 3, 4, 5), (0, 2, 3, 4, 1, 5)) * -1
    ...
    tmp2 += einsum(t2, (0, 1, 2, 3), t1, (4, 5), (0, 1, 4, 2, 5, 3)) * -1
    tmp2 += einsum(t2, (0, 1, 2, 3), t1, (4, 5), (0, 1, 4, 2, 3, 5))
    c4 += einsum(t1, (0, 1), tmp2, (2, 3, 4, 5, 6, 7), (3, 0, 4, 2, 6, 1, 7, 5))
    c4 += einsum(tmp2, (0, 1, 2, 3, 4, 5), t1, (6, 7), (1, 6, 2, 0, 4, 5, 3, 7))
    c4 += einsum(t1, (0, 1), tmp2, (2, 3, 4, 5, 6, 7), (3, 0, 4, 2, 1, 6, 7, 5)) * -1
    c4 += einsum(t1, (0, 1), tmp2, (2, 3, 4, 5, 6, 7), (3, 0, 4, 2, 6, 7, 1, 5)) * -1
    del tmp2
    tmp3 = np.copy(t3)
    tmp3 += einsum(t1, (0, 1), t2, (2, 3, 4, 5), (0, 2, 3, 1, 4, 5))
    tmp3 += einsum(t1, (0, 1), t2, (2, 3, 4, 5), (0, 2, 3, 4, 1, 5)) * -1
    tmp3 += einsum(t1, (0, 1), t2, (2, 3, 4, 5), (0, 2, 3, 4, 5, 1))
    c4 += einsum(t1, (0, 1), tmp3, (2, 3, 4, 5, 6, 7), (3, 4, 0, 2, 1, 6, 7, 5))
    c4 += einsum(tmp3, (0, 1, 2, 3, 4, 5), t1, (6, 7), (1, 2, 6, 0, 4, 5, 7, 3))
    c4 += einsum(tmp3, (0, 1, 2, 3, 4, 5), t1, (6, 7), (1, 2, 6, 0, 4, 7, 5, 3)) * -1
    c4 += einsum(t1, (0, 1), tmp3, (2, 3, 4, 5, 6, 7), (3, 4, 0, 2, 6, 7, 5, 1)) * -1
    del tmp3
