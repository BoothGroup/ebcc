 ...
 * date: 2024-12-02T16:39:38.476224
...
def update_amps_external(f=None, t3=None, t4=None, v=None, **kwargs):
    ...
    t1new = Namespace()
    t1new.OV = einsum(t3, (0, 1, 2, 3, 4, 5), v.OOVV, (1, 2, 4, 5), (0, 3)) * 0.25
    t2new = Namespace()
...
def update_amps_mixed(t1=None, t3=None, v=None, **kwargs):
    ...
    t2new = Namespace()
    t2new.OOVV = einsum(tmp0, (0, 1), t3, (2, 3, 0, 4, 5, 1), (2, 3, 4, 5))
    del tmp0
    tmp1 = einsum(v.OOvV, (0, 1, 2, 3), t1, (4, 2), (0, 1, 3, 4)) * -1
    tmp2 = einsum(t3, (0, 1, 2, 3, 4, 5), tmp1, (2, 1, 5, 6), (0, 3, 4, 6)) * -1
    del tmp1
...
def convert_c4_to_t4(c4=None, t1=None, t2=None, t3=None, **kwargs):
    ...
    tmp1 += einsum(t1, (0, 1), t2, (2, 3, 4, 5), (2, 0, 3, 4, 1, 5))
    ...
    del tmp0
    t4 += einsum(t1, (0, 1), tmp1, (2, 3, 4, 5, 6, 7), (0, 3, 4, 2, 6, 1, 7, 5))
    ...
    t4 += einsum(tmp2, (0, 1, 2, 3, 4, 5), t1, (6, 7), (1, 6, 2, 0, 4, 5, 7, 3))
