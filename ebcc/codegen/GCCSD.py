...
https://github.com/obackhouse/albert
  ...
  * date: 2024-10-18T21:45:52.156963
...
def energy(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:45:57.455314.
...
def update_amps(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:48:15.443667.
    ...
    tmp19 = einsum(t2, (0, 1, 2, 3), tmp18, (4, 3), (0, 1, 2, 4))
    del tmp18
    ...
    del tmp26
    tmp27 = einsum(v.ooov, (0, 1, 2, 3), t1, (2, 4), (0, 1, 4, 3))
    ...
    tmp32 = einsum(tmp31, (0, 1, 2, 3), t1, (1, 4), (0, 2, 4, 3))
    del tmp31
    tmp35 = np.copy(tmp32)
    del tmp32
    tmp33 = np.copy(t2)
    tmp33 += einsum(t1, (0, 1), t1, (2, 3), (0, 2, 3, 1)) * -1
    tmp34 = einsum(v.ovov, (0, 1, 2, 3), tmp33, (2, 4, 1, 5), (4, 0, 5, 3))
    del tmp33
    tmp35 += tmp34 * -1
    del tmp34
    t2new += tmp35
    ...
    del tmp35
    tmp36 = einsum(tmp5, (0, 1), t2, (2, 0, 3, 4), (1, 2, 3, 4))
    del tmp5
    tmp41 = np.copy(np.transpose(tmp36, (0, 1, 3, 2)))
    del tmp36
    tmp37 = einsum(t2, (0, 1, 2, 3), v.oovv, (4, 1, 2, 3), (0, 4))
    tmp38 = einsum(t2, (0, 1, 2, 3), tmp37, (4, 1), (0, 4, 2, 3))
    del tmp37
    ...
    del tmp42
    tmp43 = einsum(tmp6, (0, 1), t2, (2, 0, 3, 4), (2, 1, 3, 4)) * -1
    del tmp6
    tmp46 += np.transpose(tmp43, (0, 1, 3, 2))
    del tmp43
    tmp44 = einsum(t1, (0, 1), tmp3, (2, 1), (0, 2))
    del tmp3
    tmp45 = einsum(tmp44, (0, 1), t2, (2, 1, 3, 4), (0, 2, 3, 4)) * -1
    del tmp44
...
def update_lams(f=None, l1=None, l2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:50:57.245363.
    ...
    l1new = einsum(tmp0, (0, 1, 2, 3), v.ovoo, (1, 4, 3, 2), (4, 0)) * 0.25
    ...
    tmp22 += einsum(tmp1, (0, 1, 2, 3), t2, (1, 0, 4, 3), (2, 4))
    ...
    tmp29 = einsum(tmp1, (0, 1, 2, 3), v.ooov, (4, 2, 1, 5), (0, 4, 3, 5))
    tmp32 += tmp29
    del tmp29
    tmp30 = np.copy(np.transpose(v.ovov, (0, 2, 3, 1))) * -1
    tmp30 += tmp4
    del tmp4
    tmp31 = einsum(l2, (0, 1, 2, 3), tmp30, (3, 4, 1, 5), (4, 2, 5, 0))
    del tmp30
    ...
    del tmp32
    tmp33 = einsum(tmp1, (0, 1, 2, 3), f.ov, (2, 4), (0, 1, 4, 3))
    tmp39 = np.copy(tmp33) * -1
    del tmp33
    ...
    tmp44 = einsum(l2, (0, 1, 2, 3), tmp43, (4, 3), (4, 2, 0, 1))
    del tmp43
    tmp48 = np.copy(np.transpose(tmp44, (0, 1, 3, 2)))
    del tmp44
    tmp45 = einsum(v.oovv, (0, 1, 2, 3), tmp23, (4, 1), (4, 0, 2, 3)) * -1
    del tmp23
    tmp48 += np.transpose(tmp45, (0, 1, 3, 2)) * -1
    del tmp45
    tmp46 = np.copy(tmp26) * 2
    del tmp26
    tmp46 += np.transpose(tmp27, (1, 0))
    del tmp27
    tmp47 = einsum(tmp46, (0, 1), l2, (2, 3, 4, 1), (0, 4, 2, 3)) * -0.5
    del tmp46
    ...
    del tmp49
    tmp50 = einsum(tmp1, (0, 1, 2, 3), tmp7, (2, 4), (0, 1, 3, 4))
    tmp51 += tmp50
    del tmp50
    ...
    tmp55 = np.copy(tmp53)
    del tmp53
    tmp54 = einsum(tmp5, (0, 1, 2, 3), tmp1, (0, 4, 2, 5), (4, 1, 5, 3)) * -1
    del tmp1, tmp5
    tmp55 += tmp54 * -1
    del tmp54
    ...
    del tmp55
    tmp56 = einsum(t1, (0, 1), tmp7, (2, 1), (0, 2))
    del tmp7
...
def make_rdm1_f(l1=None, l2=None, t1=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:51:11.026839.
...
def make_rdm2_f(l1=None, l2=None, t1=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:53:36.674635.
...
def hbar_matvec_ip_intermediates(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:56:22.601838.
...
def hbar_matvec_ip(f=None, r1=None, r2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:56:23.951208.
...
def hbar_matvec_ea_intermediates(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:59:14.855870.
...
def hbar_matvec_ea(f=None, r1=None, r2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:59:15.619134.
    ...
    tmp6 = einsum(r2, (0, 1, 2), v.ovvv, (3, 4, 0, 1), (2, 3, 4))
...
def hbar_matvec_ee_intermediates(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T22:04:50.982124.
...
def hbar_matvec_ee(f=None, r1=None, r2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T22:04:52.224340.
    ...
    del tmp4
    tmp5 = einsum(r2, (0, 1, 2, 3), v.oovv, (4, 1, 2, 3), (0, 4))
    ...
    tmp9 = einsum(r1, (0, 1), v.ovvv, (0, 2, 3, 1), (2, 3))
    tmp10 = einsum(t2, (0, 1, 2, 3), tmp9, (4, 3), (0, 1, 2, 4)) * -1
    del tmp9
    tmp13 = np.copy(tmp10)
    del tmp10
    tmp11 = np.copy(ints.tmp71)
    tmp11 += ints.tmp94
    tmp12 = einsum(tmp11, (0, 1, 2, 3), r1, (2, 4), (0, 1, 3, 4))
    del tmp11
    tmp13 += tmp12
    del tmp12
    r2new += tmp13
    r2new += np.transpose(tmp13, (0, 1, 3, 2)) * -1
    del tmp13
    tmp14 = einsum(r2, (0, 1, 2, 3), v.oovv, (0, 1, 4, 3), (2, 4))
    tmp15 = einsum(t2, (0, 1, 2, 3), tmp14, (4, 3), (0, 1, 4, 2)) * -1
    del tmp14
    tmp24 = np.copy(tmp15) * 0.5
    del tmp15
    tmp16 = np.copy(ints.tmp106)
    tmp16 += np.transpose(ints.tmp23, (1, 2, 0, 3))
    tmp17 = einsum(tmp16, (0, 1, 2, 3), r1, (2, 4), (0, 1, 3, 4))
    del tmp16
    tmp24 += tmp17
    del tmp17
    tmp18 = einsum(r2, (0, 1, 2, 3), tmp2, (4, 3), (4, 0, 1, 2)) * -1
    del tmp2
    tmp19 = einsum(t1, (0, 1), tmp18, (0, 2, 3, 4), (3, 2, 4, 1))
    del tmp18
    tmp24 += np.transpose(tmp19, (1, 0, 2, 3)) * -1
    del tmp19
    tmp20 = einsum(r2, (0, 1, 2, 3), v.ovvv, (4, 5, 2, 3), (0, 1, 4, 5))
    tmp22 = np.copy(np.transpose(tmp20, (1, 0, 2, 3)))
    del tmp20
    tmp21 = einsum(tmp0, (0, 1), t2, (2, 3, 4, 1), (2, 3, 0, 4)) * -1
    del tmp0
    tmp22 += tmp21 * -2
    del tmp21
    tmp23 = einsum(tmp22, (0, 1, 2, 3), t1, (2, 4), (0, 1, 3, 4)) * 0.5
    del tmp22
    tmp24 += np.transpose(tmp23, (1, 0, 3, 2))
    del tmp23
    r2new += tmp24 * -1
    ...
    del tmp24
    tmp25 = einsum(r1, (0, 1), ints.tmp57, (2, 3, 4, 1), (2, 0, 3, 4))
    tmp38 = np.copy(tmp25)
    del tmp25
    tmp26 = einsum(r2, (0, 1, 2, 3), v.ovov, (4, 3, 1, 5), (0, 4, 2, 5))
    tmp38 += tmp26
    del tmp26
    tmp27 = einsum(r1, (0, 1), v.ovov, (2, 3, 4, 1), (0, 2, 4, 3))
    ...
    tmp38 += tmp30 * -1
    del tmp30
    tmp31 = einsum(r2, (0, 1, 2, 3), v.ooov, (4, 1, 5, 3), (0, 4, 5, 2))
    tmp34 = np.copy(tmp31)
    del tmp31
    tmp32 = einsum(r2, (0, 1, 2, 3), ints.tmp7, (4, 1, 5, 3), (4, 5, 0, 2))
    tmp34 += tmp32 * -1
    del tmp32
    tmp33 = einsum(tmp29, (0, 1, 2, 3), r1, (4, 3), (0, 1, 4, 2))
    del tmp29
    tmp34 += tmp33
    del tmp33
    tmp35 = einsum(t1, (0, 1), tmp34, (2, 0, 3, 4), (2, 3, 4, 1))
    del tmp34
    tmp38 += tmp35
    del tmp35
    tmp36 = np.copy(ints.tmp33)
    tmp36 += ints.tmp49
    tmp37 = einsum(tmp36, (0, 1, 2, 3), r1, (1, 4), (0, 2, 3, 4))
    del tmp36
    tmp38 += tmp37
    del tmp37
    r2new += tmp38 * -1
    ...
    tmp40 = einsum(tmp39, (0, 1, 2, 3), r1, (2, 4), (0, 1, 3, 4))
    del tmp39
    r2new += tmp40
    ...
    del tmp40
    tmp41 = einsum(ints.tmp30, (0, 1, 2, 3), r1, (2, 4), (0, 1, 3, 4))
    tmp44 = np.copy(tmp41) * -1
    del tmp41
    tmp42 = einsum(v.ooov, (0, 1, 2, 3), r1, (2, 4), (0, 1, 4, 3))
    tmp44 += np.transpose(tmp42, (1, 0, 2, 3))
    del tmp42
    tmp43 = einsum(r2, (0, 1, 2, 3), f.vv, (4, 3), (0, 1, 4, 2))
    tmp44 += np.transpose(tmp43, (1, 0, 2, 3))
    del tmp43
    r2new += np.transpose(tmp44, (1, 0, 2, 3)) * -1
    r2new += np.transpose(tmp44, (1, 0, 3, 2))
    del tmp44
    tmp45 = einsum(v.ooov, (0, 1, 2, 3), r1, (1, 3), (0, 2))
    tmp46 = einsum(tmp45, (0, 1), t2, (2, 0, 3, 4), (2, 1, 3, 4)) * -1
    del tmp45
    tmp56 = np.copy(np.transpose(tmp46, (0, 1, 3, 2))) * -1
    del tmp46
    tmp47 = einsum(r1, (0, 1), v.ooov, (2, 3, 4, 1), (0, 2, 3, 4))
    tmp48 = einsum(t1, (0, 1), tmp47, (2, 3, 0, 4), (2, 3, 4, 1))
    del tmp47
    tmp49 = einsum(t1, (0, 1), tmp48, (2, 0, 3, 4), (2, 3, 4, 1)) * -1
    del tmp48
    tmp56 += np.transpose(tmp49, (0, 1, 3, 2))
    del tmp49
    tmp50 = np.copy(ints.tmp51)
    tmp50 += ints.tmp77 * -1
    tmp51 = einsum(r1, (0, 1), tmp50, (2, 3, 4, 1), (2, 0, 3, 4)) * 0.5
    del tmp50
    tmp56 += np.transpose(tmp51, (0, 1, 3, 2)) * -1
    del tmp51
    tmp52 = einsum(r2, (0, 1, 2, 3), tmp8, (1, 4), (4, 0, 2, 3)) * -1
    del tmp8
    tmp56 += np.transpose(tmp52, (0, 1, 3, 2))
    del tmp52
    tmp53 = einsum(ints.tmp7, (0, 1, 2, 3), r1, (1, 3), (0, 2))
    tmp54 = np.copy(tmp53)
    del tmp53
    tmp54 += tmp5 * 0.5
    del tmp5
    tmp54 += np.transpose(tmp6, (1, 0))
    del tmp6
    tmp55 = einsum(tmp54, (0, 1), t2, (2, 1, 3, 4), (0, 2, 3, 4)) * -1
    del tmp54
    ...
    del tmp56
    tmp57 = np.copy(ints.tmp10) * 0.5
    tmp57 += ints.tmp4
    tmp58 = einsum(tmp57, (0, 1), r2, (2, 3, 4, 1), (2, 3, 0, 4)) * -1
    del tmp57
    tmp61 = np.copy(np.transpose(tmp58, (1, 0, 2, 3))) * -1
    del tmp58
    tmp59 = np.copy(ints.tmp55)
    tmp59 += ints.tmp81 * -1
    tmp60 = einsum(tmp59, (0, 1, 2, 3), r1, (2, 4), (0, 1, 3, 4)) * 0.5
    del tmp59
    tmp61 += tmp60 * -1
    del tmp60
    r2new += np.transpose(tmp61, (1, 0, 2, 3))
    r2new += np.transpose(tmp61, (1, 0, 3, 2)) * -1
    del tmp61
    tmp62 = einsum(r1, (0, 1), ints.tmp37, (2, 3, 4, 1), (2, 0, 3, 4))
    tmp64 = np.copy(tmp62)
    del tmp62
    tmp63 = einsum(r1, (0, 1), v.ovvv, (2, 1, 3, 4), (0, 2, 3, 4))
    tmp64 += np.transpose(tmp63, (0, 1, 3, 2)) * -1
    del tmp63
    r2new += np.transpose(tmp64, (0, 1, 3, 2))
    r2new += np.transpose(tmp64, (1, 0, 3, 2)) * -1
    del tmp64
    tmp65 = einsum(r1, (0, 1), ints.tmp7, (2, 3, 4, 1), (2, 3, 4, 0))
    tmp66 = einsum(t1, (0, 1), tmp65, (2, 3, 0, 4), (2, 3, 4, 1))
    del tmp65
    tmp67 = einsum(tmp66, (0, 1, 2, 3), t1, (1, 4), (0, 2, 4, 3))
    del tmp66
    r2new += tmp67 * -1
    ...
    r2new += einsum(tmp68, (0, 1, 2, 3), r2, (2, 3, 4, 5), (0, 1, 4, 5)) * 0.5
    del tmp68
    tmp69 = einsum(v.oovv, (0, 1, 2, 3), r2, (4, 5, 2, 3), (4, 5, 0, 1))
    tmp70 = np.copy(t2)
    tmp70 += einsum(t1, (0, 1), t1, (2, 3), (0, 2, 1, 3)) * 2
    r2new += einsum(tmp70, (0, 1, 2, 3), tmp69, (4, 5, 0, 1), (5, 4, 3, 2)) * 0.25
    del tmp70, tmp69
    ...
    tmp71 += ints.tmp22 * -1
    tmp71 += ints.tmp70 * -1
    r2new += einsum(tmp71, (0, 1), r1, (2, 3), (0, 2, 1, 3)) * -1
    r2new += einsum(r1, (0, 1), tmp71, (2, 3), (0, 2, 1, 3)) * -1
    ...
    tmp72 += ints.tmp22 * -2
    tmp72 += ints.tmp70 * -2
    r2new += einsum(tmp72, (0, 1), r1, (2, 3), (2, 0, 1, 3)) * 0.5
    del tmp72
...
def hbar_lmatvec_ip_intermediates(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T22:06:18.746751.
...
def hbar_lmatvec_ip(f=None, r1=None, r2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T22:06:19.565341.
    ...
    tmp9 += ints.tmp44
    tmp10 = einsum(r2, (0, 1, 2), tmp9, (1, 3, 2, 4), (3, 0, 4)) * -1
    del tmp9
    tmp12 += tmp10 * -1
    del tmp10
    tmp11 = np.copy(f.ov)
    ...
    r2new += einsum(tmp17, (0, 1, 2, 3), r1, (0,), (1, 2, 3))
    del tmp17
...
def hbar_lmatvec_ea_intermediates(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T22:07:44.560135.
...
def hbar_lmatvec_ea(f=None, r1=None, r2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T22:07:45.167219.
    ...
    tmp25 += tmp8 * 0.5
    del tmp8
    r2new += einsum(tmp25, (0,), v.oovv, (1, 0, 2, 3), (2, 3, 1))
    del tmp25
...
def hbar_lmatvec_ee_intermediates(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T22:10:11.396712.
...
def hbar_lmatvec_ee(f=None, r1=None, r2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T22:10:13.560895.
    ...
    tmp3 += ints.tmp36
    tmp3 += np.transpose(v.ovov, (0, 2, 3, 1)) * -1
    tmp4 = einsum(t1, (0, 1), r2, (2, 3, 4, 1), (2, 3, 0, 4))
    r1new += einsum(tmp4, (0, 1, 2, 3), tmp3, (0, 2, 3, 4), (1, 4)) * -1
    del tmp3
    tmp5 = np.copy(ints.tmp29)
    tmp5 += np.transpose(v.ovoo, (0, 2, 3, 1)) * -1
    tmp6 = einsum(t1, (0, 1), tmp4, (2, 3, 4, 1), (2, 3, 0, 4))
    r1new += einsum(tmp6, (0, 1, 2, 3), tmp5, (1, 3, 2, 4), (0, 4)) * -0.5
    ...
    del tmp7
    tmp8 = einsum(r1, (0, 1), t2, (2, 0, 3, 1), (2, 3)) * 2
    tmp8 += einsum(tmp4, (0, 1, 2, 3), t2, (1, 0, 4, 3), (2, 4)) * -1
    r1new += einsum(v.oovv, (0, 1, 2, 3), tmp8, (1, 3), (0, 2)) * 0.5
    del tmp8
    ...
    tmp16 = np.copy(f.ov)
    tmp16 += ints.tmp26
    tmp15 = np.copy(tmp9) * 2
    del tmp9
    tmp15 += tmp10
    del tmp10
    r1new += einsum(tmp15, (0, 1), tmp16, (1, 2), (0, 2)) * -0.5
    r2new = einsum(r2, (0, 1, 2, 3), v.vvvv, (4, 5, 2, 3), (0, 1, 4, 5)) * 0.5
    r2new += einsum(tmp4, (0, 1, 2, 3), v.ovvv, (2, 3, 4, 5), (1, 0, 4, 5)) * -1
    tmp17 = einsum(v.ovov, (0, 1, 2, 3), r2, (4, 2, 5, 1), (4, 0, 5, 3))
    tmp22 = np.copy(tmp17) * -1
    del tmp17
    tmp18 = einsum(tmp4, (0, 1, 2, 3), v.ooov, (4, 2, 1, 5), (0, 4, 3, 5))
    tmp22 += tmp18
    del tmp18
    tmp19 = einsum(ints.tmp29, (0, 1, 2, 3), tmp4, (4, 0, 2, 5), (1, 4, 3, 5))
    tmp22 += tmp19 * -1
    del tmp19
    ...
    tmp26 += np.transpose(tmp24, (1, 0, 2, 3))
    del tmp24
    tmp25 = einsum(r2, (0, 1, 2, 3), f.vv, (4, 3), (0, 1, 4, 2))
    tmp26 += np.transpose(tmp25, (1, 0, 2, 3))
    del tmp25
    r2new += np.transpose(tmp26, (1, 0, 2, 3)) * -1
    r2new += np.transpose(tmp26, (1, 0, 3, 2))
    del tmp26
    tmp27 = einsum(r2, (0, 1, 2, 3), tmp14, (1, 4), (4, 0, 2, 3)) * -1
    del tmp14
    tmp29 = np.copy(np.transpose(tmp27, (0, 1, 3, 2)))
    del tmp27
    tmp28 = einsum(tmp15, (0, 1), v.oovv, (2, 1, 3, 4), (2, 0, 3, 4)) * -0.5
    del tmp15
    ...
    del tmp30
    tmp31 = einsum(tmp16, (0, 1), tmp4, (2, 3, 0, 4), (2, 3, 1, 4))
    del tmp4, tmp16
    tmp32 += np.transpose(tmp31, (1, 0, 2, 3)) * -1
    del tmp31
    r2new += tmp32
    ...
    tmp36 += v.oooo * -0.5
    r2new += einsum(tmp36, (0, 1, 2, 3), r2, (0, 1, 4, 5), (2, 3, 4, 5)) * -1
    del tmp36
    tmp37 = einsum(t2, (0, 1, 2, 3), r2, (4, 5, 2, 3), (4, 5, 0, 1)) * -0.5
    tmp37 += np.transpose(tmp6, (0, 1, 3, 2))
    del tmp6
