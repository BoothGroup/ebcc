...
https://github.com/obackhouse/albert
  ...
  * date: 2024-10-20T09:35:50.045203
...
def energy(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:36:03.263704.
...
def update_amps(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:37:48.576912.
    ...
    tmp11 += einsum(tmp10, (0, 1, 2, 3), t1, (0, 3), (2, 1)) * 2
    del tmp10
    ...
    del tmp12
    tmp13 = einsum(tmp8, (0, 1), t2, (2, 0, 3, 4), (1, 2, 3, 4))
    del tmp8
    tmp18 = np.copy(tmp13)
    del tmp13
    ...
    del tmp15
    tmp17 = einsum(tmp16, (0, 1, 2, 3), t1, (0, 4), (1, 2, 3, 4))
    del tmp16
    ...
    tmp21 = einsum(t1, (0, 1), tmp20, (2, 3, 1, 4), (0, 2, 3, 4))
    tmp22 = einsum(tmp21, (0, 1, 2, 3), t1, (2, 4), (0, 1, 4, 3))
    del tmp21
    t2new += tmp22 * -1
    t2new += np.transpose(tmp22, (1, 0, 3, 2)) * -1
    del tmp22
    tmp23 = einsum(t2, (0, 1, 2, 3), f.vv, (4, 3), (0, 1, 4, 2))
    tmp27 = np.copy(tmp23)
    del tmp23
    tmp27 += tmp20
    del tmp20
    tmp24 = einsum(t1, (0, 1), v.ooov, (2, 3, 4, 1), (0, 2, 3, 4))
    tmp25 = einsum(tmp24, (0, 1, 2, 3), t1, (3, 4), (0, 2, 1, 4))
    del tmp24
    tmp26 = einsum(tmp25, (0, 1, 2, 3), t1, (1, 4), (0, 2, 4, 3))
    del tmp25
    tmp27 += tmp26
    del tmp26
    t2new += np.transpose(tmp27, (0, 1, 3, 2))
    ...
    del tmp2
    tmp30 += einsum(tmp29, (0, 1, 2, 3), t1, (0, 4), (2, 1, 3, 4))
    del tmp29
...
def update_lams(f=None, l1=None, l2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:47:46.029636.
    ...
    tmp84 = einsum(f.ov, (0, 1), l1, (2, 3), (0, 3, 1, 2))
    tmp63 = einsum(v.ooov, (0, 1, 2, 3), tmp21, (4, 1, 2, 5), (4, 0, 5, 3))
    tmp84 += tmp63
    del tmp63
    tmp64 = einsum(t1, (0, 1), v.ovvv, (0, 1, 2, 3), (2, 3))
    tmp65 = einsum(l2, (0, 1, 2, 3), tmp64, (4, 1), (2, 3, 0, 4))
    del tmp64
    tmp84 += tmp65 * 2
    del tmp65
    tmp66 = einsum(v.ovvv, (0, 1, 2, 3), tmp21, (4, 5, 0, 3), (5, 4, 1, 2))
    tmp84 += tmp66 * -1
    del tmp66
    tmp67 = einsum(tmp21, (0, 1, 2, 3), tmp5, (0, 4, 2, 5), (1, 4, 3, 5))
    tmp84 += tmp67
    del tmp67
    tmp68 = np.copy(np.transpose(l2, (3, 2, 0, 1))) * -1
    tmp68 += np.transpose(l2, (2, 3, 0, 1)) * 2
    tmp70 = np.copy(np.transpose(v.ovov, (0, 2, 3, 1)))
    tmp69 = einsum(t1, (0, 1), v.ovvv, (2, 3, 4, 1), (0, 2, 3, 4))
    tmp70 += tmp69
    del tmp69
    tmp71 = einsum(tmp70, (0, 1, 2, 3), tmp68, (0, 4, 3, 5), (4, 1, 5, 2))
    del tmp70, tmp68
    tmp84 += tmp71
    del tmp71
    tmp72 = np.copy(v.oovv)
    tmp2 = einsum(t1, (0, 1), v.ovvv, (2, 1, 3, 4), (0, 2, 3, 4))
    tmp72 += np.transpose(tmp2, (0, 1, 3, 2))
    tmp73 = einsum(tmp72, (0, 1, 2, 3), l2, (4, 2, 5, 0), (5, 1, 4, 3))
    tmp84 += tmp73 * -1
    del tmp73
    tmp42 = np.copy(tmp21) * -1
    tmp42 += np.transpose(tmp21, (1, 0, 2, 3)) * 2
    tmp74 = einsum(v.ovoo, (0, 1, 2, 3), tmp42, (2, 4, 3, 5), (0, 4, 1, 5))
    tmp84 += np.transpose(tmp74, (1, 0, 3, 2)) * -1
    del tmp74
    tmp75 = np.copy(tmp5) * 2
    tmp75 += np.transpose(tmp5, (0, 2, 1, 3)) * -1
    tmp76 = einsum(tmp21, (0, 1, 2, 3), tmp75, (1, 4, 2, 5), (0, 4, 3, 5))
    del tmp75
    tmp84 += tmp76 * -1
    del tmp76
    ...
    tmp78 += np.transpose(v.ovov, (0, 2, 1, 3)) * 2
    tmp79 = einsum(t1, (0, 1), tmp78, (0, 2, 1, 3), (2, 3))
    del tmp78
    tmp80 = einsum(t1, (0, 1), tmp79, (2, 1), (0, 2))
    tmp81 += tmp80 * -1
    del tmp80
    tmp82 = einsum(tmp81, (0, 1), l2, (2, 3, 0, 4), (4, 1, 2, 3))
    del tmp81
    tmp84 += np.transpose(tmp82, (0, 1, 3, 2))
    del tmp82
    tmp83 = einsum(tmp21, (0, 1, 2, 3), tmp79, (2, 4), (0, 1, 3, 4))
    tmp84 += tmp83 * -1
    del tmp83
    tmp84 += einsum(tmp79, (0, 1), l1, (2, 3), (3, 0, 2, 1))
    del tmp79
    l2new += np.transpose(tmp84, (2, 3, 0, 1))
    l2new += np.transpose(tmp84, (3, 2, 1, 0))
    del tmp84
    tmp85 = einsum(l2, (0, 1, 2, 3), f.vv, (4, 1), (2, 3, 4, 0))
    tmp94 = np.copy(tmp85)
    del tmp85
    tmp86 = einsum(l1, (0, 1), v.ovvv, (2, 3, 4, 0), (1, 2, 3, 4))
    tmp94 += tmp86
    del tmp86
    tmp87 = einsum(f.ov, (0, 1), t1, (2, 1), (0, 2))
    tmp88 = einsum(tmp87, (0, 1), l2, (2, 3, 4, 1), (0, 4, 2, 3))
    del tmp87
    tmp94 += tmp88 * -1
    del tmp88
    tmp89 = einsum(f.ov, (0, 1), tmp21, (2, 3, 0, 4), (2, 3, 1, 4))
    tmp94 += tmp89 * -1
    del tmp89
    tmp16 = einsum(t1, (0, 1), v.ooov, (2, 3, 4, 1), (0, 2, 3, 4))
    tmp90 = einsum(l2, (0, 1, 2, 3), tmp16, (2, 3, 4, 5), (4, 5, 0, 1))
    tmp94 += tmp90
    del tmp90
    tmp91 = einsum(v.ooov, (0, 1, 2, 3), tmp21, (1, 4, 2, 5), (4, 0, 5, 3))
    tmp94 += tmp91
    del tmp91
    tmp92 = einsum(tmp21, (0, 1, 2, 3), tmp5, (0, 2, 4, 5), (1, 4, 3, 5))
    tmp94 += tmp92
    del tmp92
    tmp93 = einsum(tmp72, (0, 1, 2, 3), l2, (4, 2, 0, 5), (5, 1, 4, 3))
    del tmp72
    tmp94 += tmp93 * -1
    del tmp93
    ...
    del tmp94
    tmp95 = einsum(l2, (0, 1, 2, 3), f.oo, (4, 3), (4, 2, 0, 1))
    tmp98 = np.copy(tmp95)
    del tmp95
    tmp96 = einsum(l1, (0, 1), tmp5, (1, 2, 3, 4), (2, 3, 0, 4))
    tmp98 += tmp96
    del tmp96
    tmp49 = einsum(t1, (0, 1), l1, (1, 2), (2, 0))
    tmp97 = einsum(v.ovov, (0, 1, 2, 3), tmp49, (4, 2), (4, 0, 1, 3))
    tmp98 += tmp97
    del tmp97
    ...
    del tmp101
    tmp102 = einsum(t1, (0, 1), v.ooov, (2, 3, 0, 1), (2, 3))
    tmp103 = einsum(l2, (0, 1, 2, 3), tmp102, (4, 3), (2, 4, 0, 1))
    del tmp102
    tmp104 += tmp103 * 2
    del tmp103
    ...
    tmp18 += einsum(tmp17, (0, 1, 2, 3), t1, (0, 4), (2, 1, 3, 4))
    del tmp17
    l1new += einsum(tmp18, (0, 1, 2, 3), l2, (4, 3, 0, 1), (4, 2))
    del tmp18
    tmp19 = np.copy(np.transpose(t2, (0, 1, 3, 2))) * -1
    tmp19 += t2 * 2
    tmp23 = einsum(l2, (0, 1, 2, 3), tmp19, (2, 4, 5, 1), (3, 4, 0, 5))
    tmp20 = np.copy(np.transpose(t2, (0, 1, 3, 2)))
    tmp20 += t2 * -0.5
    tmp23 += einsum(l2, (0, 1, 2, 3), tmp20, (3, 4, 5, 1), (2, 4, 0, 5)) * 2
    tmp22 = np.copy(tmp21)
    tmp22 += np.transpose(tmp21, (1, 0, 2, 3)) * -0.5
    tmp23 += einsum(tmp22, (0, 1, 2, 3), t1, (0, 4), (1, 2, 4, 3)) * 2
    del tmp22
    ...
    l1new += einsum(tmp24, (0, 1, 2, 3), tmp25, (2, 4, 1, 3), (4, 0))
    del tmp24, tmp25
    tmp27 = np.copy(np.transpose(l2, (2, 3, 0, 1)))
    tmp26 = np.copy(np.transpose(l2, (3, 2, 0, 1))) * -1
    tmp26 += np.transpose(l2, (2, 3, 0, 1)) * 2
    tmp27 += einsum(tmp26, (0, 1, 2, 3), tmp20, (0, 4, 5, 2), (1, 4, 3, 5))
    del tmp26
    l1new += einsum(v.ovvv, (0, 1, 2, 3), tmp27, (4, 0, 3, 1), (2, 4)) * 2
    del tmp27
    tmp28 = np.copy(v.ooov) * -1
    tmp28 += np.transpose(v.ooov, (0, 2, 1, 3)) * 2
    tmp28 += tmp5 * 2
    tmp28 += np.transpose(tmp5, (0, 2, 1, 3)) * -1
    tmp32 = einsum(t2, (0, 1, 2, 3), tmp28, (4, 1, 5, 3), (4, 0, 5, 2))
    del tmp28
    tmp29 = np.copy(v.ooov) * 2
    tmp29 += np.transpose(v.ooov, (0, 2, 1, 3)) * -1
    tmp29 += tmp5 * -1
    tmp29 += np.transpose(tmp5, (0, 2, 1, 3)) * 2
    del tmp5
    tmp32 += einsum(t2, (0, 1, 2, 3), tmp29, (4, 1, 5, 2), (4, 0, 5, 3))
    del tmp29
    ...
    tmp39 += tmp37 * -0.5
    del tmp37
    tmp38 = np.copy(tmp21) * -1
    tmp38 += np.transpose(tmp21, (1, 0, 2, 3)) * 2
    tmp39 += einsum(tmp38, (0, 1, 2, 3), tmp19, (1, 4, 3, 5), (0, 2, 4, 5)) * -0.5
    del tmp38
    l1new += einsum(tmp39, (0, 1, 2, 3), v.ovov, (2, 3, 1, 4), (4, 0)) * 2
    del tmp39
    tmp41 = np.copy(np.transpose(l2, (3, 2, 0, 1)))
    tmp40 = np.copy(tmp21) * 2
    tmp40 += np.transpose(tmp21, (1, 0, 2, 3)) * -1
    tmp41 += einsum(tmp40, (0, 1, 2, 3), t1, (1, 4), (0, 2, 3, 4))
    del tmp40
    l1new += einsum(v.ovvv, (0, 1, 2, 3), tmp41, (4, 0, 3, 1), (2, 4)) * -1
    del tmp41
    tmp44 = einsum(tmp42, (0, 1, 2, 3), t2, (4, 1, 5, 3), (0, 2, 4, 5))
    tmp43 = np.copy(tmp21) * 2
    tmp43 += np.transpose(tmp21, (1, 0, 2, 3)) * -1
    tmp44 += einsum(t2, (0, 1, 2, 3), tmp43, (4, 1, 5, 2), (4, 5, 0, 3))
    del tmp43
    l1new += einsum(v.ovov, (0, 1, 2, 3), tmp44, (4, 2, 0, 3), (1, 4))
    del tmp44
    l1new += einsum(tmp42, (0, 1, 2, 3), v.oovv, (0, 2, 4, 3), (4, 1)) * -1
    del tmp42
    tmp45 = np.copy(tmp35) * -0.5
    tmp45 += np.transpose(tmp35, (0, 1, 3, 2))
    del tmp35
    l1new += einsum(tmp45, (0, 1, 2, 3), v.ooov, (1, 2, 3, 4), (4, 0)) * 2
    del tmp45
    tmp46 = np.copy(np.transpose(tmp34, (1, 0, 2, 3))) * -1
    tmp46 += np.transpose(tmp34, (1, 0, 3, 2)) * 2
    del tmp34
    l1new += einsum(tmp46, (0, 1, 2, 3), v.ooov, (2, 0, 3, 4), (4, 1))
    del tmp46
    tmp48 = np.copy(v.ovvv) * -1
    tmp48 += np.transpose(v.ovvv, (0, 2, 3, 1)) * 2
    tmp47 = einsum(t1, (0, 1), l1, (2, 0), (2, 1))
    tmp47 += einsum(l2, (0, 1, 2, 3), tmp20, (3, 2, 4, 1), (0, 4)) * 2
    del tmp20
    l1new += einsum(tmp48, (0, 1, 2, 3), tmp47, (2, 1), (3, 0))
    del tmp48, tmp47
    tmp52 = np.copy(np.transpose(v.ovov, (0, 2, 3, 1))) * -1
    tmp52 += np.transpose(v.ovov, (0, 2, 1, 3)) * 2
    tmp51 = np.copy(t1) * -0.5
    tmp51 += einsum(tmp14, (0, 1, 2, 3), tmp21, (0, 1, 4, 2), (4, 3))
    del tmp21
    tmp51 += einsum(tmp19, (0, 1, 2, 3), l1, (2, 0), (1, 3)) * -0.5
    del tmp19
    tmp50 = np.copy(tmp49) * 0.5
    tmp50 += einsum(tmp14, (0, 1, 2, 3), l2, (2, 3, 0, 4), (4, 1))
    tmp51 += einsum(t1, (0, 1), tmp50, (0, 2), (2, 1))
    del tmp50
    l1new += einsum(tmp52, (0, 1, 2, 3), tmp51, (0, 2), (3, 1)) * -2
    del tmp52, tmp51
    tmp55 = np.copy(v.ooov) * 2
    tmp55 += np.transpose(v.ovoo, (0, 2, 3, 1)) * -1
    tmp54 = np.copy(tmp49)
    del tmp49
    tmp53 = einsum(tmp14, (0, 1, 2, 3), l2, (2, 3, 0, 4), (4, 1)) * 2
    del tmp14
    tmp54 += tmp53
    del tmp53
    ...
    tmp58 += einsum(t1, (0, 1), tmp57, (0, 2, 1, 3), (3, 2)) * 2
    del tmp57
    l1new += einsum(l1, (0, 1), tmp58, (0, 2), (2, 1))
    del tmp58
    tmp59 = np.copy(f.ov)
    tmp59 += tmp11
    del tmp11
    ...
    del tmp54
    tmp62 = np.copy(f.oo)
    tmp60 = np.copy(np.transpose(t2, (0, 1, 3, 2))) * 2
    tmp60 += t2 * -1
    tmp62 += einsum(v.ovov, (0, 1, 2, 3), tmp60, (2, 4, 1, 3), (4, 0))
    del tmp60
    tmp61 = np.copy(v.ooov) * -0.5
    tmp61 += np.transpose(v.ovoo, (0, 2, 3, 1))
    tmp62 += einsum(tmp61, (0, 1, 2, 3), t1, (0, 3), (1, 2)) * 2
    del tmp61
...
def make_rdm1_f(l1=None, l2=None, t1=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:48:07.308934.
...
def make_rdm2_f(l1=None, l2=None, t1=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:57:14.007015.
    ...
    rdm2.vvoo += l2 * 4
    tmp112 = einsum(l2, (0, 1, 2, 3), t1, (3, 4), (2, 0, 1, 4))
    rdm2.vvov = np.copy(np.transpose(tmp112, (1, 2, 0, 3))) * 4
    rdm2.vvov += np.transpose(tmp112, (2, 1, 0, 3)) * -2
    rdm2.vvvo = np.copy(np.transpose(tmp112, (1, 2, 3, 0))) * -2
    rdm2.vvvo += np.transpose(tmp112, (2, 1, 3, 0)) * 4
    ...
    tmp113 = einsum(t2, (0, 1, 2, 3), l2, (4, 5, 1, 0), (4, 5, 3, 2))
    tmp115 = np.copy(np.transpose(tmp113, (1, 0, 3, 2)))
    tmp114 = einsum(tmp112, (0, 1, 2, 3), t1, (0, 4), (2, 1, 3, 4))
    del tmp112
    tmp115 += np.transpose(tmp114, (1, 0, 3, 2))
    rdm2.vvvv = np.copy(np.transpose(tmp115, (0, 1, 3, 2))) * -2
    rdm2.vvvv += tmp115 * 2
    del tmp115
    ...
    tmp77 += t2
    tmp78 = einsum(l2, (0, 1, 2, 3), tmp77, (2, 4, 1, 5), (4, 3, 5, 0))
    del tmp77
    rdm2.ovov += np.transpose(tmp78, (0, 3, 1, 2)) * 2
    tmp9 = np.copy(np.transpose(t2, (0, 1, 3, 2))) * -1
    tmp9 += t2 * 2
    tmp79 = einsum(l2, (0, 1, 2, 3), tmp9, (3, 4, 1, 5), (4, 2, 5, 0))
    rdm2.ovov += np.transpose(tmp79, (0, 3, 1, 2)) * -2
    tmp80 = np.copy(tmp4)
    tmp80 += np.transpose(tmp4, (1, 0, 2, 3)) * -1
    tmp81 = einsum(tmp80, (0, 1, 2, 3), t1, (1, 4), (0, 2, 3, 4))
    del tmp80
    ...
    tmp83 = einsum(t2, (0, 1, 2, 3), tmp60, (0, 1, 4, 3), (4, 2))
    tmp84 += tmp83
    del tmp83
    ...
    tmp85 = einsum(tmp4, (0, 1, 2, 3), t1, (0, 4), (1, 2, 3, 4))
    ...
    tmp50 = einsum(tmp43, (0, 1, 2, 3), t2, (4, 0, 5, 2), (1, 4, 3, 5))
    rdm2.ovvo += np.transpose(tmp50, (1, 2, 3, 0)) * 4
    tmp52 = np.copy(np.transpose(l2, (3, 2, 0, 1))) * -1
    tmp52 += np.transpose(l2, (2, 3, 0, 1))
    tmp53 = einsum(t2, (0, 1, 2, 3), tmp52, (1, 4, 2, 5), (4, 0, 5, 3))
    del tmp52
    rdm2.ovvo += np.transpose(tmp53, (1, 2, 3, 0)) * -2
    ...
    rdm2.voov += np.transpose(tmp50, (2, 1, 0, 3)) * 2
    tmp91 = einsum(t2, (0, 1, 2, 3), l1, (4, 1), (0, 4, 2, 3))
    tmp98 = np.copy(tmp91)
    tmp98 += einsum(t1, (0, 1), tmp82, (2, 3), (0, 2, 1, 3))
    del tmp82
    tmp92 = np.copy(np.transpose(t2, (0, 1, 3, 2))) * 2
    tmp92 += t2 * -1
    tmp93 = einsum(l2, (0, 1, 2, 3), tmp92, (3, 4, 5, 1), (4, 2, 5, 0))
    del tmp92
    tmp96 = np.copy(np.transpose(tmp93, (1, 0, 3, 2)))
    tmp94 = np.copy(np.transpose(t2, (0, 1, 3, 2)))
    tmp94 += t2 * -1
    tmp95 = einsum(l2, (0, 1, 2, 3), tmp94, (2, 4, 5, 1), (4, 3, 5, 0))
    del tmp94
    tmp96 += np.transpose(tmp95, (1, 0, 3, 2)) * -1
    ...
    del tmp98
    tmp99 = einsum(t2, (0, 1, 2, 3), tmp4, (1, 0, 4, 5), (4, 5, 3, 2))
    tmp100 = np.copy(tmp99)
    tmp100 += einsum(t1, (0, 1), tmp61, (2, 3), (0, 2, 1, 3)) * 2
    rdm2.ovvv += tmp100 * 2
    rdm2.ovvv += np.transpose(tmp100, (0, 1, 3, 2)) * -2
    del tmp100
    tmp101 = einsum(t1, (0, 1), tmp86, (0, 2, 3, 4), (2, 3, 1, 4))
    rdm2.ovvv += tmp101 * 2
    rdm2.ovvv += np.transpose(tmp101, (0, 1, 3, 2)) * -2
    del tmp101
    rdm2.ovvv += tmp91 * 2
    rdm2.ovvv += np.transpose(tmp99, (0, 1, 3, 2)) * -2
    tmp102 = einsum(tmp67, (0, 1, 2, 3), t1, (0, 4), (1, 2, 4, 3))
    rdm2.ovvv += tmp102 * -2
    tmp104 = np.copy(tmp65)
    tmp104 += tmp86
    tmp103 = einsum(t2, (0, 1, 2, 3), tmp60, (1, 4, 3, 5), (4, 0, 5, 2))
    del tmp60
    tmp104 += tmp103 * -1
    del tmp103
    ...
    rdm2.ovvv += tmp105 * -2
    del tmp105
    rdm2.ovvv += einsum(t1, (0, 1), tmp84, (2, 3), (0, 2, 1, 3)) * 2
    tmp108 = np.copy(tmp91)
    tmp106 = np.copy(tmp86)
    tmp106 += np.transpose(tmp95, (1, 0, 3, 2))
    del tmp95
    tmp106 += np.transpose(tmp93, (1, 0, 3, 2)) * -1
    del tmp93
    tmp107 = einsum(tmp106, (0, 1, 2, 3), t1, (0, 4), (1, 2, 3, 4))
    del tmp106
    tmp108 += np.transpose(tmp107, (0, 1, 3, 2))
    del tmp107
    rdm2.vovv = np.copy(np.transpose(tmp108, (1, 0, 2, 3))) * -2
    rdm2.vovv += np.transpose(tmp108, (1, 0, 3, 2)) * 2
    del tmp108
    tmp109 = np.copy(tmp99)
    tmp109 += einsum(t1, (0, 1), tmp84, (2, 3), (0, 2, 1, 3))
    del tmp84
    rdm2.vovv += np.transpose(tmp109, (1, 0, 2, 3)) * -2
    ...
    del tmp111
    rdm2.vovv += einsum(t1, (0, 1), tmp90, (2, 3), (2, 0, 3, 1)) * 4
    del tmp90
    tmp10 = einsum(tmp9, (0, 1, 2, 3), l1, (2, 0), (1, 3))
    del tmp9
    ...
    tmp31 = einsum(tmp0, (0, 1, 2, 3), l2, (2, 3, 0, 4), (4, 1))
    del tmp0
    tmp32 += tmp31
    del tmp31
    ...
    tmp37 = einsum(t1, (0, 1), tmp2, (2, 3), (2, 0, 3, 1))
    ...
    tmp29 += t2 * 2
    tmp39 = einsum(tmp29, (0, 1, 2, 3), l1, (2, 0), (1, 3)) * 0.5
    tmp41 += tmp39 * -1
    del tmp39
    ...
    tmp41 += tmp40
    del tmp40
    rdm2.oovo += einsum(tmp41, (0, 1), delta.oo, (2, 3), (0, 2, 1, 3)) * -4
    del tmp41
    tmp35 = np.copy(tmp2)
    tmp35 += tmp1
    rdm2.oovo += einsum(tmp35, (0, 1), t1, (2, 3), (2, 1, 3, 0)) * -2
    tmp8 = einsum(t1, (0, 1), tmp2, (0, 2), (2, 1))
    tmp11 = np.copy(tmp8)
    tmp11 += tmp10 * -1
    ...
    tmp22 = np.copy(tmp16)
    tmp17 = einsum(t1, (0, 1), tmp5, (0, 2, 3, 4), (2, 4, 3, 1))
    tmp22 += tmp17
    tmp22 += tmp19
    tmp22 += tmp21 * -1
    ...
    del tmp35
    tmp42 = einsum(tmp2, (0, 1), t2, (2, 0, 3, 4), (1, 2, 3, 4))
    del tmp2
    tmp48 = np.copy(tmp42)
    tmp44 = einsum(t2, (0, 1, 2, 3), tmp43, (1, 4, 2, 5), (4, 0, 5, 3))
    del tmp43
    tmp45 = einsum(tmp44, (0, 1, 2, 3), t2, (4, 0, 5, 2), (1, 4, 3, 5))
    del tmp44
    tmp48 += np.transpose(tmp45, (1, 0, 3, 2)) * -1
    tmp46 = np.copy(tmp16)
    tmp46 += tmp19
    del tmp19
    tmp46 += tmp21 * -1
    ...
    tmp49 = einsum(tmp17, (0, 1, 2, 3), t1, (0, 4), (1, 2, 4, 3))
    del tmp17
    tmp55 = np.copy(tmp49)
    del tmp49
    tmp51 = einsum(tmp50, (0, 1, 2, 3), t2, (4, 0, 5, 2), (1, 4, 3, 5))
    del tmp50
    tmp55 += np.transpose(tmp51, (1, 0, 3, 2)) * 2
    ...
    del tmp55
    tmp56 = einsum(t2, (0, 1, 2, 3), tmp3, (1, 0, 4, 5), (4, 5, 3, 2))
    del tmp3
    tmp59 = np.copy(tmp56)
    tmp57 = einsum(tmp5, (0, 1, 2, 3), t2, (0, 1, 4, 5), (2, 3, 4, 5))
    del tmp5
    tmp59 += tmp57
    tmp58 = einsum(tmp23, (0, 1, 2, 3), t1, (0, 4), (1, 2, 4, 3))
    del tmp23
    tmp59 += tmp58
    del tmp58
    rdm2.oovv += tmp59 * 2
    ...
    del tmp63
    tmp64 += einsum(t1, (0, 1), tmp15, (2, 3), (0, 2, 1, 3)) * 2
    del tmp15
    rdm2.oovv += tmp64 * -4
    ...
    rdm2.oovv += tmp57 * 2
    del tmp57
    tmp71 = np.copy(np.transpose(tmp45, (1, 0, 3, 2))) * -1
    del tmp45
    tmp69 = np.copy(tmp25)
    del tmp25
    tmp69 += tmp21 * -1
    ...
    del tmp70
    tmp71 += einsum(t1, (0, 1), tmp10, (2, 3), (0, 2, 1, 3))
    del tmp10
    rdm2.oovv += tmp71 * 2
    ...
    tmp76 += tmp8 * -1
    del tmp8
    rdm2.oovv += einsum(t1, (0, 1), tmp76, (2, 3), (2, 0, 3, 1)) * 2
    del tmp76
...
def hbar_matvec_ip_intermediates(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:58:37.803689.
...
def hbar_matvec_ip(f=None, r1=None, r2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:58:38.428209.
    ...
    tmp11 += ints.tmp42 * -1
    del ints.tmp42
    r2new += einsum(tmp11, (0, 1, 2, 3), r1, (2,), (1, 0, 3))
    del tmp11
    tmp12 = np.copy(f.oo)
    tmp12 += ints.tmp0
    del ints.tmp0
...
def hbar_matvec_ea_intermediates(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:59:45.381566.
...
def hbar_matvec_ea(f=None, r1=None, r2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:59:45.877660.
    ...
    r2new += einsum(tmp9, (0, 1, 2), tmp10, (3, 0, 4, 2), (4, 1, 3)) * 2
    del tmp9, tmp10
    ...
    del tmp15
    tmp16 = einsum(r1, (0,), f.ov, (1, 0), (1,)) * 0.5
    tmp16 += tmp5 * -1
    del tmp5
...
def hbar_lmatvec_ip_intermediates(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T10:03:24.822339.
...
def hbar_lmatvec_ip(f=None, r1=None, r2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T10:03:26.326481.
    ...
    r2new += einsum(r2, (0, 1, 2), tmp10, (0, 3, 2, 4), (3, 1, 4))
    del tmp10
    ...
    tmp12 += t2
    tmp13 = einsum(tmp12, (0, 1, 2, 3), r2, (0, 1, 2), (3,))
    del tmp12
    r2new += einsum(v.ovov, (0, 1, 2, 3), tmp13, (3,), (0, 2, 1)) * -2
    del tmp13
    tmp14 = np.copy(f.oo)
...
def hbar_lmatvec_ea_intermediates(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T10:08:01.221087.
...
def hbar_lmatvec_ea(f=None, r1=None, r2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T10:08:02.517508.
    ...
    r2new += einsum(tmp19, (0, 1, 2, 3), tmp2, (0, 4, 2), (3, 4, 1)) * 2
    del tmp19
    ...
    tmp24 += t2 * -0.5
    tmp25 = einsum(tmp24, (0, 1, 2, 3), r2, (3, 2, 0), (1,))
    del tmp24
    ...
    r1new += einsum(tmp8, (0, 1), tmp9, (0, 2, 1), (2,)) * 2
    del tmp8, tmp9
