 ...
 * date: 2024-11-27T09:30:02.942183
...
def make_rdm1_f(l2=None, t2=None, δ=None, **kwargs):
    ...
    tmp1 += t2 * -0.5
    rdm1.vv = einsum(l2, (0, 1, 2, 3), tmp1, (2, 3, 1, 4), (0, 4)) * 4
    del tmp1
...
def hbar_matvec_ip(f=None, ints=None, r1=None, r2=None, v=None, **kwargs):
    ...
    r1new += einsum(r2, (0, 1, 2), ints.tmp0, (0, 3, 1, 2), (3,)) * 2
...
def hbar_matvec_ea_intermediates(f=None, t2=None, v=None, **kwargs):
    ...
    tmp2 = einsum(t2, (0, 1, 2, 3), tmp1, (0, 1, 3, 4), (2, 4))
    del tmp1
    tmp3 += tmp2 * -1
