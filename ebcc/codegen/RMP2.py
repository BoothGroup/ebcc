...
def hbar_matvec_ee_intermediates(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-16T23:14:07.179359.
    ...
    tmp13 = einsum(v.ovov, (0, 1, 2, 3), t2, (4, 2, 1, 3), (4, 0))
    tmp11 = einsum(v.ovov, (0, 1, 2, 3), t2, (4, 2, 3, 1), (4, 0))
...
def hbar_matvec_ee(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-16T23:14:07.183021.
    ...
    ints = kwargs["ints"]
    tmp10 = einsum(r2, (0, 1, 2, 3), f.vv, (4, 3), (0, 1, 4, 2))
    tmp11 = einsum(r1, (0, 1), v.ovvv, (2, 3, 4, 1), (0, 2, 3, 4))
    tmp2 = v.ovov.transpose((0, 2, 3, 1)).copy() * -0.5
    tmp2 += v.ovov.transpose((0, 2, 1, 3))
    tmp8 = einsum(f.oo, (0, 1), r2, (2, 1, 3, 4), (0, 2, 3, 4))
    tmp9 = einsum(v.ooov, (0, 1, 2, 3), r1, (1, 4), (0, 2, 4, 3))
    tmp12 = tmp10.copy()
    del tmp10
    tmp12 += tmp11
    del tmp11
    ...
    tmp5 += v.oovv * -0.5
    tmp3 = einsum(r1, (0, 1), tmp2, (0, 2, 1, 3), (2, 3)) * 2
    del tmp2
    tmp1 = v.ooov.copy() * -0.5
    tmp1 += v.ovoo.transpose((0, 2, 3, 1))
    r2new = tmp8.transpose((0, 1, 3, 2)).copy() * -1
    r2new += tmp8.transpose((1, 0, 2, 3)) * -1
    del tmp8
    r2new += tmp9 * -1
    r2new += tmp9.transpose((1, 0, 3, 2)) * -1
    del tmp9
    r2new += tmp12.transpose((0, 1, 3, 2))
    r2new += tmp12.transpose((1, 0, 2, 3))
    del tmp12
    r1new = einsum(tmp0, (0, 1, 2, 3), r2, (4, 0, 2, 1), (4, 3)) * 2
    del tmp0
    r1new += einsum(r2, (0, 1, 2, 3), tmp1, (1, 4, 0, 3), (4, 2)) * -2
    del tmp1
    r1new += einsum(tmp3, (0, 1), tmp4, (0, 2, 1, 3), (2, 3))
    del tmp3, tmp4
