 ...
 * date: 2024-12-18T11:25:24.561604
...
def update_amps(f=None, t2=None, v=None, **kwargs):
    ...
    del tmp2
    tmp3 = einsum(t2, (0, 1, 2, 3), tmp0, (4, 1, 5, 3), (0, 4, 2, 5))
    t2new += tmp3 * -2
    t2new += np.transpose(tmp3, (1, 0, 3, 2)) * -2
    del tmp3
    ...
    tmp7 += einsum(tmp6, (0, 1, 2, 3), t2, (4, 0, 5, 2), (4, 1, 5, 3)) * 2
    del tmp6
    t2new += einsum(tmp7, (0, 1, 2, 3), t2, (4, 1, 5, 3), (4, 0, 5, 2)) * 2
    del tmp7
    tmp8 = np.copy(np.transpose(v.ovov, (0, 2, 1, 3))) * -1
    tmp8 += tmp0
    del tmp0
    t2new += einsum(t2, (0, 1, 2, 3), tmp8, (4, 1, 5, 2), (0, 4, 3, 5))
    del tmp8
