...
def update_amps(f=None, v=None, nocc=None, nvir=None, t1=None, t2=None, **kwargs):
    ...
    del x5
    x6 = np.zeros((nocc[0], nocc[1], nvir[0], nvir[1]), dtype=np.float64)
    ...
    x98 = np.zeros((nocc[0], nocc[1], nvir[0], nvir[1]), dtype=np.float64)
    ...
    del x97, x100
    x101 = np.zeros((nocc[1], nocc[1], nvir[0], nvir[0]), dtype=np.float64)
    x101 += einsum(t1.bb, (0, 1), v.aabb.vvov, (2, 3, 4, 1), (0, 4, 2, 3))
    x102 = np.zeros((nocc[0], nocc[1], nocc[1], nvir[0]), dtype=np.float64)
    x102 += einsum(v.aabb.ovoo, (0, 1, 2, 3), (0, 2, 3, 1))
    x102 += einsum(x23, (0, 1, 2, 3), (0, 1, 2, 3))
    x103 = np.zeros((nocc[1], nocc[1], nvir[0], nvir[0]), dtype=np.float64)
    ...
    del x3
    x105 = np.zeros((nocc[0], nocc[0], nvir[1], nvir[1]), dtype=np.float64)
    ...
    del x105
    x106 = np.zeros((nvir[0], nvir[0], nvir[1], nvir[1]), dtype=np.float64)
    ...
    del x106
    x107 = np.zeros((nvir[1], nvir[1]), dtype=np.float64)
    ...
    del x112
    x113 = np.zeros((nocc[0], nocc[0], nocc[1], nocc[1]), dtype=np.float64)
    ...
    del x119
    x120 = np.zeros((nocc[0], nvir[0], nvir[1], nvir[1]), dtype=np.float64)
    ...
    del x120
    x121 = np.zeros((nocc[0], nocc[0], nocc[1], nvir[1]), dtype=np.float64)
    ...
    x127 = np.zeros((nocc[0], nocc[1], nvir[0], nvir[1]), dtype=np.float64)
