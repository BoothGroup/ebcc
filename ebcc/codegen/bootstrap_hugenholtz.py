...
def get_pdaggerq(
    ...
    if use_t2:
        ...
        energies = [x for i, x in enumerate(energies.split(",")) if i not in energies_to_remove]
        integrals = [x for i, x in enumerate(integrals.split(",")) if i not in integrals_to_remove]
