...
https://github.com/obackhouse/albert
  ...
  * date: 2024-09-28T13:47:52.993832
...
def energy(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T13:47:53.243429.
...
def update_amps(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T13:47:56.820332.
    ...
    tmp11 = einsum(t2, (0, 1, 2, 3), tmp4, (1, 4), (4, 0, 2, 3))
    ...
    del tmp23
    tmp15 = np.copy(np.transpose(tmp11, (0, 1, 3, 2))) * -1
    del tmp11
...
def update_lams(f=None, l1=None, l2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T13:48:06.347569.
    ...
    tmp35 = einsum(t1, (0, 1), f.ov, (2, 1), (2, 0))
    ...
    tmp2 = einsum(t1, (0, 1), tmp0, (2, 3, 4, 1), (3, 2, 4, 0))
    tmp33 = einsum(l1, (0, 1), tmp6, (1, 2, 3, 4), (2, 3, 0, 4))
    tmp31 = einsum(f.ov, (0, 1), tmp0, (2, 3, 0, 4), (2, 3, 1, 4))
    tmp32 = einsum(l2, (0, 1, 2, 3), tmp23, (1, 4), (2, 3, 0, 4))
    tmp43 = einsum(l2, (0, 1, 2, 3), f.oo, (4, 3), (4, 2, 0, 1))
    tmp44 = einsum(l1, (0, 1), v.ovvv, (2, 0, 3, 4), (1, 2, 3, 4))
    tmp27 = einsum(tmp0, (0, 1, 2, 3), v.ooov, (4, 2, 1, 5), (0, 4, 3, 5))
    tmp29 = einsum(tmp28, (0, 1, 2, 3), l2, (4, 2, 5, 0), (1, 5, 3, 4))
    del tmp28
    tmp41 = einsum(tmp7, (0, 1), tmp0, (2, 3, 0, 4), (2, 3, 4, 1))
    tmp40 = einsum(f.vv, (0, 1), l2, (2, 1, 3, 4), (3, 4, 0, 2))
    tmp46 = einsum(tmp7, (0, 1), t1, (2, 1), (2, 0))
    tmp36 = einsum(tmp35, (0, 1), l2, (2, 3, 4, 1), (0, 4, 2, 3))
    del tmp35
    tmp37 = einsum(v.oovv, (0, 1, 2, 3), tmp18, (4, 1), (4, 0, 2, 3))
    tmp38 = einsum(l2, (0, 1, 2, 3), tmp25, (4, 3), (2, 4, 0, 1))
    ...
    tmp15 = np.copy(np.transpose(tmp1, (1, 0, 3, 2))) * -0.5
    tmp15 += np.transpose(tmp2, (0, 1, 3, 2))
    tmp48 = einsum(tmp5, (0, 1, 2, 3), tmp0, (0, 4, 2, 5), (4, 1, 5, 3)) * -1
    del tmp5
    tmp49 = np.copy(v.oooo) * 0.5
    tmp49 += np.transpose(tmp11, (2, 3, 1, 0)) * -1
    del tmp11
    tmp34 = np.copy(tmp31) * -1
    del tmp31
    tmp34 += tmp32
    del tmp32
    tmp34 += np.transpose(tmp33, (1, 0, 2, 3))
    del tmp33
    tmp45 = np.copy(np.transpose(tmp43, (0, 1, 3, 2))) * -1
    del tmp43
    tmp45 += np.transpose(tmp44, (0, 1, 3, 2))
    del tmp44
    tmp30 = einsum(tmp7, (0, 1), l1, (2, 3), (3, 0, 2, 1))
    del tmp7
    tmp30 += tmp27
    del tmp27
    tmp30 += np.transpose(tmp29, (1, 0, 3, 2))
    del tmp29
    tmp42 = np.copy(np.transpose(tmp40, (1, 0, 2, 3))) * -1
    del tmp40
    tmp42 += tmp41
    del tmp41
    tmp47 = einsum(tmp46, (0, 1), l2, (2, 3, 4, 0), (4, 1, 2, 3))
    del tmp46
    tmp39 = np.copy(np.transpose(tmp36, (0, 1, 3, 2))) * -1
    del tmp36
    tmp39 += np.transpose(tmp37, (0, 1, 3, 2)) * -1
    del tmp37
    ...
    tmp21 += einsum(t2, (0, 1, 2, 3), tmp0, (1, 0, 4, 3), (4, 2)) * 0.5
    ...
    l2new += einsum(tmp2, (0, 1, 2, 3), v.oovv, (3, 2, 4, 5), (4, 5, 1, 0)) * 0.5
    l2new += np.transpose(tmp30, (2, 3, 0, 1))
    l2new += np.transpose(tmp30, (3, 2, 0, 1)) * -1
    l2new += np.transpose(tmp30, (2, 3, 1, 0)) * -1
    l2new += np.transpose(tmp30, (3, 2, 1, 0))
    del tmp30
    ...
    del tmp39
    l2new += np.transpose(tmp42, (2, 3, 0, 1)) * -1
    l2new += np.transpose(tmp42, (3, 2, 0, 1))
    del tmp42
    l2new += np.transpose(tmp45, (2, 3, 0, 1))
    l2new += np.transpose(tmp45, (2, 3, 1, 0)) * -1
    del tmp45
    ...
    del tmp16
    l1new += einsum(v.ovvv, (0, 1, 2, 3), tmp17, (1, 3), (2, 0)) * 0.5
    del tmp17
    l1new += einsum(tmp21, (0, 1), v.oovv, (2, 0, 3, 1), (3, 2)) * -1
    del tmp21
...
def make_rdm1_f(l1=None, l2=None, t1=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T13:48:07.033005.
...
def make_rdm2_f(l1=None, l2=None, t1=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T13:48:17.810472.
    ...
    tmp20 = einsum(tmp19, (0, 1, 2, 3), t2, (4, 0, 5, 2), (4, 1, 5, 3))
    ...
    rdm2.ooov += einsum(tmp8, (0, 1), delta.oo, (2, 3), (2, 0, 3, 1)) * -0.5
    del tmp8
...
def hbar_matvec_ip_intermediates(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T13:48:23.881122.
...
def hbar_matvec_ip(f=None, r1=None, r2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T13:48:23.898255.
...
def hbar_matvec_ea_intermediates(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T13:48:30.063369.
...
def hbar_matvec_ea(f=None, r1=None, r2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T13:48:30.078244.
    ...
    tmp8 = einsum(tmp7, (0, 1, 2), t1, (0, 3), (1, 2, 3))
    del tmp7
    tmp6 = einsum(r2, (0, 1, 2), v.ovov, (3, 1, 2, 4), (3, 0, 4))
    tmp5 = einsum(ints.tmp22, (0, 1, 2, 3), r2, (4, 3, 1), (0, 2, 4))
    del ints.tmp22
    tmp10 = einsum(r2, (0, 1, 2), tmp9, (1, 3), (2, 0, 3)) * -0.5
    del tmp9
    tmp0 = np.copy(f.ov)
    tmp0 += ints.tmp2
    del ints.tmp2
...
def hbar_matvec_ee_intermediates(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T13:48:44.284955.
...
def hbar_matvec_ee(f=None, r1=None, r2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T13:48:44.311172.
    ...
    ints = kwargs["ints"]
    tmp29 = einsum(r1, (0, 1), f.ov, (2, 1), (2, 0))
    tmp6 = einsum(r2, (0, 1, 2, 3), v.oovv, (4, 1, 2, 3), (0, 4))
    tmp27 = np.copy(f.oo)
    tmp27 += ints.tmp0
    tmp27 += np.transpose(ints.tmp9, (1, 0)) * 0.5
    tmp30 = np.copy(np.transpose(tmp29, (1, 0)))
    del tmp29
    tmp30 += tmp6 * 0.5
    tmp36 = einsum(r2, (0, 1, 2, 3), v.oovv, (0, 1, 4, 3), (2, 4))
    tmp34 = einsum(f.ov, (0, 1), r2, (2, 3, 4, 1), (0, 2, 3, 4))
    tmp12 = einsum(v.ooov, (0, 1, 2, 3), r1, (1, 3), (0, 2))
    ...
    del tmp27
    tmp31 = einsum(tmp30, (0, 1), t2, (2, 1, 3, 4), (0, 2, 3, 4)) * -1
    del tmp30
    tmp26 = einsum(r1, (0, 1), ints.tmp33, (2, 3, 4, 1), (2, 0, 3, 4))
    del ints.tmp33
    tmp33 = einsum(r1, (0, 1), ints.tmp23, (0, 2, 3, 4), (2, 3, 4, 1))
    del ints.tmp23
    tmp37 = einsum(tmp36, (0, 1), t2, (2, 3, 4, 1), (2, 3, 0, 4)) * -1
    del tmp36
    tmp35 = einsum(tmp34, (0, 1, 2, 3), t1, (0, 4), (1, 2, 3, 4))
    del tmp34
    tmp20 = einsum(v.ooov, (0, 1, 2, 3), r1, (2, 4), (0, 1, 4, 3))
    tmp21 = einsum(f.vv, (0, 1), r2, (2, 3, 4, 1), (2, 3, 0, 4))
    tmp23 = einsum(ints.tmp37, (0, 1, 2, 3), r1, (2, 4), (0, 1, 3, 4))
    del ints.tmp37
    tmp24 = einsum(ints.tmp10, (0, 1), r2, (2, 3, 4, 1), (2, 3, 0, 4))
    tmp9 = einsum(r1, (0, 1), v.ovvv, (0, 2, 3, 1), (2, 3))
    tmp13 = einsum(t2, (0, 1, 2, 3), tmp12, (1, 4), (0, 4, 2, 3)) * -1
    del tmp12
    tmp11 = einsum(v.ovvv, (0, 1, 2, 3), r1, (4, 1), (4, 0, 2, 3))
    ...
    tmp19 += tmp18 * -1
    del tmp18
    tmp32 = np.copy(np.transpose(tmp26, (0, 1, 3, 2))) * -0.5
    del tmp26
    tmp32 += np.transpose(tmp28, (0, 1, 3, 2))
    del tmp28
    ...
    del tmp23
    tmp25 += np.transpose(tmp24, (1, 0, 2, 3)) * -0.5
    del tmp24
    tmp10 = einsum(tmp9, (0, 1), t2, (2, 3, 4, 1), (2, 3, 4, 0)) * -1
    del tmp9
    tmp14 = np.copy(np.transpose(tmp11, (0, 1, 3, 2))) * -1
    del tmp11
    ...
    del tmp10
    r2new += tmp14 * -1
    r2new += np.transpose(tmp14, (1, 0, 2, 3))
    del tmp14
    r2new += tmp19 * -1
    ...
    r2new += einsum(r1, (0, 1), tmp40, (2, 3), (0, 2, 1, 3)) * -1
...
def hbar_lmatvec_ip_intermediates(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T13:48:52.662140.
...
def hbar_lmatvec_ip(f=None, r1=None, r2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T13:48:52.692552.
...
def hbar_lmatvec_ea_intermediates(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T13:49:01.845164.
...
def hbar_lmatvec_ea(f=None, r1=None, r2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T13:49:01.868516.
    ...
    del tmp3, tmp4
    r1new += einsum(r2, (0, 1, 2), tmp5, (2, 1), (0,)) * -0.5
    del tmp5
...
def hbar_lmatvec_ee_intermediates(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T13:49:17.221135.
...
def hbar_lmatvec_ee(f=None, r1=None, r2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T13:49:17.259450.
    ...
    tmp18 = einsum(v.ovov, (0, 1, 2, 3), r2, (4, 2, 5, 1), (4, 0, 5, 3))
    tmp17 = einsum(ints.tmp36, (0, 1, 2, 3), r2, (4, 0, 5, 2), (1, 4, 3, 5))
    tmp29 = einsum(tmp4, (0, 1, 2, 3), f.ov, (2, 4), (0, 1, 4, 3))
    tmp30 = einsum(v.oovv, (0, 1, 2, 3), tmp0, (4, 3), (0, 1, 4, 2)) * -1
    tmp27 = einsum(tmp26, (0, 1), r2, (2, 0, 3, 4), (1, 2, 3, 4)) * -1
    del tmp26
    tmp25 = einsum(v.oovv, (0, 1, 2, 3), tmp10, (4, 1), (4, 0, 2, 3)) * -1
    tmp21 = einsum(v.ooov, (0, 1, 2, 3), r1, (2, 4), (0, 1, 4, 3))
    tmp22 = einsum(f.vv, (0, 1), r2, (2, 3, 4, 1), (2, 3, 0, 4))
    tmp9 = einsum(r1, (0, 1), t1, (2, 1), (0, 2))
    tmp19 = einsum(r1, (0, 1), f.ov, (2, 3), (2, 0, 3, 1))
    tmp19 += tmp17
    del tmp17
    tmp19 += tmp18 * -1
    del tmp18
    ...
    tmp31 += tmp30 * -0.5
    del tmp30
    tmp24 = einsum(ints.tmp17, (0, 1), r2, (2, 3, 4, 0), (2, 3, 1, 4))
    ...
    del tmp27
    tmp23 = np.copy(np.transpose(tmp21, (1, 0, 2, 3))) * -1
    del tmp21
    ...
    tmp8 += einsum(tmp4, (0, 1, 2, 3), t2, (1, 0, 4, 3), (2, 4)) * -0.5
    tmp11 = np.copy(tmp9)
    del tmp9
    tmp11 += tmp10 * 0.5
    del tmp10
    ...
    del tmp23
    r2new += np.transpose(tmp24, (1, 0, 2, 3)) * -0.5
    r2new += np.transpose(tmp24, (1, 0, 3, 2)) * 0.5
    del tmp24
    r2new += tmp28
    ...
    del tmp31
    r2new += einsum(r2, (0, 1, 2, 3), tmp32, (0, 1, 4, 5), (4, 5, 2, 3)) * -0.25
    del tmp32
    ...
    del tmp4, tmp3
    r1new += einsum(tmp5, (0, 1, 2, 3), tmp6, (1, 3, 2, 4), (0, 4)) * -0.5
    del tmp5
    r1new += einsum(tmp7, (0, 1), r2, (2, 0, 3, 1), (2, 3)) * -0.5
    del tmp7
    r1new += einsum(tmp8, (0, 1), v.oovv, (2, 0, 3, 1), (2, 3))
    del tmp8
    r1new += einsum(tmp6, (0, 1, 2, 3), tmp11, (0, 2), (1, 3)) * -1
    del tmp6
    r1new += einsum(tmp12, (0, 1, 2, 3), r1, (0, 2), (1, 3))
    del tmp12
    r1new += einsum(tmp13, (0, 1), r1, (2, 0), (2, 1)) * -1
    del tmp13
    r1new += einsum(r1, (0, 1), tmp14, (0, 2), (2, 1)) * -1
    del tmp14
    r1new += einsum(tmp15, (0, 1), tmp11, (2, 0), (2, 1)) * -1
    del tmp11, tmp15
