...
https://github.com/obackhouse/albert
  ...
  * date: 2024-10-20T09:35:50.438665
...
def energy(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:35:51.730199.
...
def update_amps(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:36:16.467743.
    ...
    del tmp6
    tmp7 = einsum(t2, (0, 1, 2, 3), f.vv, (4, 3), (0, 1, 4, 2))
...
def update_lams(f=None, l2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:36:50.395720.
    ...
    del tmp14
    tmp15 = einsum(l2, (0, 1, 2, 3), f.oo, (4, 3), (4, 2, 0, 1))
    l2new += np.transpose(tmp15, (3, 2, 0, 1)) * -1
    l2new += np.transpose(tmp15, (3, 2, 1, 0))
    del tmp15
...
def make_rdm1_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:36:53.987557.
...
def make_rdm2_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:37:21.292423.
...
def hbar_matvec_ip_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:38:25.207549.
...
def hbar_matvec_ip(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:38:25.532895.
...
def hbar_matvec_ea_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:39:24.572211.
...
def hbar_matvec_ea(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:39:24.824442.
    ...
    tmp7 = np.copy(tmp3)
    del tmp3
    tmp4 = einsum(v.ovov, (0, 1, 2, 3), r2, (4, 1, 2), (0, 4, 3))
    tmp7 += tmp4
    del tmp4
    tmp5 = np.copy(f.vv) * 2
...
def hbar_matvec_ee_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:41:35.211949.
...
def hbar_matvec_ee(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:41:35.629813.
    ...
    tmp8 = np.copy(tmp4)
    del tmp4
    tmp5 = einsum(r1, (0, 1), ints.tmp23, (2, 3, 4, 1), (2, 0, 3, 4))
    del ints.tmp23
    tmp8 += tmp5
    del tmp5
    ...
    del tmp11
    tmp12 = einsum(r1, (0, 1), f.ov, (2, 1), (2, 0))
    tmp14 = np.copy(np.transpose(tmp12, (1, 0)))
    del tmp12
    tmp13 = einsum(r2, (0, 1, 2, 3), v.oovv, (4, 1, 2, 3), (0, 4))
    tmp14 += tmp13 * 0.5
    del tmp13
    ...
    del tmp16
    tmp17 = einsum(r1, (0, 1), v.ovvv, (0, 2, 3, 1), (2, 3))
    tmp18 = einsum(t2, (0, 1, 2, 3), tmp17, (4, 3), (0, 1, 2, 4)) * -1
    del tmp17
    r2new += tmp18
    r2new += np.transpose(tmp18, (0, 1, 3, 2)) * -1
    del tmp18
    tmp19 = einsum(r1, (0, 1), v.ovvv, (2, 1, 3, 4), (0, 2, 3, 4))
    tmp22 = np.copy(np.transpose(tmp19, (0, 1, 3, 2))) * -1
    del tmp19
    tmp20 = einsum(r1, (0, 1), v.ooov, (2, 0, 3, 1), (2, 3))
    tmp21 = einsum(t2, (0, 1, 2, 3), tmp20, (1, 4), (0, 4, 2, 3)) * -1
    del tmp20
    ...
    del tmp22
    tmp23 = einsum(r1, (0, 1), ints.tmp6, (0, 2, 3, 4), (2, 3, 4, 1))
    del ints.tmp6
    tmp26 = np.copy(tmp23)
    del tmp23
    ...
    del tmp29
    tmp30 = einsum(r1, (0, 1), ints.tmp21, (2, 3, 0, 4), (2, 3, 4, 1))
    del ints.tmp21
    tmp32 = np.copy(tmp30) * 0.5
    del tmp30
    tmp31 = einsum(ints.tmp1, (0, 1), r2, (2, 3, 4, 1), (2, 3, 0, 4))
    del ints.tmp1
    ...
    del tmp35
    r2new += einsum(r1, (0, 1), tmp34, (2, 3), (2, 0, 1, 3)) * -1
    del tmp34
...
def hbar_lmatvec_ip_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:42:19.346758.
...
def hbar_lmatvec_ip(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:42:19.639166.
...
def hbar_lmatvec_ea_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:43:03.044971.
...
def hbar_lmatvec_ea(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:43:03.240923.
    ...
    r1new = einsum(f.ov, (0, 1), tmp0, (0,), (1,)) * -0.5
...
def hbar_lmatvec_ee_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:44:22.345948.
...
def hbar_lmatvec_ee(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:44:22.703631.
    ...
    tmp2 = einsum(t2, (0, 1, 2, 3), r1, (1, 3), (0, 2))
    r1new += einsum(tmp2, (0, 1), v.oovv, (2, 0, 3, 1), (2, 3))
    del tmp2
    ...
    r1new += einsum(r2, (0, 1, 2, 3), tmp3, (1, 3, 2, 4), (0, 4)) * -1
    del tmp3
    ...
    del tmp11
    tmp12 = einsum(tmp1, (0, 1), v.oovv, (2, 1, 3, 4), (0, 2, 3, 4)) * -1
    del tmp1
    tmp14 = np.copy(np.transpose(tmp12, (0, 1, 3, 2))) * 0.5
    del tmp12
    tmp13 = einsum(r2, (0, 1, 2, 3), tmp7, (1, 4), (0, 4, 2, 3)) * -0.5
    del tmp7
    ...
    del tmp14
    tmp15 = einsum(v.oovv, (0, 1, 2, 3), tmp0, (4, 3), (0, 1, 4, 2)) * -1
    del tmp0
    r2new += tmp15 * -0.5
    r2new += np.transpose(tmp15, (0, 1, 3, 2)) * 0.5
    del tmp15
    tmp16 = einsum(r1, (0, 1), v.ovvv, (2, 1, 3, 4), (0, 2, 3, 4))
    r2new += np.transpose(tmp16, (0, 1, 3, 2))
