...
https://github.com/obackhouse/albert
  ...
  * date: 2024-10-23T10:20:49.033407
...
def energy(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:20:50.540670.
...
def update_amps(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:21:15.698310.
    ...
    t2new += np.transpose(tmp7, (1, 0, 3, 2)) * -0.5
    del tmp7
    ...
    tmp9 += einsum(v.oovv, (0, 1, 2, 3), t2, (4, 5, 2, 3), (0, 1, 4, 5))
    t2new += einsum(t2, (0, 1, 2, 3), tmp9, (0, 1, 4, 5), (4, 5, 2, 3)) * 0.25
    del tmp9
...
def update_lams(f=None, l2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:21:49.712717.
    ...
    del tmp11
    tmp12 = einsum(t2, (0, 1, 2, 3), l2, (4, 3, 0, 1), (4, 2))
...
def make_rdm1_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:21:53.237675.
...
def make_rdm2_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:22:20.405454.
...
def hbar_matvec_ip_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:23:24.747857.
...
def hbar_matvec_ip(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:23:25.104570.
    ...
    del tmp1
    tmp2 = einsum(r2, (0, 1, 2), ints.tmp0, (3, 1), (3, 0, 2))
    del ints.tmp0
    ...
    tmp5 += tmp3
    del tmp3
    tmp4 = einsum(r2, (0, 1, 2), v.ovov, (3, 2, 1, 4), (0, 3, 4))
    tmp5 += tmp4
    del tmp4
    r2new += tmp5 * -1
...
def hbar_matvec_ea_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:24:28.251357.
...
def hbar_matvec_ea(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:24:28.484461.
    ...
    del ints.tmp0
    tmp5 = einsum(r2, (0, 1, 2), tmp4, (1, 3), (2, 0, 3)) * -0.5
    del tmp4
...
def hbar_matvec_ee_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:26:55.441721.
...
def hbar_matvec_ee(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:26:55.910025.
    ...
    del tmp3
    tmp4 = einsum(v.ovvv, (0, 1, 2, 3), r1, (4, 1), (4, 0, 2, 3))
    tmp7 = np.copy(np.transpose(tmp4, (0, 1, 3, 2))) * -1
    del tmp4
    tmp5 = einsum(r1, (0, 1), v.ooov, (2, 0, 3, 1), (2, 3))
    tmp6 = einsum(tmp5, (0, 1), t2, (2, 0, 3, 4), (2, 1, 3, 4)) * -1
    del tmp5
    ...
    del tmp7
    tmp8 = einsum(ints.tmp14, (0, 1, 2, 3), r1, (1, 4), (0, 2, 3, 4))
    del ints.tmp14
    tmp12 = np.copy(tmp8)
    del tmp8
    tmp9 = einsum(ints.tmp23, (0, 1, 2, 3), r1, (4, 3), (0, 4, 1, 2))
    del ints.tmp23
    tmp12 += tmp9
    del tmp9
    ...
    tmp12 += tmp10
    del tmp10
    tmp11 = einsum(r2, (0, 1, 2, 3), ints.tmp30, (4, 1, 5, 3), (4, 0, 5, 2))
    del ints.tmp30
    tmp12 += tmp11 * -1
    del tmp11
    r2new += tmp12 * -1
    ...
    del tmp12
    tmp13 = einsum(ints.tmp16, (0, 1, 2, 3), r1, (4, 3), (0, 4, 1, 2))
    del ints.tmp16
    tmp20 = np.copy(np.transpose(tmp13, (0, 1, 3, 2))) * -0.5
    del tmp13
    tmp14 = np.copy(f.oo) * 2
    tmp14 += np.transpose(ints.tmp0, (1, 0))
    del ints.tmp0
    tmp15 = einsum(r2, (0, 1, 2, 3), tmp14, (1, 4), (0, 4, 2, 3)) * -0.5
    del tmp14
    tmp20 += np.transpose(tmp15, (1, 0, 3, 2))
    del tmp15
    tmp16 = einsum(r1, (0, 1), f.ov, (2, 1), (2, 0))
    tmp18 = np.copy(np.transpose(tmp16, (1, 0)))
    del tmp16
    tmp17 = einsum(v.oovv, (0, 1, 2, 3), r2, (4, 1, 2, 3), (4, 0))
    tmp18 += tmp17 * 0.5
    del tmp17
    ...
    del tmp21
    tmp22 = einsum(r1, (0, 1), v.ooov, (2, 3, 0, 4), (2, 3, 1, 4))
    ...
    del tmp24
    tmp25 = einsum(ints.tmp21, (0, 1, 2, 3), r1, (2, 4), (0, 1, 3, 4))
    del ints.tmp21
    tmp27 = np.copy(tmp25) * 0.5
    del tmp25
    tmp26 = einsum(ints.tmp1, (0, 1), r2, (2, 3, 4, 1), (2, 3, 0, 4))
    del ints.tmp1
    ...
    del tmp27
    tmp28 = einsum(v.ovvv, (0, 1, 2, 3), r1, (0, 3), (1, 2))
    tmp29 = einsum(tmp28, (0, 1), t2, (2, 3, 4, 1), (2, 3, 4, 0)) * -1
    del tmp28
    r2new += tmp29
    r2new += np.transpose(tmp29, (0, 1, 3, 2)) * -1
    del tmp29
    tmp30 = einsum(v.oovv, (0, 1, 2, 3), r2, (0, 1, 4, 3), (4, 2))
    tmp31 = einsum(t2, (0, 1, 2, 3), tmp30, (4, 3), (0, 1, 4, 2)) * -1
    del tmp30
    r2new += tmp31 * -0.5
    r2new += np.transpose(tmp31, (0, 1, 3, 2)) * 0.5
    del tmp31
    tmp32 = np.copy(ints.tmp28) * 0.5
    del ints.tmp28
    tmp32 += v.oooo
    r2new += einsum(r2, (0, 1, 2, 3), tmp32, (4, 5, 0, 1), (4, 5, 2, 3)) * 0.5
    del tmp32
    tmp33 = np.copy(f.ov)
    tmp33 += ints.tmp5
    tmp33 += ints.tmp13 * -0.5
    tmp33 += ints.tmp20 * -0.5
    r2new += einsum(tmp33, (0, 1), r1, (2, 3), (0, 2, 1, 3))
    r2new += einsum(r1, (0, 1), tmp33, (2, 3), (0, 2, 1, 3))
    tmp34 = np.copy(f.ov) * 2
    tmp34 += ints.tmp5 * 2
    del ints.tmp5
    tmp34 += ints.tmp13 * -1
    del ints.tmp13
    tmp34 += ints.tmp20 * -1
    del ints.tmp20
    r2new += einsum(tmp34, (0, 1), r1, (2, 3), (2, 0, 1, 3)) * -0.5
    del tmp34
    r2new += einsum(r1, (0, 1), tmp33, (2, 3), (2, 0, 1, 3)) * -1
    del tmp33
...
def hbar_lmatvec_ip_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:27:46.165052.
...
def hbar_lmatvec_ip(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:27:46.441368.
...
def hbar_lmatvec_ea_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:28:37.578751.
...
def hbar_lmatvec_ea(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:28:37.803525.
...
def hbar_lmatvec_ee_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:30:14.034248.
...
def hbar_lmatvec_ee(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-23T10:30:14.424936.
    ...
    r1new += einsum(tmp2, (0, 1), v.ovvv, (2, 0, 3, 1), (2, 3)) * 0.5
    ...
    del tmp8
    tmp11 = einsum(f.ov, (0, 1), r1, (2, 3), (0, 2, 1, 3))
    ...
    del tmp15
    tmp16 = einsum(r2, (0, 1, 2, 3), tmp7, (1, 4), (0, 4, 2, 3)) * -0.5
    del tmp7
    ...
    del tmp17
    tmp18 = einsum(tmp2, (0, 1), v.oovv, (2, 3, 4, 1), (2, 3, 0, 4)) * -1
    del tmp2
    r2new += tmp18 * -0.5
    ...
    del ints.tmp19
    tmp21 += v.oooo
    r2new += einsum(r2, (0, 1, 2, 3), tmp21, (0, 1, 4, 5), (4, 5, 2, 3)) * 0.5
    del tmp21
