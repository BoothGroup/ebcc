...
https://github.com/obackhouse/albert
  ...
  * date: 2024-08-07T20:22:42.983317
...
def energy(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-07T20:22:43.050114.
...
def update_amps(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-07T20:22:44.261030.
    ...
    tmp6 = einsum(v.oovv, (0, 1, 2, 3), t2, (4, 1, 2, 3), (4, 0))
    tmp3 = einsum(tmp2, (0, 1, 2, 3), t2, (4, 1, 5, 3), (4, 0, 5, 2))
    del tmp2
    t2new = tmp3.transpose((0, 1, 3, 2)).copy() * -1
    t2new += tmp3
    del tmp3
    ...
    del tmp6
    t2new += tmp7.transpose((1, 0, 3, 2)) * -0.5
...
def update_lams(f=None, l2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-07T20:22:45.944640.
    ...
    del tmp10
    tmp16 = v.oooo.copy()
    tmp16 += einsum(v.oovv, (0, 1, 2, 3), t2, (4, 5, 2, 3), (4, 5, 0, 1)) * 0.5
    l2new += einsum(tmp16, (0, 1, 2, 3), l2, (4, 5, 0, 1), (4, 5, 2, 3)) * 0.5
    del tmp16
    ...
    l2new += tmp2.transpose((3, 2, 1, 0)) * -1
    l2new += tmp2.transpose((2, 3, 1, 0))
    del tmp2
...
def make_rdm1_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-07T20:22:46.091890.
...
def make_rdm2_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-08-07T20:22:47.597538.
    ...
    del tmp2
    rdm2.oovv = tmp3.transpose((0, 1, 3, 2)).copy() * -1
    rdm2.oovv += tmp3
    del tmp3
    tmp0 = einsum(l2, (0, 1, 2, 3), t2, (4, 5, 0, 1), (2, 3, 4, 5))
