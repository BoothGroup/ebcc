...
https://github.com/obackhouse/albert
  ...
  * date: 2024-09-28T12:24:49.032651
...
def energy(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T12:24:49.098554.
...
def update_amps(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T12:24:50.313525.
    ...
    tmp7 = einsum(t2, (0, 1, 2, 3), v.oovv, (4, 1, 2, 3), (0, 4))
    tmp5 = einsum(v.oovv, (0, 1, 2, 3), t2, (0, 1, 4, 3), (4, 2))
    tmp9 = np.copy(v.oooo) * 2
    tmp9 += einsum(t2, (0, 1, 2, 3), v.oovv, (4, 5, 2, 3), (4, 5, 0, 1))
    tmp4 = einsum(t2, (0, 1, 2, 3), tmp3, (4, 1, 5, 3), (0, 4, 2, 5))
    del tmp3
    tmp8 = einsum(tmp7, (0, 1), t2, (2, 1, 3, 4), (2, 0, 3, 4))
    del tmp7
    tmp6 = einsum(t2, (0, 1, 2, 3), tmp5, (4, 3), (0, 1, 2, 4))
    del tmp5
    tmp2 = einsum(v.ovov, (0, 1, 2, 3), t2, (4, 2, 5, 1), (4, 0, 5, 3))
    ...
    del tmp8
    t2new += einsum(tmp9, (0, 1, 2, 3), t2, (0, 1, 4, 5), (2, 3, 4, 5)) * 0.25
    del tmp9
...
def update_lams(f=None, l2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T12:24:52.011989.
    ...
    tmp16 += einsum(t2, (0, 1, 2, 3), v.oovv, (4, 5, 2, 3), (0, 1, 4, 5)) * 0.5
    ...
    del tmp0
    l2new += np.transpose(tmp1, (2, 3, 1, 0))
    l2new += np.transpose(tmp1, (3, 2, 1, 0)) * -1
    del tmp1
    ...
    del tmp15
    l2new += einsum(l2, (0, 1, 2, 3), tmp16, (2, 3, 4, 5), (0, 1, 4, 5)) * 0.5
    del tmp16
...
def make_rdm1_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T12:24:52.162127.
...
def make_rdm2_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T12:24:53.689309.
    ...
    rdm2.oooo += einsum(tmp1, (0, 1), delta.oo, (2, 3), (2, 1, 3, 0)) * -0.5
    del tmp1
...
def hbar_matvec_ip_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T12:24:57.543557.
    ...
    tmp12 = einsum(v.oovv, (0, 1, 2, 3), t2, (0, 1, 4, 3), (4, 2))
    tmp11 = einsum(v.oovv, (0, 1, 2, 3), t2, (4, 5, 2, 3), (4, 5, 0, 1))
    tmp9 = einsum(t2, (0, 1, 2, 3), v.ovvv, (4, 5, 2, 3), (0, 1, 4, 5))
    tmp8 = einsum(t2, (0, 1, 2, 3), v.ovvv, (1, 4, 2, 3), (0, 4))
    tmp6 = einsum(v.ooov, (0, 1, 2, 3), t2, (4, 1, 5, 3), (4, 0, 2, 5))
...
def hbar_matvec_ip(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T12:24:57.555540.
    ...
    del tmp8
    r2new += einsum(r2, (0, 1, 2), tmp9, (3, 4, 0, 1), (3, 4, 2)) * 0.5
    del tmp9
...
def hbar_matvec_ea_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T12:25:01.502848.
...
def hbar_matvec_ea(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T12:25:01.513636.
    ...
    tmp3 = einsum(r2, (0, 1, 2), v.ovov, (3, 1, 2, 4), (3, 0, 4))
    tmp2 = einsum(ints.tmp12, (0, 1, 2, 3), r2, (4, 3, 1), (0, 2, 4))
    del ints.tmp12
    tmp5 = einsum(tmp4, (0, 1), r2, (2, 0, 3), (3, 2, 1)) * -0.5
    del tmp4
    tmp9 = einsum(r1, (0,), f.ov, (1, 0), (1,)) * 2
    tmp9 += einsum(r2, (0, 1, 2), v.oovv, (3, 2, 0, 1), (3,))
    tmp10 = np.copy(f.oo)
    ...
    tmp7 = einsum(ints.tmp8, (0, 1, 2, 3), r1, (3,), (0, 1, 2))
    del ints.tmp8
    tmp0 = np.copy(f.vv)
    ...
    del tmp8
    r2new += einsum(tmp9, (0,), t2, (1, 0, 2, 3), (2, 3, 1)) * 0.5
    del tmp9
...
def hbar_matvec_ee_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T12:25:11.441442.
    ...
    tmp30 = einsum(v.oovv, (0, 1, 2, 3), t2, (4, 1, 5, 3), (4, 0, 5, 2))
...
def hbar_matvec_ee(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T12:25:11.460498.
    ...
    ints = kwargs["ints"]
    tmp25 = einsum(v.oovv, (0, 1, 2, 3), r2, (4, 1, 2, 3), (4, 0))
    tmp24 = einsum(r1, (0, 1), f.ov, (2, 1), (2, 0))
    tmp30 = einsum(r2, (0, 1, 2, 3), v.oovv, (0, 1, 4, 3), (2, 4))
    tmp7 = einsum(r1, (0, 1), v.ooov, (2, 0, 3, 1), (2, 3))
    tmp26 = np.copy(np.transpose(tmp24, (1, 0)))
    del tmp24
    tmp26 += tmp25 * 0.5
    del tmp25
    tmp22 = np.copy(f.oo) * 2
    tmp22 += np.transpose(ints.tmp0, (1, 0))
    tmp31 = einsum(tmp30, (0, 1), t2, (2, 3, 4, 1), (2, 3, 0, 4)) * -1
    del tmp30
    tmp29 = einsum(r1, (0, 1), ints.tmp6, (0, 2, 3, 4), (2, 3, 4, 1))
    del ints.tmp6
    tmp8 = einsum(tmp7, (0, 1), t2, (2, 0, 3, 4), (2, 1, 3, 4)) * -1
    del tmp7
    tmp6 = einsum(v.ovvv, (0, 1, 2, 3), r1, (4, 1), (4, 0, 2, 3))
    tmp18 = einsum(r1, (0, 1), ints.tmp21, (2, 3, 0, 4), (2, 3, 4, 1))
    del ints.tmp21
    tmp19 = einsum(ints.tmp1, (0, 1), r2, (2, 3, 4, 1), (2, 3, 0, 4))
    tmp27 = einsum(tmp26, (0, 1), t2, (2, 1, 3, 4), (2, 0, 3, 4)) * -1
    del tmp26
    tmp21 = einsum(r1, (0, 1), ints.tmp16, (2, 3, 4, 1), (2, 0, 3, 4))
    del ints.tmp16
    tmp23 = einsum(r2, (0, 1, 2, 3), tmp22, (1, 4), (0, 4, 2, 3)) * -0.5
    del tmp22
    tmp16 = einsum(r2, (0, 1, 2, 3), f.vv, (4, 3), (0, 1, 4, 2))
    tmp15 = einsum(r1, (0, 1), v.ooov, (2, 3, 0, 4), (2, 3, 1, 4))
    tmp4 = einsum(v.ovvv, (0, 1, 2, 3), r1, (0, 3), (1, 2))
    tmp11 = einsum(r1, (0, 1), ints.tmp23, (2, 3, 4, 1), (2, 0, 3, 4))
    del ints.tmp23
    tmp13 = einsum(r2, (0, 1, 2, 3), ints.tmp30, (4, 1, 5, 3), (4, 0, 5, 2))
    del ints.tmp30
    tmp10 = einsum(ints.tmp14, (0, 1, 2, 3), r1, (1, 4), (0, 2, 3, 4))
    del ints.tmp14
    tmp12 = einsum(v.ovov, (0, 1, 2, 3), r2, (4, 2, 5, 1), (4, 0, 5, 3))
    tmp32 = np.copy(tmp29)
    del tmp29
    tmp32 += tmp31 * 0.5
    del tmp31
    tmp3 = einsum(v.oovv, (0, 1, 2, 3), r2, (4, 5, 2, 3), (4, 5, 0, 1))
    tmp9 = np.copy(np.transpose(tmp6, (0, 1, 3, 2))) * -1
    del tmp6
    tmp9 += np.transpose(tmp8, (0, 1, 3, 2))
    del tmp8
    tmp20 = np.copy(tmp18) * 0.5
    del tmp18
    tmp20 += np.transpose(tmp19, (1, 0, 2, 3)) * -0.5
    del tmp19
    tmp28 = np.copy(np.transpose(tmp21, (0, 1, 3, 2))) * -0.5
    del tmp21
    tmp28 += np.transpose(tmp23, (1, 0, 3, 2))
    del tmp23
    tmp28 += np.transpose(tmp27, (1, 0, 3, 2))
    del tmp27
    tmp17 = np.copy(np.transpose(tmp15, (1, 0, 2, 3))) * -1
    del tmp15
    tmp17 += np.transpose(tmp16, (1, 0, 2, 3)) * -1
    del tmp16
    tmp5 = einsum(tmp4, (0, 1), t2, (2, 3, 4, 1), (2, 3, 4, 0)) * -1
    del tmp4
    tmp14 = np.copy(tmp10)
    del tmp10
    tmp14 += tmp11
    ...
    del tmp5
    r2new += tmp9 * -1
    r2new += np.transpose(tmp9, (1, 0, 2, 3))
    del tmp9
    r2new += tmp14 * -1
    r2new += np.transpose(tmp14, (0, 1, 3, 2))
    r2new += np.transpose(tmp14, (1, 0, 2, 3))
    r2new += np.transpose(tmp14, (1, 0, 3, 2)) * -1
    del tmp14
    r2new += tmp17 * -1
    ...
    del tmp32
    r2new += einsum(r2, (0, 1, 2, 3), tmp33, (4, 5, 1, 0), (4, 5, 2, 3)) * 0.5
    del tmp33
...
def hbar_lmatvec_ip_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T12:25:15.001478.
    ...
    tmp6 = einsum(t2, (0, 1, 2, 3), v.ovvv, (4, 5, 2, 3), (0, 1, 4, 5))
    tmp5 = einsum(v.ovvv, (0, 1, 2, 3), t2, (4, 0, 2, 3), (4, 1))
    tmp4 = einsum(v.ooov, (0, 1, 2, 3), t2, (4, 1, 5, 3), (4, 0, 2, 5))
    tmp3 = einsum(v.ovoo, (0, 1, 2, 3), t2, (2, 3, 4, 1), (0, 4))
...
def hbar_lmatvec_ip(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T12:25:15.012964.
    ...
    ints = kwargs["ints"]
    tmp4 = einsum(r2, (0, 1, 2), ints.tmp2, (1, 3), (3, 0, 2))
...
def hbar_lmatvec_ea_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T12:25:18.676208.
    ...
    tmp6 = einsum(v.ovvv, (0, 1, 2, 3), t2, (4, 0, 5, 3), (4, 5, 1, 2))
    tmp5 = einsum(v.ovvv, (0, 1, 2, 3), t2, (4, 0, 2, 3), (4, 1))
...
def hbar_lmatvec_ea(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T12:25:18.686825.
    ...
    r2new += einsum(v.vvvv, (0, 1, 2, 3), r2, (2, 3, 4), (0, 1, 4)) * 0.5
    r2new += einsum(tmp4, (0, 1, 2), v.oovv, (2, 1, 3, 4), (3, 4, 0)) * -0.25
    del tmp4
    r2new += einsum(tmp0, (0,), v.oovv, (1, 0, 2, 3), (2, 3, 1)) * 0.5
    ...
    del tmp0
    r1new += einsum(r2, (0, 1, 2), tmp1, (2, 1, 0, 3), (3,)) * -1
    del tmp1
...
def hbar_lmatvec_ee_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T12:25:25.865157.
    ...
    tmp10 = einsum(t2, (0, 1, 2, 3), v.ovvv, (4, 5, 2, 3), (0, 1, 4, 5))
    ...
    tmp6 = einsum(v.ovoo, (0, 1, 2, 3), t2, (2, 3, 4, 1), (0, 4))
...
def hbar_lmatvec_ee(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T12:25:25.882492.
    ...
    tmp14 = einsum(ints.tmp21, (0, 1, 2, 3), r2, (4, 0, 5, 2), (1, 4, 3, 5))
    del ints.tmp21
    tmp15 = einsum(v.ovov, (0, 1, 2, 3), r2, (4, 2, 5, 1), (4, 0, 5, 3))
    tmp11 = einsum(r2, (0, 1, 2, 3), f.vv, (4, 3), (0, 1, 4, 2))
    tmp10 = einsum(r1, (0, 1), v.ooov, (2, 3, 0, 4), (2, 3, 1, 4))
    tmp18 = einsum(r2, (0, 1, 2, 3), tmp7, (1, 4), (0, 4, 2, 3)) * -0.5
    tmp17 = einsum(v.oovv, (0, 1, 2, 3), tmp1, (4, 1), (4, 0, 2, 3)) * -1
    tmp2 = einsum(r2, (0, 1, 2, 3), t2, (0, 1, 4, 3), (2, 4))
    tmp16 = einsum(r1, (0, 1), f.ov, (2, 3), (2, 0, 3, 1))
    tmp16 += tmp14
    del tmp14
    tmp16 += tmp15 * -1
    del tmp15
    tmp21 = np.copy(ints.tmp19) * -0.5
    del ints.tmp19
    tmp21 += v.oooo * -1
    tmp9 = einsum(v.ovvv, (0, 1, 2, 3), r1, (4, 1), (4, 0, 2, 3))
    tmp12 = np.copy(np.transpose(tmp10, (1, 0, 2, 3))) * -1
    del tmp10
    tmp12 += np.transpose(tmp11, (1, 0, 2, 3)) * -1
    del tmp11
    tmp19 = np.copy(np.transpose(tmp17, (0, 1, 3, 2))) * 0.5
    del tmp17
    tmp19 += np.transpose(tmp18, (1, 0, 3, 2))
    del tmp18
    tmp20 = einsum(v.oovv, (0, 1, 2, 3), tmp2, (4, 3), (0, 1, 4, 2)) * -1
    tmp8 = einsum(t2, (0, 1, 2, 3), r2, (4, 5, 2, 3), (4, 5, 0, 1))
    tmp13 = einsum(r2, (0, 1, 2, 3), ints.tmp4, (3, 4), (0, 1, 4, 2))
    ...
    r2new += np.transpose(tmp9, (1, 0, 3, 2)) * -1
    del tmp9
    r2new += tmp12 * -1
    ...
    del tmp19
    r2new += tmp20 * -0.5
    r2new += np.transpose(tmp20, (0, 1, 3, 2)) * 0.5
    del tmp20
    r2new += einsum(r2, (0, 1, 2, 3), tmp21, (1, 0, 4, 5), (4, 5, 2, 3)) * 0.5
    del tmp21
    ...
    del tmp1
    r1new += einsum(tmp3, (0, 1, 2, 3), r2, (4, 0, 2, 1), (4, 3)) * -1
    del tmp3
