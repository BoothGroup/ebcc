...
https://github.com/obackhouse/albert
  ...
  * date: 2024-07-18T21:42:17.819450
...
def energy(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-07-18T21:42:17.862679.
...
def update_amps(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-07-18T21:42:18.624233.
    ...
    tmp7 = einsum(v.oovv, (0, 1, 2, 3), t2, (4, 0, 2, 3), (4, 1), optimize=True) * -1
    tmp3 = einsum(t2, (0, 1, 2, 3), v.oovv, (4, 1, 5, 3), (0, 4, 2, 5), optimize=True)
    ...
    t2new = einsum(t2, (0, 1, 2, 3), tmp9, (0, 1, 4, 5), (4, 5, 3, 2), optimize=True) * -0.25
    del tmp9
    ...
    t2new += tmp1 * -1
    del tmp1
    tmp8 = einsum(tmp7, (0, 1), t2, (2, 1, 3, 4), (2, 0, 3, 4), optimize=True)
    del tmp7
...
def update_lams(f=None, l2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-07-18T21:42:19.679726.
    ...
    tmp11 = einsum(v.oovv, (0, 1, 2, 3), t2, (0, 1, 3, 4), (4, 2), optimize=True) * -1
    tmp2 = einsum(v.oovv, (0, 1, 2, 3), t2, (1, 4, 3, 5), (4, 0, 5, 2), optimize=True)
    tmp8 = einsum(t2, (0, 1, 2, 3), l2, (2, 3, 4, 0), (4, 1), optimize=True) * -1
    tmp6 = einsum(v.oovv, (0, 1, 2, 3), t2, (1, 4, 2, 3), (4, 0), optimize=True) * -1
    tmp14 = einsum(tmp13, (0, 1), v.oovv, (2, 3, 4, 1), (2, 3, 0, 4), optimize=True) * -1
    del tmp13
    tmp12 = einsum(l2, (0, 1, 2, 3), tmp11, (1, 4), (2, 3, 0, 4), optimize=True)
    del tmp11
    ...
    tmp15 += tmp14 * 0.5
    del tmp14
    l2new = tmp15.transpose((3, 2, 1, 0)).copy() * -1
    ...
    del tmp0
    tmp1 = einsum(f.oo, (0, 1), l2, (2, 3, 4, 1), (0, 4, 2, 3), optimize=True)
    l2new += tmp1.transpose((3, 2, 1, 0))
    l2new += tmp1.transpose((3, 2, 0, 1)) * -1
    del tmp1
    tmp4 = einsum(l2, (0, 1, 2, 3), tmp3, (2, 4, 0, 5), (3, 4, 1, 5), optimize=True)
    del tmp3
    ...
    tmp16 += einsum(v.oovv, (0, 1, 2, 3), t2, (4, 5, 2, 3), (5, 4, 1, 0), optimize=True) * 0.5
    l2new += einsum(tmp16, (0, 1, 2, 3), l2, (4, 5, 0, 1), (5, 4, 2, 3), optimize=True) * -0.5
    del tmp16
    tmp5 = einsum(l2, (0, 1, 2, 3), f.vv, (4, 1), (2, 3, 4, 0), optimize=True)
    l2new += tmp5.transpose((3, 2, 1, 0)) * -1
    l2new += tmp5.transpose((2, 3, 1, 0))
    del tmp5
    ...
    del tmp10
    l2new += einsum(l2, (0, 1, 2, 3), v.vvvv, (4, 5, 1, 0), (5, 4, 3, 2), optimize=True) * -0.5
...
def make_rdm1_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-07-18T21:42:19.808625.
    ...
    rdm1.oo = einsum(t2, (0, 1, 2, 3), l2, (2, 3, 4, 1), (0, 4), optimize=True) * -0.5
...
def make_rdm2_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-07-18T21:42:20.714346.
    ...
    tmp2 = einsum(l2, (0, 1, 2, 3), t2, (4, 3, 5, 1), (2, 4, 0, 5), optimize=True)
    ...
    tmp1 = einsum(t2, (0, 1, 2, 3), l2, (2, 3, 4, 1), (4, 0), optimize=True)
    rdm2.oooo = einsum(delta.oo, (0, 1), tmp1, (2, 3), (0, 3, 1, 2), optimize=True) * -0.5
    rdm2.oooo += einsum(delta.oo, (0, 1), tmp1, (2, 3), (3, 1, 0, 2), optimize=True) * 0.5
    rdm2.oooo += einsum(delta.oo, (0, 1), tmp1, (2, 3), (0, 3, 2, 1), optimize=True) * 0.5
    ...
    del tmp0
    tmp3 = einsum(tmp2, (0, 1, 2, 3), t2, (4, 0, 5, 2), (1, 4, 3, 5), optimize=True)
    del tmp2
    ...
    rdm2.oovv += tmp5 * -0.5
    del tmp5
    tmp6 = einsum(tmp1, (0, 1), t2, (2, 0, 3, 4), (2, 1, 3, 4), optimize=True)
    del tmp1
