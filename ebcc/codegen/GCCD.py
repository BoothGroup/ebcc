...
https://github.com/obackhouse/albert
  ...
  * date: 2024-10-18T21:45:51.851023
...
def energy(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:45:53.295010.
...
def update_amps(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:46:17.155747.
    ...
    tmp2 = einsum(t2, (0, 1, 2, 3), tmp1, (4, 1, 5, 3), (4, 0, 5, 2))
    del tmp1
    t2new += tmp2
    t2new += np.transpose(tmp2, (0, 1, 3, 2)) * -1
    del tmp2
    tmp3 = einsum(t2, (0, 1, 2, 3), v.oovv, (0, 1, 4, 3), (2, 4))
    tmp4 = einsum(tmp3, (0, 1), t2, (2, 3, 4, 1), (2, 3, 4, 0))
    del tmp3
    t2new += tmp4 * -0.5
...
def update_lams(f=None, l2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:46:50.999293.
    ...
    l2new = einsum(tmp0, (0, 1, 2, 3), v.oovv, (3, 2, 4, 5), (4, 5, 0, 1)) * -0.25
    del tmp0
    ...
    del tmp14
    tmp15 = einsum(f.vv, (0, 1), l2, (2, 1, 3, 4), (3, 4, 0, 2))
...
def make_rdm1_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:46:54.265499.
...
def make_rdm2_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:47:19.825476.
    ...
    rdm2.oooo += einsum(tmp1, (0, 1), delta.oo, (2, 3), (1, 2, 3, 0)) * 0.5
...
def hbar_matvec_ip_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:48:22.426530.
...
def hbar_matvec_ip(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:48:22.782169.
    ...
    del tmp4
    tmp5 = einsum(r2, (0, 1, 2), ints.tmp0, (3, 1), (3, 0, 2))
    del ints.tmp0
    tmp8 = np.copy(tmp5) * -0.5
    del tmp5
    tmp6 = einsum(r2, (0, 1, 2), ints.tmp13, (3, 1, 4, 2), (3, 0, 4))
    del ints.tmp13
    tmp8 += tmp6
    del tmp6
...
def hbar_matvec_ea_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:49:23.848296.
...
def hbar_matvec_ea(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:49:24.086469.
    ...
    r1new += einsum(r1, (0,), tmp0, (0, 1), (1,))
    del tmp0
    tmp1 = einsum(v.oovv, (0, 1, 2, 3), r2, (2, 3, 4), (4, 0, 1))
    r2new = einsum(t2, (0, 1, 2, 3), tmp1, (4, 1, 0), (2, 3, 4)) * -0.25
    del tmp1
    r2new += einsum(r2, (0, 1, 2), v.vvvv, (3, 4, 0, 1), (3, 4, 2)) * 0.5
    tmp2 = einsum(r2, (0, 1, 2), ints.tmp12, (3, 2, 4, 1), (3, 4, 0))
    del ints.tmp12
    tmp6 = np.copy(tmp2)
    del tmp2
...
def hbar_matvec_ee_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:51:38.813761.
...
def hbar_matvec_ee(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:51:39.233224.
    ...
    tmp4 = einsum(ints.tmp14, (0, 1, 2, 3), r1, (1, 4), (0, 2, 3, 4))
    del ints.tmp14
    tmp8 = np.copy(tmp4)
    del tmp4
    ...
    tmp8 += tmp5
    del tmp5
    tmp6 = einsum(r2, (0, 1, 2, 3), v.ovov, (4, 3, 1, 5), (0, 4, 2, 5))
    tmp8 += tmp6
    del tmp6
    tmp7 = einsum(ints.tmp30, (0, 1, 2, 3), r2, (4, 1, 5, 3), (0, 4, 2, 5))
    del ints.tmp30
    tmp8 += tmp7 * -1
    del tmp7
    r2new += tmp8 * -1
    ...
    del tmp8
    tmp9 = einsum(r1, (0, 1), ints.tmp16, (2, 3, 4, 1), (2, 0, 3, 4))
    del ints.tmp16
    tmp16 = np.copy(np.transpose(tmp9, (0, 1, 3, 2))) * -0.5
    del tmp9
    tmp10 = np.copy(f.oo) * 2
    tmp10 += np.transpose(ints.tmp0, (1, 0))
    del ints.tmp0
    tmp11 = einsum(r2, (0, 1, 2, 3), tmp10, (1, 4), (0, 4, 2, 3)) * -0.5
    del tmp10
    tmp16 += np.transpose(tmp11, (1, 0, 3, 2))
    del tmp11
    tmp12 = einsum(f.ov, (0, 1), r1, (2, 1), (0, 2))
    tmp14 = np.copy(np.transpose(tmp12, (1, 0)))
    del tmp12
    tmp13 = einsum(v.oovv, (0, 1, 2, 3), r2, (4, 1, 2, 3), (4, 0))
    tmp14 += tmp13 * 0.5
    del tmp13
    tmp15 = einsum(tmp14, (0, 1), t2, (2, 1, 3, 4), (2, 0, 3, 4)) * -1
    del tmp14
    ...
    tmp20 = np.copy(np.transpose(tmp17, (0, 1, 3, 2))) * -1
    del tmp17
    tmp18 = einsum(v.ooov, (0, 1, 2, 3), r1, (1, 3), (0, 2))
    tmp19 = einsum(tmp18, (0, 1), t2, (2, 0, 3, 4), (2, 1, 3, 4)) * -1
    del tmp18
    tmp20 += np.transpose(tmp19, (0, 1, 3, 2))
    del tmp19
    r2new += tmp20 * -1
    r2new += np.transpose(tmp20, (1, 0, 2, 3))
    del tmp20
    tmp21 = einsum(ints.tmp6, (0, 1, 2, 3), r1, (0, 4), (1, 2, 3, 4))
    del ints.tmp6
    tmp24 = np.copy(tmp21)
    del tmp21
    tmp22 = einsum(r2, (0, 1, 2, 3), v.oovv, (0, 1, 4, 3), (2, 4))
    ...
    del tmp24
    tmp25 = einsum(v.ooov, (0, 1, 2, 3), r1, (2, 4), (0, 1, 4, 3))
    ...
    del tmp27
    tmp28 = einsum(ints.tmp21, (0, 1, 2, 3), r1, (2, 4), (0, 1, 3, 4))
    del ints.tmp21
    tmp30 = np.copy(tmp28) * 0.5
    del tmp28
    tmp29 = einsum(r2, (0, 1, 2, 3), ints.tmp1, (4, 3), (0, 1, 4, 2))
    del ints.tmp1
    tmp30 += np.transpose(tmp29, (1, 0, 2, 3)) * -0.5
    del tmp29
    r2new += np.transpose(tmp30, (1, 0, 2, 3)) * -1
    r2new += np.transpose(tmp30, (1, 0, 3, 2))
    del tmp30
    tmp31 = einsum(v.ovvv, (0, 1, 2, 3), r1, (0, 3), (1, 2))
    ...
    r2new += einsum(r1, (0, 1), tmp34, (2, 3), (2, 0, 3, 1))
    r2new += einsum(tmp34, (0, 1), r1, (2, 3), (2, 0, 3, 1))
...
def hbar_lmatvec_ip_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:52:26.417195.
...
def hbar_lmatvec_ip(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:52:26.701872.
    ...
    r1new = einsum(r2, (0, 1, 2), tmp0, (3, 0, 1, 2), (3,))
    del tmp0
    tmp1 = np.copy(f.ov)
    tmp1 += ints.tmp0
    del ints.tmp0
    ...
    del tmp3
    tmp4 = einsum(f.oo, (0, 1), r2, (2, 1, 3), (0, 2, 3))
    r2new += tmp4
    r2new += np.transpose(tmp4, (1, 0, 2)) * -1
    del tmp4
    tmp8 = einsum(f.ov, (0, 1), r1, (2,), (0, 2, 1))
    tmp5 = einsum(r2, (0, 1, 2), ints.tmp2, (1, 3), (3, 0, 2))
    del ints.tmp2
    tmp8 += tmp5 * -0.5
    del tmp5
    tmp6 = einsum(r2, (0, 1, 2), ints.tmp12, (1, 3, 2, 4), (3, 0, 4))
    del ints.tmp12
    tmp8 += tmp6
    del tmp6
    tmp7 = einsum(r2, (0, 1, 2), v.ovov, (3, 2, 1, 4), (0, 3, 4))
    ...
    del ints.tmp10
    tmp9 += v.oooo
    r2new += einsum(r2, (0, 1, 2), tmp9, (0, 1, 3, 4), (3, 4, 2)) * 0.5
    del tmp9
    tmp10 = np.copy(f.vv)
...
def hbar_lmatvec_ea_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:53:15.365428.
...
def hbar_lmatvec_ea(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:53:15.585226.
    ...
    del tmp3
    tmp4 = einsum(t2, (0, 1, 2, 3), r2, (2, 3, 4), (4, 0, 1))
...
def hbar_lmatvec_ee_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:54:43.052602.
...
def hbar_lmatvec_ee(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:54:43.413943.
    ...
    tmp2 = einsum(r1, (0, 1), t2, (2, 0, 3, 1), (2, 3))
    r1new += einsum(v.oovv, (0, 1, 2, 3), tmp2, (1, 3), (0, 2))
    del tmp2
    ...
    tmp5 += ints.tmp9 * -0.5
    del ints.tmp9
    r1new += einsum(tmp5, (0, 1), r2, (2, 0, 3, 1), (2, 3))
    del tmp5
    tmp6 = np.copy(f.vv)
    tmp6 += ints.tmp4 * -0.5
    ...
    tmp11 += tmp9
    del tmp9
    tmp10 = einsum(r2, (0, 1, 2, 3), v.ovov, (4, 3, 1, 5), (0, 4, 2, 5))
    tmp11 += tmp10 * -1
    del tmp10
    r2new += tmp11
    ...
    del tmp11
    tmp12 = einsum(v.oovv, (0, 1, 2, 3), tmp0, (4, 1), (4, 0, 2, 3)) * -1
    del tmp0
    tmp15 = np.copy(np.transpose(tmp12, (0, 1, 3, 2))) * 0.5
    del tmp12
    tmp13 = np.copy(f.oo) * 2
    tmp13 += ints.tmp3
    del ints.tmp3
    tmp14 = einsum(tmp13, (0, 1), r2, (2, 0, 3, 4), (2, 1, 3, 4)) * -0.5
    del tmp13
    ...
    del tmp15
    tmp16 = einsum(tmp1, (0, 1), v.oovv, (2, 3, 4, 1), (2, 3, 0, 4)) * -1
    del tmp1
    r2new += tmp16 * -0.5
    r2new += np.transpose(tmp16, (0, 1, 3, 2)) * 0.5
    del tmp16
    tmp17 = einsum(v.ooov, (0, 1, 2, 3), r1, (2, 4), (0, 1, 4, 3))
    tmp19 = np.copy(np.transpose(tmp17, (1, 0, 2, 3))) * -1
    del tmp17
    ...
    del tmp20
    tmp21 = einsum(r2, (0, 1, 2, 3), ints.tmp4, (3, 4), (0, 1, 4, 2))
    del ints.tmp4
    ...
    del ints.tmp19
    tmp22 += v.oooo * 2
    r2new += einsum(r2, (0, 1, 2, 3), tmp22, (0, 1, 4, 5), (4, 5, 2, 3)) * 0.25
    del tmp22
