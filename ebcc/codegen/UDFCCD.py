...
def energy(f=None, v=None, nocc=None, nvir=None, naux=None, t2=None, **kwargs):
    # energy
    x0 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
...
def update_amps(f=None, v=None, nocc=None, nvir=None, naux=None, t2=None, **kwargs):
    ...
    # T amplitudes
    x0 = np.zeros((nvir[0], nvir[0], nvir[0], nvir[0]), dtype=np.float64)
    ...
    x16 = np.zeros((nocc[0], nocc[1], nvir[0], nvir[1]), dtype=np.float64)
    ...
    x23 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    ...
    del x28
    x29 = np.zeros((nocc[0], nocc[0], nvir[1], nvir[1]), dtype=np.float64)
    ...
    del x29
    x30 = np.zeros((nvir[0], nvir[0], nvir[1], nvir[1]), dtype=np.float64)
    x30 += einsum(v.aaa.xvv, (0, 1, 2), v.abb.xvv, (0, 3, 4), (1, 2, 3, 4))
    t2new_abab += einsum(t2.abab, (0, 1, 2, 3), x30, (4, 2, 5, 3), (0, 1, 4, 5))
    del x30
    x31 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    ...
    x34 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    ...
    x38 = np.zeros((nocc[1], nocc[1], nvir[0], nvir[0]), dtype=np.float64)
    ...
    del x40
    x41 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    ...
    del x43
    x44 = np.zeros((nocc[0], nocc[0], nocc[1], nocc[1]), dtype=np.float64)
    ...
    del x47
    x48 = np.zeros((nvir[1], nvir[1], nvir[1], nvir[1]), dtype=np.float64)
    ...
    del x48
    x49 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
...
def update_lams(f=None, v=None, nocc=None, nvir=None, naux=None, t2=None, l2=None, **kwargs):
    ...
    del x0
    x2 = np.zeros((nvir[0], nvir[0], nvir[0], nvir[0]), dtype=np.float64)
    ...
    del x26
    x28 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    ...
    del x31
    x33 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    ...
    del x1, x42
    x43 = np.zeros((nvir[0], nvir[0], nvir[1], nvir[1]), dtype=np.float64)
    x43 += einsum(v.aaa.xvv, (0, 1, 2), v.abb.xvv, (0, 3, 4), (1, 2, 3, 4))
    l2new_abab += einsum(l2.abab, (0, 1, 2, 3), x43, (4, 0, 5, 1), (4, 5, 2, 3))
    del x43
    x44 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    ...
    del x44
    x45 = np.zeros((nvir[1], nvir[1]), dtype=np.float64)
    x45 += einsum(l2.abab, (0, 1, 2, 3), t2.abab, (2, 3, 0, 4), (1, 4))
    x46 = np.zeros((nvir[1], nvir[1]), dtype=np.float64)
    ...
    del x46
    x48 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    ...
    del x50
    x52 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    ...
    del x53
    x55 = np.zeros((nocc[1], nocc[1], nvir[0], nvir[0]), dtype=np.float64)
    ...
    del x56
    x57 = np.zeros((nocc[0], nocc[0], nvir[1], nvir[1]), dtype=np.float64)
    ...
    del x65
    x66 = np.zeros((nvir[1], nvir[1], nvir[1], nvir[1]), dtype=np.float64)
    ...
    del x39
    x68 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    x68 += einsum(x13, (0, 1, 2), l2.abab, (1, 3, 0, 4), (4, 3, 2))
    del x13
    x69 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    x69 += einsum(x17, (0, 1, 2), l2.bbbb, (3, 1, 4, 0), (4, 3, 2)) * 2.0
    del x17
    x70 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    ...
    del x74
    x76 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
