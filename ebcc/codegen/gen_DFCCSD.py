"""Script to generate equations for the DF-CCSD model.
"""
...
with common.FilePrinter("%sDFCCSD" % spin[0].upper()) as file_printer:
    ...
    with FunctionPrinter(
        ...
        expression = expression.expand_cderi()
    ...
    with FunctionPrinter(
            file_printer,
            "update_lams",
            ["f", "v", "nocc", "nvir", "naux", "t1", "t2", "l1", "l2"],
            ["l1new", "l2new"],
            spin_cases={
