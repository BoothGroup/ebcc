...
def energy(f=None, v=None, nocc=None, nvir=None, naux=None, t1=None, t2=None, **kwargs):
    ...
    x2 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    ...
    del x6
    x7 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
...
def update_amps(f=None, v=None, nocc=None, nvir=None, naux=None, t1=None, t2=None, **kwargs):
    ...
    del x14
    x15 = np.zeros((nocc[1], nocc[1], naux), dtype=np.float64)
    ...
    del x21
    x22 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    x22 += einsum(t1.bb, (0, 1), v.abb.xoo, (2, 3, 0), (3, 1, 2))
    x23 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    ...
    del x25
    x26 = np.zeros((nocc[1], nocc[1], naux), dtype=np.float64)
    x26 += einsum(v.abb.xoo, (0, 1, 2), (1, 2, 0))
    x26 += einsum(x15, (0, 1, 2), (0, 1, 2))
    x27 = np.zeros((nocc[0], nocc[1], nocc[1], nvir[0]), dtype=np.float64)
    ...
    x30 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    ...
    x31 = np.zeros((nocc[1], nvir[1]), dtype=np.float64)
    ...
    del x35
    x36 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    ...
    del x56
    x57 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    x57 += einsum(v.aaa.xov, (0, 1, 2), (1, 2, 0))
    x57 += einsum(x36, (0, 1, 2), (0, 1, 2))
    del x36
    x57 += einsum(t1.aa, (0, 1), x8, (0, 2, 3), (2, 1, 3)) * -1.0
    del x8
    x58 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    x58 += einsum(t1.bb, (0, 1), v.abb.xvv, (2, 3, 1), (0, 3, 2))
    x59 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    ...
    del x61
    x62 = np.zeros((nocc[1], nocc[1]), dtype=np.float64)
    ...
    del x64
    x65 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    ...
    del x65
    x67 = np.zeros((nocc[1], nocc[1], nocc[1], nocc[1]), dtype=np.float64)
    ...
    x75 = np.zeros((nocc[1], nocc[1], nocc[1], nocc[1]), dtype=np.float64)
    x75 += einsum(v.abb.xoo, (0, 1, 2), v.abb.xoo, (0, 3, 4), (1, 3, 4, 2))
    x76 = np.zeros((nocc[1], nocc[1], nocc[1], nocc[1]), dtype=np.float64)
...
def update_lams(f=None, v=None, nocc=None, nvir=None, naux=None, t1=None, t2=None, l1=None, l2=None, **kwargs):
    ...
    x2 = np.zeros((nocc[0], nocc[0], naux), dtype=np.float64)
    x2 += einsum(t1.aa, (0, 1), v.aaa.xov, (2, 3, 1), (0, 3, 2))
    x3 = np.zeros((nocc[1], nocc[1], naux), dtype=np.float64)
    x3 += einsum(t1.bb, (0, 1), v.abb.xov, (2, 3, 1), (0, 3, 2))
    x4 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    x4 += einsum(t1.aa, (0, 1), v.aaa.xvv, (2, 3, 1), (0, 3, 2))
    x5 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    ...
    x8 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    x8 += einsum(t1.bb, (0, 1), v.abb.xvv, (2, 3, 1), (0, 3, 2))
    x9 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    x9 += einsum(v.aaa.xov, (0, 1, 2), t2.abab, (1, 3, 2, 4), (3, 4, 0))
    x10 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    x10 += einsum(v.abb.xov, (0, 1, 2), t2.bbbb, (3, 1, 4, 2), (3, 4, 0))
    x11 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    ...
    x15 = np.zeros((nocc[0], nocc[0], naux), dtype=np.float64)
    x15 += einsum(v.aaa.xoo, (0, 1, 2), (1, 2, 0))
    x15 += einsum(x2, (0, 1, 2), (0, 1, 2))
    x16 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    ...
    del x16
    x17 = np.zeros((nocc[0], nvir[0], nvir[1], nvir[1]), dtype=np.float64)
    ...
    x21 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    x21 += einsum(v.abb.xov, (0, 1, 2), (1, 2, 0))
    x21 += einsum(x8, (0, 1, 2), (0, 1, 2))
    x22 = np.zeros((nocc[1], nocc[1], naux), dtype=np.float64)
    ...
    x24 = np.zeros((nocc[0], nocc[0], naux), dtype=np.float64)
    ...
    x27 = np.zeros((naux,), dtype=np.float64)
    x27 += einsum(t1.aa, (0, 1), v.aaa.xov, (2, 0, 1), (2,))
    x28 = np.zeros((naux,), dtype=np.float64)
    x28 += einsum(t1.bb, (0, 1), v.abb.xov, (2, 0, 1), (2,))
    x29 = np.zeros((naux,), dtype=np.float64)
    x29 += einsum(x27, (0,), (0,))
    del x27
    x29 += einsum(x28, (0,), (0,))
    del x28
    ...
    x32 = np.zeros((nocc[0], nocc[1], nvir[0], nvir[1]), dtype=np.float64)
    ...
    x34 = np.zeros((nocc[0], nocc[0], nocc[1], nocc[1]), dtype=np.float64)
    x34 += einsum(x33, (0, 1, 2, 3), (0, 1, 3, 2))
    x34 += einsum(x22, (0, 1, 2), x24, (3, 4, 2), (4, 3, 1, 0))
    x35 = np.zeros((nocc[0], nocc[0], nocc[1], nvir[1]), dtype=np.float64)
    ...
    del x43
    x44 = np.zeros((nocc[0], nocc[0], nvir[1], nvir[1]), dtype=np.float64)
    ...
    x47 = np.zeros((nocc[0], nocc[0], nocc[1], nocc[1]), dtype=np.float64)
    ...
    x54 = np.zeros((nocc[0], nocc[0], nocc[1], nocc[1]), dtype=np.float64)
    ...
    x68 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    x68 += einsum(l1.aa, (0, 1), v.aaa.xvv, (2, 3, 0), (1, 3, 2))
    x69 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    ...
    x72 = np.zeros((nocc[0], nocc[0], naux), dtype=np.float64)
    ...
    del x64
    x80 = np.zeros((nocc[1], nvir[1]), dtype=np.float64)
    ...
    x86 = np.zeros((nocc[1], nocc[1]), dtype=np.float64)
    ...
    x89 = np.zeros((nocc[1], nvir[1]), dtype=np.float64)
    ...
    x93 = np.zeros((naux,), dtype=np.float64)
    ...
    del x95
    x96 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    ...
    del x77
    x99 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    ...
    del x99
    x100 = np.zeros((nocc[1], nvir[0], nvir[0], nvir[1]), dtype=np.float64)
    x100 += einsum(v.abb.xov, (0, 1, 2), v.aaa.xvv, (0, 3, 4), (1, 3, 4, 2))
    l2new_abab += einsum(x1, (0, 1, 2, 3), x100, (2, 4, 3, 5), (4, 5, 0, 1)) * -1.0
    x101 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    ...
    x104 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    x104 += einsum(v.aaa.xov, (0, 1, 2), (1, 2, 0))
    x104 += einsum(x4, (0, 1, 2), (0, 1, 2))
    x105 = np.zeros((nocc[1], nocc[1], naux), dtype=np.float64)
    x105 += einsum(v.abb.xoo, (0, 1, 2), (1, 2, 0))
    x105 += einsum(x3, (0, 1, 2), (1, 0, 2))
    x106 = np.zeros((nocc[0], nocc[1], nocc[1], nvir[0]), dtype=np.float64)
    ...
    x107 = np.zeros((nocc[0], nocc[0], nocc[1], nvir[1]), dtype=np.float64)
    ...
    x111 = np.zeros((nocc[0], nocc[0], nocc[1], nocc[1]), dtype=np.float64)
    ...
    x115 = np.zeros((nocc[1], nocc[1], nocc[1], nocc[1]), dtype=np.float64)
    ...
    x117 = np.zeros((nocc[1], nocc[1], nocc[1], nocc[1]), dtype=np.float64)
    ...
    x119 = np.zeros((nocc[1], nocc[1], nocc[1], nocc[1]), dtype=np.float64)
    ...
    x123 = np.zeros((nocc[1], nocc[1], nocc[1], nocc[1]), dtype=np.float64)
    ...
    x129 = np.zeros((nocc[0], nocc[1], nocc[1], nvir[0]), dtype=np.float64)
    ...
    del x89
    x131 = np.zeros((nocc[0], nocc[0], nocc[1], nocc[1]), dtype=np.float64)
    x131 += einsum(x54, (0, 1, 2, 3), (0, 1, 2, 3))
    del x54
    x131 += einsum(x47, (0, 1, 2, 3), (1, 0, 2, 3))
    x132 = np.zeros((nocc[1], nocc[1], nocc[1], nocc[1]), dtype=np.float64)
    x132 += einsum(x123, (0, 1, 2, 3), (1, 0, 3, 2))
    del x123
    x132 += einsum(x122, (0, 1, 2, 3), (2, 1, 0, 3))
    x133 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    x133 += einsum(l1.bb, (0, 1), v.abb.xvv, (2, 3, 0), (1, 3, 2))
    x134 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    ...
    del x87
    x137 = np.zeros((nocc[1], nocc[1], naux), dtype=np.float64)
    ...
    del x137
    x138 = np.zeros((naux,), dtype=np.float64)
    ...
    del x140
    x141 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    ...
    del x144
    x145 = np.zeros((nvir[0], nvir[0], nvir[0], nvir[0]), dtype=np.float64)
    x145 += einsum(v.aaa.xvv, (0, 1, 2), v.aaa.xvv, (0, 3, 4), (1, 3, 4, 2))
    l2new_aaaa += einsum(l2.aaaa, (0, 1, 2, 3), x145, (4, 5, 0, 1), (4, 5, 2, 3)) * -2.0
    del x145
    x146 = np.zeros((nocc[0], nocc[1], nocc[1], nvir[0]), dtype=np.float64)
    ...
    del x148
    x150 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    x150 += einsum(x104, (0, 1, 2), l2.aaaa, (3, 1, 4, 0), (4, 3, 2))
    x151 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    x151 += einsum(x21, (0, 1, 2), l2.abab, (3, 1, 4, 0), (4, 3, 2)) * 0.5
    x152 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    ...
    del x154
    x156 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    x156 += einsum(x60, (0, 1), v.aaa.xov, (2, 1, 3), (0, 3, 2))
    del x60
    x157 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    ...
    del x157
    x159 = np.zeros((nocc[0], nocc[0], nocc[0], nvir[0]), dtype=np.float64)
    ...
    del x185
    x186 = np.zeros((nvir[0], nvir[0], nvir[1], nvir[1]), dtype=np.float64)
    ...
    del x0
    x189 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    x189 += einsum(x85, (0, 1), v.abb.xov, (2, 1, 3), (0, 3, 2))
    del x85
    x190 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    x190 += einsum(x104, (0, 1, 2), l2.abab, (1, 3, 0, 4), (4, 3, 2))
    del x104
    x191 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    x191 += einsum(x21, (0, 1, 2), l2.bbbb, (3, 1, 4, 0), (4, 3, 2)) * 2.0
    del x21
    x192 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    ...
    del x192
    x193 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    ...
    del x193
    x194 = np.zeros((nocc[1], nocc[1], nvir[0], nvir[0]), dtype=np.float64)
    ...
    x196 = np.zeros((nocc[0], nocc[0], nvir[1], nvir[1]), dtype=np.float64)
    ...
    del x45, x187
    x210 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    ...
    del x195
    x213 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    ...
    del x202
    x217 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    ...
    del x118
    x231 = np.zeros((nocc[1], nocc[1]), dtype=np.float64)
...
def make_rdm2_f(f=None, v=None, nocc=None, nvir=None, naux=None, t1=None, t2=None, l1=None, l2=None, **kwargs):
    ...
    x7 = np.zeros((nocc[0], nocc[0], nocc[1], nocc[1]), dtype=np.float64)
    ...
    x8 = np.zeros((nocc[0], nocc[1], nocc[1], nvir[0]), dtype=np.float64)
    ...
    del x31
    x32 = np.zeros((nocc[0], nocc[0], nocc[1], nvir[1]), dtype=np.float64)
    ...
    x34 = np.zeros((nocc[0], nocc[0], nocc[1], nvir[1]), dtype=np.float64)
    ...
    x37 = np.zeros((nocc[1], nvir[1]), dtype=np.float64)
    ...
    x41 = np.zeros((nocc[1], nocc[1]), dtype=np.float64)
    ...
    del x51
    x52 = np.zeros((nocc[0], nocc[1], nocc[1], nvir[0]), dtype=np.float64)
    ...
    x53 = np.zeros((nocc[0], nocc[1], nocc[1], nvir[0]), dtype=np.float64)
    x53 += einsum(t2.aaaa, (0, 1, 2, 3), x8, (1, 4, 5, 3), (0, 4, 5, 2))
    rdm2_f_abab_oovo += einsum(x53, (0, 1, 2, 3), (0, 2, 3, 1)) * -2.0
    x54 = np.zeros((nocc[0], nocc[1], nocc[1], nvir[0]), dtype=np.float64)
    ...
    del x59
    x60 = np.zeros((nocc[0], nocc[1], nvir[0], nvir[1]), dtype=np.float64)
    ...
    del x78
    x79 = np.zeros((nocc[1], nocc[1], nvir[0], nvir[0]), dtype=np.float64)
    ...
    del x86
    x87 = np.zeros((nocc[0], nocc[0], nocc[1], nvir[1]), dtype=np.float64)
    ...
    x110 = np.zeros((nocc[0], nocc[0], nvir[1], nvir[1]), dtype=np.float64)
    ...
    x117 = np.zeros((nocc[0], nocc[1], nvir[0], nvir[1]), dtype=np.float64)
    ...
    del x124
    x125 = np.zeros((nocc[1], nvir[1], nvir[1], nvir[1]), dtype=np.float64)
    ...
    del x131
    x132 = np.zeros((nocc[0], nvir[0], nvir[0], nvir[0]), dtype=np.float64)
    ...
    del x132
    x133 = np.zeros((nocc[0], nvir[0], nvir[1], nvir[1]), dtype=np.float64)
