...
def energy_perturbative(f=None, v=None, nocc=None, nvir=None, t1=None, t2=None, l1=None, l2=None, **kwargs):
    ...
    x7 = np.zeros((nocc, nocc, nocc, nocc, nvir, nvir, nvir, nvir), dtype=types[float])
    ...
    x11 = np.zeros((nocc, nocc, nocc, nvir, nvir, nvir), dtype=types[float])
    x11 += einsum(t2, (0, 1, 2, 3), v.ovvv, (4, 3, 5, 6), (0, 1, 4, 2, 5, 6))
    x12 = np.zeros((nocc, nocc, nocc, nvir, nvir, nvir), dtype=types[float])
    ...
    x13 = np.zeros((nocc, nocc, nocc, nocc, nvir, nvir, nvir), dtype=types[float])
