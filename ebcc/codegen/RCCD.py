...
https://github.com/obackhouse/albert
  ...
  * date: 2024-10-18T21:45:51.085712
...
def energy(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:45:56.008972.
...
def update_amps(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:47:04.354315.
    ...
    del tmp10
    tmp11 = einsum(f.oo, (0, 1), t2, (2, 1, 3, 4), (0, 2, 3, 4))
    ...
    tmp12 += tmp3 * 2
    del tmp3
    t2new += einsum(tmp12, (0, 1, 2, 3), t2, (4, 1, 5, 3), (0, 4, 2, 5))
    del tmp12
    tmp13 = np.copy(v.oooo)
    tmp13 += einsum(v.ovov, (0, 1, 2, 3), t2, (4, 5, 1, 3), (0, 4, 5, 2))
    t2new += einsum(tmp13, (0, 1, 2, 3), t2, (0, 3, 4, 5), (2, 1, 5, 4))
    del tmp13
    tmp14 = np.copy(np.transpose(v.ovov, (0, 2, 1, 3))) * -1
    tmp14 += tmp0
    del tmp0
    t2new += einsum(t2, (0, 1, 2, 3), tmp14, (4, 1, 5, 2), (4, 0, 5, 3))
    del tmp14
...
def update_lams(f=None, l2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:48:42.117886.
    ...
    del tmp6
    tmp7 = einsum(v.oovv, (0, 1, 2, 3), l2, (4, 3, 5, 1), (5, 0, 4, 2))
    tmp17 = np.copy(tmp7)
    del tmp7
    tmp12 = np.copy(np.transpose(v.ovov, (0, 2, 3, 1))) * -1
    tmp12 += np.transpose(v.ovov, (0, 2, 1, 3)) * 2
    tmp8 = einsum(t2, (0, 1, 2, 3), l2, (4, 2, 5, 1), (5, 0, 4, 3))
    tmp11 = np.copy(tmp8)
    del tmp8
    ...
    tmp18 += t2 * -1
    tmp19 = einsum(tmp18, (0, 1, 2, 3), v.ovov, (0, 3, 1, 4), (4, 2)) * 0.5
    del tmp18
    tmp20 = einsum(tmp19, (0, 1), l2, (2, 1, 3, 4), (4, 3, 2, 0)) * 2
    del tmp19
    tmp24 = np.copy(np.transpose(tmp20, (1, 0, 2, 3)))
    del tmp20
    tmp21 = np.copy(np.transpose(t2, (0, 1, 3, 2))) * -1
    tmp21 += t2 * 2
    tmp22 = einsum(v.ovov, (0, 1, 2, 3), tmp21, (2, 4, 3, 1), (0, 4))
    del tmp21
    ...
    tmp25 += t2 * -0.5
    tmp26 = einsum(l2, (0, 1, 2, 3), tmp25, (3, 2, 4, 1), (0, 4)) * 2
    del tmp25
    tmp27 = einsum(v.ovov, (0, 1, 2, 3), tmp26, (4, 1), (0, 2, 3, 4))
    del tmp26
    tmp31 = np.copy(np.transpose(tmp27, (1, 0, 3, 2)))
    del tmp27
    tmp28 = np.copy(np.transpose(t2, (0, 1, 3, 2))) * -0.5
    tmp28 += t2
    tmp29 = einsum(tmp28, (0, 1, 2, 3), l2, (2, 3, 0, 4), (4, 1)) * 2
    del tmp28
    tmp30 = einsum(v.ovov, (0, 1, 2, 3), tmp29, (4, 2), (0, 4, 3, 1))
    del tmp29
    ...
    del tmp31
    tmp32 = einsum(f.oo, (0, 1), l2, (2, 3, 4, 1), (0, 4, 2, 3))
...
def make_rdm1_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:48:50.395475.
...
def make_rdm2_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:53:02.825286.
    ...
    rdm2.vvvv = np.copy(np.transpose(tmp31, (1, 0, 2, 3))) * -2
    rdm2.vvvv += np.transpose(tmp31, (1, 0, 3, 2)) * 4
    del tmp31
    tmp0 = np.copy(np.transpose(t2, (0, 1, 3, 2)))
    tmp0 += t2 * -0.5
    ...
    tmp26 = einsum(tmp25, (0, 1, 2, 3), t2, (4, 0, 5, 3), (4, 1, 5, 2))
    del tmp25
    rdm2.ovvo = np.copy(np.transpose(tmp26, (0, 3, 2, 1))) * 4
    tmp27 = np.copy(np.transpose(l2, (3, 2, 0, 1)))
    tmp27 += np.transpose(l2, (2, 3, 0, 1)) * -1
    tmp28 = einsum(t2, (0, 1, 2, 3), tmp27, (1, 4, 5, 2), (0, 4, 3, 5))
    del tmp27
    rdm2.ovvo += np.transpose(tmp28, (0, 3, 2, 1)) * -2
    del tmp28
    ...
    tmp30 = einsum(t2, (0, 1, 2, 3), tmp6, (1, 4, 5, 2), (0, 4, 3, 5))
    rdm2.vovo += np.transpose(tmp30, (3, 0, 2, 1)) * -2
    del tmp30
    tmp29 = einsum(tmp12, (0, 1, 2, 3), t2, (0, 1, 3, 4), (4, 2))
    del tmp12
    rdm2.vovo += einsum(delta.oo, (0, 1), tmp29, (2, 3), (3, 0, 2, 1)) * 4
    ...
    del tmp22
    rdm2.voov += einsum(delta.oo, (0, 1), tmp29, (2, 3), (3, 0, 1, 2)) * -2
    del delta, tmp29
    rdm2.voov += np.transpose(tmp17, (2, 1, 0, 3)) * -2
    rdm2.voov += np.transpose(tmp26, (3, 0, 1, 2)) * 2
    del tmp26
    ...
    rdm2.oovv += tmp10 * -4
    del tmp10
    tmp11 = einsum(tmp2, (0, 1, 2, 3), t2, (1, 0, 4, 5), (2, 3, 5, 4))
    del tmp2
    rdm2.oovv += tmp11 * 4
    ...
    del tmp14
    tmp15 = einsum(tmp1, (0, 1), t2, (2, 0, 3, 4), (2, 1, 4, 3))
    del tmp1
...
def hbar_matvec_ip_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:54:54.340839.
    ...
    tmp30 = einsum(t2, (0, 1, 2, 3), v.ovov, (0, 3, 1, 4), (2, 4))
    tmp32 = einsum(v.ovov, (0, 1, 2, 3), t2, (0, 2, 4, 3), (4, 1))
...
def hbar_matvec_ip(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:54:54.963652.
    ...
    tmp9 = einsum(tmp8, (0, 1, 2, 3), r2, (0, 1, 3), (2,))
    del tmp8
...
def hbar_matvec_ea_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:56:34.840011.
    ...
    tmp11 = einsum(t2, (0, 1, 2, 3), v.ooov, (4, 1, 0, 5), (4, 3, 2, 5))
...
def hbar_matvec_ea(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:56:35.363083.
    ...
    del ints.tmp6
    r2new += einsum(tmp7, (0, 1, 2, 3), r1, (3,), (1, 2, 0)) * -1
    del tmp7
    ...
    del tmp8
    r2new += einsum(t2, (0, 1, 2, 3), tmp9, (1,), (2, 3, 0))
    del tmp9
    tmp10 = np.copy(f.oo)
...
def hbar_lmatvec_ip_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:58:55.427245.
...
def hbar_lmatvec_ip(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:58:56.004660.
    ...
    r2new += einsum(r2, (0, 1, 2), ints.tmp49, (1, 0, 3, 4), (4, 3, 2))
    del ints.tmp49
    ...
    tmp8 += ints.tmp53 * -2
    del ints.tmp53
    r2new += einsum(tmp8, (0, 1), r2, (2, 3, 0), (2, 3, 1))
    del tmp8
    tmp9 = np.copy(np.transpose(t2, (0, 1, 3, 2)))
    tmp9 += t2 * -0.5
    tmp10 = einsum(tmp9, (0, 1, 2, 3), r2, (0, 1, 3), (2,))
    del tmp9
    r2new += einsum(tmp10, (0,), v.ovov, (1, 2, 3, 0), (1, 3, 2)) * -2
    del tmp10
    r2new += einsum(tmp4, (0, 1), r2, (0, 2, 3), (1, 2, 3)) * -1
...
def hbar_lmatvec_ea_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T22:01:09.500141.
    ...
    tmp0 = einsum(t2, (0, 1, 2, 3), f.ov, (1, 2), (0, 3))
    tmp9 = einsum(t2, (0, 1, 2, 3), v.ovov, (0, 3, 1, 4), (2, 4))
    tmp13 = einsum(v.ooov, (0, 1, 2, 3), t2, (2, 1, 4, 3), (0, 4))
    tmp22 = einsum(v.ovvv, (0, 1, 2, 3), t2, (4, 0, 3, 1), (4, 2))
    tmp1 = einsum(t2, (0, 1, 2, 3), f.ov, (1, 3), (0, 2))
    tmp11 = einsum(t2, (0, 1, 2, 3), v.ovov, (0, 2, 1, 4), (3, 4))
    tmp16 = einsum(v.ooov, (0, 1, 2, 3), t2, (2, 1, 3, 4), (0, 4))
    tmp19 = einsum(t2, (0, 1, 2, 3), v.ooov, (4, 1, 0, 5), (4, 3, 2, 5))
...
def hbar_lmatvec_ea(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T22:01:09.989216.
    ...
    r2new += einsum(v.ovov, (0, 1, 2, 3), tmp7, (4, 2, 0), (3, 1, 4))
    del tmp7
    ...
    del ints.tmp41
    tmp10 += v.oovv * -1
    r2new += einsum(tmp10, (0, 1, 2, 3), r2, (4, 2, 0), (4, 3, 1))
    r2new += einsum(r2, (0, 1, 2), tmp10, (2, 3, 0, 4), (4, 1, 3))
    del tmp10
    r2new += einsum(tmp4, (0, 1), r2, (0, 2, 3), (1, 2, 3))
    r2new += einsum(tmp4, (0, 1), r2, (2, 0, 3), (2, 1, 3))
    del tmp4
    tmp11 = np.copy(f.oo)
    tmp11 += ints.tmp39 * 2
    del ints.tmp39
    ...
    del tmp5
    r2new += einsum(v.ovov, (0, 1, 2, 3), tmp12, (2,), (1, 3, 0)) * -2
    del tmp12
