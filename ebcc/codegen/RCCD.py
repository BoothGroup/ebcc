...
https://github.com/obackhouse/albert
  ...
  * date: 2024-10-20T09:35:50.304340
...
def energy(t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:35:55.228366.
...
def update_amps(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:37:03.216157.
    ...
    del tmp3
    tmp5 = einsum(tmp4, (0, 1, 2, 3), t2, (4, 1, 3, 5), (4, 0, 5, 2))
    t2new += np.transpose(tmp5, (1, 0, 3, 2)) * -1
    t2new += tmp5 * -1
    del tmp5
    tmp6 = np.copy(np.transpose(v.ovov, (0, 2, 3, 1)))
    tmp6 += np.transpose(v.ovov, (0, 2, 1, 3)) * -0.5
    tmp7 = einsum(tmp6, (0, 1, 2, 3), t2, (0, 1, 4, 2), (4, 3))
    tmp8 = einsum(tmp7, (0, 1), t2, (2, 3, 1, 4), (2, 3, 4, 0)) * 2
    del tmp7
    tmp11 = np.copy(np.transpose(tmp8, (1, 0, 2, 3)))
    del tmp8
    tmp9 = einsum(t2, (0, 1, 2, 3), tmp6, (1, 4, 2, 3), (0, 4)) * 2
    del tmp6
    tmp10 = einsum(tmp9, (0, 1), t2, (2, 1, 3, 4), (2, 0, 4, 3))
    del tmp9
    ...
    tmp13 += einsum(v.ovov, (0, 1, 2, 3), t2, (4, 5, 1, 3), (0, 4, 2, 5))
    ...
    t2new += einsum(t2, (0, 1, 2, 3), tmp15, (4, 1, 5, 2), (4, 0, 3, 5))
    del tmp15
...
def update_lams(f=None, l2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:38:40.142405.
    ...
    tmp4 += tmp3
    del tmp3
    tmp5 = einsum(l2, (0, 1, 2, 3), tmp4, (2, 4, 1, 5), (3, 4, 0, 5))
    del tmp4
    tmp6 += tmp5
    del tmp5
    ...
    del tmp6
    tmp7 = einsum(l2, (0, 1, 2, 3), f.oo, (4, 3), (4, 2, 0, 1))
    l2new += np.transpose(tmp7, (3, 2, 0, 1)) * -1
    l2new += np.transpose(tmp7, (2, 3, 1, 0)) * -1
    del tmp7
    tmp8 = einsum(v.oovv, (0, 1, 2, 3), l2, (4, 3, 5, 1), (5, 0, 4, 2))
    tmp18 = np.copy(tmp8)
    del tmp8
    tmp13 = np.copy(np.transpose(v.ovov, (0, 2, 3, 1))) * -1
    tmp13 += np.transpose(v.ovov, (0, 2, 1, 3)) * 2
    tmp9 = einsum(t2, (0, 1, 2, 3), l2, (4, 2, 5, 1), (5, 0, 4, 3))
    tmp12 = np.copy(tmp9)
    del tmp9
    tmp10 = np.copy(np.transpose(l2, (3, 2, 0, 1))) * 2
    tmp10 += np.transpose(l2, (2, 3, 0, 1)) * -1
    tmp11 = einsum(t2, (0, 1, 2, 3), tmp10, (1, 4, 5, 3), (0, 4, 2, 5))
    del tmp10
    tmp12 += np.transpose(tmp11, (1, 0, 3, 2)) * -1
    del tmp11
    tmp14 = einsum(tmp13, (0, 1, 2, 3), tmp12, (4, 0, 5, 2), (4, 1, 5, 3))
    del tmp13, tmp12
    tmp18 += tmp14
    del tmp14
    ...
    tmp16 = np.copy(tmp15)
    del tmp15
    tmp16 += np.transpose(l2, (3, 2, 0, 1)) * -1
    tmp16 += np.transpose(l2, (2, 3, 0, 1)) * 2
    tmp17 = einsum(tmp16, (0, 1, 2, 3), v.ovov, (4, 5, 1, 3), (0, 4, 2, 5))
    del tmp16
    tmp18 += tmp17 * -1
    del tmp17
    l2new += np.transpose(tmp18, (2, 3, 0, 1)) * -1
    l2new += np.transpose(tmp18, (3, 2, 1, 0)) * -1
    del tmp18
    tmp19 = np.copy(np.transpose(t2, (0, 1, 3, 2))) * -1
    tmp19 += t2 * 2
    tmp20 = einsum(v.ovov, (0, 1, 2, 3), tmp19, (0, 2, 4, 3), (4, 1)) * 0.5
    tmp21 = einsum(l2, (0, 1, 2, 3), tmp20, (1, 4), (3, 2, 0, 4)) * 2
    del tmp20
    tmp24 = np.copy(np.transpose(tmp21, (1, 0, 2, 3)))
    del tmp21
    tmp22 = einsum(v.ovov, (0, 1, 2, 3), tmp19, (2, 4, 3, 1), (4, 0))
    del tmp19
    tmp23 = einsum(tmp22, (0, 1), l2, (2, 3, 0, 4), (4, 1, 2, 3))
    del tmp22
    ...
    tmp25 += t2 * -0.5
    tmp26 = einsum(tmp25, (0, 1, 2, 3), l2, (4, 2, 0, 1), (4, 3)) * 2
    tmp27 = einsum(v.ovov, (0, 1, 2, 3), tmp26, (4, 1), (0, 2, 4, 3))
    del tmp26
    tmp30 = np.copy(np.transpose(tmp27, (1, 0, 2, 3)))
    del tmp27
    tmp28 = einsum(tmp25, (0, 1, 2, 3), l2, (3, 2, 0, 4), (4, 1)) * 2
    del tmp25
    tmp29 = einsum(v.ovov, (0, 1, 2, 3), tmp28, (4, 2), (4, 0, 3, 1))
    del tmp28
...
def make_rdm1_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:38:48.273216.
...
def make_rdm2_f(l2=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:42:43.715051.
    ...
    tmp22 += t2
    tmp23 = einsum(l2, (0, 1, 2, 3), tmp22, (2, 4, 1, 5), (3, 4, 0, 5))
    del tmp22
    ...
    tmp14 = einsum(tmp13, (0, 1, 2, 3), t2, (0, 1, 4, 3), (4, 2)) * 0.5
    ...
    rdm2.ovvo = np.copy(np.transpose(tmp4, (1, 2, 3, 0))) * 4
    ...
    rdm2.vovo = np.copy(np.transpose(tmp4, (2, 1, 3, 0))) * -2
    tmp27 = np.copy(np.transpose(l2, (3, 2, 0, 1))) * -1
    tmp27 += np.transpose(l2, (2, 3, 0, 1))
    tmp28 = einsum(tmp27, (0, 1, 2, 3), t2, (4, 0, 3, 5), (4, 1, 5, 2))
    del tmp27
    rdm2.vovo += np.transpose(tmp28, (3, 0, 2, 1)) * -2
    del tmp28
    tmp26 = einsum(tmp13, (0, 1, 2, 3), t2, (0, 1, 4, 3), (4, 2))
    del tmp13
    ...
    rdm2.voov += np.transpose(tmp4, (2, 1, 0, 3)) * 2
    ...
    del tmp9
    tmp10 = einsum(tmp3, (0, 1, 2, 3), t2, (4, 0, 3, 5), (1, 4, 2, 5))
    del tmp3
    tmp11 = einsum(t2, (0, 1, 2, 3), tmp10, (1, 4, 3, 5), (0, 4, 2, 5))
    del tmp10
    rdm2.oovv += tmp11 * -4
    ...
    del tmp15
    tmp16 = einsum(t2, (0, 1, 2, 3), tmp1, (1, 4), (4, 0, 3, 2))
    del tmp1
    ...
    del tmp17
    tmp19 = einsum(t2, (0, 1, 2, 3), tmp18, (1, 4, 2, 5), (4, 0, 5, 3))
    del tmp18
    rdm2.oovv += tmp19 * 2
    del tmp19
    tmp21 = einsum(t2, (0, 1, 2, 3), tmp20, (1, 4, 2, 5), (4, 0, 5, 3))
    del tmp20
...
def hbar_matvec_ip_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:44:26.940429.
...
def hbar_matvec_ip(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:44:27.578451.
    ...
    r2new += einsum(tmp4, (0, 1, 2, 3), tmp3, (1, 4, 3), (0, 4, 2)) * 2
    del tmp4, tmp3
...
def hbar_matvec_ea_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:46:00.588805.
    ...
    tmp20 = einsum(t2, (0, 1, 2, 3), v.ovvv, (1, 3, 4, 2), (0, 4))
    ...
    tmp37 = einsum(v.ooov, (0, 1, 2, 3), t2, (2, 1, 4, 3), (0, 4))
    tmp38 = einsum(v.ooov, (0, 1, 2, 3), t2, (1, 2, 4, 3), (0, 4))
...
def hbar_matvec_ea(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:46:01.118648.
    ...
    r2new += einsum(tmp4, (0, 1, 2), tmp5, (3, 0, 4, 2), (4, 1, 3)) * 2
    del tmp4, tmp5
...
def hbar_lmatvec_ip_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:48:16.507822.
    ...
    tmp37 = einsum(t2, (0, 1, 2, 3), v.ovov, (4, 5, 1, 3), (0, 4, 2, 5))
    tmp49 = einsum(t2, (0, 1, 2, 3), v.ovov, (4, 2, 5, 3), (0, 1, 4, 5))
    tmp51 = einsum(v.ovov, (0, 1, 2, 3), t2, (0, 2, 4, 1), (4, 3))
...
def hbar_lmatvec_ip(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:48:17.074254.
    ...
    del tmp10
    r2new += einsum(tmp11, (0,), v.ovov, (1, 2, 3, 0), (1, 3, 2)) * -2
    del tmp11
...
def hbar_lmatvec_ea_intermediates(f=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:50:19.621219.
    ...
    tmp13 = einsum(t2, (0, 1, 2, 3), v.ooov, (4, 0, 1, 2), (4, 3))
    ...
    tmp19 = einsum(v.ooov, (0, 1, 2, 3), t2, (1, 2, 4, 5), (0, 4, 5, 3))
    ...
    tmp45 = einsum(t2, (0, 1, 2, 3), v.ovov, (4, 5, 1, 3), (0, 4, 2, 5))
...
def hbar_lmatvec_ea(f=None, r1=None, r2=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:50:20.067397.
    ...
    tmp3 += ints.tmp25 * -0.5
    del ints.tmp25
    r1new += einsum(tmp0, (0, 1, 2), tmp3, (0, 1), (2,)) * -2
    del tmp0, tmp3
    tmp4 = np.copy(f.vv)
    tmp4 += ints.tmp9
    del ints.tmp9
    ...
    tmp9 += ints.tmp44 * -1
    del ints.tmp44
    tmp8 = np.copy(np.transpose(r2, (2, 0, 1))) * -0.5
    tmp8 += np.transpose(r2, (2, 1, 0))
    r2new += einsum(tmp8, (0, 1, 2), tmp9, (0, 3, 2, 4), (4, 1, 3)) * 2
    del tmp8, tmp9
