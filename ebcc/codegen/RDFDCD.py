 ...
 * date: 2024-11-27T09:30:02.839383
...
def update_amps(f=None, t2=None, v=None, **kwargs):
    ...
    t2new += einsum(t2, (0, 1, 2, 3), tmp3, (4, 2, 5, 3), (0, 1, 5, 4))
    del tmp3
    ...
    t2new += np.transpose(tmp7, (1, 0, 2, 3)) * -1
    del tmp7
    tmp8 = einsum(v.xov, (0, 1, 2), tmp1, (3, 4, 0), (3, 1, 4, 2))
    tmp19 = np.copy(tmp8)
    del tmp8
    ...
    tmp9 += tmp1 * -1
    del tmp1
    tmp10 = einsum(v.xov, (0, 1, 2), tmp9, (3, 4, 0), (1, 3, 2, 4)) * 2
    del tmp9
    ...
    tmp16 = einsum(t2, (0, 1, 2, 3), tmp15, (2, 4), (0, 1, 3, 4))
    del tmp15
    tmp19 += np.transpose(tmp16, (1, 0, 2, 3))
    del tmp16
    tmp17 = einsum(tmp14, (0, 1, 2), v.xov, (2, 3, 1), (3, 0))
    del tmp14
    tmp18 = einsum(tmp17, (0, 1), t2, (2, 0, 3, 4), (2, 1, 4, 3)) * 0.5
    del tmp17
