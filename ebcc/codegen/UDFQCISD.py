...
def energy(f=None, v=None, nocc=None, nvir=None, naux=None, t1=None, t2=None, **kwargs):
    ...
    del x0
    x1 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
...
def update_amps(f=None, v=None, nocc=None, nvir=None, naux=None, t1=None, t2=None, **kwargs):
    ...
    x3 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    ...
    del x3
    x4 = np.zeros((nocc[0], nocc[0], naux), dtype=np.float64)
    ...
    del x8
    x9 = np.zeros((nocc[1], nocc[1], naux), dtype=np.float64)
    ...
    x11 = np.zeros((naux,), dtype=np.float64)
    x11 += einsum(t1.aa, (0, 1), v.aaa.xov, (2, 0, 1), (2,))
    x12 = np.zeros((naux,), dtype=np.float64)
    x12 += einsum(t1.bb, (0, 1), v.abb.xov, (2, 0, 1), (2,))
    x13 = np.zeros((naux,), dtype=np.float64)
    x13 += einsum(x11, (0,), (0,))
    del x11
    x13 += einsum(x12, (0,), (0,))
    del x12
    ...
    x25 = np.zeros((nocc[1], nocc[1], naux), dtype=np.float64)
    ...
    del x26
    x27 = np.zeros((nocc[1], nocc[1], naux), dtype=np.float64)
    ...
    del x28
    x29 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    ...
    x39 = np.zeros((nocc[0], nocc[1], nvir[0], nvir[1]), dtype=np.float64)
    ...
    del x49
    x50 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    ...
    x53 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    ...
    del x60
    x61 = np.zeros((nvir[0], nvir[0], nvir[1], nvir[1]), dtype=np.float64)
    x61 += einsum(v.aaa.xvv, (0, 1, 2), v.abb.xvv, (0, 3, 4), (1, 2, 3, 4))
    t2new_abab += einsum(t2.abab, (0, 1, 2, 3), x61, (4, 2, 5, 3), (0, 1, 4, 5))
    del x61
    x62 = np.zeros((nocc[1], nocc[1], nvir[0], nvir[0]), dtype=np.float64)
    ...
    x64 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    ...
    x69 = np.zeros((nocc[0], nocc[0], nvir[1], nvir[1]), dtype=np.float64)
    ...
    del x69
    x70 = np.zeros((nocc[0], nvir[0], naux), dtype=np.float64)
    ...
    del x70
    x71 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    x71 += einsum(t1.bb, (0, 1), v.abb.xvv, (2, 3, 1), (0, 3, 2))
    x72 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    ...
    del x72
    x73 = np.zeros((nvir[1], nvir[1]), dtype=np.float64)
    ...
    del x74
    x75 = np.zeros((nocc[0], nocc[0], nocc[1], nocc[1]), dtype=np.float64)
    ...
    del x76
    x77 = np.zeros((nvir[1], nvir[1], nvir[1], nvir[1]), dtype=np.float64)
    ...
    x93 = np.zeros((nocc[0], nocc[1], nvir[0], nvir[1]), dtype=np.float64)
    ...
    del x95
    x96 = np.zeros((nocc[1], nocc[1], nocc[1], nocc[1]), dtype=np.float64)
