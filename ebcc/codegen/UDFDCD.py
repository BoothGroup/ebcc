...
def update_amps(f=None, v=None, nocc=None, nvir=None, naux=None, t2=None, **kwargs):
    ...
    x25 = np.zeros((nocc[0], nocc[0], nvir[1], nvir[1]), dtype=np.float64)
    ...
    x31 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
    ...
    del x37
    x38 = np.zeros((nvir[1], nvir[1], nvir[1], nvir[1]), dtype=np.float64)
    ...
    del x43
    x44 = np.zeros((nocc[1], nvir[1], naux), dtype=np.float64)
