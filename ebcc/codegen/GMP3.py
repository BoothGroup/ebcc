...
def energy(f=None, v=None, nocc=None, nvir=None, t2=None, **kwargs):
    ...
    x1 += einsum(v.oovv, (0, 1, 2, 3), (0, 1, 2, 3))
    x1 += einsum(t2, (0, 1, 2, 3), v.ovov, (4, 3, 1, 5), (4, 0, 5, 2)) * -4.0
    x1 += einsum(t2, (0, 1, 2, 3), v.vvvv, (4, 5, 2, 3), (0, 1, 4, 5)) * 0.5
    e_mp += einsum(t2, (0, 1, 2, 3), x1, (0, 1, 2, 3), ()) * 0.25
