...
def update_amps(f=None, v=None, space=None, t1=None, t2=None, t3=None, **kwargs):
    ...
    del x11
    x12 = np.zeros((naocc, navir, navir, nocc), dtype=np.float64)
    ...
    del x12
    x13 = np.zeros((naocc, naocc, navir, nvir), dtype=np.float64)
    ...
    del x30
    x31 = np.zeros((naocc, naocc, navir, nocc), dtype=np.float64)
    x31 += einsum(t1[np.ix_(so,sv)], (0, 1), v.vVOO, (1, 2, 3, 4), (3, 4, 2, 0)) * -1.0
    x32 = np.zeros((naocc, navir, navir, nocc), dtype=np.float64)
    ...
    del x32
    x33 = np.zeros((naocc, naocc, navir, nocc), dtype=np.float64)
    x33 += einsum(v.oOVV, (0, 1, 2, 3), t3, (4, 5, 1, 6, 2, 3), (4, 5, 6, 0)) * -1.0
    x34 = np.zeros((naocc, naocc, navir, nvir), dtype=np.float64)
    ...
    del x53
    x54 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x54
    x55 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x55
    x56 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x56
    x57 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x57
    x58 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x58
    x59 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x59
    x60 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x60
    x61 = np.zeros((naocc, naocc), dtype=np.float64)
    x61 += einsum(f.vO, (0, 1), t1[np.ix_(sO,sv)], (2, 0), (1, 2))
    x62 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x62
    x63 = np.zeros((navir, navir), dtype=np.float64)
    x63 += einsum(f.oV, (0, 1), t1[np.ix_(so,sV)], (0, 2), (1, 2))
    x64 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    x66 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x66
    x67 = np.zeros((naocc, naocc, naocc, navir, navir, nocc), dtype=np.float64)
    x67 += einsum(t2[np.ix_(so,sO,sV,sV)], (0, 1, 2, 3), v.ooOO, (4, 0, 5, 6), (1, 5, 6, 2, 3, 4)) * -1.0
    x68 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    x70 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x70
    x71 = np.zeros((naocc, naocc, naocc, navir, navir, nocc), dtype=np.float64)
    x71 += einsum(t2[np.ix_(sO,sO,sv,sV)], (0, 1, 2, 3), v.oVvO, (4, 5, 2, 6), (0, 1, 6, 3, 5, 4)) * -1.0
    x72 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x72
    x73 = np.zeros((naocc, naocc, navir, navir, navir, nvir), dtype=np.float64)
    x73 += einsum(t2[np.ix_(sO,sO,sv,sV)], (0, 1, 2, 3), v.vvVV, (4, 2, 5, 6), (0, 1, 3, 5, 6, 4)) * -1.0
    x74 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x74
    x75 = np.zeros((naocc, naocc, naocc, naocc), dtype=np.float64)
    x75 += einsum(t1[np.ix_(sO,sv)], (0, 1), v.vOOO, (1, 2, 3, 4), (0, 3, 4, 2)) * -1.0
    x76 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x76
    x77 = np.zeros((naocc, naocc, navir, navir), dtype=np.float64)
    x77 += einsum(t1[np.ix_(so,sV)], (0, 1), v.oOOV, (0, 2, 3, 4), (3, 2, 1, 4)) * -1.0
    x78 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x78
    x79 = np.zeros((naocc, naocc), dtype=np.float64)
    x79 += einsum(t1[np.ix_(so,sv)], (0, 1), v.oOvO, (0, 2, 1, 3), (2, 3))
    x80 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x80
    x81 = np.zeros((naocc, naocc, navir, navir), dtype=np.float64)
    x81 += einsum(t1[np.ix_(sO,sv)], (0, 1), v.vVOV, (1, 2, 3, 4), (0, 3, 4, 2)) * -1.0
    x82 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x82
    x83 = np.zeros((navir, navir, navir, navir), dtype=np.float64)
    x83 += einsum(t1[np.ix_(so,sV)], (0, 1), v.oVVV, (0, 2, 3, 4), (1, 3, 4, 2)) * -1.0
    x84 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x84
    x85 = np.zeros((navir, navir), dtype=np.float64)
    x85 += einsum(t1[np.ix_(so,sv)], (0, 1), v.oVvV, (0, 2, 1, 3), (2, 3))
    x86 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x86
    x87 = np.zeros((naocc, naocc, navir, nocc), dtype=np.float64)
    x87 += einsum(t2[np.ix_(so,sO,sv,sV)], (0, 1, 2, 3), v.oovO, (4, 0, 2, 5), (1, 5, 3, 4)) * -1.0
    x88 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x88
    x89 = np.zeros((naocc, navir, navir, nvir), dtype=np.float64)
    x89 += einsum(t2[np.ix_(so,so,sV,sV)], (0, 1, 2, 3), v.oovO, (0, 1, 4, 5), (5, 2, 3, 4)) * -1.0
    x90 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x90
    x91 = np.zeros((naocc, navir, navir, nvir), dtype=np.float64)
    x91 += einsum(t2[np.ix_(so,sO,sv,sV)], (0, 1, 2, 3), v.oVvv, (0, 4, 5, 2), (1, 3, 4, 5)) * -1.0
    x92 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x92
    x93 = np.zeros((naocc, naocc, navir, nocc), dtype=np.float64)
    x93 += einsum(t2[np.ix_(sO,sO,sv,sv)], (0, 1, 2, 3), v.oVvv, (4, 5, 2, 3), (0, 1, 5, 4)) * -1.0
    x94 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x94
    x95 = np.zeros((naocc, naocc, naocc, naocc, navir, navir), dtype=np.float64)
    x95 += einsum(t2[np.ix_(sO,sO,sv,sV)], (0, 1, 2, 3), v.vVOO, (2, 4, 5, 6), (0, 1, 5, 6, 3, 4))
    x96 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x96
    x97 = np.zeros((naocc, naocc, naocc, naocc), dtype=np.float64)
    x97 += einsum(t2[np.ix_(sO,sO,sv,sv)], (0, 1, 2, 3), v.vvOO, (2, 3, 4, 5), (0, 1, 4, 5))
    x98 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x98
    x99 = np.zeros((naocc, naocc, navir, navir, navir, navir), dtype=np.float64)
    x99 += einsum(t2[np.ix_(so,sO,sV,sV)], (0, 1, 2, 3), v.oOVV, (0, 4, 5, 6), (1, 4, 2, 3, 5, 6))
    x100 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x100
    x101 = np.zeros((naocc, naocc, navir, navir), dtype=np.float64)
    x101 += einsum(t2[np.ix_(so,sO,sv,sV)], (0, 1, 2, 3), v.oOvV, (0, 4, 2, 5), (1, 4, 3, 5))
    x102 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x102
    x103 = np.zeros((naocc, naocc), dtype=np.float64)
    x103 += einsum(t2[np.ix_(so,sO,sv,sv)], (0, 1, 2, 3), v.oOvv, (0, 4, 2, 3), (1, 4))
    x104 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    x106 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x106
    x107 = np.zeros((navir, navir), dtype=np.float64)
    x107 += einsum(t2[np.ix_(so,so,sv,sV)], (0, 1, 2, 3), v.oovV, (0, 1, 2, 4), (3, 4))
    x108 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x108
    x109 = np.zeros((naocc, naocc, navir, navir, navir, nvir), dtype=np.float64)
    ...
    del x110
    x111 = np.zeros((naocc, navir, navir, nvir), dtype=np.float64)
    ...
    del x112
    x113 = np.zeros((naocc, naocc, navir, navir, navir, nvir), dtype=np.float64)
    ...
    del x114
    x115 = np.zeros((naocc, naocc, navir, navir, navir, nvir), dtype=np.float64)
    ...
    del x116
    x117 = np.zeros((naocc, naocc, naocc, nvir), dtype=np.float64)
    x117 += einsum(t1[np.ix_(sO,sv)], (0, 1), v.vvOO, (2, 1, 3, 4), (0, 3, 4, 2))
    x118 = np.zeros((naocc, naocc, naocc, naocc), dtype=np.float64)
    ...
    del x119
    x120 = np.zeros((naocc, naocc, navir, nocc), dtype=np.float64)
    x120 += einsum(t1[np.ix_(sO,sv)], (0, 1), v.oOvV, (2, 3, 1, 4), (0, 3, 4, 2))
    x121 = np.zeros((naocc, naocc, navir, navir), dtype=np.float64)
    x121 += einsum(t1[np.ix_(so,sV)], (0, 1), x120, (2, 3, 4, 0), (2, 3, 1, 4))
    del x120
    x122 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x122
    x123 = np.zeros((naocc, nvir), dtype=np.float64)
    x123 += einsum(t1[np.ix_(so,sv)], (0, 1), v.oOvv, (0, 2, 3, 1), (2, 3)) * -1.0
    x124 = np.zeros((naocc, naocc), dtype=np.float64)
    ...
    del x125
    x126 = np.zeros((navir, navir, navir, nocc), dtype=np.float64)
    x126 += einsum(t1[np.ix_(so,sV)], (0, 1), v.ooVV, (2, 0, 3, 4), (1, 3, 4, 2))
    x127 = np.zeros((navir, navir, navir, navir), dtype=np.float64)
    x127 += einsum(t1[np.ix_(so,sV)], (0, 1), x126, (2, 3, 4, 0), (2, 1, 4, 3))
    del x126
    x128 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x128
    x129 = np.zeros((navir, nocc), dtype=np.float64)
    x129 += einsum(t1[np.ix_(so,sv)], (0, 1), v.oovV, (2, 0, 1, 3), (3, 2)) * -1.0
    x130 = np.zeros((navir, navir), dtype=np.float64)
    ...
    del x131
    x132 = np.zeros((naocc, navir, nocc, nvir), dtype=np.float64)
    x132 += einsum(t2[np.ix_(so,sO,sv,sV)], (0, 1, 2, 3), v.oovv, (4, 0, 5, 2), (1, 3, 4, 5))
    x133 = np.zeros((naocc, naocc, navir, nocc), dtype=np.float64)
    x133 += einsum(t1[np.ix_(sO,sv)], (0, 1), x132, (2, 3, 4, 1), (0, 2, 3, 4))
    x134 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x134
    x135 = np.zeros((naocc, naocc, naocc, navir, nocc, nocc), dtype=np.float64)
    x135 += einsum(t1[np.ix_(sO,sv)], (0, 1), t2[np.ix_(sO,sO,sv,sV)], (2, 3, 4, 5), v.oovv, (6, 7, 4, 1), (0, 2, 3, 5, 6, 7))
    x136 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x136
    x137 = np.zeros((naocc, naocc, naocc, navir, navir, nocc), dtype=np.float64)
    x137 += einsum(t2[np.ix_(sO,sO,sv,sV)], (0, 1, 2, 3), x132, (4, 5, 6, 2), (0, 1, 4, 3, 5, 6)) * -1.0
    del x132
    x138 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x138
    x139 = np.zeros((naocc, naocc, nocc, nocc), dtype=np.float64)
    ...
    del x141
    x142 = np.zeros((naocc, naocc, navir, nocc), dtype=np.float64)
    ...
    del x143
    x144 = np.zeros((naocc, naocc, navir, navir, nocc, nvir), dtype=np.float64)
    x144 += einsum(t1[np.ix_(sO,sv)], (0, 1), t2[np.ix_(so,sO,sV,sV)], (2, 3, 4, 5), v.oovv, (6, 2, 7, 1), (0, 3, 4, 5, 6, 7)) * -1.0
    x145 = np.zeros((naocc, naocc, naocc, navir, navir, nocc), dtype=np.float64)
    x145 += einsum(t1[np.ix_(sO,sv)], (0, 1), x144, (2, 3, 4, 5, 6, 1), (2, 0, 3, 4, 5, 6)) * -1.0
    del x144
    x146 = np.zeros((naocc, naocc, naocc, navir, navir, navir), dtype=np.float64)
    ...
    del x146
    x147 = np.zeros((naocc, naocc, navir, navir, nocc, nvir), dtype=np.float64)
    x147 += einsum(t1[np.ix_(so,sV)], (0, 1), t2[np.ix_(sO,sO,sv,sV)], (2, 3, 4, 5), v.oovv, (6, 0, 7, 4), (2, 3, 1, 5, 6, 7)) * -1.0
    x148 = np.zeros((naocc, naocc, naocc, navir, navir, nocc), dtype=np.float64)
