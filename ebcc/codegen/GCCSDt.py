...
def update_amps(f=None, v=None, space=None, t1=None, t2=None, t3=None, **kwargs):
    ...
    t1new[np.ix_(so,sv)] += einsum(v.oOvV, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 0, 1, 5, 2, 3), (4, 5)) * 0.25
    t2new = np.zeros((nocc, nocc, nvir, nvir), dtype=np.float64)
    t2new[np.ix_(so,so,sv,sv)] += einsum(v.oovv, (0, 1, 2, 3), (0, 1, 2, 3))
    t2new[np.ix_(so,so,sv,sv)] += einsum(f.OV, (0, 1), t3[np.ix_(so,so,sO,sv,sv,sV)], (2, 3, 0, 4, 5, 1), (2, 3, 4, 5))
    ...
    t3new += einsum(v.oooo, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (2, 3, 4, 5, 6, 7), (0, 1, 4, 5, 6, 7)) * 0.5
    t3new += einsum(v.OVOV, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 5, 2, 6, 7, 1), (4, 5, 0, 6, 7, 3)) * -1.0
    t3new += einsum(v.vvvv, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 5, 6, 2, 3, 7), (4, 5, 6, 0, 1, 7)) * 0.5
    ...
    x12 += einsum(v.oOoV, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 0, 1, 5, 6, 3), (4, 2, 5, 6))
    ...
    x13 += einsum(v.vOvV, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 5, 1, 6, 2, 3), (4, 5, 6, 0))
    ...
    del x30
    x31 = np.zeros((naocc, navir, nocc, nocc), dtype=np.float64)
    x31 += einsum(t1[np.ix_(so,sv)], (0, 1), v.oOvV, (2, 3, 1, 4), (3, 4, 0, 2))
    x32 = np.zeros((nocc, nocc, nvir, nvir), dtype=np.float64)
    x32 += einsum(x31, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 3, 0, 5, 6, 1), (2, 4, 5, 6))
    del x31
    ...
    x33 += einsum(v.oOvV, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 5, 1, 6, 2, 3), (4, 5, 0, 6))
    ...
    del x34
    x35 = np.zeros((naocc, navir), dtype=np.float64)
    x35 += einsum(t1[np.ix_(so,sv)], (0, 1), v.oOvV, (0, 2, 1, 3), (2, 3))
    t2new[np.ix_(so,so,sv,sv)] += einsum(x35, (0, 1), t3[np.ix_(so,so,sO,sv,sv,sV)], (2, 3, 0, 4, 5, 1), (2, 3, 4, 5))
    del x35
    ...
    x37 += einsum(t2[np.ix_(so,so,sv,sv)], (0, 1, 2, 3), x36, (4, 1, 5, 3), (0, 4, 2, 5))
    del x36
    ...
    t3new += einsum(x41, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (2, 3, 4, 5, 6, 7), (1, 0, 4, 5, 6, 7)) * -0.25
    ...
    t2new[np.ix_(so,so,sv,sv)] += einsum(t2[np.ix_(so,so,sv,sv)], (0, 1, 2, 3), x46, (4, 5, 1, 0), (5, 4, 2, 3)) * 0.5
    t3new += einsum(x46, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (3, 2, 4, 5, 6, 7), (1, 0, 4, 5, 6, 7)) * 0.5
    ...
    del x53
    x54 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x54 += einsum(f.oo, (0, 1), t3[np.ix_(so,so,sO,sv,sv,sV)], (2, 1, 3, 4, 5, 6), (3, 6, 0, 2, 4, 5))
    t3new += einsum(x54, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1)) * -1.0
    t3new += einsum(x54, (0, 1, 2, 3, 4, 5), (3, 2, 0, 5, 4, 1))
    del x54
    x55 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x55 += einsum(f.vv, (0, 1), t3[np.ix_(so,so,sO,sv,sv,sV)], (2, 3, 4, 5, 1, 6), (4, 6, 2, 3, 0, 5))
    t3new += einsum(x55, (0, 1, 2, 3, 4, 5), (2, 3, 0, 4, 5, 1)) * -1.0
    t3new += einsum(x55, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1))
    del x55
    x56 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x56
    x57 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x57
    x58 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x58
    x59 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x59
    x60 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x60
    x61 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x61
    x62 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x62 += einsum(v.oOoO, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 2, 3, 5, 6, 7), (1, 7, 4, 0, 5, 6))
    t3new += einsum(x62, (0, 1, 2, 3, 4, 5), (3, 2, 0, 5, 4, 1)) * 0.5
    t3new += einsum(x62, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1)) * -0.5
    del x62
    x63 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x63 += einsum(v.ovov, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 2, 5, 6, 1, 7), (5, 7, 4, 0, 6, 3))
    ...
    del x63
    x64 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x64 += einsum(v.oVoV, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 2, 5, 6, 7, 1), (5, 3, 4, 0, 6, 7))
    t3new += einsum(x64, (0, 1, 2, 3, 4, 5), (3, 2, 0, 5, 4, 1)) * -1.0
    t3new += einsum(x64, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1))
    del x64
    x65 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x65 += einsum(v.vOvO, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 5, 1, 6, 2, 7), (3, 7, 4, 5, 6, 0))
    t3new += einsum(x65, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1))
    t3new += einsum(x65, (0, 1, 2, 3, 4, 5), (2, 3, 0, 4, 5, 1)) * -1.0
    del x65
    x66 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x66 += einsum(v.vVvV, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 5, 6, 7, 2, 3), (6, 1, 4, 5, 7, 0))
    t3new += einsum(x66, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1)) * -0.5
    t3new += einsum(x66, (0, 1, 2, 3, 4, 5), (2, 3, 0, 4, 5, 1)) * 0.5
    del x66
    x67 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x67 += einsum(x0, (0, 1), t3[np.ix_(so,so,sO,sv,sv,sV)], (2, 0, 3, 4, 5, 6), (3, 6, 1, 2, 4, 5))
    del x0
    t3new += einsum(x67, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1)) * -1.0
    t3new += einsum(x67, (0, 1, 2, 3, 4, 5), (3, 2, 0, 5, 4, 1))
    del x67
    x68 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    x68 += einsum(f.ov, (0, 1), t3[np.ix_(so,so,sO,sv,sv,sV)], (2, 3, 4, 5, 1, 6), (4, 6, 0, 2, 3, 5))
    x69 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x69
    x70 = np.zeros((navir, navir), dtype=np.float64)
    x70 += einsum(f.oV, (0, 1), t1[np.ix_(so,sV)], (0, 2), (1, 2))
    t3new += einsum(x70, (0, 1), t3[np.ix_(so,so,sO,sv,sv,sV)], (2, 3, 4, 5, 6, 0), (2, 3, 4, 5, 6, 1)) * -1.0
    del x70
    x71 = np.zeros((naocc, naocc), dtype=np.float64)
    x71 += einsum(f.vO, (0, 1), t1[np.ix_(sO,sv)], (2, 0), (1, 2))
    t3new += einsum(x71, (0, 1), t3[np.ix_(so,so,sO,sv,sv,sV)], (2, 3, 0, 4, 5, 6), (2, 3, 1, 4, 5, 6)) * -1.0
    del x71
    x72 = np.zeros((naocc, navir, nocc, nocc), dtype=np.float64)
    x72 += einsum(f.ov, (0, 1), t2[np.ix_(so,sO,sv,sV)], (2, 3, 1, 4), (3, 4, 0, 2))
    x73 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x73
    x74 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x74
    x75 = np.zeros((naocc, nocc, nocc, nvir), dtype=np.float64)
    x75 += einsum(f.ov, (0, 1), t2[np.ix_(so,sO,sv,sv)], (2, 3, 4, 1), (3, 0, 2, 4)) * -1.0
    x76 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x76
    x77 = np.zeros((navir, nocc, nocc, nocc), dtype=np.float64)
    ...
    del x77
    x78 = np.zeros((naocc, nocc, nocc, nvir), dtype=np.float64)
    x78 += einsum(t1[np.ix_(so,sv)], (0, 1), v.oooO, (2, 0, 3, 4), (4, 3, 2, 1)) * -1.0
    x79 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x79
    x80 = np.zeros((naocc, nocc, nocc, nvir), dtype=np.float64)
    x80 += einsum(t1[np.ix_(so,sv)], (0, 1), v.ovvO, (2, 3, 1, 4), (4, 0, 2, 3)) * -1.0
    x81 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x81
    x82 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    x82 += einsum(t2[np.ix_(so,so,sv,sV)], (0, 1, 2, 3), v.ovvO, (4, 5, 2, 6), (6, 3, 0, 1, 4, 5))
    x83 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x83
    x84 = np.zeros((naocc, navir, nocc, nocc), dtype=np.float64)
    x84 += einsum(t1[np.ix_(so,sv)], (0, 1), v.oVvO, (2, 3, 1, 4), (4, 3, 0, 2))
    x85 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x85
    x86 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    x86 += einsum(t2[np.ix_(so,so,sv,sv)], (0, 1, 2, 3), v.oVvO, (4, 5, 3, 6), (6, 5, 0, 1, 4, 2))
    x87 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x87
    x88 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    x88 += einsum(t2[np.ix_(so,sO,sv,sV)], (0, 1, 2, 3), v.oooo, (4, 5, 6, 0), (1, 3, 4, 5, 6, 2))
    x89 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x89
    x90 = np.zeros((navir, nocc, nocc, nocc), dtype=np.float64)
    x90 += einsum(t1[np.ix_(so,sv)], (0, 1), v.ovoV, (2, 1, 3, 4), (4, 0, 3, 2)) * -1.0
    x91 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x91
    x92 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x92
    x93 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    x93 += einsum(t2[np.ix_(so,sO,sv,sv)], (0, 1, 2, 3), v.ovoV, (4, 3, 5, 6), (1, 6, 0, 5, 4, 2))
    x94 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x94
    x95 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    x95 += einsum(t2[np.ix_(so,sO,sv,sV)], (0, 1, 2, 3), v.ovov, (4, 5, 6, 2), (1, 3, 0, 4, 6, 5))
    x96 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x96
    x97 = np.zeros((naocc, navir, nocc, nocc), dtype=np.float64)
    x97 += einsum(t1[np.ix_(so,sV)], (0, 1), v.oooO, (2, 0, 3, 4), (4, 1, 3, 2)) * -1.0
    x98 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x98
    x99 = np.zeros((naocc, navir, nvir, nvir), dtype=np.float64)
    x99 += einsum(t1[np.ix_(so,sV)], (0, 1), v.ovvO, (0, 2, 3, 4), (4, 1, 3, 2)) * -1.0
    x100 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x100
    x101 = np.zeros((navir, nocc, nocc, nocc), dtype=np.float64)
    ...
    del x101
    x102 = np.zeros((navir, nocc, nvir, nvir), dtype=np.float64)
    x102 += einsum(t1[np.ix_(so,sV)], (0, 1), v.ovov, (2, 3, 0, 4), (1, 2, 3, 4))
    x103 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x103
    x104 = np.zeros((navir, nocc, nvir, nvir), dtype=np.float64)
    x104 += einsum(t1[np.ix_(so,sv)], (0, 1), v.vvvV, (2, 1, 3, 4), (4, 0, 3, 2)) * -1.0
    x105 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x105
    x106 = np.zeros((naocc, navir, nocc, nvir, nvir, nvir), dtype=np.float64)
    x106 += einsum(t2[np.ix_(so,sO,sv,sV)], (0, 1, 2, 3), v.vvvv, (4, 5, 6, 2), (1, 3, 0, 4, 5, 6))
    x107 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x107
    x108 = np.zeros((naocc, navir, nocc, nocc), dtype=np.float64)
    ...
    del x109
    x110 = np.zeros((naocc, nocc, nocc, nvir), dtype=np.float64)
    ...
    del x111
    x112 = np.zeros((naocc, navir, nvir, nvir), dtype=np.float64)
    ...
    del x113
    x114 = np.zeros((naocc, nvir, nvir, nvir), dtype=np.float64)
    ...
    x115 += einsum(x21, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (1, 2, 4, 5, 6, 7), (4, 7, 0, 3, 5, 6))
    t3new += einsum(x115, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1)) * 0.5
    t3new += einsum(x115, (0, 1, 2, 3, 4, 5), (3, 2, 0, 5, 4, 1)) * -0.5
    del x115
    x116 = np.zeros((naocc, naocc, nocc, nocc), dtype=np.float64)
    x116 += einsum(t1[np.ix_(so,sv)], (0, 1), v.oOvO, (2, 3, 1, 4), (3, 4, 0, 2))
    x117 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x117 += einsum(x116, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 3, 0, 5, 6, 7), (1, 7, 2, 4, 5, 6))
    del x116
    t3new += einsum(x117, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1)) * 0.5
    t3new += einsum(x117, (0, 1, 2, 3, 4, 5), (3, 2, 0, 5, 4, 1)) * -0.5
    del x117
    x118 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    x118 += einsum(v.ooov, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 1, 5, 6, 3, 7), (5, 7, 4, 0, 2, 6))
    ...
    del x119
    x120 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x120 += einsum(x1, (0, 1), t3[np.ix_(so,so,sO,sv,sv,sV)], (2, 0, 3, 4, 5, 6), (3, 6, 2, 1, 4, 5)) * -1.0
    del x1
    ...
    x121 += einsum(v.oOvO, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 5, 1, 6, 2, 7), (3, 7, 4, 5, 0, 6))
    x122 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x123
    x124 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x124 += einsum(x26, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 1, 5, 6, 3, 7), (5, 7, 0, 4, 6, 2)) * -1.0
    del x26
    ...
    del x124
    x125 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    x125 += einsum(v.ovvv, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 5, 6, 2, 3, 7), (6, 7, 4, 5, 0, 1))
    ...
    del x126
    x127 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x127 += einsum(x2, (0, 1), t3[np.ix_(so,so,sO,sv,sv,sV)], (2, 3, 4, 5, 1, 6), (4, 6, 2, 3, 5, 0)) * -1.0
    del x2
    t3new += einsum(x127, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1)) * -1.0
    t3new += einsum(x127, (0, 1, 2, 3, 4, 5), (2, 3, 0, 4, 5, 1))
    del x127
    x128 = np.zeros((navir, navir, nocc, nocc), dtype=np.float64)
    x128 += einsum(t1[np.ix_(so,sv)], (0, 1), v.oVvV, (2, 3, 1, 4), (3, 4, 0, 2))
    x129 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x129 += einsum(x128, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 3, 5, 6, 7, 1), (5, 0, 2, 4, 6, 7))
    del x128
    t3new += einsum(x129, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1)) * -1.0
    t3new += einsum(x129, (0, 1, 2, 3, 4, 5), (3, 2, 0, 5, 4, 1))
    del x129
    x130 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    x130 += einsum(v.oVvV, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 5, 6, 7, 2, 3), (6, 1, 4, 5, 0, 7))
    x131 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x131
    x132 = np.zeros((navir, navir), dtype=np.float64)
    x132 += einsum(t1[np.ix_(so,sv)], (0, 1), v.oVvV, (0, 2, 1, 3), (2, 3))
    t3new += einsum(x132, (0, 1), t3[np.ix_(so,so,sO,sv,sv,sV)], (2, 3, 4, 5, 6, 1), (2, 3, 4, 5, 6, 0))
    del x132
    x133 = np.zeros((navir, navir, nocc, nocc), dtype=np.float64)
    x133 += einsum(t1[np.ix_(so,sV)], (0, 1), v.oooV, (2, 0, 3, 4), (1, 4, 3, 2)) * -1.0
    x134 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x134 += einsum(x133, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 3, 5, 6, 7, 1), (5, 0, 4, 2, 6, 7)) * -1.0
    del x133
    t3new += einsum(x134, (0, 1, 2, 3, 4, 5), (3, 2, 0, 5, 4, 1))
    t3new += einsum(x134, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1)) * -1.0
    del x134
    x135 = np.zeros((naocc, naocc, navir, navir), dtype=np.float64)
    x135 += einsum(t1[np.ix_(so,sV)], (0, 1), v.oOOV, (0, 2, 3, 4), (3, 2, 1, 4)) * -1.0
    t3new += einsum(x135, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 5, 1, 6, 7, 3), (4, 5, 0, 6, 7, 2))
    del x135
    x136 = np.zeros((navir, navir, nvir, nvir), dtype=np.float64)
    x136 += einsum(t1[np.ix_(so,sV)], (0, 1), v.ovvV, (0, 2, 3, 4), (1, 4, 3, 2)) * -1.0
    x137 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x137 += einsum(x136, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 5, 6, 7, 2, 1), (6, 0, 4, 5, 7, 3))
    del x136
    t3new += einsum(x137, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1)) * 0.5
    t3new += einsum(x137, (0, 1, 2, 3, 4, 5), (2, 3, 0, 4, 5, 1)) * -0.5
    del x137
    x138 = np.zeros((naocc, naocc, nocc, nocc), dtype=np.float64)
    x138 += einsum(t1[np.ix_(sO,sv)], (0, 1), v.ovoO, (2, 1, 3, 4), (0, 4, 3, 2)) * -1.0
    x139 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x139 += einsum(x138, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 2, 1, 5, 6, 7), (0, 7, 4, 3, 5, 6))
    del x138
    t3new += einsum(x139, (0, 1, 2, 3, 4, 5), (3, 2, 0, 5, 4, 1)) * -0.5
    t3new += einsum(x139, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1)) * 0.5
    del x139
    x140 = np.zeros((naocc, naocc, nvir, nvir), dtype=np.float64)
    x140 += einsum(t1[np.ix_(sO,sv)], (0, 1), v.vvvO, (2, 1, 3, 4), (0, 4, 3, 2)) * -1.0
    x141 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x141 += einsum(x140, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 5, 1, 6, 3, 7), (0, 7, 4, 5, 6, 2)) * -1.0
    del x140
    t3new += einsum(x141, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1))
    t3new += einsum(x141, (0, 1, 2, 3, 4, 5), (2, 3, 0, 4, 5, 1)) * -1.0
    del x141
    x142 = np.zeros((naocc, naocc, navir, navir), dtype=np.float64)
    x142 += einsum(t1[np.ix_(sO,sv)], (0, 1), v.vVOV, (1, 2, 3, 4), (0, 3, 4, 2)) * -1.0
    t3new += einsum(x142, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 5, 1, 6, 7, 3), (4, 5, 0, 6, 7, 2))
    del x142
    x143 = np.zeros((naocc, nocc, nocc, nvir), dtype=np.float64)
    x143 += einsum(t2[np.ix_(so,so,sv,sv)], (0, 1, 2, 3), v.oovO, (4, 1, 3, 5), (5, 0, 4, 2)) * -1.0
    x144 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x144
    x145 = np.zeros((naocc, navir, nocc, nocc), dtype=np.float64)
    ...
    del x146
    x147 = np.zeros((naocc, navir, nvir, nvir), dtype=np.float64)
    ...
    del x148
    x149 = np.zeros((naocc, nvir, nvir, nvir), dtype=np.float64)
    ...
    del x150
    x151 = np.zeros((naocc, navir, nocc, nocc), dtype=np.float64)
    ...
    del x152
    x153 = np.zeros((naocc, navir, nocc, nocc, nocc, nocc), dtype=np.float64)
    ...
    del x154
    x155 = np.zeros((naocc, nocc, nocc, nvir), dtype=np.float64)
    x155 += einsum(t2[np.ix_(so,sO,sv,sv)], (0, 1, 2, 3), v.ooov, (4, 0, 5, 3), (1, 4, 5, 2)) * -1.0
    x156 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x156
    x157 = np.zeros((navir, nocc, nocc, nocc), dtype=np.float64)
    ...
    del x158
    x159 = np.zeros((navir, nocc, nvir, nvir), dtype=np.float64)
    x159 += einsum(t2[np.ix_(so,so,sv,sV)], (0, 1, 2, 3), v.ooov, (0, 1, 4, 5), (3, 4, 2, 5)) * -1.0
    x160 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    x162 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    x164 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x165
    x166 = np.zeros((naocc, nocc, nocc, nvir), dtype=np.float64)
    x166 += einsum(t2[np.ix_(so,sO,sv,sv)], (0, 1, 2, 3), v.ovvv, (4, 5, 2, 3), (1, 0, 4, 5)) * -1.0
    x167 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x169
    x170 = np.zeros((naocc, nvir, nvir, nvir), dtype=np.float64)
    ...
    x173 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x173
    x174 = np.zeros((naocc, navir, nocc, nocc), dtype=np.float64)
    x174 += einsum(t2[np.ix_(so,sO,sv,sv)], (0, 1, 2, 3), v.oVvv, (4, 5, 2, 3), (1, 5, 0, 4))
    x175 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x175
    x176 = np.zeros((naocc, navir, nvir, nvir), dtype=np.float64)
    x176 += einsum(t2[np.ix_(so,sO,sv,sv)], (0, 1, 2, 3), v.oVvv, (0, 4, 5, 3), (1, 4, 2, 5))
    x177 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x177
    x178 = np.zeros((navir, nocc, nocc, nocc), dtype=np.float64)
    ...
    del x178
    x179 = np.zeros((naocc, navir, nvir, nvir), dtype=np.float64)
    x179 += einsum(v.oovv, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (0, 1, 4, 5, 3, 6), (4, 6, 5, 2))
    ...
    del x180
    x181 = np.zeros((naocc, navir, nocc, nocc), dtype=np.float64)
    x181 += einsum(v.oovv, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 1, 5, 2, 3, 6), (5, 6, 4, 0))
    x182 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    x183 += einsum(v.oovv, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 1, 5, 6, 3, 7), (5, 7, 4, 0, 6, 2))
    x184 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x184
    x185 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x185 += einsum(x4, (0, 1), t3[np.ix_(so,so,sO,sv,sv,sV)], (2, 1, 3, 4, 5, 6), (3, 6, 0, 2, 4, 5)) * -1.0
    del x4
    t3new += einsum(x185, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1)) * 0.5
    t3new += einsum(x185, (0, 1, 2, 3, 4, 5), (3, 2, 0, 5, 4, 1)) * -0.5
    del x185
    x186 = np.zeros((naocc, navir, nocc, nocc, nocc, nocc), dtype=np.float64)
    x186 += einsum(v.oovv, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 5, 6, 2, 3, 7), (6, 7, 4, 5, 0, 1))
    t3new += einsum(t2[np.ix_(so,so,sv,sv)], (0, 1, 2, 3), x186, (4, 5, 6, 7, 1, 0), (6, 7, 4, 2, 3, 5)) * -0.25
    x187 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x187 += einsum(x39, (0, 1), t3[np.ix_(so,so,sO,sv,sv,sV)], (2, 3, 4, 5, 1, 6), (4, 6, 2, 3, 0, 5)) * -1.0
    del x39
    t3new += einsum(x187, (0, 1, 2, 3, 4, 5), (2, 3, 0, 4, 5, 1)) * -0.5
    t3new += einsum(x187, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1)) * 0.5
    del x187
    x188 = np.zeros((naocc, nvir, nvir, nvir), dtype=np.float64)
    x188 += einsum(v.oovV, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (0, 1, 4, 5, 6, 3), (4, 5, 6, 2)) * -1.0
    t3new += einsum(t2[np.ix_(so,so,sv,sV)], (0, 1, 2, 3), x188, (4, 5, 6, 2), (0, 1, 4, 5, 6, 3)) * 0.5
    del x188
    x189 = np.zeros((naocc, nocc, nocc, nvir), dtype=np.float64)
    x189 += einsum(v.oovV, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 1, 5, 6, 2, 3), (5, 4, 0, 6)) * -1.0
    x190 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x190
    x191 = np.zeros((navir, navir, nocc, nocc), dtype=np.float64)
    x191 += einsum(t2[np.ix_(so,so,sv,sV)], (0, 1, 2, 3), v.oovV, (4, 1, 2, 5), (3, 5, 0, 4))
    x192 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x192 += einsum(x191, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 3, 5, 6, 7, 1), (5, 0, 2, 4, 6, 7)) * -1.0
    del x191
    t3new += einsum(x192, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1)) * -1.0
    t3new += einsum(x192, (0, 1, 2, 3, 4, 5), (3, 2, 0, 5, 4, 1))
    del x192
    x193 = np.zeros((navir, navir, nvir, nvir), dtype=np.float64)
    x193 += einsum(t2[np.ix_(so,so,sv,sV)], (0, 1, 2, 3), v.oovV, (0, 1, 4, 5), (3, 5, 2, 4))
    x194 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x194 += einsum(x193, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 5, 6, 7, 3, 1), (6, 0, 4, 5, 2, 7))
    del x193
    t3new += einsum(x194, (0, 1, 2, 3, 4, 5), (2, 3, 0, 4, 5, 1)) * -0.25
    t3new += einsum(x194, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1)) * 0.25
    del x194
    x195 = np.zeros((navir, navir), dtype=np.float64)
    x195 += einsum(t2[np.ix_(so,so,sv,sV)], (0, 1, 2, 3), v.oovV, (0, 1, 2, 4), (3, 4))
    t3new += einsum(x195, (0, 1), t3[np.ix_(so,so,sO,sv,sv,sV)], (2, 3, 4, 5, 6, 1), (2, 3, 4, 5, 6, 0)) * -0.5
    del x195
    x196 = np.zeros((navir, nocc, nvir, nvir), dtype=np.float64)
    x196 += einsum(v.oOvv, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 0, 1, 5, 3, 6), (6, 4, 5, 2)) * -1.0
    x197 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x197
    x198 = np.zeros((naocc, naocc, nocc, nocc), dtype=np.float64)
    x198 += einsum(t2[np.ix_(so,sO,sv,sv)], (0, 1, 2, 3), v.oOvv, (4, 5, 2, 3), (1, 5, 0, 4))
    x199 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x199 += einsum(x198, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 3, 1, 5, 6, 7), (0, 7, 2, 4, 5, 6))
    del x198
    t3new += einsum(x199, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1)) * 0.25
    t3new += einsum(x199, (0, 1, 2, 3, 4, 5), (3, 2, 0, 5, 4, 1)) * -0.25
    del x199
    x200 = np.zeros((navir, nocc, nocc, nocc), dtype=np.float64)
    x200 += einsum(v.oOvv, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 5, 1, 2, 3, 6), (6, 4, 5, 0)) * -1.0
    t3new += einsum(t2[np.ix_(so,sO,sv,sv)], (0, 1, 2, 3), x200, (4, 5, 6, 0), (5, 6, 1, 2, 3, 4)) * 0.5
    del x200
    x201 = np.zeros((naocc, naocc, nvir, nvir), dtype=np.float64)
    x201 += einsum(t2[np.ix_(so,sO,sv,sv)], (0, 1, 2, 3), v.oOvv, (0, 4, 5, 3), (1, 4, 2, 5))
    x202 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x202 += einsum(x201, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 5, 1, 6, 3, 7), (0, 7, 4, 5, 2, 6)) * -1.0
    del x201
    ...
    t3new += einsum(x203, (0, 1), t3[np.ix_(so,so,sO,sv,sv,sV)], (2, 3, 1, 4, 5, 6), (2, 3, 0, 4, 5, 6)) * -0.5
    del x203
    x204 = np.zeros((naocc, naocc, navir, navir, nocc, nocc), dtype=np.float64)
    x204 += einsum(t2[np.ix_(so,sO,sv,sV)], (0, 1, 2, 3), v.oOvV, (4, 5, 2, 6), (1, 5, 3, 6, 0, 4))
    x205 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x205 += einsum(t3[np.ix_(so,so,sO,sv,sv,sV)], (0, 1, 2, 3, 4, 5), x204, (6, 2, 7, 5, 8, 1), (6, 7, 8, 0, 3, 4))
    del x204
    t3new += einsum(x205, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1)) * -0.5
    t3new += einsum(x205, (0, 1, 2, 3, 4, 5), (3, 2, 0, 5, 4, 1)) * 0.5
    del x205
    x206 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x206
    x207 = np.zeros((naocc, naocc, navir, navir), dtype=np.float64)
    x207 += einsum(t2[np.ix_(so,sO,sv,sV)], (0, 1, 2, 3), v.oOvV, (0, 4, 2, 5), (1, 4, 3, 5))
    t3new += einsum(x207, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 5, 1, 6, 7, 3), (4, 5, 0, 6, 7, 2))
    del x207
    x208 = np.zeros((naocc, nocc, nocc, nocc), dtype=np.float64)
    x208 += einsum(t1[np.ix_(so,sv)], (0, 1), v.oovO, (2, 3, 1, 4), (4, 0, 2, 3)) * -1.0
    x209 = np.zeros((naocc, nocc, nocc, nvir), dtype=np.float64)
    x209 += einsum(t1[np.ix_(so,sv)], (0, 1), x208, (2, 3, 4, 0), (2, 3, 4, 1))
    del x208
    x210 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x210
    x211 = np.zeros((naocc, navir, nocc, nocc, nocc, nocc), dtype=np.float64)
    x211 += einsum(t2[np.ix_(so,so,sv,sV)], (0, 1, 2, 3), v.oovO, (4, 5, 2, 6), (6, 3, 0, 1, 4, 5))
    x212 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    ...
    del x212
    x213 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    x213 += einsum(t2[np.ix_(so,sO,sv,sV)], (0, 1, 2, 3), x21, (4, 0, 5, 6), (1, 3, 4, 5, 6, 2)) * -1.0
    del x21
    x214 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x214
    x215 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    ...
    del x216
    x217 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x217
    x218 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    x218 += einsum(t1[np.ix_(so,sv)], (0, 1), x161, (2, 3, 4, 5, 6, 1), (2, 3, 0, 4, 5, 6))
    del x161
    x219 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x219
    x220 = np.zeros((navir, nocc, nocc, nvir), dtype=np.float64)
    x220 += einsum(t1[np.ix_(so,sv)], (0, 1), v.oVvv, (2, 3, 4, 1), (3, 0, 2, 4)) * -1.0
    x221 = np.zeros((navir, nocc, nocc, nocc), dtype=np.float64)
    ...
    del x221
    x222 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    x222 += einsum(t2[np.ix_(so,sO,sv,sv)], (0, 1, 2, 3), x220, (4, 5, 6, 3), (1, 4, 5, 0, 6, 2))
    del x220
    x223 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x223
    x224 = np.zeros((naocc, navir, nocc, nvir), dtype=np.float64)
    x224 += einsum(t1[np.ix_(so,sV)], (0, 1), v.oovO, (2, 0, 3, 4), (4, 1, 2, 3)) * -1.0
    x225 = np.zeros((naocc, navir, nocc, nocc), dtype=np.float64)
    x225 += einsum(t1[np.ix_(so,sv)], (0, 1), x224, (2, 3, 4, 1), (2, 3, 0, 4))
    x226 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x226
    x227 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    x227 += einsum(t2[np.ix_(so,so,sv,sv)], (0, 1, 2, 3), x224, (4, 5, 6, 3), (4, 5, 0, 1, 6, 2))
    del x224
    x228 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x228
    x229 = np.zeros((navir, nocc, nocc, nvir), dtype=np.float64)
    x229 += einsum(t1[np.ix_(so,sV)], (0, 1), v.ooov, (2, 0, 3, 4), (1, 2, 3, 4))
    x230 = np.zeros((navir, nocc, nocc, nocc), dtype=np.float64)
    x230 += einsum(t1[np.ix_(so,sv)], (0, 1), x229, (2, 3, 4, 1), (2, 0, 3, 4))
    x231 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x231
    x232 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    x232 += einsum(t2[np.ix_(so,sO,sv,sv)], (0, 1, 2, 3), x229, (4, 5, 6, 3), (1, 4, 0, 5, 6, 2)) * -1.0
    del x229
    x233 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x233
    x234 = np.zeros((navir, nvir, nvir, nvir), dtype=np.float64)
    x234 += einsum(t1[np.ix_(so,sV)], (0, 1), v.ovvv, (0, 2, 3, 4), (1, 2, 3, 4))
    x235 = np.zeros((navir, nocc, nvir, nvir), dtype=np.float64)
    x235 += einsum(t1[np.ix_(so,sv)], (0, 1), x234, (2, 3, 4, 1), (2, 0, 3, 4))
    del x234
    x236 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x236
    x237 = np.zeros((naocc, nocc, nocc, nocc), dtype=np.float64)
    ...
    del x239
    x240 = np.zeros((naocc, nocc, nvir, nvir), dtype=np.float64)
    x240 += einsum(t1[np.ix_(sO,sv)], (0, 1), v.ovvv, (2, 3, 4, 1), (0, 2, 3, 4))
    x241 = np.zeros((naocc, nocc, nocc, nvir), dtype=np.float64)
    x241 += einsum(t1[np.ix_(so,sv)], (0, 1), x240, (2, 3, 4, 1), (2, 0, 3, 4)) * -1.0
    x242 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x242
    x243 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    ...
    del x244
    x245 = np.zeros((naocc, navir, nocc, nvir), dtype=np.float64)
    x245 += einsum(t1[np.ix_(sO,sv)], (0, 1), v.oVvv, (2, 3, 4, 1), (0, 3, 2, 4)) * -1.0
    x246 = np.zeros((naocc, navir, nocc, nocc), dtype=np.float64)
    x246 += einsum(t1[np.ix_(so,sv)], (0, 1), x245, (2, 3, 4, 1), (2, 3, 0, 4)) * -1.0
    x247 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x247
    x248 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    x248 += einsum(t2[np.ix_(so,so,sv,sv)], (0, 1, 2, 3), x245, (4, 5, 6, 3), (4, 5, 0, 1, 6, 2)) * -1.0
    del x245
    x249 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x249
    x250 = np.zeros((naocc, navir, nocc, nocc), dtype=np.float64)
    ...
    del x251
    x252 = np.zeros((naocc, navir, nvir, nvir), dtype=np.float64)
    ...
    del x253
    x254 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    x254 += einsum(x3, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 1, 5, 6, 3, 7), (5, 7, 0, 4, 2, 6))
    ...
    del x255
    x256 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x256 += einsum(x6, (0, 1), t3[np.ix_(so,so,sO,sv,sv,sV)], (2, 1, 3, 4, 5, 6), (3, 6, 0, 2, 4, 5)) * -1.0
    del x6
    t3new += einsum(x256, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1))
    t3new += einsum(x256, (0, 1, 2, 3, 4, 5), (3, 2, 0, 5, 4, 1)) * -1.0
    del x256
    x257 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    ...
    del x257
    x258 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    x258 += einsum(x5, (0, 1), t3[np.ix_(so,so,sO,sv,sv,sV)], (2, 3, 4, 5, 1, 6), (4, 6, 2, 3, 0, 5)) * -1.0
    x259 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x259
    x260 = np.zeros((navir, navir, nocc, nvir), dtype=np.float64)
    x260 += einsum(t1[np.ix_(so,sV)], (0, 1), v.oovV, (2, 0, 3, 4), (1, 4, 2, 3)) * -1.0
    x261 = np.zeros((navir, navir, nocc, nocc), dtype=np.float64)
    x261 += einsum(t1[np.ix_(so,sv)], (0, 1), x260, (2, 3, 4, 1), (2, 3, 0, 4))
    x262 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x262 += einsum(x261, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 3, 5, 6, 7, 1), (5, 0, 2, 4, 6, 7)) * -1.0
    del x261
    t3new += einsum(x262, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1))
    t3new += einsum(x262, (0, 1, 2, 3, 4, 5), (3, 2, 0, 5, 4, 1)) * -1.0
    del x262
    x263 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    x263 += einsum(x260, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 5, 6, 7, 3, 1), (6, 0, 4, 5, 2, 7))
    del x260
    x264 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x264
    x265 = np.zeros((navir, nocc), dtype=np.float64)
    x265 += einsum(t1[np.ix_(so,sv)], (0, 1), v.oovV, (2, 0, 1, 3), (3, 2)) * -1.0
    x266 = np.zeros((navir, navir), dtype=np.float64)
    x266 += einsum(t1[np.ix_(so,sV)], (0, 1), x265, (2, 0), (1, 2))
    del x265
    t3new += einsum(x266, (0, 1), t3[np.ix_(so,so,sO,sv,sv,sV)], (2, 3, 4, 5, 6, 1), (2, 3, 4, 5, 6, 0)) * -1.0
    del x266
    x267 = np.zeros((naocc, naocc, nocc, nvir), dtype=np.float64)
    x267 += einsum(t1[np.ix_(sO,sv)], (0, 1), v.oOvv, (2, 3, 4, 1), (0, 3, 2, 4)) * -1.0
    x268 = np.zeros((naocc, naocc, nocc, nocc), dtype=np.float64)
    x268 += einsum(t1[np.ix_(so,sv)], (0, 1), x267, (2, 3, 4, 1), (2, 3, 0, 4)) * -1.0
    x269 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x269 += einsum(x268, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 3, 1, 5, 6, 7), (0, 7, 2, 4, 5, 6))
    del x268
    t3new += einsum(x269, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1)) * 0.5
    t3new += einsum(x269, (0, 1, 2, 3, 4, 5), (3, 2, 0, 5, 4, 1)) * -0.5
    del x269
    x270 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    x270 += einsum(x267, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 5, 1, 6, 3, 7), (0, 7, 4, 5, 2, 6)) * -1.0
    del x267
    x271 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x271
    x272 = np.zeros((naocc, nvir), dtype=np.float64)
    x272 += einsum(t1[np.ix_(so,sv)], (0, 1), v.oOvv, (0, 2, 3, 1), (2, 3)) * -1.0
    x273 = np.zeros((naocc, naocc), dtype=np.float64)
    x273 += einsum(t1[np.ix_(sO,sv)], (0, 1), x272, (2, 1), (0, 2))
    del x272
    t3new += einsum(x273, (0, 1), t3[np.ix_(so,so,sO,sv,sv,sV)], (2, 3, 1, 4, 5, 6), (2, 3, 0, 4, 5, 6)) * -1.0
    del x273
    ...
    del x274
    t3new += einsum(x275, (0, 1, 2, 3), t3[np.ix_(so,so,sO,sv,sv,sV)], (4, 5, 1, 6, 7, 3), (4, 5, 0, 6, 7, 2)) * -1.0
    del x275
    x276 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x276
    x277 = np.zeros((naocc, navir, nocc, nvir), dtype=np.float64)
    x277 += einsum(t2[np.ix_(so,sO,sv,sV)], (0, 1, 2, 3), v.oovv, (4, 0, 5, 2), (1, 3, 4, 5))
    x278 = np.zeros((naocc, navir, nocc, nocc), dtype=np.float64)
    ...
    del x279
    x280 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    x280 += einsum(t2[np.ix_(so,sO,sv,sV)], (0, 1, 2, 3), v.oovv, (4, 5, 6, 2), (1, 3, 0, 4, 5, 6))
    x281 = np.zeros((naocc, navir, nocc, nocc, nocc, nocc), dtype=np.float64)
    x281 += einsum(t1[np.ix_(so,sv)], (0, 1), x280, (2, 3, 4, 5, 6, 1), (2, 3, 0, 4, 6, 5)) * -1.0
    x282 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    x282 += einsum(t2[np.ix_(so,so,sv,sv)], (0, 1, 2, 3), x281, (4, 5, 6, 7, 1, 0), (4, 5, 6, 7, 2, 3)) * -1.0
    t3new += einsum(x282, (0, 1, 2, 3, 4, 5), (2, 3, 0, 5, 4, 1)) * -0.5
    t3new += einsum(x282, (0, 1, 2, 3, 4, 5), (3, 2, 0, 5, 4, 1)) * 0.5
    del x282
    x283 = np.zeros((naocc, nocc, nocc, nvir), dtype=np.float64)
    x283 += einsum(t2[np.ix_(so,sO,sv,sv)], (0, 1, 2, 3), x3, (4, 0, 5, 3), (1, 4, 5, 2)) * -1.0
    x284 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x284
    x285 = np.zeros((navir, nocc, nocc, nvir), dtype=np.float64)
    x285 += einsum(t2[np.ix_(so,so,sv,sV)], (0, 1, 2, 3), v.oovv, (4, 1, 5, 2), (3, 0, 4, 5)) * -1.0
    x286 = np.zeros((navir, nocc, nocc, nocc), dtype=np.float64)
    x286 += einsum(t1[np.ix_(so,sv)], (0, 1), x285, (2, 3, 4, 1), (2, 0, 3, 4))
    x287 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x287
    x288 = np.zeros((navir, nocc, nvir, nvir), dtype=np.float64)
    x288 += einsum(t2[np.ix_(so,so,sv,sV)], (0, 1, 2, 3), x3, (4, 0, 1, 5), (3, 4, 2, 5)) * -1.0
    del x3
    x289 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x289
    x290 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    x290 += einsum(t2[np.ix_(so,so,sv,sv)], (0, 1, 2, 3), x280, (4, 5, 6, 7, 1, 3), (4, 5, 6, 0, 7, 2)) * -1.0
    del x280
    x291 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x291
    x292 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    ...
    del x293
    x294 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    ...
    del x295
    x296 = np.zeros((naocc, nocc, nocc, nocc), dtype=np.float64)
    x296 += einsum(t2[np.ix_(so,sO,sv,sv)], (0, 1, 2, 3), v.oovv, (4, 5, 2, 3), (1, 0, 4, 5)) * -1.0
    x297 = np.zeros((naocc, nocc, nocc, nvir), dtype=np.float64)
    ...
    del x298
    x299 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    x299 += einsum(t2[np.ix_(so,sO,sv,sv)], (0, 1, 2, 3), x285, (4, 5, 6, 3), (1, 4, 0, 5, 6, 2)) * -1.0
    del x285
    x300 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x300
    x301 = np.zeros((naocc, nocc, nvir, nvir), dtype=np.float64)
    x301 += einsum(t2[np.ix_(so,sO,sv,sv)], (0, 1, 2, 3), v.oovv, (4, 0, 5, 3), (1, 4, 2, 5)) * -1.0
    x302 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    ...
    del x303
    x304 = np.zeros((naocc, navir, nocc, nocc), dtype=np.float64)
    x304 += einsum(x5, (0, 1), t2[np.ix_(so,sO,sv,sV)], (2, 3, 1, 4), (3, 4, 2, 0)) * -1.0
    x305 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    x308 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x308
    x309 = np.zeros((navir, nocc, nocc, nocc), dtype=np.float64)
    ...
    del x309
    x310 = np.zeros((navir, nocc, nvir, nvir), dtype=np.float64)
    x310 += einsum(t1[np.ix_(so,sV)], (0, 1), v.oovv, (2, 0, 3, 4), (1, 2, 3, 4))
    x311 = np.zeros((navir, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x312
    x313 = np.zeros((naocc, navir, nocc, nocc), dtype=np.float64)
    x313 += einsum(t2[np.ix_(so,sO,sv,sv)], (0, 1, 2, 3), x310, (4, 5, 2, 3), (1, 4, 0, 5)) * -1.0
    x314 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x314
    x315 = np.zeros((naocc, navir, nvir, nvir), dtype=np.float64)
    ...
    del x316
    x317 = np.zeros((navir, nocc, nocc, nocc), dtype=np.float64)
    ...
    del x317
    x318 = np.zeros((naocc, nocc, nocc, nvir), dtype=np.float64)
    x318 += einsum(t1[np.ix_(sO,sv)], (0, 1), v.oovv, (2, 3, 4, 1), (0, 2, 3, 4))
    x319 = np.zeros((naocc, nocc, nocc, nvir), dtype=np.float64)
    x319 += einsum(t2[np.ix_(so,so,sv,sv)], (0, 1, 2, 3), x318, (4, 1, 5, 3), (4, 0, 5, 2))
    x320 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x320
    x321 = np.zeros((naocc, navir, nocc, nocc), dtype=np.float64)
    ...
    x324 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x324
    x325 = np.zeros((naocc, nvir, nvir, nvir), dtype=np.float64)
    ...
    del x325
    x326 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    ...
    del x327
    x328 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    ...
    del x329
    x330 = np.zeros((navir, nocc, nocc, nvir), dtype=np.float64)
    x330 += einsum(t1[np.ix_(so,sv)], (0, 1), x310, (2, 3, 1, 4), (2, 0, 3, 4)) * -1.0
    del x310
    x331 = np.zeros((navir, nocc, nocc, nocc), dtype=np.float64)
    ...
    del x331
    x332 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    ...
    del x333
    x334 = np.zeros((naocc, nocc, nocc, nocc), dtype=np.float64)
    x334 += einsum(t1[np.ix_(so,sv)], (0, 1), x318, (2, 3, 4, 1), (2, 0, 4, 3))
    x335 = np.zeros((naocc, nocc, nocc, nvir), dtype=np.float64)
    ...
    del x336
    x337 = np.zeros((naocc, navir, nocc, nocc, nocc, nocc), dtype=np.float64)
    x337 += einsum(t2[np.ix_(so,so,sv,sV)], (0, 1, 2, 3), x318, (4, 5, 6, 2), (4, 3, 0, 1, 6, 5)) * -1.0
    del x318
    x338 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    ...
    del x338
    x339 = np.zeros((naocc, navir, nocc, nvir), dtype=np.float64)
    x339 += einsum(t1[np.ix_(so,sV)], (0, 1), t1[np.ix_(sO,sv)], (2, 3), v.oovv, (4, 0, 5, 3), (2, 1, 4, 5))
    x340 = np.zeros((naocc, navir, nocc, nocc), dtype=np.float64)
    x340 += einsum(t1[np.ix_(so,sv)], (0, 1), x339, (2, 3, 4, 1), (2, 3, 0, 4)) * -1.0
    x341 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
    ...
    del x341
    x342 = np.zeros((naocc, navir, nocc, nocc, nocc, nvir), dtype=np.float64)
    x342 += einsum(t2[np.ix_(so,so,sv,sv)], (0, 1, 2, 3), x339, (4, 5, 6, 3), (4, 5, 0, 1, 6, 2)) * -1.0
    del x339
    x343 = np.zeros((naocc, navir, nocc, nocc, nvir, nvir), dtype=np.float64)
