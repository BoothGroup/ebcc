...
https://github.com/obackhouse/albert
  ...
  * date: 2024-10-18T21:45:50.688320
...
def energy(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:46:14.969596.
...
def update_amps(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:50:28.166425.
    ...
    t1new.bb += einsum(t1.bb, (0, 1), tmp20, (1, 2), (0, 2))
    del tmp20
    ...
    tmp22 += einsum(t1.bb, (0, 1), tmp21, (2, 3, 0, 1), (3, 2)) * -1
    del tmp21
    ...
    tmp37 = einsum(t1.aa, (0, 1), tmp1, (2, 3, 0, 4), (2, 3, 1, 4))
    ...
    del tmp40
    tmp41 = einsum(t1.aa, (0, 1), tmp36, (2, 3, 1, 4), (0, 2, 3, 4))
    ...
    tmp65 = einsum(t1.bb, (0, 1), v.bbbb.oovv, (2, 3, 4, 1), (0, 2, 3, 4))
    ...
    t2new.bbbb += tmp66
    del tmp66
    tmp71 = einsum(v.bbbb.ovvv, (0, 1, 2, 3), t1.bb, (4, 3), (4, 0, 1, 2))
    t2new.bbbb += np.transpose(tmp71, (1, 0, 2, 3))
    tmp72 = einsum(t1.bb, (0, 1), tmp16, (2, 3, 0, 4), (2, 3, 1, 4))
    ...
    tmp74 = einsum(tmp16, (0, 1, 2, 3), t1.bb, (4, 3), (0, 4, 2, 1))
    del tmp16
    ...
    del tmp78
    tmp79 = einsum(t1.bb, (0, 1), tmp71, (2, 3, 1, 4), (0, 2, 3, 4))
    ...
    tmp54 = einsum(t1.bb, (0, 1), v.aabb.ovvv, (2, 3, 4, 1), (2, 0, 3, 4))
    t2new.abab += tmp54
    ...
    del tmp56
    tmp57 = einsum(tmp17, (0, 1, 2, 3), t1.aa, (4, 3), (4, 0, 1, 2))
    del tmp17
...
def update_lams(f=None, l1=None, l2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T22:06:13.833528.
    ...
    tmp196 += tmp87
    tmp197 = einsum(l1.bb, (0, 1), tmp196, (1, 2, 3, 4), (2, 3, 4, 0))
    del tmp196
    l2new.bbbb += np.transpose(tmp197, (3, 2, 0, 1))
    tmp51 = einsum(t1.bb, (0, 1), l2.bbbb, (2, 1, 3, 4), (3, 4, 0, 2))
    tmp198 = einsum(v.bbbb.ovoo, (0, 1, 2, 3), tmp51, (3, 4, 2, 5), (4, 0, 5, 1)) * -1
    ...
    tmp199 = einsum(tmp4, (0, 1, 2, 3), tmp39, (0, 1, 4, 5), (4, 2, 5, 3))
    l2new.bbbb += np.transpose(tmp199, (3, 2, 0, 1))
    tmp200 = einsum(v.bbbb.ovvv, (0, 1, 2, 3), l1.bb, (3, 4), (4, 0, 1, 2))
    l2new.bbbb += np.transpose(tmp200, (2, 3, 0, 1)) * -1
    tmp201 = einsum(tmp87, (0, 1, 2, 3), tmp51, (0, 4, 2, 5), (4, 1, 5, 3)) * -1
    l2new.bbbb += np.transpose(tmp201, (3, 2, 0, 1)) * 2
    tmp202 = einsum(tmp39, (0, 1, 2, 3), v.aabb.ooov, (1, 0, 4, 5), (2, 4, 3, 5))
    ...
    tmp203 += einsum(tmp114, (0, 1, 2, 3), t1.bb, (4, 1), (4, 0, 3, 2)) * -1
    ...
    tmp92 += tmp91 * -1
    del tmp91
    tmp110 = einsum(tmp92, (0, 1), t1.bb, (2, 1), (2, 0))
    tmp184 += tmp110
    ...
    tmp205 += tmp181
    l2new.bbbb += einsum(l1.bb, (0, 1), tmp205, (2, 3), (3, 0, 1, 2)) * -1
    del tmp205
    ...
    tmp206 = einsum(tmp103, (0, 1, 2, 3), t1.bb, (4, 1), (4, 0, 2, 3))
    tmp207 += np.transpose(tmp206, (0, 1, 3, 2)) * -1
    del tmp206
    ...
    tmp180 += tmp179
    del tmp179
    tmp209 = einsum(l2.abab, (0, 1, 2, 3), tmp180, (2, 4, 0, 5), (4, 3, 5, 1))
    l2new.bbbb += np.transpose(tmp209, (2, 3, 0, 1))
    tmp211 = np.copy(f.bb.oo)
    tmp211 += np.transpose(tmp107, (1, 0))
    tmp210 = np.copy(v.bbbb.ooov) * -1
    tmp210 += np.transpose(v.bbbb.ovoo, (0, 2, 3, 1))
    tmp211 += einsum(t1.bb, (0, 1), tmp210, (2, 3, 0, 1), (3, 2)) * -1
    del tmp210
    tmp190 = np.copy(f.bb.ov)
    tmp190 += tmp89
    tmp188 = np.copy(np.transpose(v.bbbb.ovov, (0, 2, 3, 1))) * -1
    tmp188 += np.transpose(v.bbbb.ovov, (0, 2, 1, 3))
    tmp189 = einsum(t1.bb, (0, 1), tmp188, (0, 2, 3, 1), (2, 3))
    del tmp188
    tmp190 += tmp189 * -1
    del tmp189
    tmp211 += einsum(tmp190, (0, 1), t1.bb, (2, 1), (2, 0))
    ...
    tmp212 = einsum(tmp51, (0, 1, 2, 3), v.bbbb.ovvv, (2, 4, 5, 3), (1, 0, 4, 5))
    ...
    tmp215 = np.copy(v.bbbb.ovvv) * -1
    tmp215 += np.transpose(v.bbbb.ovvv, (0, 2, 3, 1))
    tmp216 += einsum(tmp215, (0, 1, 2, 3), t1.bb, (0, 1), (3, 2)) * -1
    del tmp215
    l2new.bbbb += einsum(l2.bbbb, (0, 1, 2, 3), tmp216, (4, 1), (4, 0, 2, 3)) * -1
    del tmp216
    tmp217 = einsum(tmp51, (0, 1, 2, 3), tmp190, (2, 4), (0, 1, 4, 3))
    l2new.bbbb += np.transpose(tmp217, (2, 3, 1, 0)) * -2
    tmp220 = np.copy(f.bb.vv)
    tmp220 += np.transpose(tmp129, (1, 0))
    tmp218 = np.copy(v.bbbb.ovvv) * -1
    tmp218 += np.transpose(v.bbbb.ovvv, (0, 2, 3, 1))
    tmp219 = einsum(tmp218, (0, 1, 2, 3), t1.bb, (0, 1), (2, 3))
    del tmp218
    tmp220 += np.transpose(tmp219, (1, 0)) * -1
    del tmp219
    tmp221 = einsum(tmp220, (0, 1), l2.bbbb, (2, 1, 3, 4), (3, 4, 0, 2)) * -1
    del tmp220
    l2new.bbbb += np.transpose(tmp221, (2, 3, 1, 0)) * -1
    ...
    tmp222 = einsum(l2.bbbb, (0, 1, 2, 3), tmp99, (2, 3, 4, 5), (4, 5, 0, 1))
    l2new.bbbb += np.transpose(tmp222, (2, 3, 0, 1)) * -2
    l2new.bbbb += np.transpose(tmp222, (2, 3, 1, 0)) * 2
    del tmp222
    tmp223 = np.copy(v.bbbb.oooo)
    tmp98 = einsum(tmp87, (0, 1, 2, 3), t1.bb, (4, 3), (4, 0, 1, 2))
    tmp223 += np.transpose(tmp98, (0, 2, 3, 1))
    l2new.bbbb += einsum(l2.bbbb, (0, 1, 2, 3), tmp223, (2, 4, 5, 3), (0, 1, 5, 4)) * -2
    del tmp223
    tmp224 = np.copy(v.bbbb.ooov)
    tmp224 += np.transpose(tmp87, (0, 2, 1, 3))
    l2new.bbbb += einsum(l1.bb, (0, 1), tmp224, (1, 2, 3, 4), (4, 0, 2, 3))
    del tmp224
    l2new.bbbb += np.transpose(tmp197, (3, 2, 1, 0)) * -1
    del tmp197
    tmp225 = einsum(v.bbbb.ooov, (0, 1, 2, 3), tmp51, (1, 4, 2, 5), (4, 0, 5, 3)) * -1
    l2new.bbbb += np.transpose(tmp225, (3, 2, 0, 1)) * -2
    tmp194 = einsum(t1.bb, (0, 1), v.bbbb.ovov, (2, 1, 0, 3), (2, 3))
    l2new.bbbb += einsum(l1.bb, (0, 1), tmp194, (2, 3), (3, 0, 1, 2))
    ...
    tmp227 = einsum(tmp51, (0, 1, 2, 3), tmp87, (1, 2, 4, 5), (0, 4, 3, 5))
    ...
    tmp133 += tmp0
    tmp134 = einsum(l1.aa, (0, 1), tmp133, (1, 2, 3, 4), (2, 3, 4, 0))
    del tmp133
    l2new.aaaa += np.transpose(tmp134, (3, 2, 0, 1))
    tmp37 = einsum(l2.aaaa, (0, 1, 2, 3), t1.aa, (4, 1), (2, 3, 4, 0))
    tmp135 = einsum(tmp37, (0, 1, 2, 3), tmp0, (0, 4, 2, 5), (1, 4, 3, 5)) * -1
    l2new.aaaa += np.transpose(tmp135, (3, 2, 0, 1)) * 2
    tmp49 = einsum(l2.abab, (0, 1, 2, 3), t1.bb, (4, 1), (2, 3, 4, 0))
    tmp136 = einsum(v.aabb.ovoo, (0, 1, 2, 3), tmp49, (4, 3, 2, 5), (4, 0, 5, 1))
    l2new.aaaa += np.transpose(tmp136, (3, 2, 0, 1))
    tmp2 = einsum(t1.bb, (0, 1), v.aabb.ovov, (2, 3, 4, 1), (2, 0, 4, 3))
    tmp137 = einsum(tmp49, (0, 1, 2, 3), tmp2, (4, 1, 2, 5), (0, 4, 3, 5))
    l2new.aaaa += np.transpose(tmp137, (3, 2, 0, 1))
    tmp138 = einsum(tmp37, (0, 1, 2, 3), v.aaaa.ovoo, (4, 5, 2, 0), (1, 4, 3, 5)) * -1
    ...
    tmp141 += einsum(t1.aa, (0, 1), tmp140, (2, 1, 3, 4), (0, 2, 4, 3)) * -1
    del tmp140
    ...
    tmp146 = einsum(tmp145, (0, 1, 2, 3), t1.aa, (4, 1), (0, 4, 2, 3))
    del tmp145
    ...
    tmp149 += tmp10
    del tmp10
    tmp150 = einsum(tmp149, (0, 1, 2, 3), l2.abab, (4, 3, 5, 1), (0, 5, 2, 4))
    l2new.aaaa += np.transpose(tmp150, (2, 3, 0, 1))
    tmp157 = np.copy(f.aa.oo)
    tmp157 += np.transpose(tmp59, (1, 0))
    ...
    l2new.aaaa += np.transpose(tmp135, (2, 3, 0, 1)) * -2
    ...
    l2new.aaaa += np.transpose(tmp135, (2, 3, 1, 0)) * 2
    del tmp135
    ...
    del tmp150
    l2new.aaaa += einsum(tmp158, (0, 1), l1.aa, (2, 3), (2, 1, 0, 3)) * -1
    tmp66 = einsum(t1.aa, (0, 1), tmp37, (2, 3, 4, 1), (3, 2, 4, 0))
    tmp159 = einsum(tmp66, (0, 1, 2, 3), v.aaaa.ovov, (3, 4, 2, 5), (0, 1, 5, 4))
    ...
    tmp161 = einsum(v.aaaa.vvvv, (0, 1, 2, 3), l2.aaaa, (1, 3, 4, 5), (4, 5, 0, 2))
    l2new.aaaa += np.transpose(tmp161, (3, 2, 1, 0)) * 2
    del tmp161
    tmp163 = np.copy(f.aa.vv)
    tmp84 = einsum(t1.bb, (0, 1), v.aabb.vvov, (2, 3, 0, 1), (2, 3))
    tmp163 += np.transpose(tmp84, (1, 0))
    tmp162 = np.copy(v.aaaa.ovvv)
    tmp162 += np.transpose(v.aaaa.ovvv, (0, 2, 1, 3)) * -1
    tmp163 += einsum(t1.aa, (0, 1), tmp162, (0, 2, 1, 3), (2, 3)) * -1
    del tmp162
    l2new.aaaa += einsum(tmp163, (0, 1), l2.aaaa, (2, 1, 3, 4), (0, 2, 3, 4)) * -1
    del tmp163
    tmp164 = einsum(tmp155, (0, 1), tmp37, (2, 3, 0, 4), (2, 3, 1, 4))
    l2new.aaaa += np.transpose(tmp164, (2, 3, 1, 0)) * -2
    tmp167 = np.copy(f.aa.vv)
    tmp167 += np.transpose(tmp84, (1, 0))
    tmp165 = np.copy(v.aaaa.ovvv)
    tmp165 += np.transpose(v.aaaa.ovvv, (0, 2, 1, 3)) * -1
    tmp166 = einsum(t1.aa, (0, 1), tmp165, (0, 2, 1, 3), (2, 3))
    tmp167 += tmp166 * -1
    del tmp166
    tmp168 = einsum(tmp167, (0, 1), l2.aaaa, (2, 1, 3, 4), (3, 4, 0, 2)) * -1
    del tmp167
    ...
    tmp169 = einsum(tmp23, (0, 1, 2, 3), l2.aaaa, (4, 5, 0, 1), (2, 3, 4, 5))
    l2new.aaaa += np.transpose(tmp169, (2, 3, 0, 1)) * -2
    l2new.aaaa += np.transpose(tmp169, (2, 3, 1, 0)) * 2
    del tmp169
    tmp170 = np.copy(v.aaaa.oooo)
    tmp22 = einsum(tmp0, (0, 1, 2, 3), t1.aa, (4, 3), (4, 0, 1, 2))
    tmp170 += np.transpose(tmp22, (0, 2, 3, 1))
    l2new.aaaa += einsum(tmp170, (0, 1, 2, 3), l2.aaaa, (4, 5, 0, 3), (4, 5, 2, 1)) * -2
    del tmp170
    tmp171 = np.copy(v.aaaa.ooov)
    tmp171 += np.transpose(tmp0, (0, 2, 1, 3))
    l2new.aaaa += einsum(l1.aa, (0, 1), tmp171, (1, 2, 3, 4), (4, 0, 2, 3))
    del tmp171
    l2new.aaaa += np.transpose(tmp134, (3, 2, 1, 0)) * -1
    del tmp134
    tmp172 = einsum(tmp37, (0, 1, 2, 3), v.aaaa.ooov, (4, 0, 2, 5), (1, 4, 3, 5)) * -1
    l2new.aaaa += np.transpose(tmp172, (3, 2, 0, 1)) * -2
    tmp173 = einsum(tmp0, (0, 1, 2, 3), tmp37, (4, 0, 1, 5), (4, 2, 5, 3))
    l2new.aaaa += np.transpose(tmp173, (3, 2, 0, 1)) * -2
    tmp174 = einsum(t1.aa, (0, 1), v.aaaa.ovov, (2, 1, 0, 3), (2, 3))
    l2new.aaaa += einsum(l1.aa, (0, 1), tmp174, (2, 3), (3, 0, 1, 2))
    tmp41 = einsum(t1.aa, (0, 1), l1.aa, (1, 2), (2, 0))
    tmp175 = einsum(tmp41, (0, 1), v.aaaa.ovov, (2, 3, 1, 4), (0, 2, 3, 4))
    l2new.aaaa += np.transpose(tmp175, (3, 2, 0, 1)) * -1
    l2new.aaaa += np.transpose(tmp172, (2, 3, 0, 1)) * 2
    l2new.aaaa += np.transpose(tmp173, (2, 3, 0, 1)) * 2
    l2new.aaaa += np.transpose(tmp175, (2, 3, 0, 1))
    l2new.aaaa += einsum(tmp174, (0, 1), l1.aa, (2, 3), (2, 1, 3, 0)) * -1
    l2new.aaaa += np.transpose(tmp172, (3, 2, 1, 0)) * 2
    l2new.aaaa += np.transpose(tmp173, (3, 2, 1, 0)) * 2
    l2new.aaaa += np.transpose(tmp175, (3, 2, 1, 0))
    l2new.aaaa += einsum(l1.aa, (0, 1), tmp174, (2, 3), (3, 0, 2, 1)) * -1
    l2new.aaaa += np.transpose(tmp172, (2, 3, 1, 0)) * -2
    del tmp172
    l2new.aaaa += np.transpose(tmp173, (2, 3, 1, 0)) * -2
    del tmp173
    l2new.aaaa += einsum(tmp174, (0, 1), l1.aa, (2, 3), (2, 1, 0, 3))
    l2new.aaaa += np.transpose(tmp175, (2, 3, 1, 0)) * -1
    del tmp175
    ...
    tmp176 += einsum(t1.aa, (0, 1), tmp165, (2, 1, 3, 4), (0, 2, 4, 3)) * -1
    del tmp165
    l2new.abab += einsum(tmp176, (0, 1, 2, 3), l2.abab, (2, 4, 0, 5), (3, 4, 1, 5))
    del tmp176
    ...
    tmp178 += einsum(tmp177, (0, 1, 2, 3), t1.bb, (4, 2), (4, 0, 3, 1)) * -1
    ...
    tmp183 += np.transpose(tmp93, (0, 1, 3, 2))
    l2new.abab += einsum(l2.abab, (0, 1, 2, 3), tmp183, (3, 4, 0, 5), (5, 1, 2, 4)) * -1
    del tmp183
    l2new.abab += einsum(tmp184, (0, 1), l2.abab, (2, 3, 4, 0), (2, 3, 4, 1)) * -1
    del tmp184
    ...
    tmp186 = einsum(tmp72, (0, 1, 2, 3), v.aabb.ovov, (1, 4, 3, 5), (0, 2, 4, 5))
    ...
    tmp85 = einsum(tmp30, (0, 1, 2, 3), t1.aa, (0, 1), (2, 3))
    tmp86 += np.transpose(tmp85, (1, 0)) * -1
    del tmp85
    l2new.abab += einsum(tmp86, (0, 1), l2.abab, (0, 2, 3, 4), (1, 2, 3, 4))
    l2new.abab += einsum(tmp155, (0, 1), tmp39, (2, 0, 3, 4), (1, 4, 2, 3)) * -1
    del tmp155
    l2new.abab += einsum(v.aabb.vvov, (0, 1, 2, 3), tmp49, (4, 5, 2, 1), (0, 3, 4, 5)) * -1
    tmp187 = np.copy(f.bb.vv)
    tmp187 += np.transpose(tmp129, (1, 0))
    tmp187 += einsum(tmp177, (0, 1, 2, 3), t1.bb, (0, 1), (3, 2)) * -1
    del tmp177
    l2new.abab += einsum(tmp187, (0, 1), l2.abab, (2, 0, 3, 4), (2, 1, 3, 4))
    del tmp187
    l2new.abab += einsum(tmp190, (0, 1), tmp49, (2, 3, 0, 4), (4, 1, 2, 3)) * -1
    del tmp190
    tmp191 = np.copy(v.aabb.ooov)
    tmp191 += tmp4
    l2new.abab += einsum(tmp191, (0, 1, 2, 3), l1.aa, (4, 0), (4, 3, 1, 2)) * -1
    ...
    tmp193 += einsum(v.aabb.ovvv, (0, 1, 2, 3), t1.aa, (4, 1), (4, 0, 2, 3))
    l2new.abab += einsum(tmp193, (0, 1, 2, 3), l2.abab, (4, 2, 0, 5), (4, 3, 1, 5)) * -1
    del tmp193
    ...
    l2new.abab += einsum(l1.bb, (0, 1), tmp174, (2, 3), (3, 0, 2, 1)) * -1
    del tmp174
    ...
    tmp25 += einsum(v.aaaa.ovvv, (0, 1, 2, 3), t2.aaaa, (4, 5, 3, 1), (0, 4, 5, 2))
    tmp18 = np.copy(v.aaaa.ooov) * -1
    tmp18 += np.transpose(v.aaaa.ooov, (0, 2, 1, 3))
    tmp18 += tmp0
    tmp18 += np.transpose(tmp0, (0, 2, 1, 3)) * -1
    del tmp0
    tmp25 += einsum(tmp18, (0, 1, 2, 3), t2.aaaa, (4, 1, 5, 3), (2, 4, 0, 5)) * 2
    del tmp18
    ...
    del tmp34
    tmp46 = np.copy(np.transpose(l1.aa, (1, 0))) * -0.5
    tmp46 += t1.aa * -0.5
    ...
    tmp44 += tmp43 * 0.5
    tmp45 = einsum(tmp44, (0, 1), t1.aa, (0, 2), (1, 2))
    tmp46 += tmp45
    del tmp45
    l1new.aa += einsum(v.aaaa.ovov, (0, 1, 2, 3), tmp46, (2, 3), (1, 0)) * -2
    ...
    l1new.aa += einsum(v.aabb.ovov, (0, 1, 2, 3), tmp57, (2, 3), (1, 0)) * -1
    del tmp57
    tmp58 = np.copy(tmp41)
    del tmp41
    tmp58 += tmp42 * 2
    ...
    l1new.aa += einsum(tmp56, (0, 1), v.aabb.ovoo, (2, 3, 1, 0), (3, 2)) * -1
    tmp63 = np.copy(f.aa.oo)
    tmp63 += np.transpose(tmp59, (1, 0))
    del tmp59
    tmp63 += einsum(t2.aaaa, (0, 1, 2, 3), v.aaaa.ovov, (4, 2, 1, 3), (0, 4)) * 2
    tmp63 += einsum(t2.abab, (0, 1, 2, 3), v.aabb.ovov, (4, 2, 1, 3), (0, 4))
    tmp63 += np.transpose(tmp61, (1, 0)) * -1
    del tmp61
    tmp63 += tmp62
    del tmp62
    l1new.aa += einsum(tmp63, (0, 1), l1.aa, (2, 0), (2, 1)) * -1
    del tmp63
    ...
    tmp65 = einsum(l2.aaaa, (0, 1, 2, 3), t2.aaaa, (4, 5, 0, 1), (2, 3, 4, 5))
    l1new.aa += einsum(v.aaaa.ooov, (0, 1, 2, 3), tmp65, (4, 0, 2, 1), (3, 4)) * 2
    ...
    tmp68 += einsum(l2.aaaa, (0, 1, 2, 3), t2.abab, (3, 4, 1, 5), (2, 4, 0, 5)) * 2
    ...
    l1new.aa += einsum(tmp69, (0, 1, 2, 3), tmp70, (4, 0, 2, 1), (3, 4)) * -1
    del tmp69, tmp70
    ...
    del tmp74
    tmp75 = np.copy(np.transpose(l2.aaaa, (2, 3, 0, 1))) * -1
    tmp75 += einsum(tmp37, (0, 1, 2, 3), t1.aa, (0, 4), (1, 2, 3, 4)) * -1
    l1new.aa += einsum(v.aaaa.ovvv, (0, 1, 2, 3), tmp75, (4, 0, 3, 1), (2, 4)) * -2
    del tmp75
    tmp76 = einsum(l2.abab, (0, 1, 2, 3), t2.abab, (4, 3, 0, 5), (2, 4, 1, 5))
    tmp76 += einsum(t1.bb, (0, 1), tmp39, (2, 3, 0, 4), (2, 3, 1, 4))
    l1new.aa += einsum(v.aabb.ovvv, (0, 1, 2, 3), tmp76, (4, 0, 3, 2), (1, 4)) * -1
    del tmp76
    tmp80 = np.copy(np.transpose(tmp37, (1, 0, 2, 3))) * -0.5
    tmp77 = einsum(t2.aaaa, (0, 1, 2, 3), tmp37, (4, 1, 5, 3), (4, 5, 0, 2)) * -1
    del tmp37
    tmp80 += np.transpose(tmp77, (2, 0, 1, 3))
    tmp78 = einsum(t2.abab, (0, 1, 2, 3), tmp39, (4, 5, 1, 3), (4, 5, 0, 2))
    tmp80 += np.transpose(tmp78, (2, 0, 1, 3)) * 0.25
    tmp79 = np.copy(np.transpose(tmp65, (1, 0, 3, 2)))
    del tmp65
    tmp79 += np.transpose(tmp66, (0, 1, 3, 2)) * -1
    del tmp66
    tmp80 += einsum(t1.aa, (0, 1), tmp79, (0, 2, 3, 4), (4, 2, 3, 1)) * 0.5
    del tmp79
    l1new.aa += einsum(v.aaaa.ovov, (0, 1, 2, 3), tmp80, (0, 4, 2, 1), (3, 4)) * -4
    del tmp80
    tmp81 = einsum(l1.aa, (0, 1), t2.aaaa, (2, 3, 4, 0), (1, 2, 3, 4)) * 0.5
    tmp81 += np.transpose(tmp77, (0, 2, 1, 3))
    del tmp77
    tmp81 += np.transpose(tmp78, (0, 2, 1, 3)) * 0.25
    del tmp78
    l1new.aa += einsum(tmp81, (0, 1, 2, 3), v.aaaa.ovov, (1, 4, 2, 3), (4, 0)) * 4
    del tmp81
    tmp82 = np.copy(tmp71)
    ...
    tmp83 += tmp40
    del tmp40
    tmp83 += einsum(tmp44, (0, 1), t1.aa, (0, 2), (1, 2)) * 2
    l1new.aa += einsum(v.aaaa.ovov, (0, 1, 2, 3), tmp83, (2, 1), (3, 0))
    del tmp83
    l1new.aa += einsum(v.aaaa.ooov, (0, 1, 2, 3), tmp58, (1, 2), (3, 0))
    l1new.aa += einsum(l1.aa, (0, 1), tmp86, (0, 2), (2, 1))
    del tmp86
    l1new.aa += einsum(tmp58, (0, 1), tmp9, (1, 2), (2, 0)) * -1
    del tmp9, tmp58
    ...
    tmp95 += tmp2
    del tmp2
    tmp95 += einsum(v.aabb.vvov, (0, 1, 2, 3), t2.abab, (4, 5, 1, 3), (4, 5, 2, 0))
    tmp88 = np.copy(v.bbbb.ooov)
    tmp88 += np.transpose(v.bbbb.ovoo, (0, 2, 3, 1)) * -1
    tmp88 += np.transpose(tmp87, (1, 0, 2, 3)) * -1
    tmp88 += np.transpose(tmp87, (2, 0, 1, 3))
    tmp95 += einsum(t2.abab, (0, 1, 2, 3), tmp88, (4, 5, 1, 3), (0, 5, 4, 2))
    del tmp88
    ...
    del tmp95
    tmp101 = np.copy(v.bbbb.ooov) * -1
    tmp101 += einsum(v.bbbb.ovvv, (0, 1, 2, 3), t2.bbbb, (4, 5, 1, 3), (0, 4, 5, 2)) * -1
    tmp96 = np.copy(v.bbbb.ooov) * -1
    tmp96 += np.transpose(v.bbbb.ooov, (0, 2, 1, 3))
    tmp96 += tmp87
    tmp96 += np.transpose(tmp87, (0, 2, 1, 3)) * -1
    del tmp87
    tmp101 += einsum(tmp96, (0, 1, 2, 3), t2.bbbb, (4, 1, 5, 3), (2, 4, 0, 5)) * 2
    del tmp96
    tmp101 += einsum(tmp14, (0, 1, 2, 3), t2.abab, (0, 4, 3, 5), (2, 4, 1, 5))
    del tmp14
    tmp101 += einsum(t2.bbbb, (0, 1, 2, 3), tmp92, (4, 3), (4, 0, 1, 2))
    tmp97 = np.copy(np.transpose(v.bbbb.ovov, (0, 2, 1, 3)))
    tmp97 += v.bbbb.oovv * -1
    tmp97 += einsum(t1.bb, (0, 1), v.bbbb.ovvv, (2, 3, 4, 1), (0, 2, 4, 3))
    tmp101 += einsum(t1.bb, (0, 1), tmp97, (2, 3, 4, 1), (3, 2, 0, 4))
    del tmp97
    tmp100 = np.copy(v.bbbb.oooo)
    tmp100 += einsum(t2.bbbb, (0, 1, 2, 3), v.bbbb.ovov, (4, 3, 5, 2), (4, 0, 5, 1)) * -1
    tmp100 += np.transpose(tmp98, (2, 1, 3, 0)) * -1
    del tmp98
    tmp100 += np.transpose(tmp99, (2, 0, 3, 1)) * -1
    tmp100 += np.transpose(tmp99, (3, 0, 2, 1))
    del tmp99
    tmp101 += einsum(t1.bb, (0, 1), tmp100, (0, 2, 3, 4), (3, 4, 2, 1))
    del tmp100
    l1new.bb += einsum(l2.bbbb, (0, 1, 2, 3), tmp101, (4, 2, 3, 1), (0, 4)) * 2
    del tmp101
    tmp102 = np.copy(tmp31)
    del tmp31
    tmp102 += tmp32
    del tmp32
    tmp102 += tmp33 * 2
    del tmp33
    l1new.bb += einsum(tmp102, (0, 1), tmp103, (2, 1, 0, 3), (3, 2)) * -1
    del tmp103, tmp102
    ...
    tmp104 += tmp28
    del tmp28
    l1new.bb += einsum(tmp104, (0, 1), v.aabb.vvov, (1, 0, 2, 3), (3, 2))
    del tmp104
    l1new.bb += einsum(v.aabb.ovov, (0, 1, 2, 3), tmp46, (0, 1), (3, 2)) * -2
    del tmp46
    tmp106 = np.copy(np.transpose(l1.bb, (1, 0))) * -0.5
    tmp106 += t1.bb * -0.5
    tmp106 += tmp47 * -0.5
    tmp106 += tmp48 * -1
    tmp106 += tmp50 * 0.5
    tmp106 += tmp52
    tmp105 = einsum(tmp56, (0, 1), t1.bb, (0, 2), (1, 2)) * 0.5
    tmp106 += tmp105
    l1new.bb += einsum(v.bbbb.ovov, (0, 1, 2, 3), tmp106, (2, 3), (1, 0)) * -2
    del tmp106
    ...
    del tmp107
    tmp111 += einsum(t2.abab, (0, 1, 2, 3), v.aabb.ovov, (0, 2, 4, 3), (1, 4))
    tmp111 += einsum(t2.bbbb, (0, 1, 2, 3), v.bbbb.ovov, (4, 3, 1, 2), (0, 4)) * -2
    tmp111 += np.transpose(tmp109, (1, 0)) * -1
    del tmp109
    tmp111 += tmp110
    del tmp110
    l1new.bb += einsum(tmp111, (0, 1), l1.bb, (2, 0), (2, 1)) * -1
    del tmp111
    l1new.bb += einsum(tmp39, (0, 1, 2, 3), v.aabb.oovv, (1, 0, 4, 3), (4, 2)) * -1
    l1new.bb += einsum(v.bbbb.oovv, (0, 1, 2, 3), tmp51, (4, 1, 0, 3), (2, 4)) * -2
    tmp112 = einsum(v.aabb.vvvv, (0, 1, 2, 3), t1.aa, (4, 1), (4, 0, 2, 3))
    l1new.bb += einsum(tmp112, (0, 1, 2, 3), l2.abab, (1, 3, 0, 4), (2, 4))
    del tmp112
    tmp113 = np.copy(np.transpose(l2.abab, (2, 3, 0, 1))) * 0.5
    tmp113 += einsum(l2.abab, (0, 1, 2, 3), t2.aaaa, (4, 2, 5, 0), (4, 3, 5, 1))
    tmp113 += einsum(t1.aa, (0, 1), tmp39, (0, 2, 3, 4), (2, 3, 1, 4)) * -0.5
    ...
    tmp115 += einsum(t2.bbbb, (0, 1, 2, 3), l2.bbbb, (4, 3, 5, 1), (5, 0, 4, 2)) * 4
    l1new.bb += einsum(tmp114, (0, 1, 2, 3), tmp115, (4, 0, 2, 1), (3, 4))
    del tmp115
    tmp116 = einsum(l1.bb, (0, 1), t2.abab, (2, 3, 4, 0), (2, 1, 3, 4)) * 0.5
    tmp116 += tmp49 * 0.5
    tmp116 += einsum(tmp49, (0, 1, 2, 3), t2.aaaa, (4, 0, 5, 3), (4, 1, 2, 5))
    tmp116 += einsum(t2.abab, (0, 1, 2, 3), tmp39, (0, 4, 5, 3), (4, 5, 1, 2)) * -0.5
    del tmp39
    tmp116 += einsum(t2.abab, (0, 1, 2, 3), tmp51, (4, 1, 5, 3), (0, 4, 5, 2)) * -1
    tmp116 += einsum(t1.aa, (0, 1), tmp73, (0, 2, 3, 4), (2, 3, 4, 1)) * -0.5
    del tmp73
    l1new.bb += einsum(tmp116, (0, 1, 2, 3), v.aabb.ovov, (0, 3, 2, 4), (4, 1)) * -2
    del tmp116
    tmp117 = einsum(t2.abab, (0, 1, 2, 3), l2.abab, (4, 3, 0, 5), (5, 1, 4, 2))
    tmp117 += einsum(tmp49, (0, 1, 2, 3), t1.aa, (0, 4), (1, 2, 4, 3))
    l1new.bb += einsum(tmp117, (0, 1, 2, 3), v.aabb.vvov, (3, 2, 1, 4), (4, 0)) * -1
    del tmp117
    tmp118 = einsum(t1.bb, (0, 1), tmp51, (2, 0, 3, 4), (2, 3, 4, 1))
    l1new.bb += einsum(tmp114, (0, 1, 2, 3), tmp118, (4, 0, 2, 1), (3, 4)) * -2
    del tmp114, tmp118
    tmp119 = np.copy(v.bbbb.ovvv)
    tmp119 += einsum(v.bbbb.vvvv, (0, 1, 2, 3), t1.bb, (4, 3), (4, 0, 2, 1)) * -1
    l1new.bb += einsum(l2.bbbb, (0, 1, 2, 3), tmp119, (3, 0, 1, 4), (4, 2)) * -2
    del tmp119
    tmp123 = np.copy(np.transpose(tmp51, (1, 0, 2, 3))) * -2
    tmp120 = einsum(t2.abab, (0, 1, 2, 3), tmp49, (0, 4, 5, 2), (4, 5, 1, 3))
    del tmp49
    tmp123 += np.transpose(tmp120, (2, 0, 1, 3))
    tmp121 = einsum(t2.bbbb, (0, 1, 2, 3), tmp51, (4, 1, 5, 3), (4, 5, 0, 2)) * -1
    del tmp51
    tmp123 += np.transpose(tmp121, (2, 0, 1, 3)) * 4
    tmp123 += einsum(t1.bb, (0, 1), tmp122, (0, 2, 3, 4), (4, 2, 3, 1)) * 2
    l1new.bb += einsum(tmp123, (0, 1, 2, 3), v.bbbb.ovov, (0, 3, 2, 4), (4, 1)) * -1
    del tmp123
    tmp125 = einsum(t2.bbbb, (0, 1, 2, 3), l1.bb, (3, 4), (4, 0, 1, 2)) * 2
    tmp125 += np.transpose(tmp120, (0, 2, 1, 3))
    del tmp120
    tmp125 += np.transpose(tmp121, (0, 2, 1, 3)) * 4
    del tmp121
    tmp124 = einsum(t2.bbbb, (0, 1, 2, 3), l2.bbbb, (2, 3, 4, 5), (4, 5, 0, 1))
    tmp125 += einsum(t1.bb, (0, 1), tmp124, (2, 0, 3, 4), (2, 4, 3, 1)) * -2
    l1new.bb += einsum(v.bbbb.ovov, (0, 1, 2, 3), tmp125, (4, 0, 2, 3), (1, 4))
    del tmp125
    tmp126 = np.copy(tmp71)
    del tmp71
    tmp126 += np.transpose(tmp72, (1, 0, 2, 3))
    del tmp72
    l1new.bb += einsum(v.aabb.ooov, (0, 1, 2, 3), tmp126, (1, 0, 4, 2), (3, 4))
    del tmp126
    tmp127 = np.copy(np.transpose(tmp124, (1, 0, 3, 2)))
    del tmp124
    tmp127 += np.transpose(tmp122, (2, 1, 0, 3))
    del tmp122
    l1new.bb += einsum(tmp127, (0, 1, 2, 3), v.bbbb.ooov, (0, 2, 3, 4), (4, 1)) * 2
    del tmp127
    ...
    del tmp129
    tmp130 = np.copy(v.bbbb.ovvv) * -1
    tmp130 += np.transpose(v.bbbb.ovvv, (0, 2, 1, 3))
    tmp131 += einsum(t1.bb, (0, 1), tmp130, (0, 1, 2, 3), (3, 2)) * -1
    del tmp130
...
def make_rdm1_f(l1=None, l2=None, t1=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T22:07:17.265007.
...
def make_rdm2_f(l1=None, l2=None, t1=None, t2=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T22:13:45.782741.
    ...
    tmp115 = einsum(tmp27, (0, 1, 2, 3), t1.aa, (0, 4), (1, 2, 4, 3))
    ...
    rdm2.bbbb.vovv += einsum(t1.bb, (0, 1), tmp111, (2, 3), (2, 0, 3, 1)) * 2
    tmp90 = np.copy(tmp88)
    tmp90 += tmp89 * 4
    ...
    tmp127 = einsum(t2.bbbb, (0, 1, 2, 3), tmp19, (1, 0, 4, 5), (4, 5, 2, 3)) * -1
    ...
    tmp32 = einsum(tmp27, (0, 1, 2, 3), t2.abab, (4, 2, 5, 3), (0, 1, 4, 5))
    rdm2.aaaa.ooov += np.transpose(tmp32, (1, 2, 0, 3)) * -1
    tmp33 = einsum(t2.aaaa, (0, 1, 2, 3), tmp6, (4, 1, 5, 3), (4, 5, 0, 2)) * -1
    ...
    tmp43 += tmp41 * 2
    tmp42 = einsum(tmp16, (0, 1), t1.bb, (0, 2), (1, 2))
    tmp43 += tmp42
    del tmp42
    ...
    tmp56 += tmp28 * 0.5
    del tmp28
    tmp55 = einsum(t1.aa, (0, 1), tmp29, (0, 2), (2, 1))
    tmp56 += tmp55
    del tmp55
    ...
    tmp63 = np.copy(tmp40) * 0.5
    del tmp40
    tmp63 += tmp41
    del tmp41
    tmp62 = einsum(tmp16, (0, 1), t1.bb, (0, 2), (1, 2)) * 0.5
    tmp63 += tmp62
    del tmp62
    ...
    del delta
    tmp44 = einsum(tmp27, (0, 1, 2, 3), t2.bbbb, (4, 2, 5, 3), (0, 1, 4, 5))
    del tmp27
    ...
    tmp47 = einsum(tmp46, (0, 1, 2, 3), t1.bb, (2, 4), (0, 1, 3, 4))
    ...
    tmp99 += tmp83 * 2
    del tmp83
    rdm2.bbbb.oovv += einsum(t2.bbbb, (0, 1, 2, 3), tmp99, (3, 4), (0, 1, 4, 2)) * 2
    del tmp99
    ...
    tmp73 = np.copy(t1.aa) * 0.5
    tmp73 += tmp21
    tmp73 += tmp22 * 0.5
    rdm2.aaaa.oovv += einsum(t1.aa, (0, 1), tmp73, (2, 3), (2, 0, 1, 3)) * -2
    del tmp73
    ...
    rdm2.aaaa.oovv += einsum(tmp74, (0, 1), t1.aa, (2, 3), (2, 0, 1, 3)) * -1
    tmp75 = einsum(t1.aa, (0, 1), tmp25, (0, 2, 3, 4), (2, 3, 1, 4))
    del tmp25
    rdm2.aaaa.oovv += tmp75 * 2
    tmp76 = np.copy(tmp64) * 2
    del tmp64
    tmp76 += tmp65
    del tmp65
    ...
    rdm2.aaaa.oovv += einsum(tmp56, (0, 1), t1.aa, (2, 3), (2, 0, 3, 1)) * -2
    ...
    rdm2.abab.oovv += einsum(tmp84, (0, 1), t2.abab, (2, 3, 4, 0), (2, 3, 4, 1)) * -2
    del tmp84
    ...
    del tmp57
    rdm2.abab.oovv += einsum(tmp17, (0, 1), t2.abab, (2, 0, 3, 4), (2, 1, 3, 4)) * -2
    del tmp17
    rdm2.abab.oovv += einsum(tmp43, (0, 1), t1.aa, (2, 3), (2, 0, 3, 1)) * -1
    del tmp43
    rdm2.abab.oovv += einsum(t2.abab, (0, 1, 2, 3), tmp29, (0, 4), (4, 1, 2, 3)) * -2
    del tmp29
...
def hbar_matvec_ip_intermediates(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T22:21:11.095670.
    ...
    tmp149 = einsum(v.aabb.ovov, (0, 1, 2, 3), t2.bbbb, (4, 2, 5, 3), (0, 4, 1, 5))
    tmp151 = einsum(t2.abab, (0, 1, 2, 3), v.aabb.ovov, (0, 2, 4, 5), (1, 4, 3, 5))
    tmp154 = einsum(t2.abab, (0, 1, 2, 3), f.aa.ov, (4, 2), (4, 0, 1, 3))
    tmp155 = einsum(t2.bbbb, (0, 1, 2, 3), v.bbbb.ooov, (4, 1, 0, 3), (4, 2)) * -1
...
def hbar_matvec_ip(f=None, r1=None, r2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T22:21:15.774286.
    ...
    tmp30 = einsum(r2.aaa, (0, 1, 2), v.aaaa.ovov, (0, 2, 1, 3), (3,)) * -1
    ...
    del tmp39
    tmp40 = einsum(v.bbbb.ovov, (0, 1, 2, 3), r2.bbb, (0, 2, 3), (1,))
    tmp41 += tmp40 * 2
    del tmp40
    ...
    tmp16 += tmp9 * 2
    del tmp9
    tmp10 = einsum(r2.bab, (0, 1, 2), ints.tmp81, (3, 0, 4, 2), (3, 1, 4)) * -1
    del ints.tmp81
    tmp16 += tmp10
    del tmp10
    ...
    r2new.aaa += einsum(r2.aaa, (0, 1, 2), tmp27, (3, 4, 1, 0), (3, 4, 2)) * -2
    del tmp27
    ...
    tmp32 += tmp31 * 0.5
    del tmp31
    r2new.aaa += einsum(tmp32, (0,), t2.aaaa, (1, 2, 3, 0), (1, 2, 3)) * 4
    del tmp32
    ...
    del tmp34
    tmp54 = einsum(r2.aba, (0, 1, 2), ints.tmp141, (0, 3, 2, 4), (3, 1, 4))
    del ints.tmp141
    tmp63 = np.copy(tmp54)
    del tmp54
    tmp55 = einsum(r2.aba, (0, 1, 2), v.aabb.ovov, (0, 2, 3, 4), (1, 3, 4))
    tmp63 += tmp55
    del tmp55
    tmp56 = einsum(r2.bbb, (0, 1, 2), v.bbbb.oovv, (3, 1, 4, 2), (0, 3, 4))
    tmp63 += tmp56 * 2
    del tmp56
    tmp57 = np.copy(ints.tmp147)
    del ints.tmp147
    tmp57 += ints.tmp151 * 0.5
    del ints.tmp151
    tmp58 = einsum(r2.bbb, (0, 1, 2), tmp57, (3, 1, 4, 2), (0, 3, 4)) * -4
    del tmp57
    tmp63 += np.transpose(tmp58, (1, 0, 2)) * -1
    del tmp58
    tmp59 = np.copy(ints.tmp41) * 2
    del ints.tmp41
    tmp59 += ints.tmp43
    del ints.tmp43
    ...
    del tmp60
    tmp61 = np.copy(ints.tmp184)
    del ints.tmp184
    tmp61 += np.transpose(v.bbbb.ooov, (0, 2, 1, 3)) * 0.5
    tmp62 = einsum(r1.b, (0,), tmp61, (1, 2, 0, 3), (1, 2, 3)) * 2
    del tmp61
    tmp63 += tmp62
    del tmp62
    r2new.bbb = np.copy(tmp63) * -1
    r2new.bbb += np.transpose(tmp63, (1, 0, 2))
    del tmp63
    tmp64 = einsum(ints.tmp145, (0, 1, 2, 3), r2.bbb, (4, 1, 3), (0, 4, 2))
    del ints.tmp145
    tmp72 = np.copy(tmp64) * 4
    del tmp64
    tmp65 = einsum(r2.bbb, (0, 1, 2), v.bbbb.ovov, (3, 4, 1, 2), (0, 3, 4))
    tmp72 += tmp65 * 2
    del tmp65
    tmp66 = np.copy(ints.tmp143)
    del ints.tmp143
    tmp66 += ints.tmp149 * 2
    del ints.tmp149
    tmp67 = einsum(r2.aba, (0, 1, 2), tmp66, (0, 3, 2, 4), (1, 3, 4))
    del tmp66
    tmp72 += np.transpose(tmp67, (1, 0, 2))
    del tmp67
    tmp68 = np.copy(f.bb.oo)
    tmp68 += ints.tmp28
    del ints.tmp28
    tmp69 = einsum(r2.bbb, (0, 1, 2), tmp68, (1, 3), (0, 3, 2)) * -1
    del tmp68
    tmp72 += np.transpose(tmp69, (1, 0, 2)) * -2
    del tmp69
    tmp70 = np.copy(ints.tmp188)
    del ints.tmp188
    tmp70 += ints.tmp186 * 2
    del ints.tmp186
    ...
    del tmp71
    r2new.bbb += tmp72
    r2new.bbb += np.transpose(tmp72, (1, 0, 2)) * -1
    del tmp72
    tmp73 = np.copy(ints.tmp178)
    del ints.tmp178
    tmp73 += np.transpose(v.bbbb.oooo, (0, 2, 1, 3))
    r2new.bbb += einsum(r2.bbb, (0, 1, 2), tmp73, (3, 4, 1, 0), (3, 4, 2)) * -2
    del tmp73
    ...
    del ints.tmp198
    r2new.bbb += einsum(tmp74, (0, 1, 2, 3), r1.b, (2,), (1, 0, 3)) * 2
    del tmp74
...
def hbar_matvec_ea_intermediates(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T22:26:36.175587.
    ...
    tmp149 = einsum(t2.bbbb, (0, 1, 2, 3), v.bbbb.ooov, (4, 1, 0, 3), (4, 2)) * -1
    ...
    tmp95 = einsum(v.aaaa.ovov, (0, 1, 2, 3), t2.aaaa, (4, 2, 3, 1), (4, 0)) * -1
    ...
    tmp168 = einsum(v.aabb.ovov, (0, 1, 2, 3), t2.bbbb, (4, 2, 5, 3), (0, 4, 1, 5))
    ...
    tmp193 = einsum(t2.bbbb, (0, 1, 2, 3), v.bbbb.ooov, (4, 1, 0, 5), (4, 2, 3, 5)) * -1
...
def hbar_matvec_ea(f=None, r1=None, r2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T22:26:38.063809.
    ...
    tmp51 += tmp3 * 2
    tmp51 += tmp4
    r2new.bab += einsum(t2.abab, (0, 1, 2, 3), tmp51, (0,), (3, 2, 1))
    del tmp51
    tmp52 = np.copy(ints.tmp141) * 2
    del ints.tmp141
    tmp52 += ints.tmp147
    del ints.tmp147
    tmp52 += ints.tmp148
    ...
    tmp52 += ints.tmp153 * -2
    del ints.tmp153
    r2new.bab += einsum(r1.a, (0,), tmp52, (1, 2), (2, 0, 1))
    ...
    del tmp23
    tmp24 = einsum(r2.aaa, (0, 1, 2), ints.tmp63, (3, 2, 4, 1), (3, 4, 0))
    tmp28 += tmp24 * 4
    del tmp24
    ...
    tmp31 += tmp4 * 0.5
    del tmp4
    r2new.aaa += einsum(tmp31, (0,), t2.aaaa, (1, 0, 2, 3), (2, 3, 1)) * 4
    del tmp31
    ...
    tmp53 = einsum(r2.bbb, (0, 1, 2), v.bbbb.ovov, (3, 1, 4, 0), (2, 3, 4)) * -1
    r2new.bbb += einsum(tmp53, (0, 1, 2), t2.bbbb, (2, 1, 3, 4), (3, 4, 0)) * -2
    del tmp53
    tmp54 = einsum(ints.tmp160, (0, 1, 2, 3), r2.aba, (2, 4, 0), (1, 3, 4))
    del ints.tmp160
    tmp65 = np.copy(tmp54)
    del tmp54
    tmp55 = einsum(r2.aba, (0, 1, 2), v.aabb.ovov, (2, 0, 3, 4), (3, 1, 4))
    tmp65 += tmp55
    del tmp55
    tmp56 = einsum(r2.bbb, (0, 1, 2), v.bbbb.oovv, (3, 2, 4, 1), (3, 0, 4))
    tmp65 += tmp56 * 2
    del tmp56
    tmp57 = einsum(r2.bbb, (0, 1, 2), f.bb.ov, (3, 1), (3, 2, 0))
    tmp58 = einsum(t1.bb, (0, 1), tmp57, (0, 2, 3), (2, 3, 1))
    del tmp57
    tmp65 += tmp58 * 2
    del tmp58
    tmp59 = np.copy(ints.tmp166) * 2
    del ints.tmp166
    tmp59 += ints.tmp170
    del ints.tmp170
    tmp60 = einsum(tmp59, (0, 1, 2, 3), r2.bbb, (4, 3, 1), (0, 4, 2)) * -2
    del tmp59
    tmp65 += np.transpose(tmp60, (0, 2, 1)) * -1
    del tmp60
    tmp61 = np.copy(np.transpose(ints.tmp41, (1, 0)))
    del ints.tmp41
    tmp61 += np.transpose(ints.tmp43, (1, 0)) * 0.5
    del ints.tmp43
    tmp61 += f.bb.vv * -0.5
    tmp62 = einsum(tmp61, (0, 1), r2.bbb, (2, 0, 3), (3, 2, 1)) * -4
    del tmp61
    tmp65 += np.transpose(tmp62, (0, 2, 1))
    del tmp62
    tmp63 = np.copy(ints.tmp176)
    del ints.tmp176
    tmp63 += ints.tmp180 * 0.5
    del ints.tmp180
    tmp63 += v.bbbb.ovvv * 0.5
    tmp64 = einsum(tmp63, (0, 1, 2, 3), r1.b, (3,), (0, 1, 2)) * 2
    del tmp63
    tmp65 += tmp64
    del tmp64
    r2new.bbb += np.transpose(tmp65, (1, 2, 0)) * -1
    r2new.bbb += np.transpose(tmp65, (2, 1, 0))
    del tmp65
    tmp66 = einsum(r1.b, (0,), ints.tmp178, (1, 2, 0, 3), (1, 2, 3))
    del ints.tmp178
    tmp71 = np.copy(tmp66) * 2
    del tmp66
    tmp67 = einsum(ints.tmp164, (0, 1, 2, 3), r2.bbb, (4, 3, 1), (0, 2, 4))
    del ints.tmp164
    tmp71 += tmp67 * 4
    del tmp67
    tmp68 = einsum(r2.bbb, (0, 1, 2), v.bbbb.ovov, (3, 4, 2, 1), (3, 0, 4))
    tmp71 += tmp68 * 2
    del tmp68
    tmp69 = np.copy(ints.tmp162)
    del ints.tmp162
    tmp69 += ints.tmp168 * 2
    del ints.tmp168
    tmp70 = einsum(r2.aba, (0, 1, 2), tmp69, (2, 3, 0, 4), (3, 1, 4))
    del tmp69
    tmp71 += np.transpose(tmp70, (0, 2, 1))
    del tmp70
    r2new.bbb += np.transpose(tmp71, (1, 2, 0))
    r2new.bbb += np.transpose(tmp71, (2, 1, 0)) * -1
    del tmp71
    r2new.bbb += einsum(tmp50, (0, 1), r2.bbb, (2, 3, 0), (2, 3, 1)) * -2
    del tmp50
    r2new.bbb += einsum(t2.bbbb, (0, 1, 2, 3), tmp43, (1,), (2, 3, 0)) * 2
    del tmp43
    r2new.bbb += einsum(tmp52, (0, 1), r1.b, (2,), (2, 1, 0)) * -1
    r2new.bbb += einsum(tmp52, (0, 1), r1.b, (2,), (1, 2, 0))
    del tmp52
...
def hbar_lmatvec_ip_intermediates(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T22:34:03.536639.
...
def hbar_lmatvec_ip(f=None, r1=None, r2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T22:34:13.194369.
    ...
    del ints.tmp21
    tmp63 = einsum(r2.bbb, (0, 1, 2), tmp62, (1, 3), (0, 3, 2)) * -1
    del tmp62
    ...
    r2new.bbb += einsum(r2.bbb, (0, 1, 2), tmp65, (1, 0, 3, 4), (3, 4, 2)) * -2
    del tmp65
...
def hbar_lmatvec_ea_intermediates(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T22:40:43.912671.
...
def hbar_lmatvec_ea(f=None, r1=None, r2=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T22:40:47.713388.
    ...
    del tmp8
    tmp28 = np.copy(ints.tmp114)
    del ints.tmp114
    tmp28 += v.bbbb.ooov * -1
    tmp27 = einsum(t1.bb, (0, 1), tmp21, (2, 3, 1), (2, 3, 0)) * -1
    r1new.b += einsum(tmp27, (0, 1, 2), tmp28, (0, 2, 1, 3), (3,)) * -2
    del tmp27, tmp28
    tmp30 = np.copy(ints.tmp117)
    del ints.tmp117
    tmp30 += v.aabb.ooov
    tmp29 = einsum(t1.bb, (0, 1), tmp25, (2, 3, 1), (2, 3, 0))
    del tmp25
    ...
    del ints.tmp177
    r1new.b += einsum(tmp31, (0, 1), r1.b, (0,), (1,)) * -1
    del tmp31
    ...
    tmp34 += tmp32 * -1
    tmp33 = einsum(t2.bbbb, (0, 1, 2, 3), r2.bbb, (2, 3, 1), (0,))
    tmp34 += tmp33 * 2
    r1new.b += einsum(tmp35, (0, 1), tmp34, (0,), (1,)) * -1
    del tmp35, tmp34
    r2new.aba = einsum(r2.aba, (0, 1, 2), v.aabb.vvvv, (3, 0, 4, 1), (3, 4, 2))
    tmp55 = einsum(t2.abab, (0, 1, 2, 3), r2.aba, (2, 3, 4), (4, 0, 1))
    r2new.aba += einsum(tmp55, (0, 1, 2), v.aabb.ovov, (1, 3, 2, 4), (3, 4, 0))
    del tmp55
    ...
    del ints.tmp294
    tmp58 += v.aabb.oovv * -1
    r2new.aba += einsum(r2.aba, (0, 1, 2), tmp58, (2, 3, 1, 4), (0, 4, 3))
    del tmp58
    ...
    r2new.aba += einsum(r2.aba, (0, 1, 2), tmp60, (1, 3), (0, 3, 2)) * -1
    del tmp60
    ...
    tmp63 += tmp33 * 2
    r2new.aba += einsum(tmp63, (0,), v.aabb.ovov, (1, 2, 0, 3), (2, 3, 1))
    del tmp63
    r2new.bab = einsum(v.aabb.vvvv, (0, 1, 2, 3), r2.bab, (3, 1, 4), (2, 0, 4))
    r2new.bab += einsum(f.bb.ov, (0, 1), r1.a, (2,), (1, 2, 0)) * -1
    tmp64 = einsum(r2.bab, (0, 1, 2), t2.abab, (3, 4, 1, 0), (3, 2, 4)) * -1
    r2new.bab += einsum(tmp64, (0, 1, 2), v.aabb.ovov, (0, 3, 2, 4), (4, 3, 1)) * -1
    del tmp64
    ...
    tmp65 += ints.tmp288 * -2
    tmp65 += v.bbbb.oovv * -1
    r2new.bab += einsum(r2.bab, (0, 1, 2), tmp65, (2, 3, 0, 4), (4, 1, 3))
    del tmp65
    tmp66 = np.copy(ints.tmp284)
    tmp66 += ints.tmp290 * 2
    tmp66 += np.transpose(v.aabb.ovov, (0, 2, 1, 3))
    tmp66 += ints.tmp287 * -1
    r2new.bab += einsum(tmp66, (0, 1, 2, 3), r2.aaa, (4, 2, 0), (3, 4, 1)) * -2
    del tmp66
    ...
    del tmp59
    r2new.bab += einsum(tmp68, (0, 1), r2.bab, (0, 2, 3), (1, 2, 3)) * -2
    del tmp68
    ...
    tmp70 = np.copy(tmp15) * 2
    tmp70 += tmp16
    r2new.bab += einsum(tmp70, (0,), v.aabb.ovov, (0, 1, 2, 3), (3, 1, 2))
    del tmp70
    tmp36 = einsum(t2.aaaa, (0, 1, 2, 3), r2.aaa, (2, 3, 4), (4, 0, 1))
    r2new.aaa = einsum(v.aaaa.ovov, (0, 1, 2, 3), tmp36, (4, 2, 0), (1, 3, 4)) * -2
    del tmp36
    r2new.aaa += einsum(v.aaaa.vvvv, (0, 1, 2, 3), r2.aaa, (3, 1, 4), (0, 2, 4)) * -2
    tmp37 = einsum(ints.tmp142, (0, 1, 2, 3), r2.aaa, (4, 2, 0), (1, 3, 4))
    del ints.tmp142
    tmp43 = np.copy(tmp37) * 4
    del tmp37
    tmp38 = einsum(r2.aaa, (0, 1, 2), v.aaaa.ovov, (3, 4, 2, 1), (3, 0, 4))
    tmp43 += tmp38 * 2
    del tmp38
    ...
    tmp43 += tmp39 * 2
    del tmp39
    tmp40 = einsum(ints.tmp144, (0, 1, 2, 3), r2.bab, (3, 4, 1), (0, 2, 4)) * -1
    del ints.tmp144
    tmp43 += tmp40
    del tmp40
    tmp41 = einsum(r2.bab, (0, 1, 2), v.aabb.ovov, (3, 4, 2, 0), (3, 1, 4)) * -1
    tmp43 += tmp41
    del tmp41
    tmp42 = einsum(tmp16, (0,), v.aaaa.ovov, (1, 2, 0, 3), (1, 2, 3))
    del tmp16
    tmp43 += tmp42
    del tmp42
    ...
    del tmp43
    tmp53 = einsum(r1.a, (0,), f.aa.ov, (1, 2), (1, 2, 0))
    tmp44 = einsum(r1.a, (0,), v.aaaa.ovvv, (1, 2, 3, 0), (1, 2, 3))
    tmp53 += tmp44
    del tmp44
    tmp45 = einsum(v.aaaa.oovv, (0, 1, 2, 3), r2.aaa, (4, 3, 1), (0, 4, 2))
    tmp53 += tmp45 * 2
    del tmp45
    tmp46 = einsum(tmp15, (0,), v.aaaa.ovov, (1, 2, 0, 3), (1, 2, 3)) * -1
    del tmp15
    tmp53 += tmp46 * 2
    del tmp46
    tmp47 = np.copy(ints.tmp139) * 2
    del ints.tmp139
    tmp47 += ints.tmp145
    del ints.tmp145
    tmp48 = einsum(tmp47, (0, 1, 2, 3), r2.aaa, (4, 2, 0), (1, 4, 3)) * -2
    del tmp47
    tmp53 += np.transpose(tmp48, (0, 2, 1)) * -1
    del tmp48
    ...
    tmp80 += tmp33
    del tmp33
    tmp81 = einsum(tmp80, (0,), v.bbbb.ovov, (1, 2, 0, 3), (1, 3, 2)) * 2
    del tmp80
    ...
    del tmp82
    tmp83 = einsum(r2.bbb, (0, 1, 2), ints.tmp288, (2, 3, 1, 4), (3, 4, 0))
    del ints.tmp288
    ...
    tmp86 += ints.tmp290 * 2
    del ints.tmp290
    tmp87 = einsum(r2.aba, (0, 1, 2), tmp86, (2, 3, 0, 4), (3, 1, 4))
    del tmp86
