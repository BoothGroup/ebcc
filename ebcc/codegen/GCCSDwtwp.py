...
https://github.com/obackhouse/albert
  ...
  * date: 2024-10-20T09:35:50.740938
...
def energy(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:35:55.801812.
...
def update_amps(f=None, t1=None, t2=None, t3=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:46:51.063667.
    ...
    tmp27 = einsum(t1, (0, 1), v.oOvV, (0, 2, 1, 3), (2, 3))
    ...
    tmp41 = einsum(tmp40, (0, 1, 2, 3), t2, (4, 1, 5, 3), (4, 0, 5, 2))
    del tmp40
    ...
    del tmp44
    tmp45 = einsum(t1, (0, 1), tmp2, (2, 3, 4, 1), (2, 0, 4, 3))
    ...
    tmp61 = einsum(t2_oOVV, (0, 1, 2, 3), tmp60, (0, 4, 5, 6), (5, 4, 1, 6, 2, 3)) * -1
    del tmp60
    ...
    del tmp61
    tmp62 = einsum(t2_oOVV, (0, 1, 2, 3), v.oVOO, (0, 4, 5, 6), (1, 5, 6, 2, 3, 4))
    ...
    del tmp66
    tmp67 = einsum(t1_oV, (0, 1), v.ooOO, (2, 0, 3, 4), (2, 3, 4, 1))
    ...
    tmp70 = einsum(tmp69, (0, 1, 2, 3), t2_oOVV, (0, 4, 5, 6), (1, 4, 2, 5, 6, 3))
    del tmp69
    ...
    del tmp86
    tmp87 = einsum(v.oOvv, (0, 1, 2, 3), t2_oOvv, (0, 4, 2, 3), (4, 1))
    ...
    tmp96 = einsum(t3, (0, 1, 2, 3, 4, 5), tmp95, (6, 7, 2, 1, 8, 5), (7, 6, 0, 8, 3, 4))
    del tmp95
    ...
    tmp99 = einsum(tmp30, (0, 1, 2, 3), t2_oOVV, (0, 4, 5, 6), (4, 2, 1, 5, 6, 3)) * -1
    del tmp30
    ...
    tmp103 = einsum(t2_OOvV, (0, 1, 2, 3), tmp102, (2, 4, 5, 6), (0, 1, 4, 5, 6, 3))
    del tmp102
    ...
    del tmp1
    tmp109 = einsum(t2_oOVV, (0, 1, 2, 3), tmp108, (0, 4, 5, 6), (5, 4, 1, 6, 2, 3))
    del tmp108
    ...
    del tmp120
    tmp122 = einsum(tmp121, (0, 1, 2, 3), t2_oOVV, (0, 4, 5, 6), (1, 4, 2, 3, 5, 6)) * -1
    del tmp121
    ...
    tmp123 = einsum(t1_oV, (0, 1), v.ooOv, (2, 0, 3, 4), (2, 4, 3, 1)) * -1
    ...
    tmp135 = einsum(t1_oV, (0, 1), tmp134, (0, 2), (1, 2)) * -1
    del tmp134
