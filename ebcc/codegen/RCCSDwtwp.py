...
https://github.com/obackhouse/albert
  ...
  * date: 2024-09-28T14:17:57.686365
...
def energy(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T14:17:58.388167.
...
def update_amps(f=None, t1=None, t2=None, t3=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-09-28T14:20:00.817057.
    ...
    tmp181 = einsum(t1, (0, 1), v.Ovov, (2, 1, 0, 3), (3, 2))
    tmp190 = einsum(v.OVov, (0, 1, 2, 3), t1_Ov, (4, 3), (2, 4, 0, 1))
    tmp187 = einsum(v.OvVo, (0, 1, 2, 3), t1_Ov, (4, 1), (3, 4, 0, 2))
    tmp154 = einsum(v.VoVo, (0, 1, 2, 3), t1_oV, (3, 4), (1, 4, 0, 2))
    tmp176 = einsum(v.Ooov, (0, 1, 2, 3), t1_Ov, (4, 3), (2, 1, 4, 0))
    ...
    tmp184 = einsum(t1, (0, 1), v.Ovov, (2, 3, 0, 1), (3, 2))
    tmp134 = einsum(v.Ooov, (0, 1, 2, 3), t1_oV, (1, 4), (2, 3, 0, 4))
    ...
    tmp239 = einsum(t2_OovV, (0, 1, 2, 3), v.OvVo, (4, 2, 5, 1), (0, 4, 3, 5))
    tmp128 = einsum(t1_oV, (0, 1), v.OoOV, (2, 0, 3, 4), (2, 3, 1, 4))
    tmp155 = einsum(t1_oV, (0, 1), tmp154, (0, 2, 3, 4), (2, 1, 4, 3))
    del tmp154
    tmp292 = einsum(v.VvVv, (0, 1, 2, 3), t1_Ov, (4, 3), (1, 4, 0, 2))
    ...
    tmp142 = einsum(v.Voov, (0, 1, 2, 3), t2_oovV, (1, 2, 3, 4), (4, 0))
    ...
    tmp146 = einsum(v.VoVo, (0, 1, 2, 3), t2_ooVV, (3, 1, 4, 5), (5, 4, 0, 2))
    tmp227 = einsum(tmp218, (0, 1, 2, 3), t2_OoVv, (4, 0, 5, 2), (1, 4, 3, 5))
    tmp144 = einsum(v.Voov, (0, 1, 2, 3), t2_oovV, (2, 1, 3, 4), (4, 0))
    ...
    tmp275 = einsum(tmp173, (0, 1, 2, 3), t2_OoVv, (4, 0, 5, 2), (1, 3, 4, 5))
    tmp223 = einsum(t3, (0, 1, 2, 3, 4, 5), v.OVVo, (2, 4, 5, 6), (6, 0, 1, 3))
    tmp214 = einsum(t2_OOvV, (0, 1, 2, 3), tmp14, (4, 2), (4, 0, 1, 3))
    tmp250 = einsum(t2_OoVv, (0, 1, 2, 3), v.OvVo, (4, 3, 5, 1), (0, 4, 2, 5))
    tmp242 = einsum(t1_oV, (0, 1), v.OVov, (2, 3, 0, 4), (4, 2, 1, 3))
    tmp140 = einsum(t1_oV, (0, 1), f.Vo, (2, 0), (2, 1))
    tmp167 = einsum(v.OvOO, (0, 1, 2, 3), t1_Ov, (4, 1), (4, 0, 2, 3))
    tmp149 = einsum(t1_oV, (0, 1), tmp148, (0, 2), (1, 2))
    del tmp148
    tmp55 = einsum(t3, (0, 1, 2, 3, 4, 5), v.OVVo, (2, 5, 4, 6), (6, 0, 1, 3))
    tmp225 = einsum(t3, (0, 1, 2, 3, 4, 5), v.OVVo, (1, 4, 5, 6), (6, 0, 2, 3))
    tmp221 = einsum(t2_OovV, (0, 1, 2, 3), v.Ooov, (4, 1, 5, 2), (5, 0, 4, 3))
    tmp252 = einsum(t2_OovV, (0, 1, 2, 3), v.OVov, (4, 5, 1, 2), (0, 4, 3, 5))
    tmp177 = einsum(t1_oV, (0, 1), tmp176, (2, 0, 3, 4), (2, 3, 4, 1))
    del tmp176
    tmp262 = einsum(t2_OovV, (0, 1, 2, 3), v.Vvov, (4, 5, 1, 2), (5, 0, 3, 4))
    tmp279 = einsum(tmp173, (0, 1, 2, 3), t2_OovV, (4, 0, 2, 5), (1, 3, 4, 5))
    tmp132 = einsum(v.Ooov, (0, 1, 2, 3), t2_ooVV, (2, 1, 4, 5), (3, 0, 4, 5))
    ...
    del tmp294
    tmp219 = einsum(t2_OovV, (0, 1, 2, 3), tmp218, (1, 4, 2, 5), (4, 0, 5, 3))
    tmp169 = einsum(v.Ovov, (0, 1, 2, 3), t2_Oovv, (4, 2, 3, 1), (4, 0))
    tmp161 = einsum(t1, (0, 1), v.VoVv, (2, 0, 3, 1), (2, 3))
    tmp53 = einsum(v.OVVo, (0, 1, 2, 3), t3, (4, 5, 0, 1, 6, 2), (3, 4, 5, 6)) * -1
    tmp135 = einsum(t1_oV, (0, 1), tmp134, (0, 2, 3, 4), (2, 3, 1, 4))
    del tmp134
    tmp311 = einsum(t2_OOvv, (0, 1, 2, 3), v.Vvov, (4, 3, 5, 2), (5, 0, 1, 4))
    tmp159 = einsum(t1, (0, 1), v.VVov, (2, 3, 0, 1), (2, 3))
    ...
    tmp42 = einsum(t2, (0, 1, 2, 3), v.ovov, (0, 3, 1, 4), (2, 4))
    ...
    del tmp244
    tmp198 = einsum(tmp171, (0, 1), t3, (2, 1, 3, 4, 5, 6), (0, 2, 3, 4, 6, 5))
    tmp284 = einsum(tmp283, (0, 1, 2, 3), t2_OoVV, (4, 0, 5, 6), (1, 2, 4, 3, 6, 5))
    del tmp283
    ...
    tmp180 = einsum(t2_OoVV, (0, 1, 2, 3), tmp179, (1, 4, 5, 6), (4, 0, 5, 6, 3, 2))
    del tmp179
    ...
    del tmp246
    tmp217 = einsum(tmp216, (0, 1, 2, 3), t2_OoVV, (4, 0, 5, 6), (4, 1, 2, 6, 5, 3))
    del tmp216
    ...
    tmp276 = einsum(tmp275, (0, 1, 2, 3), t2_OoVV, (4, 0, 5, 6), (1, 2, 4, 3, 6, 5))
    del tmp275
    ...
    tmp207 = einsum(tmp55, (0, 1, 2, 3), t2_OoVV, (4, 0, 5, 6), (4, 1, 2, 6, 5, 3))
    ...
    tmp267 = einsum(tmp146, (0, 1, 2, 3), t3, (4, 5, 6, 2, 7, 3), (4, 6, 5, 1, 0, 7)) * -1
    del tmp146
    tmp222 = einsum(tmp221, (0, 1, 2, 3), t2_OoVV, (4, 0, 5, 6), (1, 4, 2, 3, 6, 5))
    del tmp221
    tmp139 = einsum(t3, (0, 1, 2, 3, 4, 5), tmp130, (6, 1, 7, 5), (0, 2, 6, 7, 3, 4))
    tmp121 = einsum(v.OOOO, (0, 1, 2, 3), t3, (1, 4, 3, 5, 6, 7), (4, 0, 2, 5, 7, 6))
    ...
    del tmp177
    tmp263 = einsum(t2_OOvV, (0, 1, 2, 3), tmp262, (2, 4, 5, 6), (4, 0, 1, 5, 3, 6))
    del tmp262
    tmp271 = einsum(tmp254, (0, 1, 2, 3), t3, (4, 5, 1, 6, 3, 7), (0, 4, 5, 2, 6, 7))
    tmp280 = einsum(tmp279, (0, 1, 2, 3), t2_OoVV, (4, 0, 5, 6), (1, 2, 4, 3, 6, 5))
    del tmp279
    tmp133 = einsum(t2_OOvV, (0, 1, 2, 3), tmp132, (2, 4, 5, 6), (0, 1, 4, 5, 6, 3))
    del tmp132
    tmp213 = einsum(t2_OoVV, (0, 1, 2, 3), tmp212, (1, 4, 5, 6), (4, 0, 5, 6, 3, 2))
    del tmp212
    tmp123 = einsum(tmp122, (0, 1, 2, 3), t2_OoVV, (4, 0, 5, 6), (4, 2, 1, 3, 6, 5))
    del tmp122
    ...
    del tmp311
    tmp196 = einsum(tmp167, (0, 1, 2, 3), t3, (4, 1, 3, 5, 6, 7), (0, 4, 2, 5, 7, 6))
    tmp160 = einsum(t3, (0, 1, 2, 3, 4, 5), tmp159, (6, 5), (0, 2, 1, 3, 4, 6))
    tmp303 = einsum(tmp302, (0, 1, 2, 3), t2_OoVV, (4, 0, 5, 6), (2, 1, 4, 3, 6, 5))
    del tmp302
    tmp137 = einsum(v.OOOO, (0, 1, 2, 3), t3, (4, 3, 1, 5, 6, 7), (4, 0, 2, 5, 7, 6))
    tmp153 = einsum(t3, (0, 1, 2, 3, 4, 5), tmp152, (6, 5), (0, 2, 1, 6, 3, 4))
    tmp278 = einsum(tmp277, (0, 1, 2, 3), t2_OoVV, (4, 0, 5, 6), (1, 2, 4, 3, 6, 5))
    del tmp277
    ...
    del tmp258
    tmp205 = einsum(tmp203, (0, 1, 2, 3, 4, 5), t3, (6, 2, 3, 7, 8, 5), (0, 1, 6, 4, 7, 8))
    ...
    del tmp53
    tmp49 = einsum(v.OVVv, (0, 1, 2, 3), t3, (4, 5, 0, 1, 6, 2), (3, 4, 5, 6)) * -1
    tmp66 = einsum(t3, (0, 1, 2, 3, 4, 5), tmp64, (6, 1, 2, 5), (6, 0, 3, 4))
    tmp31 = einsum(t3, (0, 1, 2, 3, 4, 5), v.OoOV, (1, 6, 2, 5), (6, 0, 3, 4))
    ...
    tmp117 = einsum(tmp116, (0, 1, 2, 3), t2, (2, 3, 4, 5), (1, 0, 5, 4))
    del tmp116
    ...
    tmp20 = einsum(v.OVOV, (0, 1, 2, 3), t3, (4, 0, 2, 1, 5, 3), (4, 5)) * -1
    ...
    t3new += einsum(tmp182, (0, 1), t3, (2, 1, 3, 4, 5, 6), (2, 0, 3, 4, 5, 6))
    del tmp182
    ...
    t3new += einsum(tmp130, (0, 1, 2, 3), t3, (4, 1, 5, 6, 3, 7), (4, 0, 5, 6, 2, 7))
    del tmp130
