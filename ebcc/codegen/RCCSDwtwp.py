...
https://github.com/obackhouse/albert
  ...
  * date: 2024-10-18T21:45:51.745911
...
def energy(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T21:46:04.881105.
...
def update_amps(f=None, t1=None, t2=None, t3=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-18T22:07:53.995994.
    ...
    del tmp20
    tmp21 = einsum(t3, (0, 1, 2, 3, 4, 5), v.OVOV, (1, 5, 2, 4), (0, 3))
    t1new_OV += tmp21 * -0.5
    del tmp21
    ...
    del tmp39
    tmp30 = einsum(v.oOOV, (0, 1, 2, 3), t3, (2, 4, 1, 5, 6, 3), (0, 4, 5, 6)) * -1
    ...
    tmp65 = einsum(t3, (0, 1, 2, 3, 4, 5), tmp64, (6, 2, 0, 5), (6, 1, 3, 4)) * -1
    ...
    tmp18 = einsum(v.ooov, (0, 1, 2, 3), t2, (2, 1, 4, 3), (0, 4))
    t1new += tmp18
    del tmp18
    ...
    t2new += einsum(t2, (0, 1, 2, 3), tmp85, (4, 1, 5, 2), (0, 4, 5, 3))
    ...
    tmp95 = einsum(tmp94, (0, 1, 2, 3), t2, (4, 1, 5, 3), (4, 0, 5, 2))
    del tmp94
    t2new += tmp95 * -2
    del tmp95
    tmp96 = einsum(tmp48, (0, 1, 2, 3), t2, (4, 1, 5, 3), (4, 0, 5, 2))
    t2new += np.transpose(tmp96, (1, 0, 3, 2)) * -2
    tmp97 = einsum(t2, (0, 1, 2, 3), tmp47, (4, 1, 5, 3), (0, 4, 2, 5))
    t2new += tmp97 * 4
    del tmp97
    t2new += tmp93
    del tmp93
    t2new += tmp96 * -2
    del tmp96
    t2new += einsum(tmp48, (0, 1, 2, 3), t2, (4, 1, 3, 5), (4, 0, 5, 2))
    t2new += tmp81 * -1
    del tmp81
    ...
    tmp100 = einsum(tmp99, (0, 1, 2, 3), t2, (2, 3, 4, 5), (1, 0, 5, 4))
    t2new += tmp100
    del tmp100
    ...
    t2new += tmp117
    del tmp117
    tmp118 = einsum(t1, (0, 1), tmp116, (2, 3, 0, 4), (3, 2, 4, 1))
    del tmp116
    ...
    tmp123 = einsum(tmp122, (0, 1, 2, 3), t2_oOVV, (0, 4, 5, 6), (4, 2, 1, 3, 5, 6))
    del tmp122
    ...
    tmp132 = einsum(t2_ooVV, (0, 1, 2, 3), v.ovoO, (0, 4, 1, 5), (4, 5, 2, 3))
    tmp133 = einsum(tmp132, (0, 1, 2, 3), t2_OOvV, (4, 5, 0, 6), (4, 5, 1, 2, 3, 6))
    del tmp132
    ...
    del tmp134
    tmp136 = einsum(tmp135, (0, 1, 2, 3), t2_OOvV, (4, 5, 0, 6), (4, 5, 1, 2, 3, 6))
    del tmp135
    ...
    tmp166 = einsum(t3, (0, 1, 2, 3, 4, 5), tmp165, (2, 6), (6, 0, 1, 3, 5, 4))
    ...
    tmp176 = einsum(v.ovoO, (0, 1, 2, 3), t1_Ov, (4, 1), (0, 2, 4, 3))
    tmp177 = einsum(t1_oV, (0, 1), tmp176, (2, 0, 3, 4), (2, 3, 4, 1))
    tmp178 = einsum(t2_oOVV, (0, 1, 2, 3), tmp177, (0, 4, 5, 6), (4, 1, 5, 6, 2, 3))
    del tmp177
    ...
    tmp187 = einsum(t1_Ov, (0, 1), v.oVOv, (2, 3, 4, 1), (2, 0, 4, 3))
    tmp188 = einsum(tmp187, (0, 1, 2, 3), t1_oV, (0, 4), (1, 2, 4, 3))
    del tmp187
    tmp189 = einsum(t3, (0, 1, 2, 3, 4, 5), tmp188, (6, 2, 7, 5), (6, 0, 1, 7, 3, 4))
    ...
    tmp204 = einsum(t3, (0, 1, 2, 3, 4, 5), tmp203, (6, 7, 2, 0, 8, 5), (6, 7, 1, 8, 3, 4)) * -1
    ...
    tmp207 = einsum(t2_oOVV, (0, 1, 2, 3), tmp55, (0, 4, 5, 6), (1, 4, 5, 2, 3, 6))
    del tmp55
    ...
    tmp212 = einsum(v.oOov, (0, 1, 2, 3), t2_oOVv, (2, 4, 5, 3), (0, 4, 1, 5))
    ...
    tmp222 = einsum(t2_oOVV, (0, 1, 2, 3), tmp221, (0, 4, 5, 6), (4, 1, 5, 6, 2, 3))
    del tmp221
    ...
    tmp239 = einsum(t2_oOVv, (0, 1, 2, 3), v.oVOv, (0, 4, 5, 3), (1, 5, 2, 4))
    ...
    tmp242 = einsum(v.ovOV, (0, 1, 2, 3), t1_oV, (0, 4), (1, 2, 4, 3))
    tmp243 = einsum(t2_OOvV, (0, 1, 2, 3), tmp242, (2, 4, 5, 6), (0, 1, 4, 5, 3, 6))
    del tmp242
    t3new += np.transpose(tmp243, (2, 0, 1, 5, 3, 4)) * -1
    tmp244 = einsum(t2_oOVv, (0, 1, 2, 3), v.ovvV, (0, 4, 3, 5), (4, 1, 2, 5))
    ...
    tmp255 = einsum(t3, (0, 1, 2, 3, 4, 5), tmp254, (6, 2, 7, 5), (6, 0, 1, 7, 3, 4))
    ...
    tmp262 = einsum(t2_oOVv, (0, 1, 2, 3), v.ovvV, (0, 3, 4, 5), (4, 1, 2, 5))
    ...
    tmp266 = einsum(tmp265, (0, 1, 2, 3), t3, (4, 5, 6, 3, 7, 1), (4, 6, 5, 0, 7, 2)) * -1
    ...
    del tmp267
    tmp268 = einsum(tmp155, (0, 1, 2, 3), t3, (4, 5, 6, 2, 7, 3), (4, 6, 5, 0, 1, 7))
    del tmp155
    ...
    tmp275 = einsum(tmp173, (0, 1, 2, 3), t2_oOvV, (0, 4, 2, 5), (1, 3, 4, 5))
    tmp276 = einsum(tmp275, (0, 1, 2, 3), t2_oOVV, (0, 4, 5, 6), (1, 2, 4, 3, 5, 6))
    del tmp275
    t3new += np.transpose(tmp276, (2, 0, 1, 3, 4, 5)) * 2
    tmp277 = einsum(tmp173, (0, 1, 2, 3), t2_oOvV, (1, 4, 2, 5), (0, 3, 4, 5))
    ...
    tmp280 = einsum(t2_oOVV, (0, 1, 2, 3), tmp279, (0, 4, 5, 6), (4, 5, 1, 6, 2, 3))
    del tmp279
    ...
    tmp283 = einsum(tmp173, (0, 1, 2, 3), t2_oOVv, (1, 4, 5, 2), (0, 3, 4, 5))
    ...
    tmp295 = einsum(tmp294, (0, 1, 2, 3), t1_oV, (0, 4), (1, 2, 4, 3))
    ...
    tmp297 = einsum(v.ovvV, (0, 1, 2, 3), t1_Ov, (4, 1), (0, 2, 4, 3))
    ...
    del tmp307
    tmp309 = einsum(t2_oOVV, (0, 1, 2, 3), tmp308, (0, 4, 5, 6), (5, 4, 1, 6, 2, 3))
    del tmp308
