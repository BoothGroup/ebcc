...
https://github.com/obackhouse/albert
  ...
  * date: 2024-10-20T09:35:50.545118
...
def energy(f=None, t1=None, t2=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:36:04.496869.
...
def update_amps(f=None, t1=None, t2=None, t3=None, v=None, **kwargs):
    """
    Code generated by `albert` 0.0.0 on 2024-10-20T09:56:34.005476.
    ...
    del tmp20
    tmp21 = einsum(v.OVOV, (0, 1, 2, 3), t3, (4, 2, 0, 5, 1, 3), (4, 5))
    t1new_OV += tmp21 * -0.5
    del tmp21
    tmp22 = einsum(t3, (0, 1, 2, 3, 4, 5), v.OVOV, (2, 5, 1, 4), (0, 3))
    t1new_OV += tmp22 * 1.5
    del tmp22
    tmp23 = einsum(t3, (0, 1, 2, 3, 4, 5), v.OVOV, (0, 3, 2, 5), (1, 4))
    t1new_OV += tmp23 * 0.5
    del tmp23
    ...
    del tmp39
    tmp30 = einsum(v.oOOV, (0, 1, 2, 3), t3, (1, 4, 2, 5, 6, 3), (0, 4, 5, 6))
    t2new_OoVV = np.copy(np.transpose(tmp30, (1, 0, 3, 2))) * -1
    tmp31 = einsum(t3, (0, 1, 2, 3, 4, 5), v.oOOV, (6, 1, 2, 5), (6, 0, 3, 4))
    t2new_OoVV += np.transpose(tmp31, (1, 0, 2, 3)) * -1
    tmp64 = einsum(v.OvOV, (0, 1, 2, 3), t1, (4, 1), (4, 0, 2, 3))
    tmp65 = einsum(tmp64, (0, 1, 2, 3), t3, (1, 4, 2, 5, 6, 3), (0, 4, 5, 6))
    t2new_OoVV += np.transpose(tmp65, (1, 0, 3, 2)) * -1
    tmp66 = einsum(tmp64, (0, 1, 2, 3), t3, (4, 1, 2, 5, 6, 3), (0, 4, 5, 6))
    del tmp64
    ...
    del tmp66
    tmp49 = einsum(t3, (0, 1, 2, 3, 4, 5), v.OVvV, (2, 5, 6, 3), (6, 0, 1, 4))
    ...
    t1new += tmp1 * 2
    tmp2 = einsum(v.ovvv, (0, 1, 2, 3), t2, (4, 0, 3, 1), (4, 2))
    t1new += tmp2 * 2
    del tmp2
    tmp3 = einsum(v.ovvv, (0, 1, 2, 3), t2, (4, 0, 1, 3), (4, 2))
    t1new += tmp3 * -1
    del tmp3
    ...
    t1new += tmp5 * -2
    del tmp5
    tmp6 = einsum(tmp4, (0, 1, 2, 3), t2, (1, 2, 4, 3), (0, 4))
    t1new += tmp6
    del tmp6
    ...
    t1new += tmp12 * 2
    del tmp12
    tmp13 = einsum(v.ovvv, (0, 1, 2, 3), t1, (0, 3), (1, 2))
    ...
    t1new += einsum(tmp14, (0, 1), t2, (2, 0, 3, 1), (2, 3)) * -2
    ...
    t1new += einsum(tmp26, (0, 1), t1, (1, 2), (0, 2))
    ...
    del tmp27
    t2new += tmp33 * -2
    tmp34 = einsum(t1, (0, 1), v.oooo, (2, 3, 4, 0), (2, 3, 4, 1))
    t2new += einsum(t1, (0, 1), tmp34, (2, 0, 3, 4), (2, 3, 1, 4))
    del tmp34
    ...
    tmp41 = einsum(tmp40, (0, 1), t2, (2, 3, 4, 1), (2, 3, 4, 0))
    del tmp40
    t2new += tmp41 * -2
    tmp42 = einsum(v.ovov, (0, 1, 2, 3), t2, (0, 2, 4, 1), (4, 3))
    tmp43 = einsum(t2, (0, 1, 2, 3), tmp42, (4, 3), (0, 1, 2, 4))
    del tmp42
    t2new += tmp43
    ...
    del tmp41
    tmp57 = einsum(tmp14, (0, 1), t2, (2, 3, 4, 1), (2, 3, 0, 4))
    ...
    t2new += einsum(tmp85, (0, 1, 2, 3), t2, (4, 1, 3, 5), (0, 4, 5, 2))
    tmp86 = einsum(v.oovv, (0, 1, 2, 3), t2, (4, 1, 5, 3), (4, 0, 5, 2))
    t2new += np.transpose(tmp86, (1, 0, 3, 2)) * -1
    tmp87 = einsum(v.ooov, (0, 1, 2, 3), t2, (4, 2, 5, 3), (4, 0, 1, 5))
    tmp88 = einsum(t1, (0, 1), tmp87, (2, 3, 0, 4), (2, 3, 1, 4))
    del tmp87
    t2new += np.transpose(tmp88, (1, 0, 2, 3)) * -2
    tmp89 = einsum(v.ooov, (0, 1, 2, 3), t2, (4, 1, 5, 3), (4, 0, 2, 5))
    ...
    t2new += tmp95 * -2
    del tmp95
    tmp96 = einsum(tmp48, (0, 1, 2, 3), t2, (4, 1, 5, 3), (4, 0, 5, 2))
    ...
    del tmp92
    tmp113 = einsum(t2, (0, 1, 2, 3), v.vvvv, (4, 2, 5, 3), (0, 1, 4, 5))
    ...
    tmp117 = einsum(t2, (0, 1, 2, 3), tmp116, (4, 5, 1, 0), (5, 4, 2, 3))
    t2new += tmp117
    del tmp117
    tmp118 = einsum(t1, (0, 1), tmp116, (2, 3, 4, 0), (2, 3, 4, 1))
    del tmp116
    tmp119 = einsum(t1, (0, 1), tmp118, (2, 3, 0, 4), (2, 3, 1, 4))
    del tmp118
    t2new += tmp119
    del tmp119
    ...
    tmp121 = einsum(t3, (0, 1, 2, 3, 4, 5), v.OOOO, (6, 2, 7, 0), (1, 6, 7, 3, 5, 4)) * -1
    ...
    tmp132 = einsum(v.oOov, (0, 1, 2, 3), t2_ooVV, (0, 2, 4, 5), (3, 1, 5, 4))
    tmp133 = einsum(t2_OOvV, (0, 1, 2, 3), tmp132, (2, 4, 5, 6), (0, 1, 4, 5, 6, 3))
    del tmp132
    t3new += np.transpose(tmp133, (1, 0, 2, 5, 3, 4))
    tmp134 = einsum(v.ovoO, (0, 1, 2, 3), t1_oV, (2, 4), (0, 1, 3, 4))
    ...
    t3new += einsum(tmp124, (0, 1), t3, (2, 1, 3, 4, 5, 6), (2, 0, 3, 4, 5, 6))
    del tmp124
    ...
    tmp142 = einsum(t2_ooVv, (0, 1, 2, 3), v.ovoV, (0, 3, 1, 4), (2, 4))
    tmp143 = einsum(tmp142, (0, 1), t3, (2, 3, 4, 5, 6, 1), (2, 4, 3, 0, 5, 6))
    t3new += np.transpose(tmp143, (1, 2, 0, 4, 5, 3)) * -1
    tmp144 = einsum(v.oVov, (0, 1, 2, 3), t2_ooVv, (0, 2, 4, 3), (4, 1))
    ...
    tmp147 = einsum(tmp146, (0, 1, 2, 3), t3, (4, 5, 6, 7, 3, 2), (4, 6, 5, 0, 1, 7))
    ...
    tmp149 = einsum(tmp148, (0, 1), t1_oV, (0, 2), (2, 1))
    del tmp148
    ...
    tmp157 = einsum(f.VV, (0, 1), t3, (2, 3, 4, 5, 6, 1), (2, 4, 3, 0, 5, 6))
    ...
    tmp159 = einsum(v.ovVV, (0, 1, 2, 3), t1, (0, 1), (2, 3))
    ...
    del tmp159
    t3new += einsum(tmp161, (0, 1), t3, (2, 3, 4, 5, 0, 6), (2, 3, 4, 5, 1, 6)) * -1
    del tmp161
    ...
    tmp174 = einsum(t2_ooVV, (0, 1, 2, 3), tmp173, (0, 1, 4, 5), (4, 5, 2, 3))
    ...
    del tmp176
    tmp180 = einsum(tmp179, (0, 1, 2, 3), t2_oOVV, (0, 4, 5, 6), (1, 4, 2, 3, 5, 6))
    del tmp179
    ...
    tmp184 = einsum(t1, (0, 1), v.ovOv, (0, 1, 2, 3), (3, 2))
    ...
    tmp190 = einsum(v.ovOV, (0, 1, 2, 3), t1_Ov, (4, 1), (0, 4, 2, 3))
    tmp191 = einsum(tmp190, (0, 1, 2, 3), t1_oV, (0, 4), (1, 2, 4, 3))
    tmp192 = einsum(t3, (0, 1, 2, 3, 4, 5), tmp191, (6, 2, 7, 5), (6, 0, 1, 7, 3, 4))
    ...
    del tmp166
    tmp200 = einsum(t3, (0, 1, 2, 3, 4, 5), tmp167, (6, 2, 7, 1), (6, 0, 7, 3, 5, 4))
    del tmp167
    ...
    tmp201 = einsum(f.ov, (0, 1), t2_OOvV, (2, 3, 1, 4), (0, 2, 3, 4))
    ...
    tmp208 = einsum(t2_oOvV, (0, 1, 2, 3), v.ovoO, (4, 2, 0, 5), (4, 1, 5, 3))
    tmp209 = einsum(tmp208, (0, 1, 2, 3), t2_oOVV, (0, 4, 5, 6), (1, 4, 2, 3, 5, 6))
    del tmp208
    t3new += np.transpose(tmp209, (1, 2, 0, 3, 4, 5)) * -1
    tmp210 = einsum(t2_oOvV, (0, 1, 2, 3), v.oOov, (4, 5, 0, 2), (4, 1, 5, 3))
    tmp211 = einsum(tmp210, (0, 1, 2, 3), t2_oOVV, (0, 4, 5, 6), (1, 4, 2, 3, 5, 6))
    del tmp210
    t3new += np.transpose(tmp211, (1, 2, 0, 3, 4, 5)) * 2
    tmp212 = einsum(t2_oOVv, (0, 1, 2, 3), v.oOov, (4, 5, 0, 3), (4, 1, 5, 2))
    tmp213 = einsum(tmp212, (0, 1, 2, 3), t2_oOVV, (0, 4, 5, 6), (1, 4, 2, 3, 5, 6))
    del tmp212
    t3new += np.transpose(tmp213, (1, 2, 0, 3, 4, 5)) * -1
    tmp214 = einsum(t2_OOvV, (0, 1, 2, 3), tmp14, (4, 2), (4, 0, 1, 3))
    del tmp14
    tmp215 = einsum(t2_oOVV, (0, 1, 2, 3), tmp214, (0, 4, 5, 6), (1, 4, 5, 2, 3, 6))
    del tmp214
    ...
    tmp219 = einsum(t2_oOVv, (0, 1, 2, 3), tmp218, (0, 4, 3, 5), (4, 1, 5, 2))
    tmp220 = einsum(t2_OOvV, (0, 1, 2, 3), tmp219, (2, 4, 5, 6), (4, 0, 1, 5, 6, 3))
    del tmp219
    t3new += np.transpose(tmp220, (0, 1, 2, 5, 4, 3)) * -1
    tmp221 = einsum(v.ovoO, (0, 1, 2, 3), t2_oOVv, (2, 4, 5, 1), (0, 4, 3, 5))
    ...
    tmp223 = einsum(t3, (0, 1, 2, 3, 4, 5), v.oVOV, (6, 5, 2, 4), (6, 0, 1, 3))
    ...
    tmp225 = einsum(t3, (0, 1, 2, 3, 4, 5), v.oVOV, (6, 5, 1, 4), (6, 0, 2, 3))
    ...
    tmp227 = einsum(t2_oOvV, (0, 1, 2, 3), tmp218, (0, 4, 2, 5), (4, 1, 5, 3))
    ...
    tmp229 = einsum(t2_oOvV, (0, 1, 2, 3), tmp218, (0, 2, 4, 5), (4, 1, 5, 3))
    ...
    tmp231 = einsum(t2_oOVv, (0, 1, 2, 3), tmp218, (0, 3, 4, 5), (4, 1, 5, 2))
    ...
    tmp241 = einsum(t2_OOvV, (0, 1, 2, 3), v.OVvV, (4, 5, 2, 6), (0, 1, 4, 3, 6, 5))
    ...
    tmp246 = einsum(v.oOvV, (0, 1, 2, 3), t1_oV, (0, 4), (2, 1, 4, 3))
    ...
    tmp248 = einsum(t3, (0, 1, 2, 3, 4, 5), v.OOVV, (6, 2, 7, 5), (0, 1, 6, 3, 4, 7))
    ...
    tmp249 = einsum(t3, (0, 1, 2, 3, 4, 5), tmp239, (6, 2, 7, 5), (6, 0, 1, 7, 3, 4))
    ...
    tmp252 = einsum(t2_oOVv, (0, 1, 2, 3), v.ovOV, (0, 3, 4, 5), (1, 4, 2, 5))
    tmp253 = einsum(t3, (0, 1, 2, 3, 4, 5), tmp252, (6, 2, 7, 5), (6, 0, 1, 7, 3, 4))
    t3new += np.transpose(tmp253, (1, 2, 0, 3, 5, 4))
    tmp254 = einsum(t2_oOvV, (0, 1, 2, 3), v.ovOV, (0, 2, 4, 5), (1, 4, 3, 5))
    ...
    tmp258 = einsum(v.ovvV, (0, 1, 2, 3), t2_oOvV, (0, 4, 1, 5), (2, 4, 5, 3))
    ...
    tmp260 = einsum(v.ovvV, (0, 1, 2, 3), t2_oOvV, (0, 4, 2, 5), (1, 4, 5, 3))
    ...
    tmp267 = einsum(t3, (0, 1, 2, 3, 4, 5), tmp146, (6, 7, 3, 5), (0, 2, 1, 7, 6, 4)) * -1
    del tmp146
    ...
    tmp272 = einsum(t3, (0, 1, 2, 3, 4, 5), tmp254, (6, 1, 7, 4), (6, 0, 2, 7, 3, 5))
    del tmp254
    ...
    del tmp156
    tmp274 = einsum(t2_oOVV, (0, 1, 2, 3), tmp190, (0, 4, 5, 6), (4, 1, 5, 2, 3, 6))
    del tmp190
    ...
    tmp279 = einsum(t2_oOVv, (0, 1, 2, 3), tmp173, (0, 4, 3, 5), (4, 5, 1, 2))
    ...
    tmp281 = einsum(t1_Ov, (0, 1), v.oOvV, (2, 3, 1, 4), (2, 0, 3, 4))
    tmp282 = einsum(t2_oOVV, (0, 1, 2, 3), tmp281, (0, 4, 5, 6), (4, 1, 5, 2, 3, 6))
    del tmp281
    ...
    tmp284 = einsum(tmp283, (0, 1, 2, 3), t2_oOVV, (0, 4, 5, 6), (1, 2, 4, 3, 5, 6))
    del tmp283
    ...
    tmp289 = einsum(v.OVvV, (0, 1, 2, 3), t1_Ov, (4, 2), (4, 0, 3, 1))
    ...
    del tmp291
    tmp292 = einsum(t1_Ov, (0, 1), v.vVvV, (2, 3, 1, 4), (2, 0, 3, 4))
    ...
    tmp294 = einsum(t1_Ov, (0, 1), v.ovvV, (2, 3, 1, 4), (2, 3, 0, 4))
    ...
    del tmp289
    t3new += einsum(tmp188, (0, 1, 2, 3), t3, (4, 1, 5, 6, 3, 7), (4, 0, 5, 6, 2, 7))
    del tmp188
    ...
    tmp301 = einsum(t3, (0, 1, 2, 3, 4, 5), tmp300, (6, 7, 2, 1), (6, 7, 0, 3, 5, 4))
    t3new += np.transpose(tmp301, (2, 1, 0, 3, 5, 4))
    tmp302 = einsum(t2_OOvv, (0, 1, 2, 3), tmp218, (4, 2, 3, 5), (4, 0, 1, 5))
    del tmp218
    tmp303 = einsum(tmp302, (0, 1, 2, 3), t2_oOVV, (0, 4, 5, 6), (2, 1, 4, 3, 5, 6))
    del tmp302
    t3new += np.transpose(tmp303, (2, 1, 0, 5, 4, 3))
    tmp304 = einsum(t1_Ov, (0, 1), v.OvOv, (2, 3, 4, 1), (3, 0, 2, 4))
    tmp305 = einsum(t1_Ov, (0, 1), tmp304, (1, 2, 3, 4), (2, 0, 4, 3))
    del tmp304
    ...
    tmp310 = einsum(tmp300, (0, 1, 2, 3), t3, (3, 4, 2, 5, 6, 7), (1, 0, 4, 5, 7, 6))
    del tmp300
    ...
    del tmp133
    tmp311 = einsum(t2_OOvv, (0, 1, 2, 3), v.ovvV, (4, 2, 3, 5), (4, 0, 1, 5))
    tmp312 = einsum(tmp311, (0, 1, 2, 3), t2_oOVV, (0, 4, 5, 6), (1, 2, 4, 5, 6, 3))
    del tmp311
    ...
    del tmp294
    tmp314 = einsum(tmp313, (0, 1, 2, 3), t2_oOVV, (0, 4, 5, 6), (1, 2, 4, 5, 6, 3))
    del tmp313
