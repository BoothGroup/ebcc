...
def update_amps(f=None, v=None, nocc=None, nvir=None, t2=None, **kwargs):
    ...
    # T amplitudes
    t2new_aa = np.zeros((nocc[0], nvir[0]), dtype=np.float64)
    t2new_aa += einsum(v.aaaa.ovov, (0, 1, 2, 3), (0, 1))
    t2new_aa += einsum(v.aabb.ovov, (0, 1, 2, 3), (0, 1))
    t2new_aa += einsum(v.aaaa.ovov, (0, 1, 2, 3), (0, 3)) * -1.0
    t2new_aa += einsum(t2.aaaa, (0, 1, 2, 3), v.aaaa.vvvv, (4, 2, 5, 3), (0, 4)) * 2.0
    t2new_aa += einsum(t2.abab, (0, 1, 2, 3), v.aabb.vvoo, (4, 2, 5, 1), (0, 4)) * -1.0
    t2new_aa += einsum(t2.abab, (0, 1, 2, 3), v.aabb.ovov, (4, 5, 1, 3), (0, 5)) * -1.0
    t2new_aa += einsum(t2.abab, (0, 1, 2, 3), v.aabb.vvvv, (4, 2, 5, 3), (0, 4))
    t2new_bb = np.zeros((nocc[1], nvir[1]), dtype=np.float64)
    t2new_bb += einsum(t2.bbbb, (0, 1, 2, 3), v.bbbb.vvvv, (4, 2, 3, 5), (0, 4)) * 2.0
    t2new_bb += einsum(t2.abab, (0, 1, 2, 3), v.aabb.oovv, (0, 4, 5, 3), (1, 5)) * -1.0
    t2new_bb += einsum(v.aabb.ovov, (0, 1, 2, 3), (2, 3))
    t2new_bb += einsum(v.bbbb.ovov, (0, 1, 2, 3), (0, 1))
    t2new_bb += einsum(v.bbbb.ovov, (0, 1, 2, 3), (0, 3)) * -1.0
    t2new_bb += einsum(t2.abab, (0, 1, 2, 3), v.aabb.vvvv, (4, 2, 5, 3), (1, 5))
    t2new_bb += einsum(t2.abab, (0, 1, 2, 3), v.aabb.ovov, (0, 2, 4, 5), (1, 5)) * -1.0
    ...
    del x6
    t2new_aa += einsum(x7, (0, 1), t2.aaaa, (2, 0, 3, 1), (2, 3)) * 2.0
    t2new_bb += einsum(x7, (0, 1), t2.abab, (0, 2, 1, 3), (2, 3))
    del x7
    ...
    del x10
    t2new_aa += einsum(x11, (0, 1), t2.abab, (2, 0, 3, 1), (2, 3))
    t2new_bb += einsum(x11, (0, 1), t2.bbbb, (2, 0, 3, 1), (2, 3)) * 2.0
    del x11
    ...
    del x3
    t2new_aa += einsum(x12, (0, 1, 2), t2.aaaa, (3, 1, 4, 2), (0, 4)) * 2.0
    del x12
    ...
    del x8
    t2new_aa += einsum(x13, (0, 1, 2), t2.abab, (3, 1, 4, 2), (0, 4))
    del x13
    ...
    t2new_aa += einsum(x17, (0, 1, 2), t2.abab, (0, 3, 4, 2), (1, 4)) * -1.0
    del x17
    ...
    t2new_aa += einsum(x18, (0, 1, 2), t2.aaaa, (3, 0, 4, 1), (3, 2)) * 2.0
    del x18
    ...
    t2new_aa += einsum(x19, (0, 1, 2), t2.abab, (0, 2, 3, 4), (1, 3))
    del x19
    ...
    t2new_aa += einsum(x20, (0, 1, 2), t2.aaaa, (2, 0, 3, 4), (1, 3)) * -2.0
    del x20
    ...
    x23 += einsum(x22, (0,), (0,))
    del x22
    t2new_aa += einsum(x23, (0,), t2.abab, (1, 2, 3, 0), (1, 3)) * 2.0
    t2new_bb += einsum(x23, (0,), t2.bbbb, (1, 2, 3, 0), (1, 3)) * 4.0
    del x23
    ...
    x26 += einsum(x25, (0,), (0,))
    t2new_aa += einsum(x26, (0,), t2.aaaa, (1, 2, 3, 0), (1, 3)) * 2.0
    del x26
    ...
    t2new_aa += einsum(x14, (0, 1), x27, (2, 0), (2, 1)) * -2.0
    del x14, x27
    ...
    x30 += einsum(x29, (0,), (0,))
    del x29
    t2new_aa += einsum(x30, (0,), t2.abab, (1, 0, 2, 3), (1, 2)) * 2.0
    t2new_bb += einsum(x30, (0,), t2.bbbb, (1, 0, 2, 3), (1, 2)) * 4.0
    del x30
    ...
    del x36
    t2new_bb += einsum(x37, (0, 1, 2), t2.bbbb, (3, 1, 4, 2), (0, 4)) * -4.0
    del x37
    ...
    del x38
    t2new_bb += einsum(x39, (0, 1, 2), t2.abab, (0, 3, 2, 4), (1, 4))
    del x39
    ...
    t2new_bb += einsum(x5, (0, 1), x40, (0, 2, 1, 3), (2, 3)) * -1.0
    del x40
    ...
    t2new_bb += einsum(x41, (0, 1, 2), t2.abab, (3, 0, 2, 4), (1, 4)) * -1.0
    del x41
    ...
    t2new_bb += einsum(x42, (0, 1, 2), t2.bbbb, (3, 0, 1, 4), (3, 2)) * -2.0
    del x42
    ...
    t2new_bb += einsum(x43, (0, 1, 2), t2.abab, (0, 1, 3, 4), (2, 4))
    del x43
    ...
    t2new_bb += einsum(x44, (0, 1, 2), t2.bbbb, (2, 0, 3, 4), (1, 3)) * -2.0
    del x44
    ...
    del x25
    t2new_bb += einsum(x45, (0,), t2.abab, (1, 2, 0, 3), (2, 3)) * 2.0
    del x45
    ...
    t2new_bb += einsum(x46, (0, 1), x5, (1, 2), (0, 2)) * -1.0
    del x5, x46
    ...
    del x32
    t2new_bb += einsum(x47, (0,), t2.abab, (0, 1, 2, 3), (1, 3)) * 2.0
    del x47
