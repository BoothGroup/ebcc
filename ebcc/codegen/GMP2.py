 ...
 * date: 2024-11-27T09:30:03.112200
...
def hbar_matvec_ip_intermediates(f=None, t2=None, v=None, **kwargs):
    ...
    tmp1 = np.copy(np.transpose(f.oo, (1, 0))) * 4
...
def hbar_matvec_ip(f=None, ints=None, r1=None, r2=None, v=None, **kwargs):
    ...
    r2new += einsum(f.vv, (0, 1), r2, (2, 3, 1), (3, 2, 0)) * -1
...
def hbar_matvec_ea_intermediates(f=None, t2=None, v=None, **kwargs):
    ...
    tmp1 = np.copy(np.transpose(f.vv, (1, 0))) * -1
    tmp0 = einsum(t2, (0, 1, 2, 3), v.oovv, (0, 1, 3, 4), (2, 4)) * -1
    tmp1 += tmp0 * 0.25
...
def hbar_matvec_ea(f=None, ints=None, r1=None, r2=None, v=None, **kwargs):
    ...
    tmp0 = einsum(f.vv, (0, 1), r2, (2, 1, 3), (3, 0, 2))
...
def hbar_matvec_ee_intermediates(f=None, t2=None, v=None, **kwargs):
    ...
    tmp0 += einsum(t2, (0, 1, 2, 3), v.oovv, (1, 4, 3, 5), (4, 0, 2, 5)) * -1
    tmp1 = np.copy(np.transpose(f.vv, (1, 0)))
    tmp1 += einsum(v.oovv, (0, 1, 2, 3), t2, (0, 1, 4, 2), (3, 4)) * 0.5
...
def hbar_matvec_ee(f=None, ints=None, r1=None, r2=None, v=None, **kwargs):
    ...
    r1new += einsum(r1, (0, 1), ints.tmp1, (1, 2), (0, 2))
    r1new += einsum(r1, (0, 1), ints.tmp2, (0, 2), (2, 1)) * -0.5
    r1new += einsum(r2, (0, 1, 2, 3), v.ooov, (0, 1, 4, 3), (4, 2)) * -0.5
    r1new += einsum(ints.tmp0, (0, 1, 2, 3), r1, (0, 3), (1, 2)) * -1
    tmp0 = einsum(f.oo, (0, 1), r2, (2, 1, 3, 4), (0, 2, 3, 4))
