...
def update_amps(f=None, v=None, nocc=None, nvir=None, t1=None, t2=None, **kwargs):
    ...
    x35 = np.zeros((nocc[1], nvir[1]), dtype=np.float64)
    ...
    del x40
    x41 = np.zeros((nvir[0], nvir[0], nvir[0], nvir[0]), dtype=np.float64)
    ...
    x85 = np.zeros((nocc[0], nocc[0], nocc[1], nvir[1]), dtype=np.float64)
    ...
    del x113
    x114 = np.zeros((nocc[0], nocc[0], nocc[1], nocc[1]), dtype=np.float64)
    ...
    del x124
    x125 = np.zeros((nocc[0], nocc[1], nvir[0], nvir[1]), dtype=np.float64)
    ...
    del x10
    x132 = np.zeros((nocc[0], nocc[0], nocc[1], nvir[1]), dtype=np.float64)
    ...
    del x135
    x136 = np.zeros((nvir[1], nvir[1], nvir[1], nvir[1]), dtype=np.float64)
    ...
    del x148
    x150 = np.zeros((nocc[0], nocc[1], nocc[1], nvir[0]), dtype=np.float64)
    ...
    x155 = np.zeros((nocc[0], nocc[1], nocc[1], nvir[0]), dtype=np.float64)
