...
def energy(f=None, v=None, nocc=None, nvir=None, t1=None, t2=None, **kwargs):
    ...
    x0 += einsum(v.bbbb.ovov, (0, 1, 2, 3), (2, 0, 1, 3)) * -1.0
    x0 += einsum(v.bbbb.ovov, (0, 1, 2, 3), (2, 0, 3, 1))
    ...
    x3 += einsum(x2, (0, 1, 2, 3), t1.aa, (0, 3), (1, 2)) * -0.5
    e_cc += einsum(x3, (0, 1), t1.aa, (0, 1), ())
...
def update_amps(f=None, v=None, nocc=None, nvir=None, t1=None, t2=None, **kwargs):
    ...
    t2new_aaaa += einsum(t2.aaaa, (0, 1, 2, 3), v.aaaa.vvvv, (4, 3, 5, 2), (1, 0, 5, 4)) * -2.0
    ...
    x5 += einsum(t2.baba, (0, 1, 2, 3), (0, 2, 1, 3))
    x5 += einsum(t1.bb, (0, 1), t1.aa, (2, 3), (0, 1, 2, 3))
    t1new_aa += einsum(x5, (0, 1, 2, 3), v.bbaa.ovvv, (0, 1, 3, 4), (2, 4))
    t1new_bb += einsum(v.bbaa.vvov, (0, 1, 2, 3), x5, (4, 0, 2, 3), (4, 1))
    x6 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x6 += einsum(t2.aaaa, (0, 1, 2, 3), (1, 0, 3, 2))
    x6 += einsum(t1.aa, (0, 1), t1.aa, (2, 3), (2, 0, 3, 1)) * 0.5
    t1new_aa += einsum(x6, (0, 1, 2, 3), v.aaaa.ovvv, (0, 2, 3, 4), (1, 4)) * 2.0
    ...
    x8 += einsum(x7, (0, 1, 2, 3), t1.aa, (0, 3), (1, 2))
    ...
    x17 += einsum(t2.aaaa, (0, 1, 2, 3), v.aaaa.ovov, (1, 3, 4, 2), (0, 4))
    ...
    x22 += einsum(v.aaaa.ovvv, (0, 1, 2, 3), t1.aa, (0, 3), (1, 2)) * -1.0
    ...
    t1new_bb += einsum(x24, (0, 1, 2, 3), t2.baba, (0, 2, 4, 3), (1, 4)) * -1.0
    ...
    t1new_bb += einsum(t2.bbbb, (0, 1, 2, 3), x26, (4, 1, 0, 2), (4, 3)) * 2.0
    ...
    t1new_bb += einsum(x28, (0, 1, 2, 3), t1.bb, (0, 2), (1, 3)) * -1.0
    ...
    x31 += einsum(v.bbaa.ovov, (0, 1, 2, 3), t2.baba, (4, 2, 1, 3), (4, 0))
    ...
    x44 += einsum(t2.baba, (0, 1, 2, 3), x43, (0, 2, 4, 5), (1, 4, 3, 5))
    x45 = np.zeros((nocc[0], nvir[0], nvir[0], nvir[0]), dtype=np.float64)
    x45 += einsum(v.aaaa.ovvv, (0, 1, 2, 3), (0, 1, 3, 2)) * -1.0
    x45 += einsum(v.aaaa.ovvv, (0, 1, 2, 3), (0, 3, 1, 2))
    x46 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x46 += einsum(x45, (0, 1, 2, 3), t1.aa, (4, 2), (4, 0, 1, 3))
    x47 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x47 += einsum(t2.aaaa, (0, 1, 2, 3), x46, (4, 0, 2, 5), (1, 4, 3, 5)) * -2.0
    x48 = np.zeros((nocc[0], nocc[0], nocc[0], nvir[0]), dtype=np.float64)
    x48 += einsum(t2.baba, (0, 1, 2, 3), v.bbaa.ovoo, (0, 2, 4, 5), (1, 4, 5, 3))
    ...
    x65 += einsum(t2.aaaa, (0, 1, 2, 3), x64, (0, 4), (1, 4, 2, 3)) * 2.0
    ...
    x68 += einsum(t2.baba, (0, 1, 2, 3), x11, (0, 4, 5, 2), (4, 5, 1, 3))
    x69 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x69 += einsum(t2.baba, (0, 1, 2, 3), x68, (0, 2, 4, 5), (1, 4, 3, 5)) * -1.0
    x70 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x70 += einsum(v.aaaa.ovov, (0, 1, 2, 3), (2, 0, 3, 1))
    ...
    x71 += einsum(t1.aa, (0, 1), v.aaaa.vvvv, (2, 1, 3, 4), (0, 3, 4, 2))
    ...
    x73 += einsum(v.aaaa.ovov, (0, 1, 2, 3), (2, 0, 1, 3))
    x73 += einsum(v.aaaa.ovov, (0, 1, 2, 3), (2, 0, 3, 1)) * -1.0
    x74 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x74 += einsum(t2.aaaa, (0, 1, 2, 3), x73, (0, 4, 2, 5), (1, 4, 3, 5))
    x75 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x75 += einsum(t2.aaaa, (0, 1, 2, 3), x74, (4, 0, 5, 2), (1, 4, 3, 5)) * -4.0
    x76 = np.zeros((nvir[0], nvir[0]), dtype=np.float64)
    x76 += einsum(v.bbaa.ovvv, (0, 1, 2, 3), t1.bb, (0, 1), (2, 3))
    x77 = np.zeros((nvir[0], nvir[0]), dtype=np.float64)
    x77 += einsum(t2.baba, (0, 1, 2, 3), v.bbaa.ovov, (0, 2, 1, 4), (3, 4))
    x78 = np.zeros((nvir[0], nvir[0]), dtype=np.float64)
    x78 += einsum(v.aaaa.ovov, (0, 1, 2, 3), t2.aaaa, (0, 2, 4, 3), (4, 1))
    x79 = np.zeros((nocc[0], nvir[0], nvir[0], nvir[0]), dtype=np.float64)
    x79 += einsum(v.aaaa.ovvv, (0, 1, 2, 3), (0, 1, 3, 2))
    x79 += einsum(v.aaaa.ovvv, (0, 1, 2, 3), (0, 3, 2, 1)) * -1.0
    x80 = np.zeros((nvir[0], nvir[0]), dtype=np.float64)
    x80 += einsum(x79, (0, 1, 2, 3), t1.aa, (0, 1), (2, 3))
    x81 = np.zeros((nvir[0], nvir[0]), dtype=np.float64)
    x81 += einsum(x76, (0, 1), (1, 0)) * -1.0
    x81 += einsum(x77, (0, 1), (1, 0))
    x81 += einsum(x78, (0, 1), (1, 0)) * 2.0
    x81 += einsum(x80, (0, 1), (1, 0)) * -1.0
    x82 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x82 += einsum(x81, (0, 1), t2.aaaa, (2, 3, 0, 4), (2, 3, 4, 1)) * 2.0
    x83 = np.zeros((nocc[0], nocc[0], nocc[0], nvir[0]), dtype=np.float64)
    x83 += einsum(v.aaaa.ovvv, (0, 1, 2, 3), t2.aaaa, (4, 5, 3, 1), (4, 5, 0, 2)) * -1.0
    x84 = np.zeros((nocc[0], nocc[0], nocc[0], nvir[0]), dtype=np.float64)
    x84 += einsum(t2.aaaa, (0, 1, 2, 3), x9, (4, 2), (0, 1, 4, 3)) * 2.0
    x85 = np.zeros((nocc[0], nocc[0], nocc[0], nocc[0]), dtype=np.float64)
    x85 += einsum(t1.aa, (0, 1), x3, (2, 3, 4, 1), (2, 0, 4, 3))
    x86 = np.zeros((nocc[0], nocc[0], nocc[0], nocc[0]), dtype=np.float64)
    x86 += einsum(v.aaaa.oooo, (0, 1, 2, 3), (2, 3, 1, 0))
    x86 += einsum(x85, (0, 1, 2, 3), (3, 1, 2, 0))
    x87 = np.zeros((nocc[0], nocc[0], nocc[0], nvir[0]), dtype=np.float64)
    x87 += einsum(t1.aa, (0, 1), x86, (0, 2, 3, 4), (2, 3, 4, 1))
    x88 = np.zeros((nocc[0], nocc[0], nocc[0], nvir[0]), dtype=np.float64)
    x88 += einsum(x83, (0, 1, 2, 3), (2, 1, 0, 3)) * -2.0
    x88 += einsum(x84, (0, 1, 2, 3), (2, 1, 0, 3)) * -1.0
    x88 += einsum(x87, (0, 1, 2, 3), (1, 0, 2, 3))
    x89 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x89 += einsum(t1.aa, (0, 1), x88, (0, 2, 3, 4), (2, 3, 1, 4))
    x90 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x90 += einsum(x72, (0, 1, 2, 3), (0, 1, 2, 3))
    x90 += einsum(x75, (0, 1, 2, 3), (0, 1, 2, 3))
    x90 += einsum(x82, (0, 1, 2, 3), (1, 0, 2, 3)) * -1.0
    x90 += einsum(x89, (0, 1, 2, 3), (1, 0, 2, 3))
    t2new_aaaa += einsum(x90, (0, 1, 2, 3), (0, 1, 2, 3))
    t2new_aaaa += einsum(x90, (0, 1, 2, 3), (0, 1, 3, 2)) * -1.0
    x91 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x91 += einsum(t2.aaaa, (0, 1, 2, 3), (1, 0, 3, 2))
    x91 += einsum(t1.aa, (0, 1), t1.aa, (2, 3), (2, 0, 3, 1))
    x92 = np.zeros((nocc[0], nocc[0], nocc[0], nocc[0]), dtype=np.float64)
    x92 += einsum(v.aaaa.oooo, (0, 1, 2, 3), (2, 3, 1, 0))
    x92 += einsum(x91, (0, 1, 2, 3), v.aaaa.ovov, (4, 2, 5, 3), (5, 1, 0, 4))
    t2new_aaaa += einsum(x92, (0, 1, 2, 3), t2.aaaa, (0, 3, 4, 5), (2, 1, 5, 4)) * 2.0
    x93 = np.zeros((nocc[0], nocc[0], nocc[0], nocc[0]), dtype=np.float64)
    x93 += einsum(t2.aaaa, (0, 1, 2, 3), v.aaaa.ovov, (4, 2, 5, 3), (0, 1, 4, 5))
    x94 = np.zeros((nocc[0], nocc[0], nocc[0], nvir[0]), dtype=np.float64)
    x94 += einsum(x93, (0, 1, 2, 3), t1.aa, (2, 4), (0, 1, 3, 4)) * -2.0
    x94 += einsum(v.aaaa.ooov, (0, 1, 2, 3), (1, 2, 0, 3)) * -1.0
    x94 += einsum(v.aaaa.ooov, (0, 1, 2, 3), (2, 1, 0, 3))
    t2new_aaaa += einsum(t1.aa, (0, 1), x94, (2, 3, 0, 4), (2, 3, 1, 4))
    x95 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x95 += einsum(v.bbaa.vvov, (0, 1, 2, 3), t1.bb, (4, 1), (4, 0, 2, 3))
    t2new_abab += einsum(x95, (0, 1, 2, 3), (2, 0, 3, 1))
    t2new_baba += einsum(x95, (0, 1, 2, 3), (0, 2, 1, 3))
    x96 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x96 += einsum(v.bbaa.ovov, (0, 1, 2, 3), t2.baba, (0, 4, 1, 5), (4, 2, 5, 3))
    x97 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x97 += einsum(x73, (0, 1, 2, 3), x40, (0, 4, 2, 5), (4, 1, 5, 3)) * 2.0
    x98 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x98 += einsum(x79, (0, 1, 2, 3), t1.aa, (4, 1), (4, 0, 2, 3))
    x99 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x99 += einsum(t1.aa, (0, 1), x18, (2, 3, 0, 4), (2, 3, 1, 4))
    x100 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x100 += einsum(v.aaaa.ovov, (0, 1, 2, 3), (2, 0, 3, 1))
    x100 += einsum(v.aaaa.oovv, (0, 1, 2, 3), (1, 0, 3, 2)) * -1.0
    x100 += einsum(x96, (0, 1, 2, 3), (1, 0, 3, 2))
    x100 += einsum(x97, (0, 1, 2, 3), (1, 0, 3, 2)) * -1.0
    ...
    x101 += einsum(x100, (0, 1, 2, 3), t2.baba, (4, 0, 5, 2), (4, 5, 1, 3))
    ...
    x102 += einsum(v.bbbb.ovov, (0, 1, 2, 3), (2, 0, 1, 3))
    x102 += einsum(v.bbbb.ovov, (0, 1, 2, 3), (2, 0, 3, 1)) * -1.0
    x103 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x103 += einsum(t2.bbbb, (0, 1, 2, 3), (1, 0, 3, 2))
    x103 += einsum(t1.bb, (0, 1), t1.bb, (2, 3), (2, 0, 1, 3)) * -0.5
    x104 = np.zeros((nocc[1], nvir[1], nvir[1], nvir[1]), dtype=np.float64)
    x104 += einsum(v.bbbb.ovvv, (0, 1, 2, 3), (0, 1, 3, 2)) * -1.0
    x104 += einsum(v.bbbb.ovvv, (0, 1, 2, 3), (0, 3, 2, 1))
    x105 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x105 += einsum(v.bbbb.ooov, (0, 1, 2, 3), (1, 0, 2, 3)) * -1.0
    x105 += einsum(v.bbbb.ooov, (0, 1, 2, 3), (2, 1, 0, 3))
    x106 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x106 += einsum(v.bbbb.oovv, (0, 1, 2, 3), (1, 0, 3, 2))
    x106 += einsum(v.bbbb.ovov, (0, 1, 2, 3), (2, 0, 3, 1)) * -1.0
    x106 += einsum(x102, (0, 1, 2, 3), x103, (0, 4, 3, 5), (1, 4, 2, 5)) * -2.0
    x106 += einsum(t1.bb, (0, 1), x104, (2, 1, 3, 4), (2, 0, 4, 3)) * -1.0
    x106 += einsum(x105, (0, 1, 2, 3), t1.bb, (0, 4), (2, 1, 3, 4)) * -1.0
    t2new_abab += einsum(x106, (0, 1, 2, 3), t2.baba, (0, 4, 2, 5), (4, 1, 5, 3)) * -1.0
    x107 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x107 += einsum(v.bbaa.ooov, (0, 1, 2, 3), t1.bb, (1, 4), (0, 4, 2, 3))
    x108 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x108 += einsum(v.bbaa.ovov, (0, 1, 2, 3), x103, (0, 4, 1, 5), (4, 5, 2, 3)) * 2.0
    x109 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x109 += einsum(v.bbaa.ovov, (0, 1, 2, 3), (0, 1, 2, 3))
    x109 += einsum(x107, (0, 1, 2, 3), (0, 1, 2, 3)) * -1.0
    x109 += einsum(x95, (0, 1, 2, 3), (0, 1, 2, 3))
    x109 += einsum(x108, (0, 1, 2, 3), (0, 1, 2, 3))
    x110 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x110 += einsum(t2.aaaa, (0, 1, 2, 3), x109, (4, 5, 0, 2), (4, 5, 1, 3)) * 2.0
    t2new_abab += einsum(x110, (0, 1, 2, 3), (2, 0, 3, 1))
    t2new_baba += einsum(x110, (0, 1, 2, 3), (0, 2, 1, 3))
    x111 = np.zeros((nvir[1], nvir[1], nocc[0], nocc[0]), dtype=np.float64)
    x111 += einsum(v.bbaa.ovoo, (0, 1, 2, 3), t1.bb, (0, 4), (4, 1, 2, 3))
    x112 = np.zeros((nvir[1], nvir[1], nocc[0], nocc[0]), dtype=np.float64)
    x112 += einsum(v.bbaa.vvov, (0, 1, 2, 3), t1.aa, (4, 3), (0, 1, 4, 2))
    x113 = np.zeros((nvir[1], nvir[1], nocc[0], nocc[0]), dtype=np.float64)
    x113 += einsum(v.bbaa.ovov, (0, 1, 2, 3), x5, (0, 4, 5, 3), (1, 4, 2, 5))
    x114 = np.zeros((nvir[1], nvir[1], nocc[0], nocc[0]), dtype=np.float64)
    x114 += einsum(v.bbaa.vvoo, (0, 1, 2, 3), (1, 0, 3, 2)) * -1.0
    x114 += einsum(x111, (0, 1, 2, 3), (1, 0, 3, 2))
    x114 += einsum(x112, (0, 1, 2, 3), (1, 0, 3, 2)) * -1.0
    x114 += einsum(x113, (0, 1, 2, 3), (0, 1, 2, 3))
    x115 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x115 += einsum(t2.baba, (0, 1, 2, 3), x114, (2, 4, 1, 5), (0, 4, 5, 3))
    ...
    x116 += einsum(t1.aa, (0, 1), x2, (2, 3, 0, 4), (2, 3, 4, 1))
    x117 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x117 += einsum(v.bbaa.ovov, (0, 1, 2, 3), (0, 1, 2, 3))
    x117 += einsum(x38, (0, 1, 2, 3), (0, 1, 2, 3))
    x117 += einsum(x116, (0, 1, 2, 3), (0, 1, 2, 3)) * -1.0
    x118 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x118 += einsum(x117, (0, 1, 2, 3), x103, (0, 4, 1, 5), (4, 5, 2, 3)) * 2.0
    ...
    x120 += einsum(x23, (0, 1, 2, 3), (0, 1, 2, 3))
    x121 = np.zeros((nocc[1], nocc[1], nvir[0], nvir[0]), dtype=np.float64)
    x121 += einsum(x120, (0, 1, 2, 3), t1.aa, (2, 4), (0, 1, 4, 3))
    ...
    x124 += einsum(t1.bb, (0, 1), v.bbaa.ovvv, (0, 2, 3, 4), (1, 2, 3, 4))
    x125 = np.zeros((nvir[1], nvir[1], nvir[0], nvir[0]), dtype=np.float64)
    x125 += einsum(v.bbaa.vvov, (0, 1, 2, 3), t1.aa, (2, 4), (0, 1, 4, 3))
    ...
    x127 += einsum(t2.baba, (0, 1, 2, 3), x126, (2, 4, 3, 5), (0, 4, 1, 5))
    ...
    x130 += einsum(x5, (0, 1, 2, 3), v.bbaa.ovov, (4, 1, 5, 3), (4, 0, 5, 2))
    ...
    x139 += einsum(v.bbbb.ovvv, (0, 1, 2, 3), (0, 1, 3, 2))
    x139 += einsum(v.bbbb.ovvv, (0, 1, 2, 3), (0, 3, 2, 1)) * -1.0
    x140 = np.zeros((nvir[1], nvir[1]), dtype=np.float64)
    x140 += einsum(x139, (0, 1, 2, 3), t1.bb, (0, 1), (2, 3))
    x141 = np.zeros((nvir[1], nvir[1]), dtype=np.float64)
    x141 += einsum(x13, (0, 1), t1.bb, (0, 2), (2, 1))
    x142 = np.zeros((nvir[1], nvir[1]), dtype=np.float64)
    x142 += einsum(f.bb.vv, (0, 1), (1, 0)) * -1.0
    x142 += einsum(x136, (0, 1), (1, 0)) * -1.0
    x142 += einsum(x137, (0, 1), (1, 0)) * 2.0
    x142 += einsum(x138, (0, 1), (1, 0))
    x142 += einsum(x140, (0, 1), (1, 0)) * -1.0
    x142 += einsum(x141, (0, 1), (1, 0))
    x143 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x143 += einsum(x142, (0, 1), t2.baba, (2, 3, 0, 4), (2, 1, 3, 4))
    t2new_abab += einsum(x143, (0, 1, 2, 3), (2, 0, 3, 1)) * -1.0
    t2new_baba += einsum(x143, (0, 1, 2, 3), (0, 2, 1, 3)) * -1.0
    x144 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x144 += einsum(x21, (0, 1), t2.baba, (2, 0, 3, 4), (2, 3, 1, 4))
    ...
    x145 += einsum(x35, (0, 1), t2.baba, (0, 2, 3, 4), (1, 3, 2, 4))
    t2new_abab += einsum(x145, (0, 1, 2, 3), (2, 0, 3, 1)) * -1.0
    t2new_baba += einsum(x145, (0, 1, 2, 3), (0, 2, 1, 3)) * -1.0
    x146 = np.zeros((nvir[1], nvir[1], nocc[0], nocc[0]), dtype=np.float64)
    x146 += einsum(v.bbaa.vvoo, (0, 1, 2, 3), (1, 0, 3, 2))
    x146 += einsum(x112, (0, 1, 2, 3), (1, 0, 2, 3))
    x147 = np.zeros((nocc[1], nvir[1], nocc[0], nocc[0]), dtype=np.float64)
    x147 += einsum(x146, (0, 1, 2, 3), t1.bb, (4, 0), (4, 1, 2, 3))
    x148 = np.zeros((nocc[1], nocc[1], nocc[0], nocc[0]), dtype=np.float64)
    x148 += einsum(t2.baba, (0, 1, 2, 3), v.bbaa.ovov, (4, 2, 5, 3), (0, 4, 1, 5))
    x149 = np.zeros((nocc[1], nocc[1], nocc[0], nocc[0]), dtype=np.float64)
    x149 += einsum(v.bbaa.oooo, (0, 1, 2, 3), (1, 0, 3, 2))
    x149 += einsum(x129, (0, 1, 2, 3), (1, 0, 2, 3))
    x149 += einsum(x148, (0, 1, 2, 3), (1, 0, 2, 3))
    x150 = np.zeros((nocc[1], nvir[1], nocc[0], nocc[0]), dtype=np.float64)
    x150 += einsum(x149, (0, 1, 2, 3), t1.bb, (0, 4), (1, 4, 2, 3))
    x151 = np.zeros((nocc[1], nvir[1], nocc[0], nocc[0]), dtype=np.float64)
    x151 += einsum(v.bbaa.ovoo, (0, 1, 2, 3), (0, 1, 3, 2))
    x151 += einsum(x1, (0, 1, 2, 3), (0, 1, 3, 2))
    x151 += einsum(x147, (0, 1, 2, 3), (0, 1, 3, 2))
    x151 += einsum(x150, (0, 1, 2, 3), (0, 1, 3, 2)) * -1.0
    x152 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x152 += einsum(t1.aa, (0, 1), x151, (2, 3, 0, 4), (2, 3, 4, 1))
    t2new_abab += einsum(x152, (0, 1, 2, 3), (2, 0, 3, 1)) * -1.0
    t2new_baba += einsum(x152, (0, 1, 2, 3), (0, 2, 1, 3)) * -1.0
    x153 = np.zeros((nocc[1], nvir[1], nvir[0], nvir[0]), dtype=np.float64)
    x153 += einsum(v.bbaa.vvvv, (0, 1, 2, 3), t1.bb, (4, 1), (4, 0, 2, 3))
    x154 = np.zeros((nocc[1], nvir[1], nvir[0], nvir[0]), dtype=np.float64)
    x154 += einsum(v.bbaa.ovvv, (0, 1, 2, 3), (0, 1, 3, 2))
    x154 += einsum(x153, (0, 1, 2, 3), (0, 1, 3, 2))
    x155 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x155 += einsum(t1.aa, (0, 1), x154, (2, 3, 1, 4), (2, 3, 0, 4))
    t2new_abab += einsum(x155, (0, 1, 2, 3), (2, 0, 3, 1))
    t2new_baba += einsum(x155, (0, 1, 2, 3), (0, 2, 1, 3))
    x156 = np.zeros((nocc[1], nocc[1], nocc[0], nvir[0]), dtype=np.float64)
    x156 += einsum(t1.aa, (0, 1), v.bbaa.oovv, (2, 3, 4, 1), (2, 3, 0, 4))
    x157 = np.zeros((nocc[1], nocc[1], nocc[0], nvir[0]), dtype=np.float64)
    x157 += einsum(v.bbaa.ooov, (0, 1, 2, 3), (1, 0, 2, 3))
    x157 += einsum(x156, (0, 1, 2, 3), (1, 0, 2, 3))
    x158 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x158 += einsum(x157, (0, 1, 2, 3), t1.bb, (0, 4), (1, 4, 2, 3))
    t2new_abab += einsum(x158, (0, 1, 2, 3), (2, 0, 3, 1)) * -1.0
    t2new_baba += einsum(x158, (0, 1, 2, 3), (0, 2, 1, 3)) * -1.0
    x159 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x159 += einsum(v.bbbb.oovv, (0, 1, 2, 3), (1, 0, 3, 2)) * 0.5
    x159 += einsum(v.bbbb.ovov, (0, 1, 2, 3), (2, 0, 3, 1)) * -0.5
    x159 += einsum(x102, (0, 1, 2, 3), x103, (0, 4, 3, 5), (1, 4, 2, 5)) * -1.0
    x159 += einsum(t1.bb, (0, 1), x104, (2, 1, 3, 4), (2, 0, 4, 3)) * -0.5
    x159 += einsum(x105, (0, 1, 2, 3), t1.bb, (0, 4), (2, 1, 3, 4)) * -0.5
    t2new_baba += einsum(x159, (0, 1, 2, 3), t2.baba, (0, 4, 2, 5), (1, 4, 3, 5)) * -2.0
    x160 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x160 += einsum(t1.bb, (0, 1), v.bbbb.ovvv, (2, 3, 4, 1), (0, 2, 3, 4))
    x161 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x161 += einsum(t2.baba, (0, 1, 2, 3), v.bbaa.ovov, (4, 5, 1, 3), (0, 4, 2, 5))
    x162 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x162 += einsum(x95, (0, 1, 2, 3), t2.baba, (4, 2, 5, 3), (0, 4, 5, 1))
    x163 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x163 += einsum(v.bbbb.ovov, (0, 1, 2, 3), (2, 0, 3, 1))
    x163 += einsum(v.bbbb.oovv, (0, 1, 2, 3), (1, 0, 3, 2)) * -1.0
    x163 += einsum(x161, (0, 1, 2, 3), (1, 0, 3, 2))
    x164 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x164 += einsum(t2.bbbb, (0, 1, 2, 3), x163, (0, 4, 2, 5), (1, 4, 3, 5)) * 2.0
    x165 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x165 += einsum(t1.bb, (0, 1), x139, (2, 1, 3, 4), (0, 2, 3, 4))
    x166 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x166 += einsum(x165, (0, 1, 2, 3), t2.bbbb, (1, 4, 3, 5), (4, 0, 5, 2)) * -2.0
    x167 = np.zeros((nocc[1], nocc[1], nocc[1], nocc[1]), dtype=np.float64)
    x167 += einsum(v.bbbb.ooov, (0, 1, 2, 3), t1.bb, (4, 3), (4, 0, 1, 2))
    x168 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x168 += einsum(x167, (0, 1, 2, 3), t1.bb, (3, 4), (0, 2, 1, 4))
    x169 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x169 += einsum(v.bbaa.ooov, (0, 1, 2, 3), t2.baba, (4, 2, 5, 3), (4, 0, 1, 5))
    x170 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x170 += einsum(x23, (0, 1, 2, 3), t2.baba, (4, 2, 5, 3), (0, 4, 1, 5))
    x171 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x171 += einsum(v.bbbb.ooov, (0, 1, 2, 3), (1, 0, 2, 3))
    x171 += einsum(v.bbbb.ooov, (0, 1, 2, 3), (1, 2, 0, 3)) * -1.0
    x172 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x172 += einsum(t2.bbbb, (0, 1, 2, 3), x171, (4, 5, 0, 2), (1, 4, 5, 3)) * 2.0
    x173 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x173 += einsum(x25, (0, 1, 2, 3), (0, 1, 2, 3))
    x173 += einsum(x25, (0, 1, 2, 3), (0, 2, 1, 3)) * -1.0
    x174 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x174 += einsum(t2.bbbb, (0, 1, 2, 3), x173, (4, 5, 0, 2), (1, 4, 5, 3)) * 2.0
    x175 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x175 += einsum(v.bbbb.ovov, (0, 1, 2, 3), (2, 0, 1, 3))
    x175 += einsum(v.bbbb.oovv, (0, 1, 2, 3), (1, 0, 3, 2)) * -1.0
    x175 += einsum(x160, (0, 1, 2, 3), (0, 1, 2, 3))
    x176 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x176 += einsum(x175, (0, 1, 2, 3), t1.bb, (4, 2), (4, 0, 1, 3))
    x177 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x177 += einsum(x168, (0, 1, 2, 3), (0, 2, 1, 3))
    x177 += einsum(x169, (0, 1, 2, 3), (0, 2, 1, 3)) * -1.0
    x177 += einsum(x170, (0, 1, 2, 3), (0, 2, 1, 3))
    x177 += einsum(x172, (0, 1, 2, 3), (0, 2, 1, 3)) * -1.0
    x177 += einsum(x174, (0, 1, 2, 3), (1, 2, 0, 3)) * -1.0
    x177 += einsum(x176, (0, 1, 2, 3), (0, 2, 1, 3))
    x178 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x178 += einsum(x177, (0, 1, 2, 3), t1.bb, (1, 4), (0, 2, 4, 3))
    x179 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x179 += einsum(x160, (0, 1, 2, 3), (0, 1, 2, 3))
    x179 += einsum(x161, (0, 1, 2, 3), (0, 1, 2, 3)) * -1.0
    x179 += einsum(x162, (0, 1, 2, 3), (0, 1, 2, 3))
    x179 += einsum(x164, (0, 1, 2, 3), (0, 1, 2, 3)) * -1.0
    x179 += einsum(x166, (0, 1, 2, 3), (1, 0, 2, 3))
    x179 += einsum(x178, (0, 1, 2, 3), (0, 1, 2, 3))
    t2new_bbbb += einsum(x179, (0, 1, 2, 3), (0, 1, 2, 3)) * -1.0
    t2new_bbbb += einsum(x179, (0, 1, 2, 3), (0, 1, 3, 2))
    t2new_bbbb += einsum(x179, (0, 1, 2, 3), (1, 0, 2, 3))
    t2new_bbbb += einsum(x179, (0, 1, 2, 3), (1, 0, 3, 2)) * -1.0
    x180 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x180 += einsum(v.bbbb.ooov, (0, 1, 2, 3), t1.bb, (1, 4), (0, 2, 4, 3))
    x181 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x181 += einsum(x167, (0, 1, 2, 3), t2.bbbb, (3, 2, 4, 5), (0, 1, 4, 5)) * -1.0
    x182 = np.zeros((nocc[1], nocc[1]), dtype=np.float64)
    x182 += einsum(f.bb.oo, (0, 1), (1, 0))
    x182 += einsum(x34, (0, 1), (0, 1))
    x183 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x183 += einsum(x182, (0, 1), t2.bbbb, (1, 2, 3, 4), (2, 0, 3, 4)) * 2.0
    x184 = np.zeros((nocc[1], nocc[1]), dtype=np.float64)
    x184 += einsum(x29, (0, 1), (1, 0))
    x184 += einsum(x30, (0, 1), (1, 0)) * 2.0
    x184 += einsum(x31, (0, 1), (1, 0))
    x184 += einsum(x33, (0, 1), (1, 0)) * -1.0
    x185 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x185 += einsum(x184, (0, 1), t2.bbbb, (0, 2, 3, 4), (2, 1, 3, 4)) * 2.0
    x186 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x186 += einsum(x180, (0, 1, 2, 3), (0, 1, 3, 2)) * -1.0
    x186 += einsum(x181, (0, 1, 2, 3), (0, 1, 3, 2)) * -2.0
    x186 += einsum(x183, (0, 1, 2, 3), (1, 0, 3, 2)) * -1.0
    x186 += einsum(x185, (0, 1, 2, 3), (0, 1, 3, 2))
    t2new_bbbb += einsum(x186, (0, 1, 2, 3), (0, 1, 2, 3)) * -1.0
    t2new_bbbb += einsum(x186, (0, 1, 2, 3), (1, 0, 2, 3))
    x187 = np.zeros((nocc[1], nvir[1], nvir[1], nvir[1]), dtype=np.float64)
    x187 += einsum(t1.bb, (0, 1), v.bbbb.vvvv, (2, 1, 3, 4), (0, 3, 4, 2))
    ...
    x189 += einsum(t2.bbbb, (0, 1, 2, 3), x102, (0, 4, 2, 5), (1, 4, 3, 5))
    x190 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x190 += einsum(t2.bbbb, (0, 1, 2, 3), x189, (4, 0, 5, 2), (1, 4, 3, 5)) * -4.0
    x191 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x191 += einsum(x7, (0, 1, 2, 3), t2.baba, (4, 0, 5, 3), (4, 5, 1, 2))
    x192 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x192 += einsum(x191, (0, 1, 2, 3), t2.baba, (4, 2, 5, 3), (4, 0, 5, 1)) * -1.0
    x193 = np.zeros((nvir[1], nvir[1]), dtype=np.float64)
    x193 += einsum(x136, (0, 1), (1, 0)) * -1.0
    x193 += einsum(x137, (0, 1), (1, 0)) * 2.0
    x193 += einsum(x138, (0, 1), (1, 0))
    x193 += einsum(x140, (0, 1), (1, 0)) * -1.0
    x194 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x194 += einsum(t2.bbbb, (0, 1, 2, 3), x193, (2, 4), (0, 1, 3, 4)) * 2.0
    x195 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x195 += einsum(t2.bbbb, (0, 1, 2, 3), v.bbbb.ovvv, (4, 3, 5, 2), (0, 1, 4, 5)) * -1.0
    x196 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x196 += einsum(x13, (0, 1), t2.bbbb, (2, 3, 1, 4), (0, 2, 3, 4)) * 2.0
    x197 = np.zeros((nocc[1], nocc[1], nocc[1], nocc[1]), dtype=np.float64)
    x197 += einsum(t1.bb, (0, 1), x25, (2, 3, 4, 1), (2, 0, 4, 3))
    x198 = np.zeros((nocc[1], nocc[1], nocc[1], nocc[1]), dtype=np.float64)
    x198 += einsum(v.bbbb.oooo, (0, 1, 2, 3), (2, 3, 1, 0))
    x198 += einsum(x197, (0, 1, 2, 3), (3, 1, 2, 0))
    x199 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x199 += einsum(x198, (0, 1, 2, 3), t1.bb, (0, 4), (1, 2, 3, 4))
    x200 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x200 += einsum(x195, (0, 1, 2, 3), (2, 1, 0, 3)) * -2.0
    x200 += einsum(x196, (0, 1, 2, 3), (0, 2, 1, 3)) * -1.0
    x200 += einsum(x199, (0, 1, 2, 3), (1, 0, 2, 3))
    x201 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x201 += einsum(x200, (0, 1, 2, 3), t1.bb, (0, 4), (1, 2, 4, 3))
    x202 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x202 += einsum(x188, (0, 1, 2, 3), (0, 1, 2, 3))
    x202 += einsum(x190, (0, 1, 2, 3), (1, 0, 3, 2))
    x202 += einsum(x192, (0, 1, 2, 3), (1, 0, 3, 2))
    x202 += einsum(x194, (0, 1, 2, 3), (1, 0, 2, 3)) * -1.0
    x202 += einsum(x201, (0, 1, 2, 3), (1, 0, 2, 3))
    t2new_bbbb += einsum(x202, (0, 1, 2, 3), (0, 1, 2, 3))
    t2new_bbbb += einsum(x202, (0, 1, 2, 3), (0, 1, 3, 2)) * -1.0
    x203 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x203 += einsum(f.bb.vv, (0, 1), t2.bbbb, (2, 3, 4, 1), (2, 3, 0, 4))
    x204 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x204 += einsum(v.bbbb.ovov, (0, 1, 2, 3), (2, 0, 3, 1))
    x204 += einsum(x203, (0, 1, 2, 3), (1, 0, 3, 2)) * -2.0
    t2new_bbbb += einsum(x204, (0, 1, 2, 3), (0, 1, 3, 2)) * -1.0
    t2new_bbbb += einsum(x204, (0, 1, 2, 3), (0, 1, 2, 3))
    x205 = np.zeros((nocc[1], nocc[1], nocc[1], nocc[1]), dtype=np.float64)
    x205 += einsum(t2.bbbb, (0, 1, 2, 3), v.bbbb.ovov, (4, 2, 5, 3), (0, 1, 4, 5))
    x206 = np.zeros((nocc[1], nocc[1], nocc[1], nocc[1]), dtype=np.float64)
    x206 += einsum(v.bbbb.oooo, (0, 1, 2, 3), (2, 3, 1, 0)) * -1.0
    x206 += einsum(x205, (0, 1, 2, 3), (3, 1, 2, 0)) * -1.0
    x206 += einsum(x197, (0, 1, 2, 3), (2, 1, 3, 0))
    t2new_bbbb += einsum(x206, (0, 1, 2, 3), t2.bbbb, (0, 2, 4, 5), (1, 3, 5, 4)) * 2.0
    x207 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x207 += einsum(t1.bb, (0, 1), x205, (2, 3, 0, 4), (2, 3, 4, 1)) * -1.0
    x207 += einsum(v.bbbb.ooov, (0, 1, 2, 3), (1, 2, 0, 3)) * -0.5
    x207 += einsum(v.bbbb.ooov, (0, 1, 2, 3), (2, 1, 0, 3)) * 0.5
    t2new_bbbb += einsum(x207, (0, 1, 2, 3), t1.bb, (2, 4), (0, 1, 4, 3)) * 2.0
...
def update_lams(f=None, v=None, nocc=None, nvir=None, t1=None, t2=None, l1=None, l2=None, **kwargs):
    ...
    l2new_aaaa += einsum(v.aaaa.vvvv, (0, 1, 2, 3), l2.aaaa, (1, 3, 4, 5), (2, 0, 5, 4)) * 2.0
    ...
    x0 += einsum(v.bbaa.vvvv, (0, 1, 2, 3), t1.bb, (4, 1), (4, 0, 2, 3))
    l1new_aa += einsum(x0, (0, 1, 2, 3), l2.baba, (1, 3, 0, 4), (2, 4))
    ...
    x2 += einsum(l2.baba, (0, 1, 2, 3), t1.bb, (4, 0), (2, 4, 3, 1))
    l1new_aa += einsum(v.bbaa.oovv, (0, 1, 2, 3), x2, (0, 1, 4, 3), (2, 4)) * -1.0
    x3 = np.zeros((nocc[0], nocc[0], nocc[0], nocc[0]), dtype=np.float64)
    x3 += einsum(l2.aaaa, (0, 1, 2, 3), t2.aaaa, (4, 5, 0, 1), (2, 3, 4, 5))
    l1new_aa += einsum(v.aaaa.ooov, (0, 1, 2, 3), x3, (4, 1, 2, 0), (3, 4)) * 2.0
    x4 = np.zeros((nocc[0], nocc[0], nocc[0], nocc[0]), dtype=np.float64)
    x4 += einsum(t1.aa, (0, 1), x1, (2, 3, 4, 1), (3, 2, 4, 0))
    l1new_aa += einsum(x4, (0, 1, 2, 3), v.aaaa.ooov, (1, 2, 3, 4), (4, 0)) * -2.0
    ...
    x6 += einsum(t1.aa, (0, 1), v.aaaa.ovov, (2, 1, 3, 4), (0, 3, 2, 4))
    ...
    x12 += einsum(v.aaaa.ovov, (0, 1, 2, 3), (2, 0, 1, 3)) * -1.0
    x12 += einsum(v.aaaa.ovov, (0, 1, 2, 3), (2, 0, 3, 1))
    x13 = np.zeros((nocc[0], nvir[0]), dtype=np.float64)
    x13 += einsum(x12, (0, 1, 2, 3), t1.aa, (0, 3), (1, 2))
    ...
    x15 += einsum(v.bbaa.vvov, (0, 1, 2, 3), t1.aa, (4, 3), (0, 1, 4, 2))
    ...
    x22 += einsum(t2.baba, (0, 1, 2, 3), v.bbaa.vvov, (2, 4, 5, 3), (0, 4, 1, 5))
    x22 += einsum(t2.baba, (0, 1, 2, 3), x7, (4, 5, 1, 3), (0, 2, 5, 4)) * -1.0
    x22 += einsum(t2.bbbb, (0, 1, 2, 3), x8, (0, 2, 4, 5), (1, 3, 5, 4)) * 2.0
    x22 += einsum(x10, (0, 1, 2, 3), t2.baba, (0, 4, 5, 3), (1, 5, 4, 2)) * -1.0
    x22 += einsum(t2.baba, (0, 1, 2, 3), x14, (4, 3), (0, 2, 1, 4))
    x22 += einsum(x16, (0, 1, 2, 3), t1.bb, (4, 0), (4, 1, 3, 2))
    x22 += einsum(t1.bb, (0, 1), x21, (0, 2, 3, 4), (2, 1, 4, 3)) * -1.0
    l1new_aa += einsum(x22, (0, 1, 2, 3), l2.baba, (1, 4, 0, 2), (4, 3)) * -1.0
    ...
    x24 += einsum(t1.aa, (0, 1), v.aaaa.ovvv, (2, 3, 1, 4), (0, 2, 3, 4))
    ...
    x29 += einsum(v.aaaa.ovvv, (0, 1, 2, 3), t2.aaaa, (4, 5, 2, 1), (0, 5, 4, 3)) * -1.0
    x29 += einsum(x23, (0, 1, 2, 3), t2.aaaa, (1, 4, 3, 5), (2, 4, 0, 5)) * -2.0
    x29 += einsum(t2.baba, (0, 1, 2, 3), x19, (0, 2, 4, 5), (5, 1, 4, 3))
    x29 += einsum(t2.aaaa, (0, 1, 2, 3), x14, (4, 2), (4, 1, 0, 3))
    x29 += einsum(x24, (0, 1, 2, 3), t1.aa, (4, 2), (1, 0, 4, 3))
    x29 += einsum(x28, (0, 1, 2, 3), t1.aa, (0, 4), (2, 3, 1, 4))
    l1new_aa += einsum(l2.aaaa, (0, 1, 2, 3), x29, (4, 2, 3, 0), (1, 4)) * -2.0
    ...
    x30 += einsum(x2, (0, 1, 2, 3), t1.bb, (0, 4), (1, 4, 2, 3)) * -1.0
    x30 += einsum(l2.aaaa, (0, 1, 2, 3), t2.baba, (4, 2, 5, 1), (4, 5, 3, 0)) * -2.0
    l1new_aa += einsum(v.bbaa.ovvv, (0, 1, 2, 3), x30, (0, 1, 4, 2), (3, 4))
    x31 = np.zeros((nocc[0], nvir[0], nvir[0], nvir[0]), dtype=np.float64)
    x31 += einsum(v.aaaa.ovvv, (0, 1, 2, 3), (0, 1, 3, 2)) * -1.0
    x31 += einsum(v.aaaa.ovvv, (0, 1, 2, 3), (0, 3, 1, 2))
    x32 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x32 += einsum(l2.baba, (0, 1, 2, 3), t2.baba, (2, 4, 0, 5), (3, 4, 1, 5)) * 0.25
    x32 += einsum(t2.aaaa, (0, 1, 2, 3), l2.aaaa, (4, 3, 1, 5), (5, 0, 4, 2)) * -1.0
    l1new_aa += einsum(x31, (0, 1, 2, 3), x32, (4, 0, 3, 2), (1, 4)) * 4.0
    x33 = np.zeros((nocc[1], nvir[1], nocc[0], nocc[0]), dtype=np.float64)
    x33 += einsum(t1.aa, (0, 1), l2.baba, (2, 1, 3, 4), (3, 2, 4, 0))
    ...
    x35 += einsum(x33, (0, 1, 2, 3), t1.bb, (4, 1), (0, 4, 2, 3))
    ...
    x37 += einsum(l2.baba, (0, 1, 2, 3), t2.baba, (2, 4, 0, 1), (3, 4))
    x38 = np.zeros((nocc[0], nocc[0]), dtype=np.float64)
    x38 += einsum(l2.aaaa, (0, 1, 2, 3), t2.aaaa, (2, 4, 0, 1), (3, 4))
    ...
    x40 += einsum(x2, (0, 1, 2, 3), t2.baba, (0, 4, 5, 3), (1, 5, 2, 4)) * -1.0
    x40 += einsum(x1, (0, 1, 2, 3), t2.baba, (4, 1, 5, 3), (4, 5, 0, 2)) * -2.0
    x40 += einsum(x36, (0, 1, 2, 3), t1.bb, (0, 4), (1, 4, 2, 3)) * -1.0
    x40 += einsum(x39, (0, 1), t1.bb, (2, 3), (2, 3, 0, 1))
    l1new_aa += einsum(x40, (0, 1, 2, 3), v.bbaa.ovov, (0, 1, 3, 4), (4, 2)) * -1.0
    x41 = np.zeros((nvir[1], nvir[1], nocc[0], nocc[0]), dtype=np.float64)
    x41 += einsum(l2.baba, (0, 1, 2, 3), t2.baba, (2, 4, 5, 1), (0, 5, 3, 4))
    x41 += einsum(x33, (0, 1, 2, 3), t1.bb, (0, 4), (4, 1, 2, 3))
    l1new_aa += einsum(x41, (0, 1, 2, 3), v.bbaa.vvov, (1, 0, 3, 4), (4, 2)) * -1.0
    x42 = np.zeros((nocc[0], nvir[0], nvir[0], nvir[0]), dtype=np.float64)
    x42 += einsum(v.aaaa.ovvv, (0, 1, 2, 3), (0, 1, 3, 2))
    x42 += einsum(t1.aa, (0, 1), v.aaaa.vvvv, (2, 3, 1, 4), (0, 3, 4, 2)) * -1.0
    l1new_aa += einsum(x42, (0, 1, 2, 3), l2.aaaa, (1, 2, 0, 4), (3, 4)) * 2.0
    x43 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x43 += einsum(x1, (0, 1, 2, 3), t1.aa, (1, 4), (0, 2, 3, 4))
    x44 = np.zeros((nocc[0], nvir[0], nvir[0], nvir[0]), dtype=np.float64)
    x44 += einsum(v.aaaa.ovvv, (0, 1, 2, 3), (0, 1, 3, 2)) * -1.0
    x44 += einsum(v.aaaa.ovvv, (0, 1, 2, 3), (0, 3, 2, 1))
    l1new_aa += einsum(x44, (0, 1, 2, 3), x43, (4, 0, 2, 3), (1, 4)) * -2.0
    x45 = np.zeros((nocc[0], nocc[0], nocc[0], nvir[0]), dtype=np.float64)
    x45 += einsum(x33, (0, 1, 2, 3), t2.baba, (0, 4, 1, 5), (2, 3, 4, 5))
    x46 = np.zeros((nocc[0], nocc[0], nocc[0], nvir[0]), dtype=np.float64)
    x46 += einsum(x1, (0, 1, 2, 3), t2.aaaa, (4, 1, 5, 3), (0, 2, 4, 5)) * -1.0
    x47 = np.zeros((nocc[0], nocc[0], nocc[0], nocc[0]), dtype=np.float64)
    x47 += einsum(x3, (0, 1, 2, 3), (1, 0, 3, 2))
    x47 += einsum(x4, (0, 1, 2, 3), (0, 1, 3, 2)) * -1.0
    l2new_aaaa += einsum(x47, (0, 1, 2, 3), v.aaaa.ovov, (2, 4, 3, 5), (5, 4, 1, 0)) * 2.0
    x48 = np.zeros((nocc[0], nocc[0], nocc[0], nvir[0]), dtype=np.float64)
    ...
    x48 += einsum(x39, (0, 1), t1.aa, (2, 3), (2, 0, 1, 3)) * 0.5
    l1new_aa += einsum(v.aaaa.ovov, (0, 1, 2, 3), x48, (0, 4, 2, 1), (3, 4)) * -2.0
    x49 = np.zeros((nvir[0], nvir[0]), dtype=np.float64)
    x49 += einsum(t1.aa, (0, 1), l1.aa, (2, 0), (2, 1))
    x50 = np.zeros((nvir[0], nvir[0]), dtype=np.float64)
    x50 += einsum(l2.baba, (0, 1, 2, 3), t2.baba, (2, 3, 0, 4), (1, 4))
    x51 = np.zeros((nvir[0], nvir[0]), dtype=np.float64)
    x51 += einsum(l2.aaaa, (0, 1, 2, 3), t2.aaaa, (2, 3, 0, 4), (1, 4))
    x52 = np.zeros((nvir[0], nvir[0]), dtype=np.float64)
    x52 += einsum(x49, (0, 1), (0, 1))
    x52 += einsum(x50, (0, 1), (0, 1))
    x52 += einsum(x51, (0, 1), (0, 1)) * 2.0
    l1new_bb += einsum(x52, (0, 1), v.bbaa.ovvv, (2, 3, 1, 0), (3, 2))
    x53 = np.zeros((nocc[0], nvir[0], nvir[0], nvir[0]), dtype=np.float64)
    x53 += einsum(v.aaaa.ovvv, (0, 1, 2, 3), (0, 1, 3, 2))
    x53 += einsum(v.aaaa.ovvv, (0, 1, 2, 3), (0, 3, 2, 1)) * -1.0
    l1new_aa += einsum(x52, (0, 1), x53, (2, 1, 0, 3), (3, 2)) * -1.0
    x54 = np.zeros((nocc[0], nocc[0], nocc[0], nvir[0]), dtype=np.float64)
    x54 += einsum(t2.aaaa, (0, 1, 2, 3), l1.aa, (3, 4), (4, 1, 0, 2)) * -1.0
    x54 += einsum(x45, (0, 1, 2, 3), (0, 2, 1, 3)) * 0.5
    x54 += einsum(x46, (0, 1, 2, 3), (0, 2, 1, 3)) * 2.0
    x54 += einsum(t1.aa, (0, 1), x39, (2, 3), (2, 0, 3, 1)) * 0.5
    l1new_aa += einsum(v.aaaa.ovov, (0, 1, 2, 3), x54, (4, 0, 2, 3), (1, 4)) * 2.0
    x55 = np.zeros((nocc[0], nvir[0]), dtype=np.float64)
    x55 += einsum(t2.baba, (0, 1, 2, 3), l1.bb, (2, 0), (1, 3))
    ...
    x57 += einsum(t2.baba, (0, 1, 2, 3), x33, (0, 2, 1, 4), (4, 3))
    x58 = np.zeros((nocc[0], nvir[0]), dtype=np.float64)
    x58 += einsum(t2.aaaa, (0, 1, 2, 3), x1, (0, 1, 4, 2), (4, 3))
    x59 = np.zeros((nocc[0], nocc[0]), dtype=np.float64)
    x59 += einsum(t1.aa, (0, 1), l1.aa, (1, 2), (2, 0))
    l1new_aa += einsum(x14, (0, 1), x59, (2, 0), (1, 2)) * -1.0
    x60 = np.zeros((nocc[0], nocc[0]), dtype=np.float64)
    x60 += einsum(x59, (0, 1), (0, 1)) * 0.5
    x60 += einsum(x37, (0, 1), (0, 1)) * 0.5
    x60 += einsum(x38, (0, 1), (0, 1))
    l2new_abab += einsum(x60, (0, 1), v.bbaa.ovov, (2, 3, 1, 4), (4, 3, 0, 2)) * -2.0
    x61 = np.zeros((nocc[0], nvir[0]), dtype=np.float64)
    x61 += einsum(t1.aa, (0, 1), x60, (0, 2), (2, 1)) * 2.0
    x62 = np.zeros((nocc[0], nvir[0]), dtype=np.float64)
    x62 += einsum(t1.aa, (0, 1), (0, 1)) * -1.0
    x62 += einsum(x55, (0, 1), (0, 1)) * -1.0
    x62 += einsum(x56, (0, 1), (0, 1)) * -2.0
    x62 += einsum(x57, (0, 1), (0, 1))
    x62 += einsum(x58, (0, 1), (0, 1)) * 2.0
    x62 += einsum(x61, (0, 1), (0, 1))
    l1new_aa += einsum(x12, (0, 1, 2, 3), x62, (0, 3), (2, 1))
    x63 = np.zeros((nvir[1], nvir[1]), dtype=np.float64)
    x63 += einsum(l1.bb, (0, 1), t1.bb, (1, 2), (0, 2))
    x64 = np.zeros((nvir[1], nvir[1]), dtype=np.float64)
    x64 += einsum(t2.bbbb, (0, 1, 2, 3), l2.bbbb, (2, 4, 0, 1), (4, 3))
    x65 = np.zeros((nvir[1], nvir[1]), dtype=np.float64)
    x65 += einsum(l2.baba, (0, 1, 2, 3), t2.baba, (2, 3, 4, 1), (0, 4))
    x66 = np.zeros((nvir[1], nvir[1]), dtype=np.float64)
    x66 += einsum(x63, (0, 1), (0, 1)) * 0.5
    x66 += einsum(x64, (0, 1), (0, 1))
    x66 += einsum(x65, (0, 1), (0, 1)) * 0.5
    l1new_aa += einsum(v.bbaa.vvov, (0, 1, 2, 3), x66, (1, 0), (3, 2)) * 2.0
    x67 = np.zeros((nocc[1], nvir[1]), dtype=np.float64)
    x67 += einsum(l1.bb, (0, 1), t2.bbbb, (2, 1, 3, 0), (2, 3))
    x68 = np.zeros((nocc[1], nvir[1]), dtype=np.float64)
    x68 += einsum(t2.baba, (0, 1, 2, 3), l1.aa, (3, 1), (0, 2))
    x69 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x69 += einsum(l2.bbbb, (0, 1, 2, 3), t1.bb, (4, 1), (2, 3, 4, 0))
    l1new_bb += einsum(v.bbbb.oovv, (0, 1, 2, 3), x69, (4, 0, 1, 3), (2, 4)) * -2.0
    x70 = np.zeros((nocc[1], nvir[1]), dtype=np.float64)
    x70 += einsum(x69, (0, 1, 2, 3), t2.bbbb, (0, 1, 3, 4), (2, 4))
    x71 = np.zeros((nocc[1], nvir[1]), dtype=np.float64)
    x71 += einsum(x2, (0, 1, 2, 3), t2.baba, (0, 2, 4, 3), (1, 4))
    x72 = np.zeros((nocc[1], nocc[1]), dtype=np.float64)
    x72 += einsum(l1.bb, (0, 1), t1.bb, (2, 0), (1, 2))
    x73 = np.zeros((nocc[1], nocc[1]), dtype=np.float64)
    x73 += einsum(t2.bbbb, (0, 1, 2, 3), l2.bbbb, (2, 3, 0, 4), (4, 1))
    x74 = np.zeros((nocc[1], nocc[1]), dtype=np.float64)
    x74 += einsum(l2.baba, (0, 1, 2, 3), t2.baba, (4, 3, 0, 1), (2, 4))
    x75 = np.zeros((nocc[1], nocc[1]), dtype=np.float64)
    x75 += einsum(x72, (0, 1), (0, 1))
    x75 += einsum(x73, (0, 1), (0, 1)) * 2.0
    x75 += einsum(x74, (0, 1), (0, 1))
    l1new_aa += einsum(v.bbaa.ooov, (0, 1, 2, 3), x75, (1, 0), (3, 2)) * -1.0
    l2new_abab += einsum(v.bbaa.ovov, (0, 1, 2, 3), x75, (4, 0), (3, 1, 2, 4)) * -1.0
    x76 = np.zeros((nocc[1], nvir[1]), dtype=np.float64)
    x76 += einsum(x75, (0, 1), t1.bb, (0, 2), (1, 2))
    x77 = np.zeros((nocc[1], nvir[1]), dtype=np.float64)
    x77 += einsum(l1.bb, (0, 1), (1, 0)) * -1.0
    x77 += einsum(t1.bb, (0, 1), (0, 1)) * -1.0
    x77 += einsum(x67, (0, 1), (0, 1)) * -2.0
    x77 += einsum(x68, (0, 1), (0, 1)) * -1.0
    x77 += einsum(x70, (0, 1), (0, 1)) * 2.0
    x77 += einsum(x71, (0, 1), (0, 1))
    x77 += einsum(x76, (0, 1), (0, 1))
    l1new_aa += einsum(v.bbaa.ovov, (0, 1, 2, 3), x77, (0, 1), (3, 2)) * -1.0
    x78 = np.zeros((nocc[1], nocc[1], nocc[0], nocc[0]), dtype=np.float64)
    x78 += einsum(x34, (0, 1, 2, 3), (0, 1, 2, 3))
    x78 += einsum(x35, (0, 1, 2, 3), (1, 0, 2, 3))
    l1new_aa += einsum(v.bbaa.ooov, (0, 1, 2, 3), x78, (1, 0, 4, 2), (3, 4))
    x79 = np.zeros((nocc[0], nocc[0]), dtype=np.float64)
    x79 += einsum(x59, (0, 1), (0, 1))
    x79 += einsum(x37, (0, 1), (0, 1))
    x79 += einsum(x38, (0, 1), (0, 1)) * 2.0
    l1new_bb += einsum(x79, (0, 1), v.bbaa.ovoo, (2, 3, 1, 0), (3, 2)) * -1.0
    l2new_baba += einsum(v.bbaa.ovov, (0, 1, 2, 3), x79, (4, 2), (1, 3, 0, 4)) * -1.0
    x80 = np.zeros((nocc[0], nocc[0], nocc[0], nvir[0]), dtype=np.float64)
    x80 += einsum(v.aaaa.ooov, (0, 1, 2, 3), (1, 0, 2, 3)) * -1.0
    x80 += einsum(v.aaaa.ooov, (0, 1, 2, 3), (1, 2, 0, 3))
    l1new_aa += einsum(x80, (0, 1, 2, 3), x79, (0, 2), (3, 1)) * -1.0
    x81 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x81 += einsum(v.aaaa.oovv, (0, 1, 2, 3), (1, 0, 3, 2))
    x81 += einsum(v.aaaa.ovov, (0, 1, 2, 3), (2, 0, 3, 1)) * -1.0
    l1new_aa += einsum(x81, (0, 1, 2, 3), l1.aa, (2, 0), (3, 1)) * -1.0
    x82 = np.zeros((nvir[0], nvir[0]), dtype=np.float64)
    x82 += einsum(v.bbaa.ovvv, (0, 1, 2, 3), t1.bb, (0, 1), (2, 3))
    x83 = np.zeros((nocc[0], nvir[0], nvir[0], nvir[0]), dtype=np.float64)
    x83 += einsum(v.aaaa.ovvv, (0, 1, 2, 3), (0, 1, 3, 2))
    x83 += einsum(v.aaaa.ovvv, (0, 1, 2, 3), (0, 3, 1, 2)) * -1.0
    x84 = np.zeros((nvir[0], nvir[0]), dtype=np.float64)
    x84 += einsum(f.aa.vv, (0, 1), (1, 0))
    ...
    x85 += einsum(t1.bb, (0, 1), v.bbaa.ovoo, (0, 1, 2, 3), (2, 3))
    ...
    x87 += einsum(t2.aaaa, (0, 1, 2, 3), v.aaaa.ovov, (4, 2, 0, 3), (1, 4)) * -1.0
    x88 = np.zeros((nocc[0], nocc[0], nocc[0], nvir[0]), dtype=np.float64)
    x88 += einsum(v.aaaa.ooov, (0, 1, 2, 3), (1, 0, 2, 3)) * -1.0
    x88 += einsum(v.aaaa.ooov, (0, 1, 2, 3), (2, 1, 0, 3))
    x89 = np.zeros((nocc[0], nocc[0]), dtype=np.float64)
    x89 += einsum(x88, (0, 1, 2, 3), t1.aa, (2, 3), (0, 1))
    x90 = np.zeros((nocc[0], nocc[0]), dtype=np.float64)
    x90 += einsum(x14, (0, 1), t1.aa, (2, 1), (2, 0))
    x91 = np.zeros((nocc[0], nocc[0]), dtype=np.float64)
    x91 += einsum(f.aa.oo, (0, 1), (1, 0))
    x91 += einsum(x85, (0, 1), (1, 0))
    x91 += einsum(x86, (0, 1), (0, 1))
    x91 += einsum(x87, (0, 1), (0, 1)) * 2.0
    x91 += einsum(x89, (0, 1), (1, 0)) * -1.0
    x91 += einsum(x90, (0, 1), (0, 1))
    l1new_aa += einsum(l1.aa, (0, 1), x91, (1, 2), (0, 2)) * -1.0
    x92 = np.zeros((nocc[0], nocc[0]), dtype=np.float64)
    x92 += einsum(x37, (0, 1), (0, 1)) * 0.5
    x92 += einsum(x38, (0, 1), (0, 1))
    l1new_aa += einsum(f.aa.ov, (0, 1), x92, (2, 0), (1, 2)) * -2.0
    x93 = np.zeros((nocc[1], nocc[1], nocc[1], nocc[1]), dtype=np.float64)
    x93 += einsum(l2.bbbb, (0, 1, 2, 3), t2.bbbb, (4, 5, 0, 1), (2, 3, 4, 5))
    l1new_bb += einsum(x93, (0, 1, 2, 3), v.bbbb.ooov, (3, 1, 2, 4), (4, 0)) * 2.0
    x94 = np.zeros((nocc[1], nocc[1], nocc[1], nocc[1]), dtype=np.float64)
    x94 += einsum(x69, (0, 1, 2, 3), t1.bb, (4, 3), (1, 0, 2, 4))
    l1new_bb += einsum(x94, (0, 1, 2, 3), v.bbbb.ooov, (1, 2, 3, 4), (4, 0)) * -2.0
    x95 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x95 += einsum(v.bbbb.ovvv, (0, 1, 2, 3), t1.bb, (4, 2), (4, 0, 1, 3))
    l1new_bb += einsum(x95, (0, 1, 2, 3), x69, (4, 0, 1, 3), (2, 4)) * 2.0
    x96 = np.zeros((nvir[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x96 += einsum(t1.aa, (0, 1), v.bbaa.vvvv, (2, 3, 4, 1), (2, 3, 0, 4))
    l1new_bb += einsum(x96, (0, 1, 2, 3), l2.baba, (1, 3, 4, 2), (0, 4))
    x97 = np.zeros((nocc[1], nvir[1], nvir[1], nvir[1]), dtype=np.float64)
    x97 += einsum(t1.bb, (0, 1), v.bbbb.vvvv, (2, 3, 1, 4), (0, 2, 3, 4))
    l1new_bb += einsum(x97, (0, 1, 2, 3), l2.bbbb, (3, 2, 4, 0), (1, 4)) * -2.0
    x98 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x98 += einsum(v.bbbb.ovov, (0, 1, 2, 3), t1.bb, (4, 3), (4, 0, 2, 1))
    x99 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x99 += einsum(v.bbbb.ooov, (0, 1, 2, 3), (1, 0, 2, 3)) * -1.0
    x99 += einsum(v.bbbb.ooov, (0, 1, 2, 3), (2, 1, 0, 3))
    x99 += einsum(x98, (0, 1, 2, 3), (1, 0, 2, 3))
    x99 += einsum(x98, (0, 1, 2, 3), (2, 0, 1, 3)) * -1.0
    x100 = np.zeros((nocc[1], nvir[1]), dtype=np.float64)
    x100 += einsum(v.bbaa.ovov, (0, 1, 2, 3), t1.aa, (2, 3), (0, 1))
    x101 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x101 += einsum(v.bbbb.ovov, (0, 1, 2, 3), (2, 0, 1, 3)) * -1.0
    x101 += einsum(v.bbbb.ovov, (0, 1, 2, 3), (2, 0, 3, 1))
    x102 = np.zeros((nocc[1], nvir[1]), dtype=np.float64)
    x102 += einsum(t1.bb, (0, 1), x101, (0, 2, 3, 1), (2, 3))
    x103 = np.zeros((nocc[1], nvir[1]), dtype=np.float64)
    x103 += einsum(f.bb.ov, (0, 1), (0, 1))
    x103 += einsum(x100, (0, 1), (0, 1))
    x103 += einsum(x102, (0, 1), (0, 1)) * -1.0
    l1new_bb += einsum(x103, (0, 1), x72, (2, 0), (1, 2)) * -1.0
    l2new_abab += einsum(x103, (0, 1), l1.aa, (2, 3), (2, 1, 3, 0))
    l2new_baba += einsum(x103, (0, 1), l1.aa, (2, 3), (1, 2, 0, 3))
    x104 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x104 += einsum(t1.aa, (0, 1), v.bbaa.ovvv, (2, 3, 1, 4), (2, 3, 0, 4))
    x105 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x105 += einsum(v.bbaa.ovov, (0, 1, 2, 3), (0, 1, 2, 3))
    x105 += einsum(x104, (0, 1, 2, 3), (0, 1, 2, 3))
    x106 = np.zeros((nocc[1], nocc[1], nocc[0], nvir[0]), dtype=np.float64)
    x106 += einsum(v.bbaa.ooov, (0, 1, 2, 3), (1, 0, 2, 3))
    x106 += einsum(t1.aa, (0, 1), v.bbaa.oovv, (2, 3, 4, 1), (3, 2, 0, 4))
    x106 += einsum(t2.baba, (0, 1, 2, 3), v.bbaa.ovvv, (4, 2, 3, 5), (0, 4, 1, 5))
    x106 += einsum(x99, (0, 1, 2, 3), t2.baba, (2, 4, 3, 5), (1, 0, 4, 5)) * -1.0
    x106 += einsum(x10, (0, 1, 2, 3), t2.aaaa, (2, 4, 3, 5), (1, 0, 4, 5)) * 2.0
    x106 += einsum(t2.baba, (0, 1, 2, 3), x8, (4, 2, 1, 5), (0, 4, 5, 3)) * -1.0
    x106 += einsum(t2.baba, (0, 1, 2, 3), x103, (4, 2), (0, 4, 1, 3))
    x106 += einsum(x105, (0, 1, 2, 3), t1.bb, (4, 1), (4, 0, 2, 3))
    x106 += einsum(t1.aa, (0, 1), x21, (2, 3, 0, 4), (3, 2, 4, 1)) * -1.0
    l1new_bb += einsum(l2.baba, (0, 1, 2, 3), x106, (2, 4, 3, 1), (0, 4)) * -1.0
    x107 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x107 += einsum(v.bbbb.ooov, (0, 1, 2, 3), (1, 0, 2, 3))
    x107 += einsum(v.bbbb.ooov, (0, 1, 2, 3), (1, 2, 0, 3)) * -1.0
    x107 += einsum(x98, (0, 1, 2, 3), (0, 1, 2, 3)) * -1.0
    x107 += einsum(x98, (0, 1, 2, 3), (0, 2, 1, 3))
    x108 = np.zeros((nocc[1], nocc[1], nocc[0], nvir[0]), dtype=np.float64)
    x108 += einsum(v.bbaa.ooov, (0, 1, 2, 3), (1, 0, 2, 3))
    x108 += einsum(x9, (0, 1, 2, 3), (0, 1, 2, 3))
    x109 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x109 += einsum(v.bbbb.ovov, (0, 1, 2, 3), (2, 0, 1, 3))
    x109 += einsum(v.bbbb.oovv, (0, 1, 2, 3), (1, 0, 3, 2)) * -1.0
    x109 += einsum(x95, (0, 1, 2, 3), (0, 1, 2, 3))
    x110 = np.zeros((nocc[1], nocc[1], nocc[1], nocc[1]), dtype=np.float64)
    x110 += einsum(v.bbbb.ovov, (0, 1, 2, 3), t2.bbbb, (4, 5, 3, 1), (4, 5, 0, 2)) * -1.0
    x111 = np.zeros((nocc[1], nocc[1], nocc[1], nocc[1]), dtype=np.float64)
    x111 += einsum(x98, (0, 1, 2, 3), t1.bb, (4, 3), (4, 0, 1, 2))
    x112 = np.zeros((nocc[1], nocc[1], nocc[1], nocc[1]), dtype=np.float64)
    x112 += einsum(v.bbbb.ooov, (0, 1, 2, 3), t1.bb, (4, 3), (4, 0, 1, 2))
    x113 = np.zeros((nocc[1], nocc[1], nocc[1], nocc[1]), dtype=np.float64)
    x113 += einsum(v.bbbb.oooo, (0, 1, 2, 3), (2, 3, 1, 0))
    x113 += einsum(x110, (0, 1, 2, 3), (3, 1, 2, 0))
    x113 += einsum(x111, (0, 1, 2, 3), (2, 1, 3, 0)) * -1.0
    x113 += einsum(x112, (0, 1, 2, 3), (2, 0, 3, 1)) * -1.0
    x113 += einsum(x112, (0, 1, 2, 3), (3, 0, 2, 1))
    x114 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x114 += einsum(v.bbbb.ooov, (0, 1, 2, 3), (1, 0, 2, 3)) * -1.0
    x114 += einsum(t2.bbbb, (0, 1, 2, 3), v.bbbb.ovvv, (4, 3, 2, 5), (4, 1, 0, 5)) * -1.0
    x114 += einsum(t2.bbbb, (0, 1, 2, 3), x107, (4, 0, 5, 2), (5, 1, 4, 3)) * -2.0
    x114 += einsum(x108, (0, 1, 2, 3), t2.baba, (4, 2, 5, 3), (1, 4, 0, 5))
    x114 += einsum(x103, (0, 1), t2.bbbb, (2, 3, 1, 4), (0, 3, 2, 4))
    x114 += einsum(x109, (0, 1, 2, 3), t1.bb, (4, 2), (1, 0, 4, 3))
    x114 += einsum(x113, (0, 1, 2, 3), t1.bb, (0, 4), (2, 3, 1, 4))
    l1new_bb += einsum(x114, (0, 1, 2, 3), l2.bbbb, (3, 4, 1, 2), (4, 0)) * -2.0
    x115 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x115 += einsum(l2.baba, (0, 1, 2, 3), (2, 0, 3, 1))
    x115 += einsum(t2.baba, (0, 1, 2, 3), l2.bbbb, (4, 2, 0, 5), (5, 4, 1, 3)) * -2.0
    x115 += einsum(l2.baba, (0, 1, 2, 3), t2.aaaa, (4, 3, 5, 1), (2, 0, 4, 5)) * 2.0
    x115 += einsum(t1.aa, (0, 1), x33, (2, 3, 0, 4), (2, 3, 4, 1)) * -1.0
    l1new_bb += einsum(x115, (0, 1, 2, 3), v.bbaa.vvov, (1, 4, 2, 3), (4, 0))
    x116 = np.zeros((nocc[1], nvir[1], nvir[1], nvir[1]), dtype=np.float64)
    x116 += einsum(v.bbbb.ovvv, (0, 1, 2, 3), (0, 1, 3, 2)) * -1.0
    x116 += einsum(v.bbbb.ovvv, (0, 1, 2, 3), (0, 3, 2, 1))
    x117 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x117 += einsum(t2.bbbb, (0, 1, 2, 3), l2.bbbb, (4, 3, 1, 5), (5, 0, 4, 2)) * -4.0
    x117 += einsum(l2.baba, (0, 1, 2, 3), t2.baba, (4, 3, 5, 1), (2, 4, 0, 5))
    l1new_bb += einsum(x117, (0, 1, 2, 3), x116, (1, 3, 2, 4), (4, 0)) * -1.0
    x118 = np.zeros((nocc[1], nocc[1]), dtype=np.float64)
    x118 += einsum(x73, (0, 1), (0, 1))
    x118 += einsum(x74, (0, 1), (0, 1)) * 0.5
    x119 = np.zeros((nocc[1], nocc[1], nocc[0], nvir[0]), dtype=np.float64)
    x119 += einsum(l1.bb, (0, 1), t2.baba, (2, 3, 0, 4), (1, 2, 3, 4))
    x119 += einsum(x2, (0, 1, 2, 3), (0, 1, 2, 3))
    x119 += einsum(x69, (0, 1, 2, 3), t2.baba, (1, 4, 3, 5), (0, 2, 4, 5)) * -2.0
    x119 += einsum(x2, (0, 1, 2, 3), t2.aaaa, (4, 2, 5, 3), (0, 1, 4, 5)) * 2.0
    x119 += einsum(t2.baba, (0, 1, 2, 3), x33, (4, 2, 1, 5), (4, 0, 5, 3)) * -1.0
    x119 += einsum(t1.aa, (0, 1), x36, (2, 3, 0, 4), (2, 3, 4, 1)) * -1.0
    x119 += einsum(x118, (0, 1), t1.aa, (2, 3), (0, 1, 2, 3)) * 2.0
    l1new_bb += einsum(v.bbaa.ovov, (0, 1, 2, 3), x119, (4, 0, 2, 3), (1, 4)) * -1.0
    x120 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x120 += einsum(l2.bbbb, (0, 1, 2, 3), (3, 2, 1, 0)) * -1.0
    x120 += einsum(x69, (0, 1, 2, 3), t1.bb, (1, 4), (0, 2, 3, 4))
    l1new_bb += einsum(x120, (0, 1, 2, 3), v.bbbb.ovvv, (1, 3, 2, 4), (4, 0)) * -2.0
    x121 = np.zeros((nocc[1], nocc[1], nvir[0], nvir[0]), dtype=np.float64)
    x121 += einsum(l2.baba, (0, 1, 2, 3), t2.baba, (4, 3, 0, 5), (2, 4, 1, 5))
    x121 += einsum(x2, (0, 1, 2, 3), t1.aa, (2, 4), (0, 1, 4, 3))
    l1new_bb += einsum(x121, (0, 1, 2, 3), v.bbaa.ovvv, (1, 4, 3, 2), (4, 0)) * -1.0
    x122 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x122 += einsum(x69, (0, 1, 2, 3), t2.bbbb, (4, 1, 5, 3), (0, 2, 4, 5)) * -1.0
    x123 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x123 += einsum(x2, (0, 1, 2, 3), t2.baba, (4, 2, 5, 3), (0, 1, 4, 5))
    x124 = np.zeros((nocc[1], nocc[1], nocc[1], nocc[1]), dtype=np.float64)
    x124 += einsum(x93, (0, 1, 2, 3), (1, 0, 3, 2))
    x124 += einsum(x94, (0, 1, 2, 3), (0, 1, 3, 2)) * -1.0
    l2new_bbbb += einsum(v.bbbb.ovov, (0, 1, 2, 3), x124, (4, 5, 0, 2), (3, 1, 5, 4)) * 2.0
    x125 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x125 += einsum(x69, (0, 1, 2, 3), (1, 0, 2, 3)) * -2.0
    x125 += einsum(x122, (0, 1, 2, 3), (2, 0, 1, 3)) * 4.0
    x125 += einsum(x123, (0, 1, 2, 3), (2, 0, 1, 3))
    x125 += einsum(t1.bb, (0, 1), x124, (0, 2, 3, 4), (4, 2, 3, 1)) * 2.0
    x125 += einsum(x118, (0, 1), t1.bb, (2, 3), (2, 0, 1, 3)) * 2.0
    l1new_bb += einsum(x125, (0, 1, 2, 3), v.bbbb.ovov, (0, 3, 2, 4), (4, 1)) * -1.0
    x126 = np.zeros((nocc[1], nvir[1], nvir[1], nvir[1]), dtype=np.float64)
    x126 += einsum(v.bbbb.ovvv, (0, 1, 2, 3), (0, 1, 3, 2))
    x126 += einsum(v.bbbb.ovvv, (0, 1, 2, 3), (0, 3, 2, 1)) * -1.0
    l1new_bb += einsum(x126, (0, 1, 2, 3), x66, (2, 1), (3, 0)) * -2.0
    x127 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x127 += einsum(l1.bb, (0, 1), t2.bbbb, (2, 3, 4, 0), (1, 3, 2, 4)) * -2.0
    x127 += einsum(x122, (0, 1, 2, 3), (0, 2, 1, 3)) * 4.0
    x127 += einsum(x123, (0, 1, 2, 3), (0, 2, 1, 3))
    x127 += einsum(x118, (0, 1), t1.bb, (2, 3), (0, 2, 1, 3)) * 2.0
    l1new_bb += einsum(v.bbbb.ovov, (0, 1, 2, 3), x127, (4, 0, 2, 3), (1, 4))
    x128 = np.zeros((nocc[1], nvir[1]), dtype=np.float64)
    x128 += einsum(t1.bb, (0, 1), (0, 1)) * -1.0
    x128 += einsum(x67, (0, 1), (0, 1)) * -2.0
    x128 += einsum(x68, (0, 1), (0, 1)) * -1.0
    x128 += einsum(x70, (0, 1), (0, 1)) * 2.0
    x128 += einsum(x71, (0, 1), (0, 1))
    x128 += einsum(x76, (0, 1), (0, 1))
    x129 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x129 += einsum(v.bbbb.ovov, (0, 1, 2, 3), (2, 0, 1, 3))
    x129 += einsum(v.bbbb.ovov, (0, 1, 2, 3), (2, 0, 3, 1)) * -1.0
    l1new_bb += einsum(x129, (0, 1, 2, 3), x128, (0, 3), (2, 1)) * -1.0
    x130 = np.zeros((nocc[0], nvir[0]), dtype=np.float64)
    x130 += einsum(l1.aa, (0, 1), (1, 0)) * -1.0
    x130 += einsum(t1.aa, (0, 1), (0, 1)) * -1.0
    x130 += einsum(x55, (0, 1), (0, 1)) * -1.0
    x130 += einsum(x56, (0, 1), (0, 1)) * -2.0
    x130 += einsum(x57, (0, 1), (0, 1))
    x130 += einsum(x58, (0, 1), (0, 1)) * 2.0
    x130 += einsum(x61, (0, 1), (0, 1))
    l1new_bb += einsum(v.bbaa.ovov, (0, 1, 2, 3), x130, (2, 3), (1, 0)) * -1.0
    x131 = np.zeros((nocc[1], nocc[1], nocc[0], nocc[0]), dtype=np.float64)
    x131 += einsum(x34, (0, 1, 2, 3), (0, 1, 2, 3))
    x131 += einsum(x35, (0, 1, 2, 3), (0, 1, 3, 2))
    l1new_bb += einsum(x131, (0, 1, 2, 3), v.bbaa.ovoo, (1, 4, 3, 2), (4, 0))
    x132 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x132 += einsum(v.bbbb.ooov, (0, 1, 2, 3), (1, 0, 2, 3)) * -1.0
    x132 += einsum(v.bbbb.ooov, (0, 1, 2, 3), (1, 2, 0, 3))
    l1new_bb += einsum(x132, (0, 1, 2, 3), x75, (0, 2), (3, 1)) * -1.0
    x133 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x133 += einsum(v.bbbb.oovv, (0, 1, 2, 3), (1, 0, 3, 2))
    x133 += einsum(v.bbbb.ovov, (0, 1, 2, 3), (2, 0, 3, 1)) * -1.0
    l1new_bb += einsum(l1.bb, (0, 1), x133, (1, 2, 0, 3), (3, 2)) * -1.0
    x134 = np.zeros((nvir[1], nvir[1]), dtype=np.float64)
    x134 += einsum(v.bbaa.vvov, (0, 1, 2, 3), t1.aa, (2, 3), (0, 1))
    x135 = np.zeros((nocc[1], nvir[1], nvir[1], nvir[1]), dtype=np.float64)
    x135 += einsum(v.bbbb.ovvv, (0, 1, 2, 3), (0, 1, 3, 2))
    x135 += einsum(v.bbbb.ovvv, (0, 1, 2, 3), (0, 3, 1, 2)) * -1.0
    x136 = np.zeros((nvir[1], nvir[1]), dtype=np.float64)
    x136 += einsum(f.bb.vv, (0, 1), (1, 0))
    x136 += einsum(x134, (0, 1), (1, 0))
    x136 += einsum(x135, (0, 1, 2, 3), t1.bb, (0, 2), (3, 1)) * -1.0
    l1new_bb += einsum(x136, (0, 1), l1.bb, (0, 2), (1, 2))
    x137 = np.zeros((nocc[1], nocc[1]), dtype=np.float64)
    x137 += einsum(v.bbaa.ooov, (0, 1, 2, 3), t1.aa, (2, 3), (0, 1))
    x138 = np.zeros((nocc[1], nocc[1]), dtype=np.float64)
    x138 += einsum(t2.bbbb, (0, 1, 2, 3), v.bbbb.ovov, (4, 3, 0, 2), (1, 4))
    x139 = np.zeros((nocc[1], nocc[1]), dtype=np.float64)
    x139 += einsum(v.bbaa.ovov, (0, 1, 2, 3), t2.baba, (4, 2, 1, 3), (4, 0))
    x140 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x140 += einsum(v.bbbb.ooov, (0, 1, 2, 3), (1, 0, 2, 3)) * -1.0
    x140 += einsum(v.bbbb.ooov, (0, 1, 2, 3), (2, 1, 0, 3))
    x141 = np.zeros((nocc[1], nocc[1]), dtype=np.float64)
    x141 += einsum(x140, (0, 1, 2, 3), t1.bb, (2, 3), (0, 1))
    x142 = np.zeros((nocc[1], nocc[1]), dtype=np.float64)
    x142 += einsum(x103, (0, 1), t1.bb, (2, 1), (2, 0))
    x143 = np.zeros((nocc[1], nocc[1]), dtype=np.float64)
    x143 += einsum(f.bb.oo, (0, 1), (1, 0))
    x143 += einsum(x137, (0, 1), (1, 0))
    x143 += einsum(x138, (0, 1), (0, 1)) * 2.0
    x143 += einsum(x139, (0, 1), (0, 1))
    x143 += einsum(x141, (0, 1), (1, 0)) * -1.0
    x143 += einsum(x142, (0, 1), (0, 1))
    l1new_bb += einsum(l1.bb, (0, 1), x143, (1, 2), (0, 2)) * -1.0
    x144 = np.zeros((nocc[1], nocc[1]), dtype=np.float64)
    x144 += einsum(x73, (0, 1), (0, 1)) * 2.0
    x144 += einsum(x74, (0, 1), (0, 1))
    l1new_bb += einsum(x144, (0, 1), f.bb.ov, (1, 2), (2, 0)) * -1.0
    x145 = np.zeros((nocc[0], nocc[0]), dtype=np.float64)
    x145 += einsum(t1.aa, (0, 1), f.aa.ov, (2, 1), (2, 0))
    x146 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x146 += einsum(x145, (0, 1), l2.aaaa, (2, 3, 4, 1), (0, 4, 2, 3))
    x147 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x147 += einsum(l2.aaaa, (0, 1, 2, 3), x27, (3, 4, 2, 5), (4, 5, 0, 1)) * -1.0
    x148 = np.zeros((nocc[0], nvir[0]), dtype=np.float64)
    x148 += einsum(x11, (0, 1), (0, 1))
    x148 += einsum(x13, (0, 1), (0, 1)) * -1.0
    x149 = np.zeros((nocc[0], nocc[0]), dtype=np.float64)
    x149 += einsum(t1.aa, (0, 1), x148, (2, 1), (2, 0))
    x150 = np.zeros((nocc[0], nocc[0]), dtype=np.float64)
    x150 += einsum(x85, (0, 1), (1, 0))
    x150 += einsum(x86, (0, 1), (0, 1))
    x150 += einsum(x87, (0, 1), (0, 1)) * 2.0
    x150 += einsum(x89, (0, 1), (1, 0)) * -1.0
    x150 += einsum(x149, (0, 1), (1, 0))
    x151 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x151 += einsum(l2.aaaa, (0, 1, 2, 3), x150, (2, 4), (4, 3, 0, 1)) * 2.0
    x152 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x152 += einsum(x146, (0, 1, 2, 3), (0, 1, 3, 2)) * 2.0
    x152 += einsum(x147, (0, 1, 2, 3), (0, 1, 3, 2)) * -2.0
    x152 += einsum(x151, (0, 1, 2, 3), (1, 0, 3, 2))
    l2new_aaaa += einsum(x152, (0, 1, 2, 3), (3, 2, 0, 1))
    l2new_aaaa += einsum(x152, (0, 1, 2, 3), (3, 2, 1, 0)) * -1.0
    x153 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x153 += einsum(v.aaaa.ovvv, (0, 1, 2, 3), l1.aa, (3, 4), (4, 0, 1, 2))
    x154 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x154 += einsum(x2, (0, 1, 2, 3), v.bbaa.ooov, (0, 1, 4, 5), (2, 4, 3, 5))
    x155 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x155 += einsum(x2, (0, 1, 2, 3), x9, (0, 1, 4, 5), (2, 4, 3, 5))
    x156 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x156 += einsum(v.bbaa.ovov, (0, 1, 2, 3), t2.baba, (0, 4, 1, 5), (4, 2, 5, 3))
    x157 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x157 += einsum(v.aaaa.ovov, (0, 1, 2, 3), (2, 0, 1, 3))
    x157 += einsum(v.aaaa.ovov, (0, 1, 2, 3), (2, 0, 3, 1)) * -1.0
    x158 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x158 += einsum(t2.aaaa, (0, 1, 2, 3), x157, (0, 4, 2, 5), (4, 1, 5, 3)) * 2.0
    x159 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x159 += einsum(t1.aa, (0, 1), x31, (2, 3, 1, 4), (0, 2, 3, 4))
    x160 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x160 += einsum(v.aaaa.ovov, (0, 1, 2, 3), (2, 0, 3, 1))
    x160 += einsum(v.aaaa.oovv, (0, 1, 2, 3), (1, 0, 3, 2)) * -1.0
    x160 += einsum(x156, (0, 1, 2, 3), (0, 1, 2, 3))
    x160 += einsum(x158, (0, 1, 2, 3), (1, 0, 3, 2)) * -1.0
    x160 += einsum(x159, (0, 1, 2, 3), (0, 1, 3, 2)) * -1.0
    x161 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x161 += einsum(x160, (0, 1, 2, 3), l2.aaaa, (2, 4, 0, 5), (1, 5, 3, 4)) * 2.0
    x162 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x162 += einsum(v.bbaa.vvov, (0, 1, 2, 3), t1.bb, (4, 0), (4, 1, 2, 3))
    x163 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x163 += einsum(t2.bbbb, (0, 1, 2, 3), v.bbaa.ovov, (0, 2, 4, 5), (1, 3, 4, 5))
    x164 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x164 += einsum(x12, (0, 1, 2, 3), t2.baba, (4, 0, 5, 3), (4, 5, 1, 2))
    x165 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x165 += einsum(v.bbaa.ovov, (0, 1, 2, 3), (0, 1, 2, 3))
    x165 += einsum(x162, (0, 1, 2, 3), (0, 1, 2, 3))
    x165 += einsum(x163, (0, 1, 2, 3), (0, 1, 2, 3)) * 2.0
    x165 += einsum(x164, (0, 1, 2, 3), (0, 1, 2, 3)) * -1.0
    x166 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x166 += einsum(l2.baba, (0, 1, 2, 3), x165, (2, 0, 4, 5), (4, 3, 5, 1))
    x167 = np.zeros((nocc[0], nocc[0], nocc[0], nvir[0]), dtype=np.float64)
    x167 += einsum(x6, (0, 1, 2, 3), (0, 1, 2, 3))
    x167 += einsum(x6, (0, 1, 2, 3), (0, 2, 1, 3)) * -1.0
    x168 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x168 += einsum(x1, (0, 1, 2, 3), x167, (0, 4, 2, 5), (4, 1, 5, 3)) * 2.0
    x169 = np.zeros((nocc[0], nocc[0], nocc[0], nvir[0]), dtype=np.float64)
    x169 += einsum(v.aaaa.ooov, (0, 1, 2, 3), (1, 0, 2, 3))
    x169 += einsum(v.aaaa.ooov, (0, 1, 2, 3), (1, 2, 0, 3)) * -1.0
    x170 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x170 += einsum(x1, (0, 1, 2, 3), x169, (0, 2, 4, 5), (4, 1, 5, 3)) * 2.0
    x171 = np.zeros((nvir[0], nvir[0]), dtype=np.float64)
    x171 += einsum(x50, (0, 1), (0, 1))
    x171 += einsum(x51, (0, 1), (0, 1)) * 2.0
    x172 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x172 += einsum(x171, (0, 1), v.aaaa.ovov, (2, 1, 3, 4), (2, 3, 0, 4))
    x173 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x173 += einsum(x60, (0, 1), v.aaaa.ovov, (1, 2, 3, 4), (3, 0, 2, 4)) * 2.0
    x174 = np.zeros((nocc[0], nocc[0], nocc[0], nvir[0]), dtype=np.float64)
    x174 += einsum(v.aaaa.ooov, (0, 1, 2, 3), (1, 0, 2, 3)) * -1.0
    x174 += einsum(x6, (0, 1, 2, 3), (0, 1, 2, 3))
    x175 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x175 += einsum(x174, (0, 1, 2, 3), l1.aa, (4, 0), (1, 2, 3, 4))
    x176 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x176 += einsum(l1.aa, (0, 1), f.aa.ov, (2, 3), (2, 1, 3, 0))
    x176 += einsum(x153, (0, 1, 2, 3), (0, 1, 2, 3)) * -1.0
    x176 += einsum(x154, (0, 1, 2, 3), (0, 1, 2, 3)) * -1.0
    x176 += einsum(x155, (0, 1, 2, 3), (0, 1, 2, 3)) * -1.0
    x176 += einsum(x161, (0, 1, 2, 3), (1, 0, 3, 2))
    x176 += einsum(x166, (0, 1, 2, 3), (1, 0, 3, 2))
    x176 += einsum(x168, (0, 1, 2, 3), (1, 0, 3, 2))
    x176 += einsum(x170, (0, 1, 2, 3), (1, 0, 3, 2))
    x176 += einsum(x172, (0, 1, 2, 3), (1, 0, 2, 3))
    x176 += einsum(x173, (0, 1, 2, 3), (1, 0, 3, 2))
    x176 += einsum(x175, (0, 1, 2, 3), (0, 1, 3, 2))
    x176 += einsum(l1.aa, (0, 1), x148, (2, 3), (1, 2, 0, 3))
    l2new_aaaa += einsum(x176, (0, 1, 2, 3), (2, 3, 0, 1))
    l2new_aaaa += einsum(x176, (0, 1, 2, 3), (3, 2, 0, 1)) * -1.0
    l2new_aaaa += einsum(x176, (0, 1, 2, 3), (2, 3, 1, 0)) * -1.0
    l2new_aaaa += einsum(x176, (0, 1, 2, 3), (3, 2, 1, 0))
    x177 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x177 += einsum(f.aa.vv, (0, 1), l2.aaaa, (2, 1, 3, 4), (3, 4, 0, 2))
    x178 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x178 += einsum(x1, (0, 1, 2, 3), f.aa.ov, (2, 4), (0, 1, 4, 3))
    x179 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x179 += einsum(v.aaaa.ovvv, (0, 1, 2, 3), x1, (4, 5, 0, 2), (5, 4, 1, 3))
    x180 = np.zeros((nvir[0], nvir[0]), dtype=np.float64)
    x180 += einsum(t2.baba, (0, 1, 2, 3), v.bbaa.ovov, (0, 2, 1, 4), (3, 4))
    x181 = np.zeros((nvir[0], nvir[0]), dtype=np.float64)
    x181 += einsum(v.aaaa.ovov, (0, 1, 2, 3), t2.aaaa, (0, 2, 3, 4), (4, 1)) * -1.0
    x182 = np.zeros((nvir[0], nvir[0]), dtype=np.float64)
    x182 += einsum(t1.aa, (0, 1), x53, (0, 1, 2, 3), (2, 3))
    x183 = np.zeros((nvir[0], nvir[0]), dtype=np.float64)
    x183 += einsum(x82, (0, 1), (1, 0)) * -1.0
    x183 += einsum(x180, (0, 1), (1, 0))
    x183 += einsum(x181, (0, 1), (1, 0)) * 2.0
    x183 += einsum(x182, (0, 1), (1, 0)) * -1.0
    x184 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x184 += einsum(x183, (0, 1), l2.aaaa, (1, 2, 3, 4), (3, 4, 0, 2)) * 2.0
    x185 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x185 += einsum(x1, (0, 1, 2, 3), x148, (2, 4), (0, 1, 4, 3)) * 2.0
    x186 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x186 += einsum(v.aaaa.ovov, (0, 1, 2, 3), (2, 0, 3, 1)) * -1.0
    x186 += einsum(x177, (0, 1, 2, 3), (1, 0, 3, 2)) * 2.0
    x186 += einsum(x178, (0, 1, 2, 3), (0, 1, 3, 2)) * 2.0
    x186 += einsum(x179, (0, 1, 2, 3), (0, 1, 3, 2)) * -2.0
    x186 += einsum(x184, (0, 1, 2, 3), (1, 0, 2, 3)) * -1.0
    x186 += einsum(x185, (0, 1, 2, 3), (1, 0, 2, 3))
    l2new_aaaa += einsum(x186, (0, 1, 2, 3), (3, 2, 0, 1))
    l2new_aaaa += einsum(x186, (0, 1, 2, 3), (2, 3, 0, 1)) * -1.0
    x187 = np.zeros((nocc[0], nocc[0], nvir[0], nvir[0]), dtype=np.float64)
    x187 += einsum(l2.aaaa, (0, 1, 2, 3), f.aa.oo, (4, 3), (4, 2, 0, 1))
    l2new_aaaa += einsum(x187, (0, 1, 2, 3), (3, 2, 0, 1)) * -2.0
    l2new_aaaa += einsum(x187, (0, 1, 2, 3), (3, 2, 1, 0)) * 2.0
    x188 = np.zeros((nocc[0], nocc[0], nocc[0], nocc[0]), dtype=np.float64)
    x188 += einsum(v.aaaa.oooo, (0, 1, 2, 3), (2, 3, 1, 0))
    x188 += einsum(x25, (0, 1, 2, 3), (1, 3, 2, 0))
    x188 += einsum(x26, (0, 1, 2, 3), (0, 2, 3, 1))
    l2new_aaaa += einsum(x188, (0, 1, 2, 3), l2.aaaa, (4, 5, 0, 3), (5, 4, 2, 1)) * 2.0
    x189 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x189 += einsum(l1.bb, (0, 1), v.bbaa.vvov, (2, 0, 3, 4), (1, 2, 3, 4))
    l2new_abab += einsum(x189, (0, 1, 2, 3), (3, 1, 2, 0))
    l2new_baba += einsum(x189, (0, 1, 2, 3), (1, 3, 0, 2))
    x190 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x190 += einsum(x1, (0, 1, 2, 3), v.bbaa.ovoo, (4, 5, 1, 2), (4, 5, 0, 3))
    l2new_abab += einsum(x190, (0, 1, 2, 3), (3, 1, 2, 0)) * -2.0
    l2new_baba += einsum(x190, (0, 1, 2, 3), (1, 3, 0, 2)) * -2.0
    x191 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x191 += einsum(x5, (0, 1, 2, 3), x1, (4, 2, 3, 5), (0, 1, 4, 5))
    ...
    x192 += einsum(v.bbaa.ovvv, (0, 1, 2, 3), l1.aa, (3, 4), (0, 1, 4, 2))
    l2new_abab += einsum(x192, (0, 1, 2, 3), (3, 1, 2, 0))
    l2new_baba += einsum(x192, (0, 1, 2, 3), (1, 3, 0, 2))
    x193 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x193 += einsum(x9, (0, 1, 2, 3), x69, (4, 0, 1, 5), (4, 5, 2, 3))
    l2new_abab += einsum(x193, (0, 1, 2, 3), (3, 1, 2, 0)) * -2.0
    l2new_baba += einsum(x193, (0, 1, 2, 3), (1, 3, 0, 2)) * -2.0
    x194 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x194 += einsum(v.bbaa.ovvv, (0, 1, 2, 3), x2, (4, 0, 5, 3), (4, 1, 5, 2))
    l2new_abab += einsum(x194, (0, 1, 2, 3), (3, 1, 2, 0)) * -1.0
    l2new_baba += einsum(x194, (0, 1, 2, 3), (1, 3, 0, 2)) * -1.0
    x195 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x195 += einsum(l2.baba, (0, 1, 2, 3), v.bbaa.vvvv, (0, 4, 5, 1), (2, 4, 3, 5))
    ...
    x196 += einsum(x33, (0, 1, 2, 3), v.bbaa.vvov, (1, 4, 3, 5), (0, 4, 2, 5))
    ...
    x197 += einsum(v.bbaa.ooov, (0, 1, 2, 3), x69, (4, 0, 1, 5), (4, 5, 2, 3))
    l2new_abab += einsum(x197, (0, 1, 2, 3), (3, 1, 2, 0)) * -2.0
    l2new_baba += einsum(x197, (0, 1, 2, 3), (1, 3, 0, 2)) * -2.0
    x198 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x198 += einsum(l2.baba, (0, 1, 2, 3), x160, (3, 4, 1, 5), (2, 0, 4, 5))
    ...
    x199 += einsum(t2.baba, (0, 1, 2, 3), v.bbaa.ovov, (4, 5, 1, 3), (0, 4, 2, 5))
    x200 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x200 += einsum(t2.bbbb, (0, 1, 2, 3), x129, (0, 4, 2, 5), (4, 1, 5, 3)) * 2.0
    x201 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x201 += einsum(t1.bb, (0, 1), x135, (2, 1, 3, 4), (2, 0, 3, 4))
    x202 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x202 += einsum(v.bbbb.ovov, (0, 1, 2, 3), (2, 0, 3, 1))
    x202 += einsum(v.bbbb.oovv, (0, 1, 2, 3), (1, 0, 3, 2)) * -1.0
    x202 += einsum(x199, (0, 1, 2, 3), (0, 1, 2, 3))
    x202 += einsum(x200, (0, 1, 2, 3), (1, 0, 3, 2)) * -1.0
    x202 += einsum(x201, (0, 1, 2, 3), (1, 0, 3, 2)) * -1.0
    x203 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x203 += einsum(x202, (0, 1, 2, 3), l2.baba, (2, 4, 0, 5), (1, 3, 5, 4))
    ...
    x204 += einsum(v.bbaa.ovov, (0, 1, 2, 3), t2.aaaa, (2, 4, 3, 5), (0, 1, 4, 5))
    x205 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x205 += einsum(t2.baba, (0, 1, 2, 3), x101, (0, 4, 5, 2), (4, 5, 1, 3))
    x206 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x206 += einsum(v.bbaa.ovov, (0, 1, 2, 3), (0, 1, 2, 3))
    x206 += einsum(x104, (0, 1, 2, 3), (0, 1, 2, 3))
    x206 += einsum(x204, (0, 1, 2, 3), (0, 1, 2, 3)) * 2.0
    x206 += einsum(x205, (0, 1, 2, 3), (0, 1, 2, 3)) * -1.0
    x207 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x207 += einsum(l2.aaaa, (0, 1, 2, 3), x206, (4, 5, 2, 0), (4, 5, 3, 1)) * 2.0
    l2new_abab += einsum(x207, (0, 1, 2, 3), (3, 1, 2, 0))
    l2new_baba += einsum(x207, (0, 1, 2, 3), (1, 3, 0, 2))
    x208 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x208 += einsum(x165, (0, 1, 2, 3), l2.bbbb, (1, 4, 0, 5), (5, 4, 2, 3)) * 2.0
    l2new_abab += einsum(x208, (0, 1, 2, 3), (3, 1, 2, 0))
    l2new_baba += einsum(x208, (0, 1, 2, 3), (1, 3, 0, 2))
    x209 = np.zeros((nvir[1], nvir[1], nocc[0], nocc[0]), dtype=np.float64)
    x209 += einsum(t2.baba, (0, 1, 2, 3), v.bbaa.ovov, (0, 4, 5, 3), (2, 4, 1, 5))
    x210 = np.zeros((nvir[1], nvir[1], nocc[0], nocc[0]), dtype=np.float64)
    x210 += einsum(v.bbaa.vvoo, (0, 1, 2, 3), (1, 0, 3, 2))
    x210 += einsum(x15, (0, 1, 2, 3), (1, 0, 2, 3))
    x210 += einsum(x209, (0, 1, 2, 3), (0, 1, 2, 3)) * -1.0
    x211 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x211 += einsum(l2.baba, (0, 1, 2, 3), x210, (0, 4, 3, 5), (2, 4, 5, 1))
    ...
    x212 += einsum(v.bbaa.ovvv, (0, 1, 2, 3), t1.bb, (4, 1), (4, 0, 2, 3))
    x213 = np.zeros((nocc[1], nocc[1], nvir[0], nvir[0]), dtype=np.float64)
    x213 += einsum(t2.baba, (0, 1, 2, 3), v.bbaa.ovov, (4, 2, 1, 5), (0, 4, 3, 5))
    x214 = np.zeros((nocc[1], nocc[1], nvir[0], nvir[0]), dtype=np.float64)
    x214 += einsum(v.bbaa.oovv, (0, 1, 2, 3), (1, 0, 3, 2))
    x214 += einsum(x212, (0, 1, 2, 3), (0, 1, 3, 2))
    x214 += einsum(x213, (0, 1, 2, 3), (0, 1, 2, 3)) * -1.0
    x215 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x215 += einsum(x214, (0, 1, 2, 3), l2.baba, (4, 2, 0, 5), (1, 4, 5, 3))
    l2new_abab += einsum(x215, (0, 1, 2, 3), (3, 1, 2, 0)) * -1.0
    l2new_baba += einsum(x215, (0, 1, 2, 3), (1, 3, 0, 2)) * -1.0
    x216 = np.zeros((nocc[1], nocc[1], nocc[0], nocc[0]), dtype=np.float64)
    x216 += einsum(x8, (0, 1, 2, 3), t1.bb, (4, 1), (4, 0, 2, 3))
    x217 = np.zeros((nocc[1], nocc[1], nocc[0], nocc[0]), dtype=np.float64)
    x217 += einsum(v.bbaa.oooo, (0, 1, 2, 3), (1, 0, 3, 2))
    x217 += einsum(x17, (0, 1, 2, 3), (1, 0, 2, 3))
    x217 += einsum(x18, (0, 1, 2, 3), (0, 1, 2, 3))
    x217 += einsum(x216, (0, 1, 2, 3), (0, 1, 3, 2))
    x218 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x218 += einsum(x217, (0, 1, 2, 3), l2.baba, (4, 5, 0, 2), (1, 4, 3, 5))
    l2new_abab += einsum(x218, (0, 1, 2, 3), (3, 1, 2, 0))
    l2new_baba += einsum(x218, (0, 1, 2, 3), (1, 3, 0, 2))
    x219 = np.zeros((nvir[0], nvir[0]), dtype=np.float64)
    x219 += einsum(t1.aa, (0, 1), x83, (0, 1, 2, 3), (2, 3))
    x220 = np.zeros((nvir[0], nvir[0]), dtype=np.float64)
    x220 += einsum(f.aa.vv, (0, 1), (1, 0)) * -1.0
    x220 += einsum(x82, (0, 1), (1, 0)) * -1.0
    x220 += einsum(x180, (0, 1), (0, 1))
    x220 += einsum(x181, (0, 1), (0, 1)) * 2.0
    x220 += einsum(x219, (0, 1), (1, 0)) * -1.0
    x221 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x221 += einsum(x220, (0, 1), l2.baba, (2, 0, 3, 4), (3, 2, 4, 1))
    ...
    x222 += einsum(t2.bbbb, (0, 1, 2, 3), v.bbbb.ovov, (0, 4, 1, 2), (3, 4)) * -1.0
    x223 = np.zeros((nvir[1], nvir[1]), dtype=np.float64)
    x223 += einsum(t2.baba, (0, 1, 2, 3), v.bbaa.ovov, (0, 4, 1, 3), (2, 4))
    x224 = np.zeros((nvir[1], nvir[1]), dtype=np.float64)
    x224 += einsum(t1.bb, (0, 1), x135, (0, 1, 2, 3), (2, 3))
    x225 = np.zeros((nvir[1], nvir[1]), dtype=np.float64)
    x225 += einsum(f.bb.vv, (0, 1), (1, 0)) * -1.0
    x225 += einsum(x134, (0, 1), (1, 0)) * -1.0
    x225 += einsum(x222, (0, 1), (0, 1)) * 2.0
    x225 += einsum(x223, (0, 1), (0, 1))
    x225 += einsum(x224, (0, 1), (1, 0)) * -1.0
    x226 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x226 += einsum(x225, (0, 1), l2.baba, (0, 2, 3, 4), (3, 1, 4, 2))
    l2new_abab += einsum(x226, (0, 1, 2, 3), (3, 1, 2, 0)) * -1.0
    l2new_baba += einsum(x226, (0, 1, 2, 3), (1, 3, 0, 2)) * -1.0
    x227 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x227 += einsum(x36, (0, 1, 2, 3), v.bbaa.ovov, (1, 4, 3, 5), (0, 4, 2, 5))
    l2new_abab += einsum(x227, (0, 1, 2, 3), (3, 1, 2, 0))
    l2new_baba += einsum(x227, (0, 1, 2, 3), (1, 3, 0, 2))
    x228 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x228 += einsum(x2, (0, 1, 2, 3), x19, (1, 4, 2, 5), (0, 4, 5, 3))
    ...
    x229 += einsum(x108, (0, 1, 2, 3), x33, (0, 4, 5, 2), (1, 4, 5, 3))
    ...
    x230 += einsum(x169, (0, 1, 2, 3), x33, (4, 5, 0, 1), (4, 5, 2, 3))
    ...
    x231 += einsum(x6, (0, 1, 2, 3), (0, 1, 2, 3)) * -1.0
    x231 += einsum(x6, (0, 1, 2, 3), (0, 2, 1, 3))
    x232 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x232 += einsum(x231, (0, 1, 2, 3), x33, (4, 5, 0, 1), (4, 5, 2, 3))
    ...
    x233 += einsum(x98, (0, 1, 2, 3), (0, 1, 2, 3)) * -1.0
    x233 += einsum(x98, (0, 1, 2, 3), (0, 2, 1, 3))
    x234 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x234 += einsum(x2, (0, 1, 2, 3), x233, (0, 1, 4, 5), (4, 5, 2, 3))
    ...
    x235 += einsum(x2, (0, 1, 2, 3), x132, (0, 4, 1, 5), (4, 5, 2, 3))
    ...
    x236 += einsum(x91, (0, 1), l2.baba, (2, 3, 4, 0), (4, 2, 1, 3))
    ...
    x237 += einsum(l2.baba, (0, 1, 2, 3), x143, (2, 4), (4, 0, 3, 1))
    ...
    x238 += einsum(x171, (0, 1), v.bbaa.ovov, (2, 3, 4, 1), (2, 3, 4, 0))
    l2new_abab += einsum(x238, (0, 1, 2, 3), (3, 1, 2, 0)) * -1.0
    l2new_baba += einsum(x238, (0, 1, 2, 3), (1, 3, 0, 2)) * -1.0
    x239 = np.zeros((nvir[1], nvir[1]), dtype=np.float64)
    x239 += einsum(x64, (0, 1), (0, 1))
    x239 += einsum(x65, (0, 1), (0, 1)) * 0.5
    x240 = np.zeros((nocc[1], nvir[1], nocc[0], nvir[0]), dtype=np.float64)
    x240 += einsum(x239, (0, 1), v.bbaa.ovov, (2, 1, 3, 4), (2, 0, 3, 4)) * 2.0
    ...
    x241 += einsum(x33, (0, 1, 2, 3), x14, (3, 4), (0, 1, 2, 4))
    ...
    x242 += einsum(x2, (0, 1, 2, 3), x103, (1, 4), (0, 4, 2, 3))
    ...
    x244 += einsum(l1.bb, (0, 1), x108, (1, 2, 3, 4), (2, 0, 3, 4))
    l2new_abab += einsum(x244, (0, 1, 2, 3), (3, 1, 2, 0)) * -1.0
    l2new_baba += einsum(x244, (0, 1, 2, 3), (1, 3, 0, 2)) * -1.0
    x245 = np.zeros((nocc[1], nocc[1]), dtype=np.float64)
    x245 += einsum(x72, (0, 1), (0, 1)) * 0.5
    x245 += einsum(x73, (0, 1), (0, 1))
    x245 += einsum(x74, (0, 1), (0, 1)) * 0.5
    l2new_baba += einsum(v.bbaa.ovov, (0, 1, 2, 3), x245, (4, 0), (1, 3, 4, 2)) * -2.0
    x246 = np.zeros((nocc[1], nocc[1]), dtype=np.float64)
    x246 += einsum(f.bb.ov, (0, 1), t1.bb, (2, 1), (0, 2))
    x247 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x247 += einsum(x246, (0, 1), l2.bbbb, (2, 3, 4, 1), (0, 4, 2, 3))
    x248 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x248 += einsum(x112, (0, 1, 2, 3), l2.bbbb, (4, 5, 1, 0), (2, 3, 4, 5)) * -1.0
    x249 = np.zeros((nocc[1], nvir[1]), dtype=np.float64)
    x249 += einsum(x100, (0, 1), (0, 1))
    x249 += einsum(x102, (0, 1), (0, 1)) * -1.0
    x250 = np.zeros((nocc[1], nocc[1]), dtype=np.float64)
    x250 += einsum(t1.bb, (0, 1), x249, (2, 1), (2, 0))
    x251 = np.zeros((nocc[1], nocc[1]), dtype=np.float64)
    x251 += einsum(x137, (0, 1), (1, 0))
    x251 += einsum(x138, (0, 1), (0, 1)) * 2.0
    x251 += einsum(x139, (0, 1), (0, 1))
    x251 += einsum(x141, (0, 1), (1, 0)) * -1.0
    x251 += einsum(x250, (0, 1), (1, 0))
    x252 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x252 += einsum(x251, (0, 1), l2.bbbb, (2, 3, 0, 4), (1, 4, 2, 3)) * 2.0
    x253 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x253 += einsum(x247, (0, 1, 2, 3), (0, 1, 3, 2)) * 2.0
    x253 += einsum(x248, (0, 1, 2, 3), (0, 1, 3, 2)) * -2.0
    x253 += einsum(x252, (0, 1, 2, 3), (1, 0, 3, 2))
    l2new_bbbb += einsum(x253, (0, 1, 2, 3), (3, 2, 0, 1))
    l2new_bbbb += einsum(x253, (0, 1, 2, 3), (3, 2, 1, 0)) * -1.0
    x254 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x254 += einsum(v.bbbb.ovvv, (0, 1, 2, 3), l1.bb, (3, 4), (4, 0, 1, 2))
    x255 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x255 += einsum(v.bbaa.ovoo, (0, 1, 2, 3), x33, (4, 5, 2, 3), (4, 0, 5, 1))
    x256 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x256 += einsum(x33, (0, 1, 2, 3), x5, (4, 5, 2, 3), (0, 4, 1, 5))
    x257 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x257 += einsum(l2.bbbb, (0, 1, 2, 3), x202, (2, 4, 0, 5), (4, 3, 5, 1)) * 2.0
    x258 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x258 += einsum(l2.baba, (0, 1, 2, 3), x206, (4, 5, 3, 1), (4, 2, 5, 0))
    x259 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x259 += einsum(x98, (0, 1, 2, 3), (0, 1, 2, 3))
    x259 += einsum(x98, (0, 1, 2, 3), (0, 2, 1, 3)) * -1.0
    x260 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x260 += einsum(x69, (0, 1, 2, 3), x259, (0, 4, 2, 5), (4, 1, 5, 3)) * 2.0
    x261 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x261 += einsum(v.bbbb.ooov, (0, 1, 2, 3), (1, 0, 2, 3))
    x261 += einsum(v.bbbb.ooov, (0, 1, 2, 3), (1, 2, 0, 3)) * -1.0
    x262 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x262 += einsum(x261, (0, 1, 2, 3), x69, (0, 4, 1, 5), (2, 4, 3, 5)) * 2.0
    x263 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x263 += einsum(v.bbbb.ovov, (0, 1, 2, 3), x239, (4, 1), (0, 2, 4, 3)) * 2.0
    x264 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x264 += einsum(v.bbbb.ovov, (0, 1, 2, 3), x75, (4, 0), (2, 4, 1, 3))
    x265 = np.zeros((nocc[1], nocc[1], nocc[1], nvir[1]), dtype=np.float64)
    x265 += einsum(v.bbbb.ooov, (0, 1, 2, 3), (1, 0, 2, 3)) * -1.0
    x265 += einsum(x98, (0, 1, 2, 3), (0, 1, 2, 3))
    x266 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x266 += einsum(l1.bb, (0, 1), x265, (1, 2, 3, 4), (2, 3, 4, 0))
    x267 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x267 += einsum(l1.bb, (0, 1), f.bb.ov, (2, 3), (2, 1, 3, 0))
    x267 += einsum(x254, (0, 1, 2, 3), (0, 1, 2, 3)) * -1.0
    x267 += einsum(x255, (0, 1, 2, 3), (0, 1, 2, 3)) * -1.0
    x267 += einsum(x256, (0, 1, 2, 3), (0, 1, 2, 3)) * -1.0
    x267 += einsum(x257, (0, 1, 2, 3), (1, 0, 3, 2))
    x267 += einsum(x258, (0, 1, 2, 3), (1, 0, 3, 2))
    x267 += einsum(x260, (0, 1, 2, 3), (1, 0, 3, 2))
    x267 += einsum(x262, (0, 1, 2, 3), (1, 0, 3, 2))
    x267 += einsum(x263, (0, 1, 2, 3), (1, 0, 2, 3))
    x267 += einsum(x264, (0, 1, 2, 3), (1, 0, 3, 2))
    x267 += einsum(x266, (0, 1, 2, 3), (0, 1, 3, 2))
    x267 += einsum(l1.bb, (0, 1), x249, (2, 3), (1, 2, 0, 3))
    l2new_bbbb += einsum(x267, (0, 1, 2, 3), (2, 3, 0, 1))
    l2new_bbbb += einsum(x267, (0, 1, 2, 3), (3, 2, 0, 1)) * -1.0
    l2new_bbbb += einsum(x267, (0, 1, 2, 3), (2, 3, 1, 0)) * -1.0
    l2new_bbbb += einsum(x267, (0, 1, 2, 3), (3, 2, 1, 0))
    x268 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x268 += einsum(f.bb.vv, (0, 1), l2.bbbb, (2, 1, 3, 4), (3, 4, 0, 2))
    x269 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x269 += einsum(x69, (0, 1, 2, 3), f.bb.ov, (2, 4), (0, 1, 4, 3))
    x270 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x270 += einsum(v.bbbb.ovvv, (0, 1, 2, 3), x69, (4, 5, 0, 3), (5, 4, 1, 2))
    x271 = np.zeros((nvir[1], nvir[1]), dtype=np.float64)
    x271 += einsum(t1.bb, (0, 1), x126, (0, 1, 2, 3), (2, 3))
    x272 = np.zeros((nvir[1], nvir[1]), dtype=np.float64)
    x272 += einsum(x134, (0, 1), (1, 0)) * -1.0
    x272 += einsum(x222, (0, 1), (1, 0)) * 2.0
    x272 += einsum(x223, (0, 1), (1, 0))
    x272 += einsum(x271, (0, 1), (1, 0)) * -1.0
    x273 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x273 += einsum(l2.bbbb, (0, 1, 2, 3), x272, (4, 0), (2, 3, 4, 1)) * 2.0
    x274 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x274 += einsum(x69, (0, 1, 2, 3), x249, (2, 4), (0, 1, 4, 3)) * 2.0
    x275 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x275 += einsum(v.bbbb.ovov, (0, 1, 2, 3), (2, 0, 3, 1)) * -1.0
    x275 += einsum(x268, (0, 1, 2, 3), (1, 0, 3, 2)) * 2.0
    x275 += einsum(x269, (0, 1, 2, 3), (0, 1, 3, 2)) * 2.0
    x275 += einsum(x270, (0, 1, 2, 3), (0, 1, 3, 2)) * -2.0
    x275 += einsum(x273, (0, 1, 2, 3), (1, 0, 2, 3)) * -1.0
    x275 += einsum(x274, (0, 1, 2, 3), (1, 0, 2, 3))
    l2new_bbbb += einsum(x275, (0, 1, 2, 3), (3, 2, 0, 1))
    l2new_bbbb += einsum(x275, (0, 1, 2, 3), (2, 3, 0, 1)) * -1.0
    x276 = np.zeros((nocc[1], nocc[1], nvir[1], nvir[1]), dtype=np.float64)
    x276 += einsum(l2.bbbb, (0, 1, 2, 3), f.bb.oo, (4, 3), (4, 2, 0, 1))
    l2new_bbbb += einsum(x276, (0, 1, 2, 3), (3, 2, 0, 1)) * -2.0
    l2new_bbbb += einsum(x276, (0, 1, 2, 3), (3, 2, 1, 0)) * 2.0
    x277 = np.zeros((nocc[1], nocc[1], nocc[1], nocc[1]), dtype=np.float64)
    x277 += einsum(v.bbbb.oooo, (0, 1, 2, 3), (2, 3, 1, 0))
    x277 += einsum(x110, (0, 1, 2, 3), (1, 3, 2, 0))
    x277 += einsum(x111, (0, 1, 2, 3), (0, 2, 3, 1))
    l2new_bbbb += einsum(x277, (0, 1, 2, 3), l2.bbbb, (4, 5, 0, 3), (5, 4, 2, 1)) * 2.0
...
def make_rdm1_f(f=None, v=None, nocc=None, nvir=None, t1=None, t2=None, l1=None, l2=None, **kwargs):
    ...
    rdm1_f_bb_vv += einsum(t2.bbbb, (0, 1, 2, 3), l2.bbbb, (3, 4, 0, 1), (4, 2)) * -2.0
    ...
    x1 += einsum(t2.aaaa, (0, 1, 2, 3), l2.aaaa, (2, 3, 4, 1), (4, 0))
    rdm1_f_aa_oo += einsum(x1, (0, 1), (1, 0)) * -2.0
    x2 = np.zeros((nocc[0], nocc[0]), dtype=np.float64)
    x2 += einsum(t1.aa, (0, 1), l1.aa, (1, 2), (2, 0))
    ...
    x4 += einsum(l2.baba, (0, 1, 2, 3), t2.baba, (4, 3, 0, 1), (2, 4))
    ...
    x6 += einsum(t1.aa, (0, 1), l2.baba, (2, 1, 3, 4), (3, 2, 4, 0))
