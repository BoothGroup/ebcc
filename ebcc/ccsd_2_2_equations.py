...
def ccsd_2_2_energy(cc, T1, T2, S1, U11):
    ''' Calculate CCSD-2-2 energy. 
        Equation generating script using the 'wick' program found in gen_eqns/ccsd_22_amps.py
    '''
    ...
    E += 1.0*einsum('I,I->', cc.G, S1)
    E += 1.0*einsum('Iai,Iai->', cc.g_mo_blocks.vo, U11)
    E += 1.0*einsum('Iai,ai,I->', cc.g_mo_blocks.vo, T1, S1)

    return E

def amp_updates_ccsd_2_2(cc, autogen=False):
    ''' Solve residual equations for CCSD-2-2.
        Equation generating script using the 'wick' program found in gen_eqns/ccsd_22_amps.py
    '''
    ...
    # Update T1, T2, S1, S2, U11 and U12
    if autogen:
        T1 = F.vo.copy()
        ...
        S1 += 1.0*einsum('Jai,IJai->I', g.vo, U12old)
        ...
        S2 += 1.0*einsum('Kai,K,IJai->IJ', g.vo, S1old, U12old)
        ...
        U11 += -1.0*einsum('Jij,IJaj->Iai', g.oo, U12old)
        U11 += 1.0*einsum('Jba,IJbi->Iai', g.vv, U12old)
        ...
        U11 += -1.0*einsum('Jbj,aj,IJbi->Iai', g.vo, T1old, U12old)
        U11 += -1.0*einsum('Jbj,bi,IJaj->Iai', g.vo, T1old, U12old)
        U11 += 1.0*einsum('Jbj,bj,IJai->Iai', g.vo, T1old, U12old)
        ...
        U12 += -1.0*einsum('Iji,Jaj->IJai', g.oo, U11old)
        U12 += 1.0*einsum('Iab,Jbi->IJai', g.vv, U11old)
        U12 += -1.0*einsum('Jji,Iaj->IJai', g.oo, U11old)
        U12 += 1.0*einsum('Jab,Ibi->IJai', g.vv, U11old)
        U12 += -1.0*einsum('jaib,IJbj->IJai', I.ovov, U12old)
        ...
        U12 += -1.0*einsum('Ijb,aj,Jbi->IJai', g.ov, T1old, U11old)
        U12 += -1.0*einsum('Ijb,bi,Jaj->IJai', g.ov, T1old, U11old)
        U12 += -1.0*einsum('Jjb,aj,Ibi->IJai', g.ov, T1old, U11old)
        U12 += -1.0*einsum('Jjb,bi,Iaj->IJai', g.ov, T1old, U11old)
        U12 += -1.0*einsum('Kij,K,IJaj->IJai', g.oo, S1old, U12old)
        U12 += -1.0*einsum('Kij,IK,Jaj->IJai', g.oo, S2old, U11old)
        U12 += -1.0*einsum('Kij,JK,Iaj->IJai', g.oo, S2old, U11old)
        U12 += 1.0*einsum('Kba,K,IJbi->IJai', g.vv, S1old, U12old)
        U12 += 1.0*einsum('Kba,IK,Jbi->IJai', g.vv, S2old, U11old)
        U12 += 1.0*einsum('Kba,JK,Ibi->IJai', g.vv, S2old, U11old)
        U12 += -1.0*einsum('Kbj,Iaj,JKbi->IJai', g.vo, U11old, U12old)
        U12 += -1.0*einsum('Kbj,Ibi,JKaj->IJai', g.vo, U11old, U12old)
        U12 += 1.0*einsum('Kbj,Ibj,JKai->IJai', g.vo, U11old, U12old)
        U12 += -1.0*einsum('Kbj,Jaj,IKbi->IJai', g.vo, U11old, U12old)
        U12 += -1.0*einsum('Kbj,Jbi,IKaj->IJai', g.vo, U11old, U12old)
        U12 += 1.0*einsum('Kbj,Jbj,IKai->IJai', g.vo, U11old, U12old)
        U12 += 1.0*einsum('Kbj,Kai,IJbj->IJai', g.vo, U11old, U12old)
        U12 += -1.0*einsum('Kbj,Kaj,IJbi->IJai', g.vo, U11old, U12old)
        U12 += -1.0*einsum('Kbj,Kbi,IJaj->IJai', g.vo, U11old, U12old)
        ...
        U12 += 1.0*einsum('jabc,ci,IJbj->IJai', I.ovvv, T1old, U12old)
        U12 += -1.0*einsum('jabc,cj,IJbi->IJai', I.ovvv, T1old, U12old)
        U12 += 1.0*einsum('jabc,Ici,Jbj->IJai', I.ovvv, U11old, U11old)
        U12 += -1.0*einsum('jabc,Icj,Jbi->IJai', I.ovvv, U11old, U11old)
        U12 += 1.0*einsum('jkbc,acji,IJbk->IJai', I.oovv, T2old, U12old)
        U12 += 0.5*einsum('jkbc,ackj,IJbi->IJai', I.oovv, T2old, U12old)
        U12 += 0.5*einsum('jkbc,cbji,IJak->IJai', I.oovv, T2old, U12old)
        U12 += -1.0*einsum('Kbj,K,Iaj,Jbi->IJai', g.vo, S1old, U11old, U11old)
        U12 += -1.0*einsum('Kbj,K,Ibi,Jaj->IJai', g.vo, S1old, U11old, U11old)
        U12 += -1.0*einsum('Kbj,aj,K,IJbi->IJai', g.vo, T1old, S1old, U12old)
        U12 += -1.0*einsum('Kbj,aj,IK,Jbi->IJai', g.vo, T1old, S2old, U11old)
        U12 += -1.0*einsum('Kbj,aj,JK,Ibi->IJai', g.vo, T1old, S2old, U11old)
        U12 += -1.0*einsum('Kbj,bi,K,IJaj->IJai', g.vo, T1old, S1old, U12old)
        U12 += -1.0*einsum('Kbj,bi,IK,Jaj->IJai', g.vo, T1old, S2old, U11old)
        U12 += -1.0*einsum('Kbj,bi,JK,Iaj->IJai', g.vo, T1old, S2old, U11old)
