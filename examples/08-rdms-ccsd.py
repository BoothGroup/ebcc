...
cc = ebccsd.EBCCSD(mol, mf, eri, options={'tthresh': 1e-11, 'diis space': 12}, autogen_code=True)
...
assert(np.allclose(cc.T1[:cc.va, :cc.na],mycc.t1[0].T))
assert(np.allclose(cc.T2[:cc.va, :cc.va, :cc.na, :cc.na],mycc.t2[0].transpose(3,2,1,0)))
...
assert(np.allclose(cc.L1[:cc.na, :cc.va],mycc.l1[0]))
assert(np.allclose(cc.L2[:cc.na, :cc.na, :cc.va, :cc.va], mycc.l2[0]))
...
assert(np.allclose(dm1_eb[:cc.na, :cc.na],dm1[0][:cc.na, :cc.na]))
print('occ-occ 1rdm block correct')
assert(np.allclose(dm1_eb[cc.no:cc.no+cc.va, cc.no:cc.no+cc.va],dm1[0][cc.na:, cc.na:]))
print('virt-virt 1rdm block correct')
#print(dm1_eb[:cc.na, cc.no:cc.no+cc.va]-dm1[0][:cc.na, cc.na:])
assert(np.allclose(dm1_eb[:cc.na, cc.no:cc.no+cc.va],dm1[0][:cc.na, cc.na:]))
print('occ-virt 1rdm block correct')
assert(np.allclose(dm1_eb[cc.no:cc.no+cc.va, :cc.na],dm1[0][cc.na:, :cc.na]))
...
dm1_eb_ghf = utils.reorder_to_ghf(cc, dm1_eb)
dm2_eb_ghf = utils.reorder_to_ghf(cc, dm2_eb)
