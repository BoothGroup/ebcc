...
cc = ebccsd.EBCCSD(mol, myhf, eri, options={'diis space': 12}, rank=(2,1,1), omega=omega, gmat=gmat)
...
cc = ebccsd.EBCCSD(mol, myhf, eri, options={'diis space': 12}, rank=(2,2,1), omega=omega, gmat=gmat)
etot, e_corr = cc.kernel()
...
cc = ebccsd.EBCCSD(mol, myhf, eri, options={'diis space': 12}, rank=(2,2,2), omega=omega, gmat=gmat)
etot, e_corr = cc.kernel()
