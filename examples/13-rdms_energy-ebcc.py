...
def get_e_b(cc, dm1_bb, dm1_coup_cre, dm1_coup_ann, dm_singbos_cre, dm_singbos_ann, dm1_ferm, unshifted_bos):
...
for rank in [(2,1,1)]:
    for shift in [True, False]:
        ...
        E_bos = get_e_b(cc, dm1_bb, dm1_coup_cre, dm1_coup_ann, dm1_b_sing_cre, dm1_b_sing_ann, dm1_eb, unshifted_bos)
